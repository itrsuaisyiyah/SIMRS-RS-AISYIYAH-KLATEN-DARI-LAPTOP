...
public class DlgIKBBayi extends javax.swing.JDialog {
    ...
    public DlgIKBBayi(java.awt.Frame parent, boolean modal) {
        ...
        NoRm.setDocument(new batasInput((byte)15).getOnlyAngka(NoRm));
    ...
    private void initComponents() {
        ...
        MnSKL1.setText("Surat Keterangan Lahir");
        ...
        Proses.setBounds(130, 310, 335, 23);
        ...
        label34.setBounds(0, 310, 126, 23);
        ...
        label41.setBounds(40, 220, 50, 23);
        ...
        BtnPenjab.setBounds(440, 280, 28, 23);
        ...
        label27.setBounds(0, 450, 126, 23);
        ...
        scrollPane2.setBounds(130, 440, 340, 40);
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoRm.getText().trim().equals("")){
            ...
            // Jika No.Rekam Medis (atau No.SKL) yang diisi ternyata sudah
            // dipakai, sistem otomatis pindah ke nomor berikutnya lalu
            // mencoba simpan lagi, sampai berhasil (dibatasi jumlah
            // percobaan supaya tidak berulang tanpa henti).
            if(Sequel.cariIsi("select pasien.no_rkm_medis from pasien where pasien.no_rkm_medis=?",NoRm.getText()).isEmpty()){ 
                if(!sudahSiapkanDataReferensi){
                    ...
                    sudahSiapkanDataReferensi=true;
                }
                if(Sequel.menyimpantf("pasien","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rekam Medis Pasien",36,new String[]{
                    ...
                    try {
                        int n1sum = Valid.SetInteger(tbAPGAR.getValueAt(0,4).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(1,4).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(2,4).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(3,4).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(4,4).toString());
                        int n5sum = Valid.SetInteger(tbAPGAR.getValueAt(0,5).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(1,5).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(2,5).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(3,5).toString())
                                  + Valid.SetInteger(tbAPGAR.getValueAt(4,5).toString());
                        int n10sum = Valid.SetInteger(tbAPGAR.getValueAt(0,6).toString())
                                   + Valid.SetInteger(tbAPGAR.getValueAt(1,6).toString())
                                   + Valid.SetInteger(tbAPGAR.getValueAt(2,6).toString())
                                   + Valid.SetInteger(tbAPGAR.getValueAt(3,6).toString())
                                   + Valid.SetInteger(tbAPGAR.getValueAt(4,6).toString());
                        if(Sequel.menyimpantf("pasien_bayi","'"+NoRm.getText()+"','"+
                                ...
                                KdPenolong.getText()+"','"+NoSKL.getText()+"','"+G.getText()+"','"+P.getText()+"','"+A.getText()+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(0,4).toString())+"','"+Valid.SetInteger(tbAPGAR.getValueAt(1,4).toString())+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(2,4).toString())+"','"+Valid.SetInteger(tbAPGAR.getValueAt(3,4).toString())+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(4,4).toString())+"','"+n1sum+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(0,5).toString())+"','"+Valid.SetInteger(tbAPGAR.getValueAt(1,5).toString())+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(2,5).toString())+"','"+Valid.SetInteger(tbAPGAR.getValueAt(3,5).toString())+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(4,5).toString())+"','"+n5sum+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(0,6).toString())+"','"+Valid.SetInteger(tbAPGAR.getValueAt(1,6).toString())+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(2,6).toString())+"','"+Valid.SetInteger(tbAPGAR.getValueAt(3,6).toString())+"','"+
                                Valid.SetInteger(tbAPGAR.getValueAt(4,6).toString())+"','"+n10sum+"','"+
                                Resusitas.getText()+"','"+ObatDiberikan.getText()+"','"+
                            ...
                            sudahSiapkanDataReferensi=false;
                            percobaanNoRm=0;
                            percobaanNoSkl=0;
                            emptTeks();
                        }else{
                            // Gagal simpan pasien_bayi meski No.Rekam Medis baru
                            // saja berhasil dibuat -> kemungkinan No.SKL bentrok,
                            // bukan No.Rekam Medis. Tidak dibatasi jumlah percobaan.
                            Sequel.meghapus("pasien","no_rkm_medis",NoRm.getText());
                            cobaNomorSklBerikutnya(evt);
                        }
                    } catch (Exception e) {
                        Sequel.meghapus("pasien","no_rkm_medis",NoRm.getText());
                        cobaNomorSklBerikutnya(evt);
                    ...
                    // No.Rekam Medis bentrok saat disimpan (dipakai pihak lain
                    // di saat bersamaan) -> coba No.Rekam Medis berikutnya
                    cobaNomorRmBerikutnya(evt);
                }
            }else{
                try {
                    int n1sum = Valid.SetInteger(tbAPGAR.getValueAt(0,4).toString())
                    ...
                    if(Sequel.menyimpantf("pasien_bayi","'"+NoRm.getText()+"','"+
                        ...
                        // No.Rekam Medis ini sudah ada isian data bayinya
                        // -> otomatis pindah ke No.Rekam Medis berikutnya (maks 3x)
                        cobaNomorRmBerikutnya(evt);
                    }
                } catch (Exception e) {
                    cobaNomorRmBerikutnya(evt);
    ...
    // Dipakai oleh BtnSimpanActionPerformed saat No.Rekam Medis yang diisi
    // ternyata sudah dipakai: otomatis ambil No.Rekam Medis berikutnya lalu
    // ulangi proses simpan. Dibatasi maksimal 3 kali percobaan.
    private void cobaNomorRmBerikutnya(java.awt.event.ActionEvent evt){
        percobaanNoRm++;
        if(percobaanNoRm>3){
            percobaanNoRm=0;
            percobaanNoSkl=0;
            sudahSiapkanDataReferensi=false;
            JOptionPane.showMessageDialog(null,"Gagal menyimpan kelahiran bayi, No.Rekam Medis sudah dicoba 3 kali dan tetap terpakai, silahkan periksa data yang mau disimpan..!!");
            return;
        }
        Kd2.setText("");
        autoNomor();
    ...
    // Dipakai oleh BtnSimpanActionPerformed saat No.SKL yang diisi ternyata
    // sudah dipakai: otomatis ambil No.SKL berikutnya lalu ulangi proses
    // simpan. Tidak dibatasi jumlah percobaan (hanya No.Rekam Medis yang
    // dibatasi 3 kali).
    private void cobaNomorSklBerikutnya(java.awt.event.ActionEvent evt){
        percobaanNoSkl++;
        autoSKL();
        BtnSimpanActionPerformed(evt);
    }
...
private void BtnEditActionPerformed1(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed1
        ...
        // Saat Ganti/Edit, HANYA tabel pasien_bayi yang diperbarui.
        // Tabel pasien (data master No.RM, Nama Bayi, J.K, Nama Ibu,
        // Alamat Ibu, Nama Ayah, dsb.) tidak ikut diubah dari sini.
        Valid.editTable(tabMode,"pasien_bayi","no_rkm_medis",Kd2,
...
//                            tbAPGAR.getValueAt(3,6).toString()+"','"+tbAPGAR.getValueAt(4,6).toString()+"','"+N10.getText()+"','"+Resusitas.getText()+"','"+ObatDiberikan.getText()+"','"+
    ...
    */
    ...
    // Penanda untuk mekanisme otomatis pindah ke nomor berikutnya saat
    // No.Rekam Medis atau No.SKL yang diisi sudah dipakai.
    // Percobaan No.Rekam Medis dibatasi maksimal 3 kali; No.SKL tidak dibatasi.
    private int percobaanNoRm=0;
    private int percobaanNoSkl=0;
    private boolean sudahSiapkanDataReferensi=false;
    ...
    public void emptTeks() {
        // Aktifkan kembali field No.RM Bayi, Nama Ibu, Nama Ayah,
        // Alamat Ibu, dan J.K Bayi untuk input data baru
        NoRm.setEditable(true);
        Nmibu.setEditable(true);
        NmAyah.setEditable(true);
        AlamatIbu.setEditable(true);
        JKel.setEnabled(true);
 ...
 //       N10.setText("");
    ...
    private void getData() {
        if(tbDokter.getSelectedRow()!= -1){
            ...
            // Nama Ibu, Nama Ayah, Alamat Ibu, dan J.K Bayi selalu diambil
            // otomatis (live) dari tabel pasien (data master), bukan dari
            // cache tabel pasien_bayi, supaya selalu sinkron/terbaru.
            String jkPasien=Sequel.cariIsi("select pasien.jk from pasien where pasien.no_rkm_medis=?",NoRm.getText());
            if(jkPasien.equals("L")){
                JKel.setSelectedItem("LAKI-LAKI");
            }else if(jkPasien.equals("P")){
            ...
            Sequel.cariIsi(
                    "select pasien.nm_ibu from pasien where pasien.no_rkm_medis=?",
                    Nmibu,
                    NoRm.getText()
            );
            ...
            Sequel.cariIsi(
                    "select pasien.alamat from pasien where pasien.no_rkm_medis=?",
                    AlamatIbu,
                    NoRm.getText()
            );
...
//            N10.setText(tbDokter.getValueAt(tbDokter.getSelectedRow(),45).toString());
            ...
            // No.RM Bayi, Nama Ibu, Nama Ayah, dan Alamat Ibu tidak boleh
            // diubah saat mode edit/ganti data. J.K Bayi tetap bisa diedit.
            NoRm.setEditable(false);
            Nmibu.setEditable(false);
            NmAyah.setEditable(false);
