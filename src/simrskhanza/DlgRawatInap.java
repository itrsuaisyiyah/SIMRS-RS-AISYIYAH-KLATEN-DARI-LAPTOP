...
import laporan.DlgStatusDataRM1;
...
import rekammedis.RMChecklistKriteriaKeluarBBRT;
import rekammedis.RMChecklistKriteriaMasukNICU;
import rekammedis.RMChecklistKriteriaMasukPICU;
import rekammedis.RMChecklistKriteriaMasukBBRT;
...
import rekammedis.RMStandarAsuhanKeperawatan;
import rekammedis.RMTbak;
import rekammedis.RMTimeOutSebelumInsisi;
import rekammedis.RMTransferPasienAntarRuang;
import rekammedis.StatusVerifikasiSOAP;
...
public final class DlgRawatInap extends javax.swing.JDialog {
    ...
    private static String lastKeluhan="";
    private static String lastPemeriksaan="";
    private static String lastPenilaian="";
    private static String lastRTL="";
    // Posisi scroll menu kiri (ScrollMenu) terakhir, disimpan static supaya tetap "diingat"
    // lintas buka-tutup dialog / lintas pasien. Lihat komentar lengkap di constructor.
    private static final java.awt.Point posisiScrollMenuTerakhir = new java.awt.Point(0,0);
    private static String lastInstruksi="";
    private static String lastEvaluasi="";
    private static String lastAlergi="";
    private static String lastTensi="";
    private static String lastRespirasi="";
    private static String lastTinggi="";
    private static String lastTD="";
    private static String lastNadi="";
    private static String lastRR="";
    private static String lastSuhu="";
    private static String lastBerat="";
    private static String lastTB="";
    private static String lastSpO2="";
    private static String lastGCS="";
    private static String lastKesadaran="";
    // Variabel khusus restore saat tombol Batal diklik
private static String batalKeluhan="";
private static String batalPemeriksaan="";
private static String batalPenilaian="";
private static String batalRTL="";
private static String batalInstruksi="";
private static String batalEvaluasi="";
private static String batalAlergi="";
private static String batalTensi="";
private static String batalRespirasi="";
private static String batalTinggi="";
private static String batalTD="";
private static String batalNadi="";
private static String batalRR="";
private static String batalSuhu="";
private static String batalBerat="";
private static String batalTB="";
private static String batalSpO2="";
private static String batalGCS="";
private static String batalKesadaran="";
    ...
    public DlgRawatInap(java.awt.Frame parent, boolean modal) {
        ...
        // Posisi scroll menu kiri (ScrollMenu) disimpan di field STATIC supaya tetap "diingat"
        // walau dialog ini ditutup lalu dibuka lagi untuk pasien lain (baik dialog di-reuse
        // maupun dibuat ulang dengan "new DlgRawatInap(...)"). Sebelumnya posisi hanya
        // dipertahankan selama isCek() dipanggil pada instance yang sama - begitu dialog
        // ditutup lalu dibuka lagi, posisi ikut hilang karena instance/lifecycle-nya berbeda.
        //
        // 1) ChangeListener di bawah terus-menerus mencatat posisi scroll TERBARU setiap kali
        //    user scroll manual, supaya posisi yang tersimpan selalu akurat.
        // 2) ComponentListener (componentShown) mengembalikan posisi tersimpan setiap kali
        //    dialog ini benar-benar tampil di layar lagi - ini menutup celah yang tidak
        //    tertangani oleh fix sebelumnya di isCek() (yang hanya menangani resize FormMenu,
        //    bukan siklus tutup-buka dialog).
        ScrollMenu.getViewport().addChangeListener(evt -> {
            posisiScrollMenuTerakhir.setLocation(ScrollMenu.getViewport().getViewPosition());
        });
        this.addComponentListener(new java.awt.event.ComponentAdapter() {
            @Override
            public void componentShown(java.awt.event.ComponentEvent evt) {
                // invokeLater dipanggil 2x berantai supaya eksekusinya "jatuh" setelah
                // seluruh proses validate/layout akibat setVisible(true) benar-benar selesai
                // (kalau cuma 1x invokeLater, kadang masih kalah cepat dengan layout pass
                // berikutnya yang balik me-reset viewport ke atas).
                SwingUtilities.invokeLater(() -> SwingUtilities.invokeLater(() -> {
                    javax.swing.JViewport vp = ScrollMenu.getViewport();
                    java.awt.Dimension ukuranView = FormMenu.getPreferredSize();
                    int maxX = Math.max(0, ukuranView.width - vp.getWidth());
                    int maxY = Math.max(0, ukuranView.height - vp.getHeight());
                    int x = Math.min(posisiScrollMenuTerakhir.x, maxX);
                    int y = Math.min(posisiScrollMenuTerakhir.y, maxY);
    ...
    private void initComponents() {
        ...
        BtnInputTerimaPasienAntarRuang2 = new widget.Button();
        ...
        BtnAsuhanKeperawatan = new widget.Button();
        BtnVerifikasiSOAP = new widget.Button();
        BtnDataVerifikasiSOAP = new widget.Button();
        ...
        BtnAwalMedisKulitDanKelamin = new widget.Button();
        ...
        BtnChecklistKriteriaKeluarBBRT = new widget.Button();
        ...
        BtnChecklistKriteriaMasukBBRT = new widget.Button();
        ...
        jLabel4.setBounds(300, 160, 70, 23);

        TTensi.setHighlighter(null);
        TTensi.setName("TTensi"); // NOI18N
        TTensi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TTensiActionPerformed(evt);
            }
        });
        ...
        TTensi.setBounds(380, 160, 55, 23);
        ...
        BtnInputResume.setBounds(1100, 80, 160, 30);
        ...
        BtnHasilRadiologi.setBounds(1100, 110, 160, 30);

        jLabel17.setText("BB (Kg) :");
        ...
        BtnBalanceCairan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnBalanceCairan1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnBalanceCairan1.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        BtnBalanceCairan1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnBalanceCairan1ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnBalanceCairan1);
        BtnBalanceCairan1.setBounds(910, 190, 160, 26);

        BtnInputTerimaPasienAntarRuang2.setForeground(new java.awt.Color(0, 0, 0));
        BtnInputTerimaPasienAntarRuang2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/inventaris.png"))); // NOI18N
        BtnInputTerimaPasienAntarRuang2.setMnemonic('4');
        BtnInputTerimaPasienAntarRuang2.setText("Status Data RM");
        BtnInputTerimaPasienAntarRuang2.setToolTipText("");
        BtnInputTerimaPasienAntarRuang2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnInputTerimaPasienAntarRuang2.setGlassColor(new java.awt.Color(204, 204, 255));
        BtnInputTerimaPasienAntarRuang2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnInputTerimaPasienAntarRuang2.setMaximumSize(new java.awt.Dimension(144, 32));
        BtnInputTerimaPasienAntarRuang2.setMinimumSize(new java.awt.Dimension(144, 32));
        BtnInputTerimaPasienAntarRuang2.setName("BtnInputTerimaPasienAntarRuang2"); // NOI18N
        BtnInputTerimaPasienAntarRuang2.setPreferredSize(new java.awt.Dimension(144, 32));
        BtnInputTerimaPasienAntarRuang2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnInputTerimaPasienAntarRuang2ActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnInputTerimaPasienAntarRuang2);
        BtnInputTerimaPasienAntarRuang2.setBounds(910, 220, 160, 26);

        BtnPermintaanKonsultasiMedik.setForeground(new java.awt.Color(0, 0, 0));
        BtnPermintaanKonsultasiMedik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnPermintaanKonsultasiMedik.setMnemonic('4');
        BtnPermintaanKonsultasiMedik.setText("Konsultasi Medik");
        BtnPermintaanKonsultasiMedik.setToolTipText("");
        BtnPermintaanKonsultasiMedik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPermintaanKonsultasiMedik.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        panelGlass12.add(BtnPermintaanKonsultasiMedik);
        BtnPermintaanKonsultasiMedik.setBounds(1100, 140, 160, 26);
        ...
        BtnDataSbar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Doctor.png"))); // NOI18N
        BtnDataSbar.setMnemonic('4');
        BtnDataSbar.setText("Verifikasi SBAR");
        ...
        BtnDataSbar.setName("BtnDataSbar"); // NOI18N
        BtnDataSbar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDataSbarActionPerformed(evt);
            }
        });
        ...
        BtnDataVerifikasiSbar.setText("Status Verifikasi SBAR");
        ...
        BtnDataVerifikasiSbar.setName("BtnDataVerifikasiSbar"); // NOI18N
        BtnDataVerifikasiSbar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDataVerifikasiSbarActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnDataVerifikasiSbar);
        BtnDataVerifikasiSbar.setBounds(910, 70, 160, 26);

        BtnAsuhanKeperawatan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Surgeon SH.png"))); // NOI18N
        BtnAsuhanKeperawatan.setMnemonic('4');
        BtnAsuhanKeperawatan.setText("Asuhan Keperawatan");
        BtnAsuhanKeperawatan.setToolTipText("");
        BtnAsuhanKeperawatan.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAsuhanKeperawatan.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnAsuhanKeperawatan.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAsuhanKeperawatan.setName("BtnAsuhanKeperawatan"); // NOI18N
        BtnAsuhanKeperawatan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAsuhanKeperawatanActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnAsuhanKeperawatan);
        BtnAsuhanKeperawatan.setBounds(1100, 20, 160, 26);
        ...
        BtnVerifikasiSOAP.setMnemonic('4');
        ...
        BtnVerifikasiSOAP.setGlassColor(new java.awt.Color(0, 255, 0));
        ...
        BtnVerifikasiSOAP.setBounds(910, 110, 160, 26);

        BtnDataVerifikasiSOAP.setForeground(new java.awt.Color(0, 0, 0));
        BtnDataVerifikasiSOAP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnDataVerifikasiSOAP.setMnemonic('4');
        BtnDataVerifikasiSOAP.setText("Status Verifikasi SOAP");
        BtnDataVerifikasiSOAP.setToolTipText("ALt+4");
        BtnDataVerifikasiSOAP.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDataVerifikasiSOAP.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnDataVerifikasiSOAP.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDataVerifikasiSOAP.setName("BtnDataVerifikasiSOAP"); // NOI18N
        BtnDataVerifikasiSOAP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDataVerifikasiSOAPActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnDataVerifikasiSOAP);
        BtnDataVerifikasiSOAP.setBounds(910, 140, 160, 26);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2026" }));
        ...
        ScrollMenu.setPreferredSize(new java.awt.Dimension(355, 43));
        ...
        BtnAwalMedisKandungan.setText("Awal Medis Ranap Kandungan");
        ...
        BtnAwalMedisAnak.setText("Awal Medis Ranap Anak");
        ...
        BtnAwalMedisBedah.setText("Awal Medis Ranap Bedah");
        ...
        BtnAwalMedisBedahMulut.setText("Awal Medis Ranap Bedah Mulut");
        ...
        BtnAwalMedisGeriatri.setText("Awal Medis Ranap Geriatri");
        ...
        BtnAwalMedisHemodialisa.setText("Awal Medis Ranap Hemodialisa");
        ...
        BtnAwalMedisKulitDanKelamin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisKulitDanKelamin.setText("Awal Medis Ranap Kulit Kelamin");
        BtnAwalMedisKulitDanKelamin.setFocusPainted(false);
        BtnAwalMedisKulitDanKelamin.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnAwalMedisKulitDanKelamin.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnAwalMedisKulitDanKelamin.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnAwalMedisKulitDanKelamin.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnAwalMedisKulitDanKelamin.setName("BtnAwalMedisKulitDanKelamin"); // NOI18N
        BtnAwalMedisKulitDanKelamin.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnAwalMedisKulitDanKelamin.setRoundRect(false);
        BtnAwalMedisKulitDanKelamin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnAwalMedisKulitDanKelaminActionPerformed(evt);
            }
        });
        FormMenu.add(BtnAwalMedisKulitDanKelamin);

        BtnAwalMedisMata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnAwalMedisMata.setText("Awal Medis Ranap Mata");
        ...
        BtnAwalMedisNeurologi.setText("Awal Medis Ranap Neurologi");
        ...
        BtnAwalMedisOrthopedi.setText("Awal Medis Ranap Orthopedi");
        ...
        BtnAwalMedisParu.setText("Awal Medis Ranap Paru");
        ...
        BtnAwalMedisPenyakitDalam.setText("Awal Medis Ranap Penyakit Dalam");
        ...
        BtnAwalMedisPsikiatri.setText("Awal Medis Ranap Psikiatri");
        ...
        BtnAwalMedisRehabMedik.setText("Awal Medis Ranap Rehab Medik");
        ...
        BtnAwalMedisTHT.setText("Awal Medis Ranap THT");
        ...
        BtnCatatanObservasiVentilator.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnCatatanObservasiVentilator.setText("Observasi Ventilator");
        BtnCatatanObservasiVentilator.setFocusPainted(false);
        BtnCatatanObservasiVentilator.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnCatatanObservasiVentilator.setName("BtnCatatanObservasiVentilator"); // NOI18N
        ...
        BtnCatatanObservasiVentilator.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCatatanObservasiVentilatorActionPerformed(evt);
            }
        });
        ...
        BtnChecklistKriteriaKeluarBBRT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnChecklistKriteriaKeluarBBRT.setText("Check List Keluar BBRT");
        BtnChecklistKriteriaKeluarBBRT.setFocusPainted(false);
        BtnChecklistKriteriaKeluarBBRT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnChecklistKriteriaKeluarBBRT.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnChecklistKriteriaKeluarBBRT.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnChecklistKriteriaKeluarBBRT.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnChecklistKriteriaKeluarBBRT.setName("BtnChecklistKriteriaKeluarBBRT"); // NOI18N
        BtnChecklistKriteriaKeluarBBRT.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnChecklistKriteriaKeluarBBRT.setRoundRect(false);
        BtnChecklistKriteriaKeluarBBRT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChecklistKriteriaKeluarBBRTActionPerformed(evt);
            }
        });
        FormMenu.add(BtnChecklistKriteriaKeluarBBRT);
        ...
        BtnChecklistKriteriaKeluarNICU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnChecklistKriteriaKeluarNICU.setText("Check List Keluar NICU");
        BtnChecklistKriteriaKeluarNICU.setFocusPainted(false);
        BtnChecklistKriteriaKeluarNICU.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaKeluarNICU.setName("BtnChecklistKriteriaKeluarNICU"); // NOI18N
        ...
        BtnChecklistKriteriaKeluarNICU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChecklistKriteriaKeluarNICUActionPerformed(evt);
            }
        });
        FormMenu.add(BtnChecklistKriteriaKeluarNICU);

        BtnChecklistKriteriaKeluarPICU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnChecklistKriteriaKeluarPICU.setText("Check List Keluar PICU");
        BtnChecklistKriteriaKeluarPICU.setFocusPainted(false);
        BtnChecklistKriteriaKeluarPICU.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaKeluarPICU.setName("BtnChecklistKriteriaKeluarPICU"); // NOI18N
        ...
        BtnChecklistKriteriaKeluarPICU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChecklistKriteriaKeluarPICUActionPerformed(evt);
            }
        });
        FormMenu.add(BtnChecklistKriteriaKeluarPICU);

        BtnChecklistKriteriaMasukBBRT.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnChecklistKriteriaMasukBBRT.setText("Check List Masuk BBRT");
        BtnChecklistKriteriaMasukBBRT.setFocusPainted(false);
        BtnChecklistKriteriaMasukBBRT.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnChecklistKriteriaMasukBBRT.setGlassColor(new java.awt.Color(255, 255, 255));
        BtnChecklistKriteriaMasukBBRT.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnChecklistKriteriaMasukBBRT.setMargin(new java.awt.Insets(1, 1, 1, 1));
        BtnChecklistKriteriaMasukBBRT.setName("BtnChecklistKriteriaMasukBBRT"); // NOI18N
        BtnChecklistKriteriaMasukBBRT.setPreferredSize(new java.awt.Dimension(190, 23));
        BtnChecklistKriteriaMasukBBRT.setRoundRect(false);
        BtnChecklistKriteriaMasukBBRT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChecklistKriteriaMasukBBRTActionPerformed(evt);
            }
        });
        FormMenu.add(BtnChecklistKriteriaMasukBBRT);
        ...
        BtnChecklistKriteriaMasukNICU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnChecklistKriteriaMasukNICU.setText("Check List Masuk NICU");
        BtnChecklistKriteriaMasukNICU.setFocusPainted(false);
        BtnChecklistKriteriaMasukNICU.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaMasukNICU.setName("BtnChecklistKriteriaMasukNICU"); // NOI18N
        ...
        BtnChecklistKriteriaMasukNICU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChecklistKriteriaMasukNICUActionPerformed(evt);
            }
        });
        FormMenu.add(BtnChecklistKriteriaMasukNICU);

        BtnChecklistKriteriaMasukPICU.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/item.png"))); // NOI18N
        BtnChecklistKriteriaMasukPICU.setText("Check List Masuk PICU");
        BtnChecklistKriteriaMasukPICU.setFocusPainted(false);
        BtnChecklistKriteriaMasukPICU.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ...
        BtnChecklistKriteriaMasukPICU.setName("BtnChecklistKriteriaMasukPICU"); // NOI18N
        ...
        BtnChecklistKriteriaMasukPICU.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnChecklistKriteriaMasukPICUActionPerformed(evt);
            }
        });
    ...
    private void BtnBatalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBatalActionPerformed
        ...
        TKeluhan.setText(batalKeluhan);
        TPemeriksaan.setText(batalPemeriksaan);
        TPenilaian.setText(batalPenilaian);
        TindakLanjut.setText(batalRTL);
        TInstruksi.setText(batalInstruksi);
        TEvaluasi.setText(batalEvaluasi);
        TAlergi.setText(batalAlergi);
        TSuhu.setText(batalSuhu);
        TTensi.setText(batalTensi);
        TNadi.setText(batalNadi);
        TRespirasi.setText(batalRespirasi);
        TTinggi.setText(batalTinggi);
        TBerat.setText(batalBerat);
        SpO2.setText(batalSpO2);
        TGCS.setText(batalGCS);

        if(!batalKesadaran.equals("")){
        cmbKesadaran.setSelectedItem(batalKesadaran);
}
}//GEN-LAST:event_BtnBatalActionPerformed

        private void simpanDataBatal(){
        batalKeluhan     = TKeluhan.getText();
        batalPemeriksaan = TPemeriksaan.getText();
        batalPenilaian   = TPenilaian.getText();
        batalRTL         = TindakLanjut.getText();
        batalInstruksi   = TInstruksi.getText();
        batalEvaluasi    = TEvaluasi.getText();
        batalAlergi      = TAlergi.getText();
        batalTensi       = TTensi.getText();
        batalRespirasi   = TRespirasi.getText();
        batalTinggi      = TTinggi.getText();
        batalTD          = TTensi.getText();
        batalNadi        = TNadi.getText();
        batalRR          = TRespirasi.getText();
        batalSuhu        = TSuhu.getText();
        batalBerat       = TBerat.getText();
        batalTB          = TTinggi.getText();
        batalSpO2        = SpO2.getText();
        batalGCS         = TGCS.getText();

        if(cmbKesadaran.getSelectedItem()!=null){
            batalKesadaran = cmbKesadaran.getSelectedItem().toString();
        }else{
            batalKesadaran = "";
        }
    }
...
private void BtnEditKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnEditKeyPressed
    ...
    private void BtnAwalMedisOrthopediActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisOrthopediActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapOrthopedi form = new RMPenilaianAwalMedisRanapOrthopedi(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
     ...
     private void BtnAwalMedisParuActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapParu form = new RMPenilaianAwalMedisRanapParu(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
     ...
     private void BtnAwalMedisMataActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapMata form = new RMPenilaianAwalMedisRanapMata(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
      ...
      private void BtnAwalMedisPsikiatriActionPerformed(java.awt.event.ActionEvent evt) {                                                 
       ...
       private void BtnAwalMedisNeurologiActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapNeurologi form = new RMPenilaianAwalMedisRanapNeurologi(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
        ...
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapGeriatri form = new RMPenilaianAwalMedisRanapGeriatri(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
           ...
           private void BtnAwalMedisKulitDanKelaminActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
        ...
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapRehabMedik form = new RMPenilaianAwalMedisRanapRehabMedik(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
        ...
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getDefaultCursor());
             ...
             private void BtnAwalMedisPenyakitDalamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAwalMedisParuActionPerformed
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMPenilaianAwalMedisRanapPenyakitDalam form = new RMPenilaianAwalMedisRanapPenyakitDalam(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void BtnChecklistKriteriaKeluarPICUActionPerformed(java.awt.event.ActionEvent evt) {                                                              
     ...
     private void BtnChecklistKriteriaMasukBBRTActionPerformed(java.awt.event.ActionEvent evt) {                                                             
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMChecklistKriteriaMasukBBRT form=new RMChecklistKriteriaMasukBBRT(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void BtnChecklistKriteriaKeluarBBRTActionPerformed(java.awt.event.ActionEvent evt) {                                                              
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMChecklistKriteriaKeluarBBRT form=new RMChecklistKriteriaKeluarBBRT(null,false);
            form.isCek();
            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
    ...
    private void BtnChecklistKriteriaMasukNICUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnChecklistKriteriaMasukHCUActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    private void BtnChecklistKriteriaKeluarNICUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnChecklistKriteriaKeluarHCUActionPerformed
        if(TPasien.getText().trim().equals("")||TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    private void TTensiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TTensiActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TTensiActionPerformed
    ...
    private void BtnInputTerimaPasienAntarRuang2ActionPerformed(java.awt.event.ActionEvent evt) {                                                                
        DlgStatusDataRM1 form=new DlgStatusDataRM1(null,false);
        form.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
        form.setLocationRelativeTo(internalFrame1);
    ...
    private void BtnInputResumeActionPerformed(java.awt.event.ActionEvent evt) {                                               
        if(TNoRw.getText().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
    ...
    */
    ...
    private widget.Button BtnAsuhanKeperawatan;
    ...
    private widget.Button BtnAwalMedisKulitDanKelamin;
    ...
    private widget.Button BtnCatatanObservasiVentilator;
    private widget.Button BtnCatatanPersalinan;
    private widget.Button BtnChecklistKriteriaKeluarBBRT;
    private widget.Button BtnChecklistKriteriaKeluarHCU;
    private widget.Button BtnChecklistKriteriaKeluarICU;
    private widget.Button BtnChecklistKriteriaKeluarNICU;
    private widget.Button BtnChecklistKriteriaKeluarPICU;
    private widget.Button BtnChecklistKriteriaMasukBBRT;
    private widget.Button BtnChecklistKriteriaMasukHCU;
    private widget.Button BtnChecklistKriteriaMasukICU;
    private widget.Button BtnChecklistKriteriaMasukNICU;
    private widget.Button BtnChecklistKriteriaMasukPICU;
    ...
    private widget.Button BtnDataVerifikasiSOAP;
    ...
    private widget.Button BtnInputTerimaPasienAntarRuang2;
    ...
    // LOAD SOAP TERAKHIR
    // ===============================
    TKeluhan.setText(lastKeluhan);
    TPemeriksaan.setText(lastPemeriksaan);
    TPenilaian.setText(lastPenilaian);
    TindakLanjut.setText(lastRTL);
    TInstruksi.setText(lastInstruksi);
    TEvaluasi.setText(lastEvaluasi);
    TAlergi.setText(lastAlergi);

    TSuhu.setText(lastSuhu);
    TTensi.setText(lastTensi);
    TNadi.setText(lastNadi);
    TRespirasi.setText(lastRespirasi);
    TTinggi.setText(lastTinggi);
    TBerat.setText(lastBerat);
    SpO2.setText(lastSpO2);
    TGCS.setText(lastGCS);

    if(!lastKesadaran.equals("")){
        cmbKesadaran.setSelectedItem(lastKesadaran);
    }
    // ===============================
    ...
    public void isCek(){
        tinggi=0;
        // Simpan posisi scroll menu kiri SEBELUM ukuran FormMenu dihitung ulang.
        // FormMenu.setPreferredSize() di bawah akan memicu revalidate() pada ScrollMenu,
        // yang secara default me-reset viewport ke posisi paling atas (0,0).
        // Posisi ini akan dikembalikan setelah resize selesai, supaya menu tidak
        // balik ke atas setiap kali pasien diganti. Pakai field static posisiScrollMenuTerakhir
        // yang sama dengan yang dipakai componentShown di constructor, supaya konsisten.
        final java.awt.Point posisiScrollMenuSebelum = new java.awt.Point(posisiScrollMenuTerakhir);
        ...
        BtnChecklistKriteriaMasukPICU.setVisible(akses.getchecklist_kriteria_masuk_picu()); 
        if(akses.getchecklist_kriteria_masuk_picu()==true){
            tinggi=tinggi+24;
        }
        BtnChecklistKriteriaKeluarPICU.setVisible(akses.getchecklist_kriteria_keluar_picu()); 
        if(akses.getchecklist_kriteria_keluar_picu()==true){
            tinggi=tinggi+24;
        }
        BtnChecklistKriteriaMasukBBRT.setVisible(akses.getchecklist_kriteria_masuk_bbrt()); 
        if(akses.getchecklist_kriteria_masuk_bbrt()==true){
            tinggi=tinggi+24;
        }
        BtnChecklistKriteriaKeluarBBRT.setVisible(akses.getchecklist_kriteria_keluar_bbrt()); 
        if(akses.getchecklist_kriteria_keluar_bbrt()==true){
            tinggi=tinggi+24;
        }
        BtnChecklistKriteriaMasukNICU.setVisible(akses.getchecklist_kriteria_masuk_nicu()); 
        if(akses.getchecklist_kriteria_masuk_nicu()==true){
            tinggi=tinggi+24;
        }
        BtnChecklistKriteriaKeluarNICU.setVisible(akses.getchecklist_kriteria_keluar_nicu()); 
        if(akses.getchecklist_kriteria_keluar_nicu()==true){
            tinggi=tinggi+24;
        }
        ...
        FormMenu.setPreferredSize(new Dimension(200, tinggi + 1000));
        FormMenu.revalidate();
        FormMenu.repaint();
        ...
        // Kembalikan posisi scroll menu kiri setelah resize selesai. Dijalankan lewat
        // invokeLater supaya dieksekusi SETELAH Swing selesai memproses revalidate/layout
        // akibat setPreferredSize() di atas (kalau langsung di-set di sini, posisinya akan
        // ketimpa lagi oleh proses revalidate yang belum selesai).
        SwingUtilities.invokeLater(() -> {
            javax.swing.JViewport vp = ScrollMenu.getViewport();
            java.awt.Dimension ukuranView = FormMenu.getPreferredSize();
            int maxX = Math.max(0, ukuranView.width - vp.getWidth());
            int maxY = Math.max(0, ukuranView.height - vp.getHeight());
            int x = Math.min(posisiScrollMenuSebelum.x, maxX);
            int y = Math.min(posisiScrollMenuSebelum.y, maxY);
            vp.setViewPosition(new java.awt.Point(x, y));
        });
    ...
    private void getDataPemeriksaan() {
        if(tbPemeriksaan.getSelectedRow()!= -1){
            ...
            // ======================
            // SIMPAN SOAP TERAKHIR YANG DILIHAT
            // ======================
            lastSuhu        = TSuhu.getText();
            lastTensi       = TTensi.getText();
            lastNadi        = TNadi.getText();
            lastRespirasi   = TRespirasi.getText();
            lastTinggi      = TTinggi.getText();
            lastBerat       = TBerat.getText();
            lastSpO2        = SpO2.getText();
            lastGCS         = TGCS.getText();
            lastKesadaran   = cmbKesadaran.getSelectedItem().toString();

            lastKeluhan     = TKeluhan.getText();
            lastPemeriksaan = TPemeriksaan.getText();
            lastAlergi      = TAlergi.getText();
            lastPenilaian   = TPenilaian.getText();
            lastRTL         = TindakLanjut.getText();
            lastInstruksi   = TInstruksi.getText();
            lastEvaluasi    = TEvaluasi.getText();
        }
    }
    ...
    private void isMenu(){
        if(ChkAccor.isSelected()==true){
            ...
            ChkAccor.setVisible(false);
            PanelAccor.setPreferredSize(new Dimension(25,HEIGHT));
    ...
    //    BtnTbak.setName("BtnTbak"); // NOI18N
    //    BtnTbak.addActionListener(new java.awt.event.ActionListener() {
    //        public void actionPerformed(java.awt.event.ActionEvent evt) {
    //            BtnTbakActionPerformed(evt);
    //        }
    //    });
    //    panelGlass12.add(BtnTbak);
    //    BtnTbak.setBounds(910, 110, 160, 26);
    ...
    //    BtnVerifikasiTbak.setText("Verifikasi TBAK");
    ...
    //    BtnVerifikasiTbak.setName("BtnVerifikasiTbak"); // NOI18N
    //    BtnVerifikasiTbak.addActionListener(new java.awt.event.ActionListener() {
    //       public void actionPerformed(java.awt.event.ActionEvent evt) {
    //            BtnVerifikasiTbakActionPerformed(evt);
    //        }
    //    });
    //    panelGlass12.add(BtnVerifikasiTbak);
    //    BtnVerifikasiTbak.setBounds(910, 140, 160, 26);
    ...
    private void BtnSbarActionPerformed(java.awt.event.ActionEvent evt) {                                                    
         if (TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMSbar sbar = new RMSbar(null, false);
    ...
    private void BtnDataVerifikasiSbarActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        if(TNoRw.getText().trim().equals("") ){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            VerifikasiSBAR soap=new VerifikasiSBAR(null,false);
    ...
    private void BtnTbakActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        if (TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMTbak sbar = new RMTbak(null, false);
            sbar.setNoRm(TNoRw.getText(), DTPTgl.getDate());
            //form.setNoRm(TNoRw.getText(),DTPCari1.getDate(),jenisbayar,TNoRM.getText());
            sbar.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            sbar.setLocationRelativeTo(internalFrame1);
    ...
    private void BtnAsuhanKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {                                                     
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    private void BtnBalanceCairan1ActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void BtnDataVerifikasiSOAPActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        if(TNoRw.getText().trim().equals("") ){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            StatusVerifikasiSOAP soap=new StatusVerifikasiSOAP(null,false);
            soap.setNoRawat(TNoRw.getText(),TNoRw.getText());
            soap.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
            soap.setLocationRelativeTo(internalFrame1);
            soap.setVisible(true);
