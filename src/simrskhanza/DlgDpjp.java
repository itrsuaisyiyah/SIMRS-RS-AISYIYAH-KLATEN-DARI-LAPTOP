...
public class DlgDpjp extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        BtnExport.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Export.png"))); // NOI18N
        BtnExport.setMnemonic('U');
        BtnExport.setText("Export");
        BtnExport.setToolTipText("Alt+U");
        BtnExport.setName("BtnExport"); // NOI18N
        BtnExport.setPreferredSize(new java.awt.Dimension(89, 30));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-08-2026" }));
  ...
  isForm();                
    ...
    private void BtnExportActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnExportActionPerformed
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            exportDpjp(TabModePasien, filePath);
        }
...
public void exportDpjp(DefaultTableModel tableModel, String filePath) {
        
       //Pengaman jika model tabel kosong
      if (tableModel == null) {
          JOptionPane.showMessageDialog(this,
                  "Model tabel DPJP masih kosong.");
          return;
        }
      ...
      if (tableModel.getRowCount() == 0){
          JOptionPane.showMessageDialog(this,
                  "Tidak ada data DPJP untuk diekspor.");
          return;
        }  
       ...
       try {
           ...
           WritableSheet sheet = workbook.createSheet("DPJP Ranap",0);
      ...
      for (int i = 0; i < tableModel.getColumnCount(); i++) {
        ...
        // Inisialisasi lebar kolom berdasarkan panjang header
        int maxColumnWidth = tableModel.getColumnName(i).length() + 5;

        // Temukan teks terpanjang di kolom
      ...
      sheet.getSettings().setVerticalFreeze(1); // Freeze the first row
      sheet.getSettings().setHorizontalFreeze(3); // Freeze the first three columns

      // Tulis workbook ke file sebelum menutupnya
      workbook.write();
