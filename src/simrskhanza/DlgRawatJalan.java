...
import rekammedis.VerifikasiSBARRalan;
import rekammedis.VerifikasiTBAKRalan;
...
import rekammedis.RMRiwayatPenunjang1;
import rekammedis.RMRiwayatPerawatan;
import rekammedis.RMSbarRalan;
...
import rekammedis.RMTbakRalan;
import rekammedis.RMTimeOutSebelumInsisi;
import rekammedis.RMTransferPasienAntarRuang;
import rekammedis.RMTriaseIGD;
import rekammedis.RMUjiFungsiKFR;
import rekammedis.ValidasiSBARRalan;
import rekammedis.ValidasiTBAKRalan;
...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, ps2, ps3, ps4, ps5, ps6, pstindakan, psset_tarif, psrekening,psrencanakontrol;
    private ResultSet rs, rstindakan, rsset_tarif, rsrekening,rsrencanakontrol;
    ...
    private Button BtnTemplateResep;
    private Button BtnTemplatePemberianObat;
    private Button BtnTemplateResep1;
    private Button BtnTemplatePemberianObat1;
    boolean bypassranap;
    ...
    private void initComponents() {
        ...
        MnBuatSkdp = new javax.swing.JMenuItem();
        MnLembarRehabMedik = new javax.swing.JMenuItem();
        MnLembarRehabMedik1 = new javax.swing.JMenuItem();
        MnLembarRehabMedik2 = new javax.swing.JMenuItem();
        MnLembarRehabMedik3 = new javax.swing.JMenuItem();
        MnLembarRehabMedik4 = new javax.swing.JMenuItem();
        MnLembarRehabMedik5 = new javax.swing.JMenuItem();
        MnLembarRehabMedik6 = new javax.swing.JMenuItem();
        MnLembarRehabMedik7 = new javax.swing.JMenuItem();
        MnLembarRehabMedik8 = new javax.swing.JMenuItem();
        MnLembarRehabMedik9 = new javax.swing.JMenuItem();
        MnLembarRehabMedik10 = new javax.swing.JMenuItem();
        ...
        BtnDataSbar = new widget.Button();
        BtnDataVerifikasiSbar = new widget.Button();
        BtnTbak = new widget.Button();
        BtnVerifikasiTbak = new widget.Button();
        BtnDataVerifikasiTbak = new widget.Button();
        BtnPeriksaLab = new widget.Button();
        ...
        MnBuatSkdp.setBackground(new java.awt.Color(255, 255, 254));
        MnBuatSkdp.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnBuatSkdp.setForeground(new java.awt.Color(50, 50, 50));
        MnBuatSkdp.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnBuatSkdp.setText("Buat SKDP");
        MnBuatSkdp.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnBuatSkdp.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnBuatSkdp.setName("MnBuatSkdp"); // NOI18N
        MnBuatSkdp.setPreferredSize(new java.awt.Dimension(320, 26));
        MnBuatSkdp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnBuatSkdpActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnBuatSkdp);

        MnLembarRehabMedik.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik.setText("Lembar Rehabilitasi Medik");
        MnLembarRehabMedik.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik.setName("MnLembarRehabMedik"); // NOI18N
        MnLembarRehabMedik.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedikActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik);

        MnLembarRehabMedik1.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik1.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik1.setText("Lembar Rehabilitasi Medik Sebelah");
        MnLembarRehabMedik1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik1.setName("MnLembarRehabMedik1"); // NOI18N
        MnLembarRehabMedik1.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik1ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik1);

        MnLembarRehabMedik2.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik2.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik2.setText("Resume Rawat Jalan");
        MnLembarRehabMedik2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik2.setName("MnLembarRehabMedik2"); // NOI18N
        MnLembarRehabMedik2.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik2ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik2);

        MnLembarRehabMedik3.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik3.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik3.setText("Lembar Program Terapi (Salma)");
        MnLembarRehabMedik3.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik3.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik3.setName("MnLembarRehabMedik3"); // NOI18N
        MnLembarRehabMedik3.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik3ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik3);

        MnLembarRehabMedik4.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik4.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik4.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik4.setText("Lembar Program Terapi (Annisa Linggar)");
        MnLembarRehabMedik4.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik4.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik4.setName("MnLembarRehabMedik4"); // NOI18N
        MnLembarRehabMedik4.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik4ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik4);

        MnLembarRehabMedik5.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik5.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik5.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik5.setText("Lembar Program Terapi (Annisa Khoirul)");
        MnLembarRehabMedik5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik5.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik5.setName("MnLembarRehabMedik5"); // NOI18N
        MnLembarRehabMedik5.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik5ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik5);

        MnLembarRehabMedik6.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik6.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik6.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik6.setText("Lembar Program Terapi (Shanti)");
        MnLembarRehabMedik6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik6.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik6.setName("MnLembarRehabMedik6"); // NOI18N
        MnLembarRehabMedik6.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik6ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik6);

        MnLembarRehabMedik7.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik7.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik7.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik7.setText("Lembar Program Terapi (Tri Wulandari)");
        MnLembarRehabMedik7.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik7.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik7.setName("MnLembarRehabMedik7"); // NOI18N
        MnLembarRehabMedik7.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik7ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik7);

        MnLembarRehabMedik8.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik8.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik8.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik8.setText("Lembar Program Terapi (Kurnia)");
        MnLembarRehabMedik8.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik8.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik8.setName("MnLembarRehabMedik8"); // NOI18N
        MnLembarRehabMedik8.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik8ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik8);

        MnLembarRehabMedik9.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik9.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik9.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik9.setText("Lembar Program Terapi (Azizah)");
        MnLembarRehabMedik9.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik9.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik9.setName("MnLembarRehabMedik9"); // NOI18N
        MnLembarRehabMedik9.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik9ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik9);

        MnLembarRehabMedik10.setBackground(new java.awt.Color(255, 255, 254));
        MnLembarRehabMedik10.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLembarRehabMedik10.setForeground(new java.awt.Color(50, 50, 50));
        MnLembarRehabMedik10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLembarRehabMedik10.setText("Lembar Program Terapi (Hafidz)");
        MnLembarRehabMedik10.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLembarRehabMedik10.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLembarRehabMedik10.setName("MnLembarRehabMedik10"); // NOI18N
        MnLembarRehabMedik10.setPreferredSize(new java.awt.Dimension(320, 26));
        MnLembarRehabMedik10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLembarRehabMedik10ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLembarRehabMedik10);
        ...
        panelGlass12.setPreferredSize(new java.awt.Dimension(34, 134));
        ...
        scrollPane1.setBounds(83, 70, 350, 40);

        jLabel28.setText("Asesmen :");
        jLabel28.setName("jLabel28"); // NOI18N
        panelGlass12.add(jLabel28);
        jLabel28.setBounds(440, 50, 90, 23);

        jLabel26.setText("Plan :");
        jLabel26.setName("jLabel26"); // NOI18N
        panelGlass12.add(jLabel26);
        jLabel26.setBounds(440, 100, 90, 14);

        scrollPane2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane2.setName("scrollPane2"); // NOI18N
        scrollPane2.setPreferredSize(new java.awt.Dimension(162, 72));
        ...
        scrollPane2.setBounds(80, 120, 350, 50);
        ...
        TTinggi.setBounds(250, 180, 55, 23);
        ...
        TRespirasi.setBounds(190, 210, 55, 23);
        ...
        TBerat.setBounds(390, 180, 55, 23);
        ...
        TAlergi.setBounds(540, 10, 206, 23);
        ...
        scrollPane3.setBounds(540, 40, 360, 40);
        ...
        scrollPane6.setBounds(540, 90, 360, 50);

        jLabel29.setText("Kesadaran :");
        jLabel29.setName("jLabel29"); // NOI18N
        panelGlass12.add(jLabel29);
        jLabel29.setBounds(10, 240, 70, 23);
        ...
        cmbKesadaran.setBounds(90, 240, 126, 23);
        ...
        Jabatan.setBounds(70, 40, 209, 23);

        jLabel41.setText("Profesi  :");
        jLabel41.setName("jLabel41"); // NOI18N
        panelGlass12.add(jLabel41);
        jLabel41.setBounds(0, 40, 70, 23);

        jLabel53.setText("Instruksi :");
        jLabel53.setName("jLabel53"); // NOI18N
        panelGlass12.add(jLabel53);
        jLabel53.setBounds(450, 150, 80, 23);
        ...
        scrollPane7.setBounds(540, 150, 360, 50);

        jLabel54.setText("SpO2 (%) :");
        jLabel54.setName("jLabel54"); // NOI18N
        panelGlass12.add(jLabel54);
        jLabel54.setBounds(340, 240, 70, 23);
        ...
        SpO2.setBounds(410, 240, 42, 23);

        jLabel56.setText("Evaluasi :");
        jLabel56.setName("jLabel56"); // NOI18N
        panelGlass12.add(jLabel56);
        jLabel56.setBounds(450, 220, 90, 40);
        ...
        scrollPane8.setBounds(540, 210, 360, 50);
        ...
        LingkarPerut.setBounds(430, 210, 50, 23);
        ...
        Btn5Soap.setBounds(280, 40, 120, 23);
        ...
        BtnHasilRadiologi.setBounds(910, 130, 160, 26);
        ...
        BtnRiwayatFKTP.setText("Riwayat  ICare");
        ...
        BtnRiwayatFKTP.setBounds(1100, 180, 160, 26);

        BtnDicom.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Agenda-1-16x16.png"))); // NOI18N
        BtnDicom.setMnemonic('4');
        BtnDicom.setText("Dicom");
        BtnDicom.setToolTipText("");
        BtnDicom.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDicom.setGlassColor(new java.awt.Color(255, 153, 153));
        ...
        panelGlass12.add(BtnDicom);
        BtnDicom.setBounds(910, 160, 160, 26);

        BtnSuratKontrolBpjs.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Edit.png"))); // NOI18N
        BtnSuratKontrolBpjs.setMnemonic('4');
        BtnSuratKontrolBpjs.setText("Rencana Kontrol BPJS");
        BtnSuratKontrolBpjs.setToolTipText("");
        BtnSuratKontrolBpjs.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSuratKontrolBpjs.setGlassColor(new java.awt.Color(30, 111, 92));
        BtnSuratKontrolBpjs.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSuratKontrolBpjs.setName("BtnSuratKontrolBpjs"); // NOI18N
        BtnSuratKontrolBpjs.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnSuratKontrolBpjsActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnSuratKontrolBpjs);
        BtnSuratKontrolBpjs.setBounds(1100, 220, 160, 26);

        BtnTemplatePemeriksaan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TEMPLATESOAP1.png"))); // NOI18N
        ...
        BtnTemplatePemeriksaan.setBounds(390, 30, 48, 40);
        ...
        BtnSbar.setText("Input Resep");
        BtnSbar.setToolTipText("ALt+4");
        BtnSbar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnSbar.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnSbar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnSbar.setName("BtnResepObat"); // NOI18N
        ...
        BtnSbar.setBounds(910, 10, 160, 26);

        BtnDataSbar.setForeground(new java.awt.Color(0, 0, 0));
        BtnDataSbar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnDataSbar.setMnemonic('4');
        BtnDataSbar.setText("Permintaan LAB");
        BtnDataSbar.setToolTipText("ALt+4");
        BtnDataSbar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDataSbar.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnDataSbar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDataSbar.setName("BtnPermintaanLab"); // NOI18N
        BtnDataSbar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPermintaanLabActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnDataSbar);
        BtnDataSbar.setBounds(910, 40, 160, 26);

        BtnDataVerifikasiSbar.setForeground(new java.awt.Color(0, 0, 0));
        BtnDataVerifikasiSbar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnDataVerifikasiSbar.setMnemonic('4');
        BtnDataVerifikasiSbar.setText("Permintaan RAD");
        BtnDataVerifikasiSbar.setToolTipText("ALt+4");
        BtnDataVerifikasiSbar.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDataVerifikasiSbar.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnDataVerifikasiSbar.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDataVerifikasiSbar.setName("BtnPermintaanRad"); // NOI18N
        BtnDataVerifikasiSbar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPermintaanRadActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnDataVerifikasiSbar);
        BtnDataVerifikasiSbar.setBounds(910, 100, 160, 26);

        BtnTbak.setForeground(new java.awt.Color(0, 0, 0));
        BtnTbak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnTbak.setMnemonic('4');
        BtnTbak.setText("Konsultasi Medik");
        BtnTbak.setToolTipText("ALt+4");
        BtnTbak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnTbak.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnTbak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnTbak.setName("BtnPermintaanKonsultasiMedik"); // NOI18N
        BtnTbak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPermintaanKonsultasiMedikActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnTbak);
        BtnTbak.setBounds(910, 200, 160, 26);

        BtnVerifikasiTbak.setForeground(new java.awt.Color(0, 0, 0));
        BtnVerifikasiTbak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnVerifikasiTbak.setMnemonic('4');
        BtnVerifikasiTbak.setText("Input Jadwal Operasi");
        BtnVerifikasiTbak.setToolTipText("ALt+4");
        BtnVerifikasiTbak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnVerifikasiTbak.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnVerifikasiTbak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnVerifikasiTbak.setName("BtnJadwalOperasi"); // NOI18N
        BtnVerifikasiTbak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnJadwalOperasiActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnVerifikasiTbak);
        BtnVerifikasiTbak.setBounds(1100, 140, 160, 26);

        BtnDataVerifikasiTbak.setForeground(new java.awt.Color(0, 0, 0));
        BtnDataVerifikasiTbak.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/attachment.png"))); // NOI18N
        BtnDataVerifikasiTbak.setMnemonic('4');
        BtnDataVerifikasiTbak.setText("Rujuk Internal");
        BtnDataVerifikasiTbak.setToolTipText("ALt+4");
        BtnDataVerifikasiTbak.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnDataVerifikasiTbak.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnDataVerifikasiTbak.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnDataVerifikasiTbak.setName("BtnRujukInternal"); // NOI18N
        BtnDataVerifikasiTbak.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRujukInternalActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnDataVerifikasiTbak);
        BtnDataVerifikasiTbak.setBounds(910, 230, 160, 26);

        BtnPeriksaLab.setForeground(new java.awt.Color(0, 0, 0));
        BtnPeriksaLab.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/TestTubes.png"))); // NOI18N
        BtnPeriksaLab.setMnemonic('4');
        BtnPeriksaLab.setText("Hasil Periksa Lab");
        BtnPeriksaLab.setToolTipText("ALt+4");
        BtnPeriksaLab.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        BtnPeriksaLab.setGlassColor(new java.awt.Color(0, 255, 0));
        BtnPeriksaLab.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        BtnPeriksaLab.setName("BtnPeriksaLab"); // NOI18N
        BtnPeriksaLab.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPeriksaLabActionPerformed(evt);
            }
        });
        panelGlass12.add(BtnPeriksaLab);
        BtnPeriksaLab.setBounds(910, 70, 160, 26);
        ...
        ChkInput.setBounds(0, 270, 1303, 20);

        BtnOdontogram.setForeground(new java.awt.Color(0, 0, 0));
        BtnOdontogram.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Add patient.png"))); // NOI18N
        ...
        BtnOdontogram.setBounds(1100, 100, 160, 30);
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-09-2026" }));
        ...
        BtnAwalKeperawatanGeriatri.setToolTipText("");
        ...
        BtnAwalMedisHemodialisa.setToolTipText("");
        ...
        BtnAwalMedisIGDPsikiatri.setToolTipText("");
        ...
        BtnAwalMedisKulitKelamin.setToolTipText("");
        ...
        BtnAwalMedisParu.setToolTipText("");
        ...
        BtnAwalMedisRehabMedik.setToolTipText("");
        ...
        BtnAwalTerapiWicara.setToolTipText("");
        ...
        BtnCatatanADIMEGizi.setToolTipText("");
        ...
        BtnCatatanKeperawatan.setToolTipText("");
        ...
        BtnCatatanPersalinanan.setToolTipText("");
        ...
        BtnChecklistKriteriaMasukHCU.setToolTipText("");
        ...
        BtnChecklistKriteriaMasukICU.setToolTipText("");
        ...
        BtnDokumentasiESWL.setToolTipText("");
        ...
        BtnPemantauanEWSNeonatus.setToolTipText("");
        ...
        BtnPemantauanMEOWS.setToolTipText("");
        ...
        BtnPengkajianRestrain.setToolTipText("");
        ...
        BtnPenilaianLanjutanRisikoJatuhGeriatri.setToolTipText("");
        ...
        BtnPenilaianLanjutanRisikoJatuhNeonatus.setToolTipText("");
        ...
        BtnPenilaianLanjutanRisikoJatuhPsikiatri.setToolTipText("");
        ...
        BtnPenilaianLanjutanSkriningFungsional.setToolTipText("");
        ...
        BtnPenilaianPasienKeracunan.setToolTipText("");
        ...
        BtnPenilaianUlangNyeri.setToolTipText("");
        ...
        BtnSkorAldrettePascaAnestesi.setToolTipText("");
        ...
        BtnSkorStewardPascaAnestesi.setToolTipText("");
        ...
        try {
            ...
            if (i == JOptionPane.YES_OPTION) {
                if (TNoRw.getText().trim().equals("")) {
                    JOptionPane.showMessageDialog(null, "No.Rawat kosong, status pasien tidak bisa diperbarui.");
                } else {
                // DIGANTI dari Sequel.mengedittf(...) ke UPDATE langsung: dengan overload
                // ber-parameter "?" seperti sebelumnya, urutan klausa WHERE/SET dan urutan
                // parameter array rawan tertukar antar overload (tidak bisa dipastikan tanpa
                // source Sequel), dan sebelumnya mengedittf() dianggap "berhasil" walau 0
                // baris yang ter-update - itulah kenapa status terlihat tidak berubah padahal
                // sudah klik Yes. Query ditulis langsung di sini supaya urutan parameter pasti
                // benar, dan hasilnya dicek dari JUMLAH BARIS yang benar-benar ter-update.
                boolean berhasilUpdate = false;
                try (PreparedStatement psUpdateStts = koneksi.prepareStatement("update reg_periksa set stts=? where no_rawat=?")) {
                    psUpdateStts.setString(1, "Sudah");
                    psUpdateStts.setString(2, TNoRw.getText());
                    berhasilUpdate = psUpdateStts.executeUpdate() > 0;
                } catch (Exception exUpdateStts) {
                    System.out.println("Notifikasi : " + exUpdateStts);
                }
                if (berhasilUpdate) {
                    ...
                    // DITAMBAHKAN: supaya DlgKasirRalan yang sedang terbuka (kalau ada) langsung
                    // ikut refresh status/warnanya seketika, tanpa perlu menunggu timer polling
                    // atau klik centang hijau manual di sana.
                    DlgKasirRalan.refreshOtomatis();
                } else {
                    JOptionPane.showMessageDialog(null, "Gagal memperbarui status pasien. Silahkan periksa No.Rawat, lalu coba lagi.");
                }
                }
            }
        } catch (Exception e) {
    ...
    /**
     * Mengisi kolom Petugas Yg Menangani secara otomatis sesuai dengan
     * petugas yang sedang login (akses.getkode()), baik pada tab
     * "Penanganan Petugas" maupun tab "Penanganan Dokter & Petugas".
     * Tombol cari petugas (BtnSeekPetugas/BtnSeekPetugas2) tetap bisa
     * dipakai apabila petugas yang menangani berbeda dengan yang login.
     */
    ...
    private void BtnHasilRadiologiActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        if(TNoRw.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMRiwayatPenunjang1 resume=new RMRiwayatPenunjang1(null,true);
    ...
    private void TAlergiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TAlergiKeyPressed
        Valid.pindah(evt, SpO2, TPenilaian);
    ...
    private void cmbKesadaranKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cmbKesadaranKeyPressed
        Valid.pindah(evt, LingkarPerut, TGCS);
   ...
   private void BtnAwalMedisMataActionPerformed(java.awt.event.ActionEvent evt) {
    if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
        ...
        try {
            RMPenilaianAwalMedisRalanMata form =
                    new RMPenilaianAwalMedisRalanMata(null, false);
            ...
            JOptionPane.showMessageDialog(null,
                    "Gagal membuka form: " + e.getMessage());
            e.printStackTrace();
    ...
    private void BtnTemplateResep1ActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        // TODO add your handling code here:
    }                                                 
...
//                        inputResep2();
    ...
    private void BtnSuratKontrolBpjsActionPerformed(java.awt.event.ActionEvent evt) {                                            
            if(TNoRw.getText().trim().equals("")){
                ...
                try {
                    psrencanakontrol=koneksi.prepareStatement("select bridging_sep.no_sep,bridging_sep.no_kartu,bridging_sep.tanggal_lahir,bridging_sep.jkel,bridging_sep.nmdiagnosaawal from bridging_sep where bridging_sep.no_rawat=?");
                    try {
                        psrencanakontrol.setString(1,TNoRw.getText());
                        rsrencanakontrol=psrencanakontrol.executeQuery();
                        if(rsrencanakontrol.next()){
                            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                            BPJSSuratKontrol form=new BPJSSuratKontrol(null,false);
                            form.setNoRm(TNoRw.getText(),rsrencanakontrol.getString("no_sep"),rsrencanakontrol.getString("no_kartu"),TNoRM.getText(),TPasien.getText(),rsrencanakontrol.getString("tanggal_lahir"),rsrencanakontrol.getString("jkel"),rsrencanakontrol.getString("nmdiagnosaawal"));
                            form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                            form.setLocationRelativeTo(internalFrame1);
                            form.setVisible(true);
                            this.setCursor(Cursor.getDefaultCursor());
                        ...
                        if(rsrencanakontrol!=null){
                            rsrencanakontrol.close();
                        }
                        if(psrencanakontrol!=null){
                            psrencanakontrol.close();
                        }
                    }
                } catch (Exception e) {
                    System.out.println("Notif : "+e);
    ...
    private void MnLembarRehabMedikActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik2.jasper","report","::[ Lembar Rehabilitasi Medik ]::",
                        ...
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        ...
                        "WHERE reg_periksa.no_rawat='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString()+"' AND pemeriksaan_ralan.nip='"+tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),23).toString()+"'",param);
        }else{
     ...
     private void MnLembarRehabMedik1ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedikSebelah.jasper","report","::[ Lembar Rehabilitasi Medik ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik2ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik3.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik3ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik4.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik4ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik5.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik5ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik6.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik6ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik7.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik7ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik8.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik8ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik9.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik9ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik10.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnLembarRehabMedik10ActionPerformed(java.awt.event.ActionEvent evt)
    {
//    JOptionPane.showMessageDialog(null,tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),1).toString());
        if(tbPemeriksaan.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            ...
            param.put("emailrs",akses.getemailrs());          
            param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
            Valid.MyReportqry("rptCetakLembarRehabilitasiMedik11.jasper","report","::[ Lembar Pendampingan ]::",
                        "SELECT reg_periksa.no_rawat, pasien.no_rkm_medis,pasien.nm_pasien,IF(pasien.jk = 'L', 'Laki-Laki', 'Perempuan') AS jk,pasien.tgl_lahir,pasien.agama,bahasa_pasien.nama_bahasa,cacat_fisik.nama_cacat,\n" +
                        "pasien.no_tlp,DATE_FORMAT(pemeriksaan_ralan.tgl_perawatan, '%d-%m-%Y') AS tgl_perawatan,pemeriksaan_ralan.keluhan AS subjek,pemeriksaan_ralan.pemeriksaan AS objek,pemeriksaan_ralan.rtl AS plan,pemeriksaan_ralan.penilaian AS asesment,pemeriksaan_ralan.instruksi,pegawai.nama,\n" +
                        "pemeriksaan_ralan.evaluasi,CONCAT(pasien.tgl_lahir, ' / ', reg_periksa.umurdaftar, ' ', reg_periksa.sttsumur) AS umur,\n" +
                        "CONCAT(pasien.alamatpj,', ',pasien.kelurahanpj,', ',pasien.kecamatanpj,', ',pasien.kabupatenpj,', ',pasien.propinsipj) as alamat\n" +
    ...
    private void MnBuatSkdpActionPerformed(java.awt.event.ActionEvent evt){
        if(tbPemeriksaan.getSelectedRow()>-1){
            if(Sequel.cariInteger("select count(kamar_inap.no_rawat) from kamar_inap where kamar_inap.no_rawat=?",TNoRw.getText())>0){
                JOptionPane.showMessageDialog(null,"Maaf, Pasien sudah masuk Kamar Inap. Gunakan billing Ranap..!!!");
            }else {
                ...
                form.setNoRm(
                        ...
                        TPasien.getText(), 
                        kode_poli,
                        Sequel.cariIsi("select poliklinik.nm_poli from poliklinik where poliklinik.kd_poli=?",kode_poli),
                        KdDok.getText(),
                        TDokter.getText());
//                form.tampilData(
//                        TNoRw.getText(), 
//                        tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),21).toString(), 
//                        tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),22).toString(), 
//                        tbPemeriksaan.getValueAt(tbPemeriksaan.getSelectedRow(),19).toString());
                form.setVisible(true);
            }
        }else{ 
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
    ...
    private void BtnRiwayatFKTPActionPerformed(java.awt.event.ActionEvent evt) {                                               
        String variabel = Sequel.cariIsi("select maping_dokter_dpjpvclaim.kd_dokter_bpjs from maping_dokter_dpjpvclaim where maping_dokter_dpjpvclaim.kd_dokter=?",KdPeg.getText());
                if(!variabel.equals("")){
                    akses.setform("DlgRawatJalan");
    ...
    private widget.Button BtnDataSbar;
    private widget.Button BtnDataVerifikasiSbar;
    private widget.Button BtnDataVerifikasiTbak;
    ...
    private widget.Button BtnPeriksaLab;
    ...
    private widget.Button BtnVerifikasiTbak;
    ...
    private javax.swing.JMenuItem MnBuatSkdp;
    private javax.swing.JMenuItem MnLembarRehabMedik;
    private javax.swing.JMenuItem MnLembarRehabMedik1;
    private javax.swing.JMenuItem MnLembarRehabMedik10;
    private javax.swing.JMenuItem MnLembarRehabMedik2;
    private javax.swing.JMenuItem MnLembarRehabMedik3;
    private javax.swing.JMenuItem MnLembarRehabMedik4;
    private javax.swing.JMenuItem MnLembarRehabMedik5;
    private javax.swing.JMenuItem MnLembarRehabMedik6;
    private javax.swing.JMenuItem MnLembarRehabMedik7;
    private javax.swing.JMenuItem MnLembarRehabMedik8;
    private javax.swing.JMenuItem MnLembarRehabMedik9;
    ...
    private widget.Button BtnSkorBromagePascaAnestesi, BtnPenilaianPreInduksi, BtnHasilPemeriksaanUSGUrologi, BtnHasilPemeriksaanUSGGynecologi, BtnHasilPemeriksaanEKG, BtnPenatalaksanaanTerapiOkupasi, BtnPenilaianPsikolog,
            ...
            BtnSkriningKesehatanGigiMulutremaja, BtnSkriningTBC, BtnCatatanPerawat;
    ...
    try {
        ps = koneksi.prepareStatement(
            ...
            " CONCAT(p.nm_pasien,' (',p.umur,')') AS pasien," +
            " rp.kd_dokter,d.nm_dokter,rp.tgl_registrasi,rp.jam_reg " +
            "FROM reg_periksa rp " +
        ...
        if (rs.next()) {
            // Misal bila ingin ditampilkan
            TNoRM.setText(rs.getString("no_rkm_medis"));
            TPasien.setText(rs.getString("pasien"));

            // Kolom Dokter yang masih kosong otomatis diisi dengan dokter yang
            // dituju sesuai pendaftaran (reg_periksa.kd_dokter). Tidak menimpa
            // apabila dokter sudah pernah dipilih/tersimpan sebelumnya.
            String kdDokterDituju = rs.getString("kd_dokter");
            String namaDokterDituju = rs.getString("nm_dokter");
            if (kdDokterDituju != null && !kdDokterDituju.trim().equals("")) {
                if (KdDok.getText().trim().equals("")) {
                    KdDok.setText(kdDokterDituju);
                    TDokter.setText(namaDokterDituju == null ? "" : namaDokterDituju);
                }
                if (KdDok2.getText().trim().equals("")) {
                    KdDok2.setText(kdDokterDituju);
                    TDokter2.setText(namaDokterDituju == null ? "" : namaDokterDituju);
                }
                if (KdDok3.getText().trim().equals("")) {
                    KdDok3.setText(kdDokterDituju);
                    TDokter3.setText(namaDokterDituju == null ? "" : namaDokterDituju);
                }
            }
        }
        ...
        ps = koneksi.prepareStatement(
            "SELECT suhu,td,bb,tb,nadi,rr,gcs,keluhan_utama " +
        ...
        if (rs.next()) {
            ...
            TKeluhan.setText(rs.getString("keluhan_utama"));
        } else {
            // Bila tidak ada, cek tabel bayi
            rs.close();
            ps.close();

            ps = koneksi.prepareStatement(
                "SELECT suhu,td,bb,tb,nadi,rr,gcs,keluhan_utama " +
                "FROM penilaian_awal_keperawatan_ralan_bayi " +
                "WHERE no_rawat=?"
            );
    ...
    public void isCek() {
        ...
        //Modifikasi Cahya(IT)
        MnLembarRehabMedik.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik1.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik2.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik3.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik4.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik5.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik6.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik7.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik8.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik9.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnLembarRehabMedik10.setVisible(akses.getpenilaian_medis_ralan_rehab_medik());
        MnBuatSkdp.setVisible(akses.getskdp_bpjs());
        //End Modifikasi Cahya(IT)
    ...
    private void inputResep() {
        ...
        if (!resepobat.isVisible()) {
            // Dokter untuk resep mengikuti tab Tindakan yang sedang aktif:
            // - Tab "Penanganan Dokter & Petugas" memakai dokter pada tab tsb (KdDok2/TDokter2),
            //   baik tindakan tersebut diinput oleh dokter maupun oleh petugas.
            // - Tab lainnya (mis. "Penanganan Dokter") tetap memakai dokter utama (KdDok/TDokter).
            String kdDokResep = KdDok.getText();
            String namaDokterResep = TDokter.getText();
            if (TabRawat.getSelectedIndex() == TabRawat.indexOfTab("Penanganan Dokter & Petugas")) {
                kdDokResep = KdDok2.getText();
                namaDokterResep = TDokter2.getText();
            }
            resepobat.setNoRm(TNoRw.getText(),DTPTgl.getDate(),cmbJam.getSelectedItem().toString(),cmbMnt.getSelectedItem().toString(),cmbDtk.getSelectedItem().toString(),kdDokResep,namaDokterResep,"ralan");
            resepobat.isCek();
    ...
    private void initRawatJalan() {
        ...
        BtnHasilPemeriksaanUSG.setText("Hasil USG Obstetri");
        BtnHasilPemeriksaanUSG.setFocusPainted(false);
        ...
        //BtnCatatanPerawat = new widget.Button();
        //BtnCatatanPerawat.setForeground(new java.awt.Color(0, 0, 0));
        //BtnCatatanPerawat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/6009609_corona_coronavirus_covid19_crowd_huddle_icon.png"))); // NOI18N
        //BtnCatatanPerawat.setMnemonic('4');
        //BtnCatatanPerawat.setText("SKDP");
        //BtnCatatanPerawat.setToolTipText("ALt+4");
        //BtnCatatanPerawat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        //BtnCatatanPerawat.setGlassColor(new java.awt.Color(0, 255, 0));
        //BtnCatatanPerawat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        //BtnCatatanPerawat.setName("BtnSKDP"); // NOI18N
        //BtnCatatanPerawat.addActionListener(new java.awt.event.ActionListener() {
        //    public void actionPerformed(java.awt.event.ActionEvent evt) {
        //        BtnSKDPActionPerformed(evt);
        //    }
        //});
        //panelGlass12.add(BtnCatatanPerawat);
        //BtnCatatanPerawat.setBounds(1100, 20, 200, 26);
        ...
        rataUkuranTombolMenu();
    }

    /**
     * Sejumlah tombol pada menu kiri (FormMenu) tidak memiliki ukuran preferred yang
     * seragam sehingga tampilan daftar menu terlihat tidak rata. Method ini menyamakan
     * ukurannya dengan tombol-tombol lain (190 x 23) agar tampilan menu kiri rapi/rata.
     */
    private void rataUkuranTombolMenu() {
        widget.Button[] tombolMenu = new widget.Button[]{
            BtnAwalKeperawatanGeriatri, BtnAwalMedisHemodialisa, BtnAwalMedisIGDPsikiatri,
            BtnAwalMedisKulitKelamin, BtnAwalMedisParu, BtnAwalMedisRehabMedik,
            BtnCatatanADIMEGizi, BtnCatatanKeperawatan, BtnCatatanPersalinanan,
            BtnChecklistKriteriaMasukHCU, BtnChecklistKriteriaMasukICU, BtnDokumentasiESWL,
            BtnPenilaianLanjutanRisikoJatuhGeriatri, BtnPenilaianLanjutanRisikoJatuhNeonatus,
            BtnPenilaianLanjutanRisikoJatuhPsikiatri, BtnPenilaianLanjutanSkriningFungsional,
            BtnPemantauanEWSNeonatus, BtnPemantauanMEOWS, BtnPengkajianRestrain,
            BtnPenilaianPasienKeracunan, BtnPenilaianUlangNyeri, BtnSkorAldrettePascaAnestesi,
            BtnSkorStewardPascaAnestesi, BtnAwalTerapiWicara
        };
        java.awt.Dimension ukuranStandar = new java.awt.Dimension(190, 23);
        for (widget.Button tombol : tombolMenu) {
            if (tombol != null) {
                tombol.setFocusPainted(false);
                tombol.setMargin(new java.awt.Insets(1, 1, 1, 1));
                tombol.setPreferredSize(ukuranStandar);
                tombol.setRoundRect(false);
            }
        }
    }
    ...
    private void BtnSbarActionPerformed(java.awt.event.ActionEvent evt) {
        if (TNoRw.getText().trim().equals("")) {
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMSbarRalan sbar = new RMSbarRalan(null, false);
            sbar.setNoRm(TNoRw.getText(), DTPTgl.getDate());
            //form.setNoRm(TNoRw.getText(),DTPCari1.getDate(),jenisbayar,TNoRM.getText());
            sbar.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
    ...
    private void BtnDataSbarActionPerformed(java.awt.event.ActionEvent evt) {
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            ValidasiSBARRalan form = new ValidasiSBARRalan(null, false);
            form.isCek();
            form.emptTeks();
            form.setNoRm(TNoRw.getText(), DTPCari2.getDate());
            form.tampil();
    ...
    private void BtnDataVerifikasiSbarActionPerformed(java.awt.event.ActionEvent evt) {
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            VerifikasiSBARRalan soap = new VerifikasiSBARRalan(null, false);
    ...
    private void BtnTbakActionPerformed(java.awt.event.ActionEvent evt) {
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            RMTbakRalan sbar = new RMTbakRalan(null, false);
            sbar.setNoRm(TNoRw.getText(), DTPTgl.getDate());
            //form.setNoRm(TNoRw.getText(),DTPCari1.getDate(),jenisbayar,TNoRM.getText());
            sbar.setSize(internalFrame1.getWidth(), internalFrame1.getHeight());
            sbar.setLocationRelativeTo(internalFrame1);
    ...
    private void BtnVerifikasiTbakActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void BtnDataVerifikasiTbakActionPerformed(java.awt.event.ActionEvent evt) {
        if (TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    private void BtnCatatanPerawatActionPerformed(java.awt.event.ActionEvent evt) {
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
    ...
    private void BtnPeriksaLabActionPerformed(java.awt.event.ActionEvent evt) {
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, Silahkan anda pilih dulu dengan menklik data pada table...!!!");
            TCari.requestFocus();
        } else {
