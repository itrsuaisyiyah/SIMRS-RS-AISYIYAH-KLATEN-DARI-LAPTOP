...
public class DlgCariTagihanOperasi extends javax.swing.JDialog {
    ...
    // ==== Komponen & variabel untuk fitur "Ubah Tindakan Operasi" ====
    private javax.swing.JDialog WindowUbahTindakanOperasi;
    private DefaultTableModel modelTindakanSesi, modelCariTindakanBaru;
    private JTable tbTindakanSesi, tbCariTindakanBaru;
    private JTextField TCariTindakanBaru;
    private JButton BtnSimpanTindakanOperasi, BtnTutupTindakanOperasi;
    private String noRawatTindakanTerpilih="", tglOperasiTindakanTerpilih="", kodePaketLamaTerpilih="";

    // ==== Komponen & variabel untuk fitur "Hapus Tindakan Operasi" (khusus admin) ====
    private javax.swing.JDialog WindowHapusTindakanOperasi;
    private DefaultTableModel modelTindakanHapus;
    private JTable tbTindakanHapus;
    private JButton BtnHapusTindakanOperasi, BtnTutupHapusTindakanOperasi;
    private String noRawatHapusTerpilih="", tglOperasiHapusTerpilih="", kodePaketHapusTerpilih="";
    ...
    private void initComponents() {
        ...
        MnUbahTindakanOperasi = new javax.swing.JMenuItem();
        ...
        MnHapusTagihanOperasi.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        MnHapusTagihanOperasi.setHideActionText(true);
        ...
        MnHapusTagihanOperasi.setRequestFocusEnabled(false);
        MnHapusTagihanOperasi.setVerifyInputWhenFocusTarget(false);
        ...
        MnUbahTindakanOperasi.setBackground(new java.awt.Color(255, 255, 254));
        MnUbahTindakanOperasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnUbahTindakanOperasi.setForeground(new java.awt.Color(50, 50, 50));
        MnUbahTindakanOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnUbahTindakanOperasi.setText("Ubah Tindakan Operasi");
        MnUbahTindakanOperasi.setName("MnUbahTindakanOperasi"); // NOI18N
        MnUbahTindakanOperasi.setPreferredSize(new java.awt.Dimension(220, 26));
        MnUbahTindakanOperasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnUbahTindakanOperasiActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnUbahTindakanOperasi);
...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    ...
    private void MnUbahTindakanOperasiActionPerformed(java.awt.event.ActionEvent evt) {
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString())>0){
                    JOptionPane.showMessageDialog(rootPane,"Data billing sudah terverifikasi, data tidak boleh diubah.\nSilahkan hubungi bagian kasir/keuangan ..!!");
                    ...
                    noRawatTindakanTerpilih=tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString();
                    tglOperasiTindakanTerpilih=tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString();
                    kodePaketLamaTerpilih="";
                    if(WindowUbahTindakanOperasi==null){
                        buatWindowUbahTindakanOperasi();
                    }
                    muatDaftarTindakanSesi();
                    TCariTindakanBaru.setText("");
                    modelCariTindakanBaru.setRowCount(0);
                    WindowUbahTindakanOperasi.setSize(700,550);
                    WindowUbahTindakanOperasi.setLocationRelativeTo(this);
                    WindowUbahTindakanOperasi.setVisible(true);
                }
            }else{
                JOptionPane.showMessageDialog(rootPane,"Silahkan pilih data, klik pada No.Rawat ..!!");
            }
    ...
    /** Membuat window "Ubah Tindakan Operasi" secara manual (di luar Form Editor),
     *  berisi daftar tindakan pada sesi operasi terpilih dan pencarian tindakan/paket
     *  operasi baru dari tabel paket_operasi. Tampilan disesuaikan dengan tema
     *  aplikasi (Tahoma, titled border hijau muda, ikon standar aplikasi). */
    private void buatWindowUbahTindakanOperasi(){
        java.awt.Font fontIsi = new java.awt.Font("Tahoma", 0, 11);
        java.awt.Font fontJudul = new java.awt.Font("Tahoma", 1, 12);
        java.awt.Color warnaBorder = new java.awt.Color(240, 245, 235);
        java.awt.Color warnaTeks = new java.awt.Color(50, 50, 50);
        java.awt.Color warnaHeader = new java.awt.Color(60, 90, 60);

        WindowUbahTindakanOperasi = new javax.swing.JDialog(this, "Ubah Tindakan Operasi", true);
        WindowUbahTindakanOperasi.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        WindowUbahTindakanOperasi.getContentPane().setBackground(java.awt.Color.WHITE);
        WindowUbahTindakanOperasi.setLayout(new BorderLayout(0,0));

        // ---- Header judul ----
        JPanel panelHeader = new JPanel(new BorderLayout());
        panelHeader.setBackground(warnaHeader);
        panelHeader.setBorder(javax.swing.BorderFactory.createEmptyBorder(8,12,8,12));
        JLabel labelHeader = new JLabel("Ubah Tindakan Operasi");
        labelHeader.setFont(new java.awt.Font("Tahoma", 1, 14));
        labelHeader.setForeground(java.awt.Color.WHITE);
        panelHeader.add(labelHeader, BorderLayout.WEST);
        WindowUbahTindakanOperasi.add(panelHeader, BorderLayout.NORTH);

        // ---- Panel isi (atas: daftar tindakan sesi, bawah: cari & pilih tindakan baru) ----
        JPanel panelIsi = new JPanel(new BorderLayout(8,8));
        panelIsi.setBackground(java.awt.Color.WHITE);
        panelIsi.setBorder(javax.swing.BorderFactory.createEmptyBorder(10,10,10,10));

        JPanel panelAtas = new JPanel(new BorderLayout(0,5));
        panelAtas.setBackground(java.awt.Color.WHITE);
        panelAtas.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(warnaBorder),
                "::[ Tindakan Pada Sesi Operasi Ini ]::",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                javax.swing.border.TitledBorder.DEFAULT_POSITION, fontIsi, warnaTeks));

        modelTindakanSesi = new DefaultTableModel(null, new Object[]{"Kode Paket","Nama Tindakan"}){
            @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbTindakanSesi = new JTable(modelTindakanSesi);
        gayakanTabel(tbTindakanSesi);
        tbTindakanSesi.getColumnModel().getColumn(0).setPreferredWidth(90);
        tbTindakanSesi.getColumnModel().getColumn(1).setPreferredWidth(400);
        tbTindakanSesi.getSelectionModel().addListSelectionListener(evt2 -> {
            if(!evt2.getValueIsAdjusting() && tbTindakanSesi.getSelectedRow()>-1){
                kodePaketLamaTerpilih=modelTindakanSesi.getValueAt(tbTindakanSesi.getSelectedRow(),0).toString();
            }
        });
        JScrollPane scrollAtas = new JScrollPane(tbTindakanSesi);
        scrollAtas.setBorder(javax.swing.BorderFactory.createLineBorder(warnaBorder));
        panelAtas.add(scrollAtas, BorderLayout.CENTER);

        JPanel panelBawah = new JPanel(new BorderLayout(0,5));
        panelBawah.setBackground(java.awt.Color.WHITE);
        panelBawah.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(warnaBorder),
                "::[ Cari & Pilih Tindakan/Paket Operasi Pengganti ]::",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                javax.swing.border.TitledBorder.DEFAULT_POSITION, fontIsi, warnaTeks));

        JPanel panelCari = new JPanel(new BorderLayout(6,0));
        panelCari.setBackground(java.awt.Color.WHITE);
        panelCari.setBorder(javax.swing.BorderFactory.createEmptyBorder(4,4,6,4));
        JLabel labelCari = new JLabel("Cari :");
        labelCari.setFont(fontIsi);
        labelCari.setForeground(warnaTeks);
        try{
            labelCari.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Search-16x16.png")));
        }catch(Exception ignore){}
        panelCari.add(labelCari, BorderLayout.WEST);
        TCariTindakanBaru = new JTextField();
        TCariTindakanBaru.setFont(fontIsi);
        TCariTindakanBaru.setBorder(javax.swing.BorderFactory.createCompoundBorder(
        ...
        TCariTindakanBaru.setToolTipText("Ketik nama atau kode tindakan untuk mencari...");
        TCariTindakanBaru.setDocument(new batasInput((byte)100).getKata(TCariTindakanBaru));
        TCariTindakanBaru.getDocument().addDocumentListener(new DocumentListener(){
            @Override public void insertUpdate(DocumentEvent e){ runBackground(() -> muatPencarianTindakanBaru()); }
            @Override public void removeUpdate(DocumentEvent e){ runBackground(() -> muatPencarianTindakanBaru()); }
            @Override public void changedUpdate(DocumentEvent e){ runBackground(() -> muatPencarianTindakanBaru()); }
        });
        panelCari.add(TCariTindakanBaru, BorderLayout.CENTER);
        panelBawah.add(panelCari, BorderLayout.NORTH);

        modelCariTindakanBaru = new DefaultTableModel(null, new Object[]{"Kode Paket","Nama Tindakan"}){
            @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbCariTindakanBaru = new JTable(modelCariTindakanBaru);
        gayakanTabel(tbCariTindakanBaru);
        tbCariTindakanBaru.getColumnModel().getColumn(0).setPreferredWidth(90);
        tbCariTindakanBaru.getColumnModel().getColumn(1).setPreferredWidth(400);
        JScrollPane scrollBawah = new JScrollPane(tbCariTindakanBaru);
        scrollBawah.setBorder(javax.swing.BorderFactory.createLineBorder(warnaBorder));
        panelBawah.add(scrollBawah, BorderLayout.CENTER);

        javax.swing.JSplitPane split = new javax.swing.JSplitPane(javax.swing.JSplitPane.VERTICAL_SPLIT, panelAtas, panelBawah);
        split.setResizeWeight(0.4);
        split.setBorder(null);
        split.setBackground(java.awt.Color.WHITE);
        panelIsi.add(split, BorderLayout.CENTER);

        // ---- Panel tombol ----
        JPanel panelTombol = new JPanel(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT,8,8));
        panelTombol.setBackground(new java.awt.Color(245,245,245));
        panelTombol.setBorder(javax.swing.BorderFactory.createMatteBorder(1,0,0,0,new java.awt.Color(220,220,220)));

        BtnSimpanTindakanOperasi = new JButton("Simpan");
        BtnSimpanTindakanOperasi.setFont(fontIsi);
        BtnSimpanTindakanOperasi.setForeground(warnaTeks);
        BtnSimpanTindakanOperasi.setPreferredSize(new java.awt.Dimension(110,28));
        try{
            BtnSimpanTindakanOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/save-16x16.png")));
        }catch(Exception ignore){}
        BtnSimpanTindakanOperasi.addActionListener(this::BtnSimpanTindakanOperasiActionPerformed);

        BtnTutupTindakanOperasi = new JButton("Tutup");
        BtnTutupTindakanOperasi.setFont(fontIsi);
        BtnTutupTindakanOperasi.setForeground(warnaTeks);
        BtnTutupTindakanOperasi.setPreferredSize(new java.awt.Dimension(110,28));
        try{
            BtnTutupTindakanOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cross.png")));
        }catch(Exception ignore){}
        BtnTutupTindakanOperasi.addActionListener(evt2 -> WindowUbahTindakanOperasi.dispose());

        panelTombol.add(BtnSimpanTindakanOperasi);
        panelTombol.add(BtnTutupTindakanOperasi);

        WindowUbahTindakanOperasi.add(panelIsi, BorderLayout.CENTER);
        WindowUbahTindakanOperasi.add(panelTombol, BorderLayout.SOUTH);
    }

    /** Menyeragamkan tampilan JTable pada window Ubah Tindakan Operasi
     *  supaya selaras dengan tabel utama (font, tinggi baris, warna header, garis). */
    private void gayakanTabel(JTable tabel){
        tabel.setFont(new java.awt.Font("Tahoma", 0, 11));
        tabel.setRowHeight(22);
        tabel.setGridColor(new java.awt.Color(230,230,230));
        tabel.setSelectionBackground(new java.awt.Color(200,225,200));
        tabel.setSelectionForeground(new java.awt.Color(50,50,50));
        tabel.getTableHeader().setFont(new java.awt.Font("Tahoma", 1, 11));
        tabel.getTableHeader().setBackground(new java.awt.Color(235,240,232));
        tabel.getTableHeader().setForeground(new java.awt.Color(50,50,50));
        tabel.setDefaultRenderer(Object.class, new WarnaTable());
    }

    /** Menampilkan seluruh tindakan (baris tabel operasi) pada sesi
     *  no_rawat + tgl_operasi yang sedang diubah. */
    private void muatDaftarTindakanSesi(){
        modelTindakanSesi.setRowCount(0);
        try{
            ResultSet rsTindakan=koneksi.createStatement().executeQuery(
                    "select operasi.kode_paket, paket_operasi.nm_perawatan from operasi inner join paket_operasi "+
                    "on operasi.kode_paket=paket_operasi.kode_paket where operasi.no_rawat='"+noRawatTindakanTerpilih+"' "+
                    "and operasi.tgl_operasi='"+tglOperasiTindakanTerpilih+"'");
            while(rsTindakan.next()){
                modelTindakanSesi.addRow(new Object[]{rsTindakan.getString("kode_paket"),rsTindakan.getString("nm_perawatan")});
            }
            rsTindakan.close();
        }catch(Exception e){
            System.out.println("Notifikasi Muat Tindakan Sesi : "+e);
        }
    }

    /** Mencari tindakan/paket operasi dari tabel paket_operasi berdasarkan
     *  kata kunci yang diketikkan pada TCariTindakanBaru. */
    private void muatPencarianTindakanBaru(){
        String kata=TCariTindakanBaru.getText().trim();
        SwingUtilities.invokeLater(() -> modelCariTindakanBaru.setRowCount(0));
        if(kata.length()<1) return;
        try{
            ResultSet rsCari=koneksi.createStatement().executeQuery(
                    "select kode_paket,nm_perawatan from paket_operasi where nm_perawatan like '%"+kata+"%' or kode_paket like '%"+kata+"%' order by nm_perawatan limit 50");
            while(rsCari.next()){
                String kode=rsCari.getString("kode_paket");
                String nama=rsCari.getString("nm_perawatan");
                SwingUtilities.invokeLater(() -> modelCariTindakanBaru.addRow(new Object[]{kode,nama}));
            }
            rsCari.close();
        }catch(Exception e){
            System.out.println("Notifikasi Cari Tindakan Baru : "+e);
        }
    }

    private void BtnSimpanTindakanOperasiActionPerformed(java.awt.event.ActionEvent evt){
        if(kodePaketLamaTerpilih.equals("")){
            JOptionPane.showMessageDialog(WindowUbahTindakanOperasi,"Silahkan pilih dulu tindakan yang akan diubah pada daftar di atas ..!!");
        }else if(tbCariTindakanBaru.getSelectedRow()==-1){
            JOptionPane.showMessageDialog(WindowUbahTindakanOperasi,"Silahkan cari & pilih tindakan/paket operasi pengganti ..!!");
        }else{
            String kodePaketBaru=modelCariTindakanBaru.getValueAt(tbCariTindakanBaru.getSelectedRow(),0).toString();
            int reply = JOptionPane.showConfirmDialog(WindowUbahTindakanOperasi,"Eeiiiiiits, udah bener belum data yang mau disimpan..??","Konfirmasi",JOptionPane.YES_NO_OPTION);
            if(reply==JOptionPane.YES_OPTION){
                Map<String,String> tarifBaru = ambilTarifPaketOperasi(kodePaketBaru);
                if(tarifBaru==null){
                    JOptionPane.showMessageDialog(WindowUbahTindakanOperasi,"Data tarif paket operasi tidak ditemukan, perubahan dibatalkan ..!!");
                }else if(Sequel.mengedittf("operasi","no_rawat=? and tgl_operasi=? and kode_paket=?",
                        "kode_paket=?,biayaoperator1=?,biayaoperator2=?,biayaoperator3=?,biayaasisten_operator1=?,biayaasisten_operator2=?,"+
                        "biayaasisten_operator3=?,biayainstrumen=?,biayadokter_anak=?,biayaperawaat_resusitas=?,biayadokter_anestesi=?,"+
                        "biayaasisten_anestesi=?,biayaasisten_anestesi2=?,biayabidan=?,biayabidan2=?,biayabidan3=?,biayaperawat_luar=?,"+
                        "biayasewaok=?,biayaalat=?,akomodasi=?,bagian_rs=?,biaya_omloop=?,biaya_omloop2=?,biaya_omloop3=?,biaya_omloop4=?,"+
                        "biaya_omloop5=?,biayasarpras=?,biaya_dokter_pjanak=?,biaya_dokter_umum=?",32,new String[]{
                            kodePaketBaru,
                            tarifBaru.get("operator1"),tarifBaru.get("operator2"),tarifBaru.get("operator3"),
                            tarifBaru.get("asisten_operator1"),tarifBaru.get("asisten_operator2"),tarifBaru.get("asisten_operator3"),
                            tarifBaru.get("instrumen"),tarifBaru.get("dokter_anak"),tarifBaru.get("perawaat_resusitas"),
                            tarifBaru.get("dokter_anestesi"),tarifBaru.get("asisten_anestesi"),tarifBaru.get("asisten_anestesi2"),
                            tarifBaru.get("bidan"),tarifBaru.get("bidan2"),tarifBaru.get("bidan3"),tarifBaru.get("perawat_luar"),
                            tarifBaru.get("sewa_ok"),tarifBaru.get("alat"),tarifBaru.get("akomodasi"),tarifBaru.get("bagian_rs"),
                            tarifBaru.get("omloop"),tarifBaru.get("omloop2"),tarifBaru.get("omloop3"),tarifBaru.get("omloop4"),
                            tarifBaru.get("omloop5"),tarifBaru.get("sarpras"),tarifBaru.get("dokter_pjanak"),tarifBaru.get("dokter_umum"),
                            noRawatTindakanTerpilih,tglOperasiTindakanTerpilih,kodePaketLamaTerpilih
                        })==true){
                    JOptionPane.showMessageDialog(WindowUbahTindakanOperasi,"Tindakan operasi & tarif berhasil diubah ..!!");
                    kodePaketLamaTerpilih="";
                    muatDaftarTindakanSesi();
                    runBackground(() -> tampil());
                }else{
                    JOptionPane.showMessageDialog(WindowUbahTindakanOperasi,"Terjadi kesalahan saat menyimpan perubahan tindakan operasi ..!!");
                }
            }
        }
    }

    /** Mengambil seluruh kolom tarif dari paket_operasi untuk kode_paket tertentu,
     *  dipakai untuk menyesuaikan biaya di tabel operasi saat tindakan diganti. */
    private Map<String,String> ambilTarifPaketOperasi(String kodePaket){
        Map<String,String> hasil=new HashMap<>();
        try{
            ResultSet rsTarif=koneksi.createStatement().executeQuery(
                    "select operator1,operator2,operator3,asisten_operator1,asisten_operator2,asisten_operator3,instrumen,"+
                    "dokter_anak,perawaat_resusitas,dokter_anestesi,asisten_anestesi,asisten_anestesi2,bidan,bidan2,bidan3,"+
                    "perawat_luar,sewa_ok,alat,akomodasi,bagian_rs,omloop,omloop2,omloop3,omloop4,omloop5,sarpras,"+
                    "dokter_pjanak,dokter_umum from paket_operasi where kode_paket='"+kodePaket+"'");
            if(rsTarif.next()){
                String[] kolom={"operator1","operator2","operator3","asisten_operator1","asisten_operator2","asisten_operator3",
                    "instrumen","dokter_anak","perawaat_resusitas","dokter_anestesi","asisten_anestesi","asisten_anestesi2",
                    "bidan","bidan2","bidan3","perawat_luar","sewa_ok","alat","akomodasi","bagian_rs","omloop","omloop2",
                    "omloop3","omloop4","omloop5","sarpras","dokter_pjanak","dokter_umum"};
                for(String k : kolom){
                    hasil.put(k, rsTarif.getString(k));
                }
            }else{
                rsTarif.close();
                return null;
            ...
            System.out.println("Notifikasi Ambil Tarif Paket Operasi : "+e);
            return null;
        }
        return hasil;
    }

    private void MnHapusTagihanOperasiActionPerformed(java.awt.event.ActionEvent evt) {
        if(!akses.getadmin()){
            JOptionPane.showMessageDialog(rootPane,"Maaf, hapus tindakan operasi hanya boleh dilakukan oleh Admin ..!!");
            return;
        }
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
                if(Sequel.cariRegistrasi(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString())>0){
                    ...
                    noRawatHapusTerpilih=tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString();
                    tglOperasiHapusTerpilih=tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString();
                    kodePaketHapusTerpilih="";
                    if(WindowHapusTindakanOperasi==null){
                        buatWindowHapusTindakanOperasi();
                    }
                    muatDaftarTindakanHapus();
                    WindowHapusTindakanOperasi.setSize(550,400);
                    WindowHapusTindakanOperasi.setLocationRelativeTo(this);
                    WindowHapusTindakanOperasi.setVisible(true);
                }
            }else{
                JOptionPane.showMessageDialog(rootPane,"Silahkan pilih data, klik pada No.Rawat ..!!");
            }
    ...
    /** Membuat window "Hapus Tindakan Operasi" (khusus admin), berisi daftar
     *  tindakan pada sesi operasi terpilih beserta tombol Hapus. Tema warna
     *  dibuat merah untuk menegaskan ini aksi yang berisiko/destruktif. */
    private void buatWindowHapusTindakanOperasi(){
        java.awt.Font fontIsi = new java.awt.Font("Tahoma", 0, 11);
        java.awt.Color warnaBorder = new java.awt.Color(245, 225, 225);
        java.awt.Color warnaTeks = new java.awt.Color(50, 50, 50);
        java.awt.Color warnaHeader = new java.awt.Color(150, 40, 40);

        WindowHapusTindakanOperasi = new javax.swing.JDialog(this, "Hapus Tindakan Operasi (Khusus Admin)", true);
        WindowHapusTindakanOperasi.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        WindowHapusTindakanOperasi.getContentPane().setBackground(java.awt.Color.WHITE);
        WindowHapusTindakanOperasi.setLayout(new BorderLayout(0,0));

        JPanel panelHeader = new JPanel(new BorderLayout());
        panelHeader.setBackground(warnaHeader);
        panelHeader.setBorder(javax.swing.BorderFactory.createEmptyBorder(8,12,8,12));
        JLabel labelHeader = new JLabel("Hapus Tindakan Operasi — Khusus Admin");
        labelHeader.setFont(new java.awt.Font("Tahoma", 1, 14));
        labelHeader.setForeground(java.awt.Color.WHITE);
        panelHeader.add(labelHeader, BorderLayout.WEST);
        WindowHapusTindakanOperasi.add(panelHeader, BorderLayout.NORTH);

        JPanel panelIsi = new JPanel(new BorderLayout(0,5));
        panelIsi.setBackground(java.awt.Color.WHITE);
        panelIsi.setBorder(javax.swing.BorderFactory.createEmptyBorder(10,10,10,10));
        panelIsi.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(warnaBorder),
                "::[ Pilih Tindakan Yang Akan Dihapus ]::",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                javax.swing.border.TitledBorder.DEFAULT_POSITION, fontIsi, warnaTeks));

        modelTindakanHapus = new DefaultTableModel(null, new Object[]{"Kode Paket","Nama Tindakan"}){
            @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
        tbTindakanHapus = new JTable(modelTindakanHapus);
        gayakanTabel(tbTindakanHapus);
        tbTindakanHapus.getColumnModel().getColumn(0).setPreferredWidth(90);
        tbTindakanHapus.getColumnModel().getColumn(1).setPreferredWidth(350);
        tbTindakanHapus.getSelectionModel().addListSelectionListener(evt2 -> {
            if(!evt2.getValueIsAdjusting() && tbTindakanHapus.getSelectedRow()>-1){
                kodePaketHapusTerpilih=modelTindakanHapus.getValueAt(tbTindakanHapus.getSelectedRow(),0).toString();
            }
        });
        JScrollPane scrollTabel = new JScrollPane(tbTindakanHapus);
        scrollTabel.setBorder(javax.swing.BorderFactory.createLineBorder(warnaBorder));
        panelIsi.add(scrollTabel, BorderLayout.CENTER);

        JLabel labelPeringatan = new JLabel("Perhatian: data tindakan yang dihapus tidak dapat dikembalikan.");
        labelPeringatan.setFont(fontIsi);
        labelPeringatan.setForeground(warnaHeader);
        labelPeringatan.setBorder(javax.swing.BorderFactory.createEmptyBorder(6,2,0,2));
        panelIsi.add(labelPeringatan, BorderLayout.SOUTH);

        JPanel panelTombol = new JPanel(new java.awt.FlowLayout(java.awt.FlowLayout.RIGHT,8,8));
        panelTombol.setBackground(new java.awt.Color(245,245,245));
        panelTombol.setBorder(javax.swing.BorderFactory.createMatteBorder(1,0,0,0,new java.awt.Color(220,220,220)));

        BtnHapusTindakanOperasi = new JButton("Hapus");
        BtnHapusTindakanOperasi.setFont(fontIsi);
        BtnHapusTindakanOperasi.setForeground(java.awt.Color.WHITE);
        BtnHapusTindakanOperasi.setBackground(warnaHeader);
        BtnHapusTindakanOperasi.setOpaque(true);
        BtnHapusTindakanOperasi.setPreferredSize(new java.awt.Dimension(110,28));
        try{
            BtnHapusTindakanOperasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/cross.png")));
        }catch(Exception ignore){}
        BtnHapusTindakanOperasi.addActionListener(this::BtnHapusTindakanOperasiActionPerformed);

        BtnTutupHapusTindakanOperasi = new JButton("Tutup");
        BtnTutupHapusTindakanOperasi.setFont(fontIsi);
        BtnTutupHapusTindakanOperasi.setForeground(warnaTeks);
        BtnTutupHapusTindakanOperasi.setPreferredSize(new java.awt.Dimension(110,28));
        BtnTutupHapusTindakanOperasi.addActionListener(evt2 -> WindowHapusTindakanOperasi.dispose());

        panelTombol.add(BtnHapusTindakanOperasi);
        panelTombol.add(BtnTutupHapusTindakanOperasi);

        WindowHapusTindakanOperasi.add(panelIsi, BorderLayout.CENTER);
        WindowHapusTindakanOperasi.add(panelTombol, BorderLayout.SOUTH);
    }

    /** Menampilkan seluruh tindakan pada sesi operasi yang sedang diproses hapus. */
    private void muatDaftarTindakanHapus(){
        modelTindakanHapus.setRowCount(0);
        try{
            ResultSet rsTindakan=koneksi.createStatement().executeQuery(
                    "select operasi.kode_paket, paket_operasi.nm_perawatan from operasi inner join paket_operasi "+
                    "on operasi.kode_paket=paket_operasi.kode_paket where operasi.no_rawat='"+noRawatHapusTerpilih+"' "+
                    "and operasi.tgl_operasi='"+tglOperasiHapusTerpilih+"'");
            while(rsTindakan.next()){
                modelTindakanHapus.addRow(new Object[]{rsTindakan.getString("kode_paket"),rsTindakan.getString("nm_perawatan")});
            }
            rsTindakan.close();
        }catch(Exception e){
            System.out.println("Notifikasi Muat Tindakan Hapus : "+e);
        }
    }

    private void BtnHapusTindakanOperasiActionPerformed(java.awt.event.ActionEvent evt){
        if(!akses.getadmin()){
            JOptionPane.showMessageDialog(WindowHapusTindakanOperasi,"Maaf, hapus tindakan operasi hanya boleh dilakukan oleh Admin ..!!");
            return;
        }
        if(kodePaketHapusTerpilih.equals("")){
            JOptionPane.showMessageDialog(WindowHapusTindakanOperasi,"Silahkan pilih dulu tindakan yang akan dihapus pada daftar di atas ..!!");
        }else{
            int reply = JOptionPane.showConfirmDialog(WindowHapusTindakanOperasi,
                    "Yakin mau hapus tindakan ini? Data yang sudah dihapus tidak bisa dikembalikan ..!!","Konfirmasi Hapus",JOptionPane.YES_NO_OPTION);
            if(reply==JOptionPane.YES_OPTION){
                if(Sequel.queryutf("delete from operasi where no_rawat='"+noRawatHapusTerpilih+"' and tgl_operasi='"+tglOperasiHapusTerpilih+"' "+
                        "and kode_paket='"+kodePaketHapusTerpilih+"'")==true){
                    JOptionPane.showMessageDialog(WindowHapusTindakanOperasi,"Tindakan operasi berhasil dihapus ..!!");
                    kodePaketHapusTerpilih="";
                    muatDaftarTindakanHapus();
                    runBackground(() -> tampil());
                    if(modelTindakanHapus.getRowCount()==0){
                        WindowHapusTindakanOperasi.dispose();
                    }
                }else{
                    JOptionPane.showMessageDialog(WindowHapusTindakanOperasi,"Terjadi kesalahan saat menghapus tindakan operasi ..!!");
                }
            }
        }
    }
    ...
    */
    ...
    private javax.swing.JMenuItem MnUbahTindakanOperasi;
    ...
    public void isCek(){
        ...
        MnHapusTagihanOperasi.setEnabled(akses.getoperasi() && akses.getadmin());
        MnUbahOperatorPetugas.setEnabled(akses.getoperasi());
        MnUbahTindakanOperasi.setEnabled(akses.getoperasi());
