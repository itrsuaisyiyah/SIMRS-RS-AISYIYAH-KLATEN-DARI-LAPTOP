...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppKirimWaLabPasien = new javax.swing.JMenuItem();
        ...
        ppKirimWaLabPasien.setBackground(new java.awt.Color(255, 255, 254));
        ppKirimWaLabPasien.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppKirimWaLabPasien.setForeground(new java.awt.Color(50, 50, 50));
        ppKirimWaLabPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppKirimWaLabPasien.setText("Kirim WA Pasien");
        ppKirimWaLabPasien.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppKirimWaLabPasien.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppKirimWaLabPasien.setName("ppKirimWaLabPasien"); // NOI18N
        ppKirimWaLabPasien.setPreferredSize(new java.awt.Dimension(190, 26));
        ppKirimWaLabPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppKirimWaLabPasienBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppKirimWaLabPasien);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void ppKirimWaLabPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppKirimWaLabPasienBtnPrintActionPerformed
        // TODO add your handling code here:
        String FileName = "LAB_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 1).toString().replaceAll("[/()\\-:, ]", "");
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        UploadPDF(FileName, "media/");
        HapusPDF();
    }//GEN-LAST:event_ppKirimWaLabPasienBtnPrintActionPerformed
                    ...
                    while (rs.next()) {
                        ...
                        try {
                            ...
                            if (rspermintaan.next()) {
                                ...
                                Valid.MyReportPDFUpload("rptPeriksaLab9Permintaan.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", FileName, param);
                            } else {
                                //Valid.MyReport("rptPeriksaLab9.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", param);
                                //Valid.MyReportPDFUpload("rptBridgingSEP2.jasper", "report", "::[ Cetak SEP ]::", FileName, param);
                                Valid.MyReportPDFUpload("rptPeriksaLab9.jasper", "report", "::[ Pemeriksaan Laboratorium ]::", FileName, param);
                            }
                        } catch (Exception e) {
                            System.out.println("Notif : " + e);
                        } finally {
    ...
    */
    ...
    private javax.swing.JMenuItem ppKirimWaLabPasien;
...
private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            String pesan = "==========================\n"
                    ...
                    + "==========================\nSilakan unduh file terlampir.\n==========================\nWA Unit Laboratorium: wa.me/6285180954219 \nTerimakasih.";
        ...
        //    TNoRm.setText(Sequel.cariIsi("select no_rkm_medis from reg_periksa where no_rawat='" + tbDokter.getValueAt(tbDokter.getSelectedRow(), 0) + "'"));
            ...
            try {
                String sql = "INSERT INTO wa_outbox (NOMOR, NOWA, PESAN, TANGGAL_JAM, STATUS, SOURCE, SENDER, SUCCESS, RESPONSE, SENDER_NAME, REQUEST, TYPE, FILE) "
                        + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                ...
                ps.setString(6, "LABORAT");  // SOURCE
                ps.setString(7, "NODEJS");                  // SENDER
                ps.setString(8, "");                        // SUCCESS
                ps.setString(9, "");                        // RESPONSE
                 ps.setString(10, "");                       // REQUEST
                ps.setString(11, "");                       // REQUEST
                ps.setString(12, "FILE");                   // TYPE
                ps.setString(13, FileName + ".pdf");              // FILE
                ps.executeUpdate();
