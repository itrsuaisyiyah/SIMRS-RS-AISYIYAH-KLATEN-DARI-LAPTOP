...
public class DlgPemberianDiet extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel5.setBounds(740, 40, 74, 23);
        ...
        Keterangan.setBounds(820, 40, 360, 23);
        ...
        if(TabRawat.getSelectedIndex()==0){
            if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
                ...
                if(Sequel.menyimpantf("detail_beri_diet","'"+TNoRw.getText()+"','"+Kamar.getText()+"','"+
                        ...
                        WaktuDiet.getText()+"','"+
                        KdDiet.getText()+"','"+
                        Keterangan.getText()+"'","data")==true){
                    tabMode.addRow(new String[]{
                        TNoRw.getText(),TPasien.getText(),Ruang.getText(),Valid.SetTgl(DTPTgl.getSelectedItem()+""),WaktuDiet.getText(),JamDiet.getText(),NmDiet.getText(),"-",Kamar.getText(),KdDiet.getText(),Keterangan.getText()
                    });
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            ...
            if(tabMode.getRowCount()==0){
                ...
                param.put("alamat",Sequel.cariIsi("select reg_periksa.almt_pj from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));
                param.put("logo",Sequel.cariGambar("select setting.logo from setting")); 
                 Valid.MyReportqry("rptBrDiet.jasper","report","::[ Data Pemberian Diet ]::",
                    ...
                    "detail_beri_diet.tanggal,detail_beri_diet.waktu,jam_diet_pasien.jam,diet.nama_diet,detail_beri_diet.kd_kamar,detail_beri_diet.kd_diet,detail_beri_diet.keterangan " +
                    ...
                    "(detail_beri_diet.no_rawat like '%"+TCari.getText().trim()+"%' or reg_periksa.no_rkm_medis like '%"+TCari.getText().trim()+"%' or pasien.nm_pasien like '%"+TCari.getText().trim()+"%') order by bangsal.kd_bangsal,diet.nama_diet",param);
            }
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void MnLabelDietActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLabelDietActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            Valid.MyReportqry("rptLabelDiet.jasper","report","::[ Label Diet ]::",
                "select detail_beri_diet.no_rawat,reg_periksa.no_rkm_medis,reg_periksa.almt_pj,pasien.nm_pasien,pasien.tgl_lahir, " +
                "concat(detail_beri_diet.kd_kamar,', ',bangsal.nm_bangsal) as kamar,detail_beri_diet.tanggal,detail_beri_diet.waktu,jam_diet_pasien.jam,diet.nama_diet,detail_beri_diet.keterangan " +
    ...
    private void MnLabelDiet1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLabelDiet1ActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptLabelDiet.jasper","report","::[ Label Diet ]::",
                ...
                "detail_beri_diet.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and detail_beri_diet.waktu like '%"+WaktuDiet2.getText().trim()+"%' and bangsal.nm_bangsal like '%"+NmBangsalCari.getText().trim()+"%' and bangsal.nm_bangsal like '%"+TCari.getText().trim()+"%' or "+
                ...
                "order by bangsal.kd_bangsal,diet.nama_diet",param);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void WaktuDietKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_WaktuDietKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            Sequel.cariIsi("select jam from jam_diet_pasien where waktu=? ",JamDiet,JamDiet.getText());
        }else if(evt.getKeyCode()==KeyEvent.VK_UP){
    ...
    public void tampil() {   
        try{
            ...
            ps=koneksi.prepareStatement(
                ...
                (TCari.getText().trim().equals("")?"":"and (detail_beri_diet.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or bangsal.nm_bangsal like ? ) ")+
                "order by bangsal.kd_bangsal,diet.nama_diet");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("kd_kamar"),rs.getString("kd_diet"),rs.getString("keterangan")
                    });
                }
            } catch (Exception e) {
    ...
    public void tampil2() {   
        try{
            ...
            ps2=koneksi.prepareStatement(
                ...
                "where detail_beri_diet.tanggal between ? and ? and detail_beri_diet.waktu like ? and bangsal.nm_bangsal like ? "+
                (TCari.getText().trim().equals("")?"":"and (detail_beri_diet.no_rawat like ? or reg_periksa.no_rkm_medis like ? or pasien.nm_pasien like ? or bangsal.nm_bangsal like ? ) ")+
                "group by diet.nama_diet order by bangsal.kd_bangsal,diet.nama_diet");
            try {
