    ...
    private static void reconnect() throws SQLException {
        ...
        while (retries > 0) {
            try {
                ...
                System.out.println(
                    "  Koneksi Berhasil. Sorry bro loading, tunggu dulu.... \n\n"+
...
"  #   | |/ / |__   __ _ _ __  ______ _  |  _ \\/ ___|| | | | / \\   \n" +
"  #   | ' /| '_ \\ / _` | '_ \\|_  / _` | | |_) \\___ \\| | | |/ _ \\  \n" +
"  #   | . \\| | | | (_| | | | |/ / (_| | |  _ < ___) | |_| / ___ \\ \n" +
"  #   |_|\\_\\_| |_|\\__,_|_| |_/___\\__,_| |_| \\_\\____/ \\___/_/   \\_\\\n" +
"  #                                                               \n" +
"                                                                   \n" +
    ...
    public static String KEYEKLAIM() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = prop.getProperty("KEYEKLAIM");
        } catch (Exception e) {
            var = "";
        }
        return var;
    ...
    public static String WARADIOLOGI() {
        try {
            prop.loadFromXML(new FileInputStream("setting/database.xml"));
            var = EnkripsiAES.decrypt(prop.getProperty("WARADIOLOGI"));
        } catch (Exception e) {
            var = "";
        }
        return var;
