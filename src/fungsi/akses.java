...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            satu_sehat_mapping_kptl_tarif_kamar=false,penilaian_medis_ranap_rehab_medik=false,penilaian_awal_medis_ranap_anak=true,penilaian_awal_medis_ranap_bedah_mulut=true,penilaian_awal_medis_ranap_tht=true,penilaian_awal_medis_ranap_neurologi=true,penilaian_awal_medis_ranap_mata=true,penilaian_awal_medis_ranap_orthopedi=true,penilaian_awal_medis_ranap_penyakit_dalam=true,penilaian_awal_medis_ranap_geriatri=true,penilaian_awal_medis_ranap_bedah=true,penilaian_awal_medis_ranap_paru=true,penilaian_awal_medis_ranap_kulit_kelamin=true,checklist_kriteria_masuk_picu=false,checklist_kriteria_keluar_picu=false,checklist_kriteria_masuk_nicu=false,checklist_kriteria_keluar_nicu=false,checklist_kriteria_masuk_bbrt=false,checklist_kriteria_keluar_bbrt=false,kriteria_masuk_bbrt=false,kriteria_keluar_bbrt=false;
    private static boolean skrining_igd;
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.penilaian_medis_ranap_rehab_medik=true;
                        akses.penilaian_awal_medis_ranap_anak=true;
                        akses.penilaian_awal_medis_ranap_bedah_mulut=true;
                        akses.penilaian_awal_medis_ranap_tht=true;
                        akses.penilaian_awal_medis_ranap_neurologi=true;
                        akses.penilaian_awal_medis_ranap_mata=true;
                        akses.penilaian_awal_medis_ranap_orthopedi=true;
                        akses.penilaian_awal_medis_ranap_penyakit_dalam=true;
                        akses.penilaian_awal_medis_ranap_geriatri=true;
                        akses.penilaian_awal_medis_ranap_bedah=true;
                        akses.penilaian_awal_medis_ranap_paru=true;
                        akses.penilaian_awal_medis_ranap_kulit_kelamin=true;
                        akses.checklist_kriteria_masuk_picu=true;
                        akses.checklist_kriteria_keluar_picu=true;
                        akses.checklist_kriteria_masuk_nicu=true;
                        akses.checklist_kriteria_keluar_nicu=true;
                        akses.checklist_kriteria_masuk_bbrt=true;
                        akses.checklist_kriteria_keluar_bbrt=true;
                        akses.kriteria_masuk_bbrt=true;
                        akses.kriteria_keluar_bbrt=true;
                        ...
                        akses.skrining_igd=rs2.getBoolean("skrining_igd");
                        ...
                        akses.checklist_kriteria_masuk_picu=rs2.getBoolean("checklist_kriteria_masuk_picu");
                        akses.checklist_kriteria_keluar_picu=rs2.getBoolean("checklist_kriteria_keluar_picu");
                        akses.checklist_kriteria_masuk_nicu=rs2.getBoolean("checklist_kriteria_masuk_nicu");
                        akses.checklist_kriteria_keluar_nicu=rs2.getBoolean("checklist_kriteria_keluar_nicu");
                        akses.checklist_kriteria_masuk_bbrt=rs2.getBoolean("checklist_kriteria_masuk_bbrt");
                        akses.checklist_kriteria_keluar_bbrt=rs2.getBoolean("checklist_kriteria_keluar_bbrt");
                        akses.kriteria_masuk_bbrt=rs2.getBoolean("kriteria_masuk_bbrt");
                        akses.kriteria_keluar_bbrt=rs2.getBoolean("kriteria_keluar_bbrt");
    ...
    public static void setLogOut(){
        ...
        akses.penilaian_medis_ranap_rehab_medik=false;
        akses.penilaian_awal_medis_ranap_anak=true;
        akses.penilaian_awal_medis_ranap_bedah_mulut=true;
        akses.penilaian_awal_medis_ranap_tht=true;
        akses.penilaian_awal_medis_ranap_neurologi=true;
        ...
        akses.penilaian_awal_medis_ranap_orthopedi=true;
        akses.penilaian_awal_medis_ranap_penyakit_dalam=true;
        akses.penilaian_awal_medis_ranap_geriatri=false;
        akses.penilaian_awal_medis_ranap_bedah=true;
        akses.penilaian_awal_medis_ranap_paru=true;
        akses.penilaian_awal_medis_ranap_kulit_kelamin=true;
        akses.checklist_kriteria_masuk_picu=true;
    ...
    public static boolean getskrining_igd(){return akses.skrining_igd;}
    ...
    public static boolean getpenilaian_medis_ranap_rehab_medik(){return akses.penilaian_medis_ranap_rehab_medik;}
    public static boolean getpenilaian_awal_medis_ranap_anak(){return akses.penilaian_awal_medis_ranap_anak;}
    public static boolean getpenilaian_awal_medis_ranap_bedah_mulut(){return akses.penilaian_awal_medis_ranap_bedah_mulut;}
    public static boolean getpenilaian_awal_medis_ranap_tht(){return akses.penilaian_awal_medis_ranap_tht;}
    public static boolean getpenilaian_awal_medis_ranap_neurologi(){return akses.penilaian_awal_medis_ranap_neurologi;}
    public static boolean getpenilaian_awal_medis_ranap_mata(){return akses.penilaian_awal_medis_ranap_mata;}
    public static boolean getpenilaian_awal_medis_ranap_orthopedi(){return akses.penilaian_awal_medis_ranap_orthopedi;}
    public static boolean getpenilaian_awal_medis_ranap_penyakit_dalam(){return akses.penilaian_awal_medis_ranap_penyakit_dalam;}
    public static boolean getpenilaian_awal_medis_ranap_geriatri(){return akses.penilaian_awal_medis_ranap_geriatri;}
    public static boolean getpenilaian_awal_medis_ranap_bedah(){return akses.penilaian_awal_medis_ranap_bedah;}
    public static boolean getpenilaian_awal_medis_ranap_paru(){return akses.penilaian_awal_medis_ranap_paru;}
    public static boolean getpenilaian_awal_medis_ranap_kulit_kelamin(){return akses.penilaian_awal_medis_ranap_kulit_kelamin;}
    public static boolean getchecklist_kriteria_masuk_picu(){return akses.checklist_kriteria_masuk_picu;}
    public static boolean getchecklist_kriteria_keluar_picu(){return akses.checklist_kriteria_keluar_picu;}
    public static boolean getchecklist_kriteria_masuk_nicu(){return akses.checklist_kriteria_masuk_nicu;}
    public static boolean getchecklist_kriteria_keluar_nicu(){return akses.checklist_kriteria_keluar_nicu;}
    public static boolean getchecklist_kriteria_masuk_bbrt(){return akses.checklist_kriteria_masuk_bbrt;}
    public static boolean getchecklist_kriteria_keluar_bbrt(){return akses.checklist_kriteria_keluar_bbrt;}
    public static boolean getkriteria_masuk_bbrt(){return akses.kriteria_masuk_bbrt;}
    public static boolean getkriteria_keluar_bbrt(){return akses.kriteria_keluar_bbrt;}
