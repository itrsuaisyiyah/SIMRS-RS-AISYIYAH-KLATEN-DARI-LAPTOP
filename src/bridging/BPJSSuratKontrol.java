...
public class BPJSSuratKontrol extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,psWa;
    ...
    private String link="",requestJson="",URL="",user="",utc="",notifwapasien = "",FileName="";
    ...
    private void initComponents() {
        ...
        MnKirimWaSuratKontrolPasien = new javax.swing.JMenuItem();
        ...
        MnKirimWaSuratKontrolPasien.setBackground(new java.awt.Color(255, 255, 254));
        MnKirimWaSuratKontrolPasien.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKirimWaSuratKontrolPasien.setForeground(new java.awt.Color(50, 50, 50));
        MnKirimWaSuratKontrolPasien.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnKirimWaSuratKontrolPasien.setText("Kirim WA Surat Kontrol");
        MnKirimWaSuratKontrolPasien.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKirimWaSuratKontrolPasien.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnKirimWaSuratKontrolPasien.setName("MnKirimWaSuratKontrolPasien"); // NOI18N
        MnKirimWaSuratKontrolPasien.setPreferredSize(new java.awt.Dimension(160, 26));
        MnKirimWaSuratKontrolPasien.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKirimWaSuratKontrolPasienActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnKirimWaSuratKontrolPasien);
        ...
        DTPTanggalSurat1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-07-2025" }));
        ...
        DTPTanggalSurat2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-07-2025" }));
        ...
        DTPTanggalKontrol1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-07-2025" }));
        ...
        DTPTanggalKontrol2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-07-2025" }));
        ...
        TanggalSurat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-07-2025" }));
        ...
        TanggalKontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "29-07-2025" }));
    ...
    if(tabMode.getRowCount()==0){
        ...
        // =========================================================
        // R1 : BERDASARKAN TANGGAL SURAT KONTROL
        // =========================================================
        if(R1.isSelected()==true){
            ...
            Valid.MyReportqry(
                "rptBridgingSuratKontrol.jasper",
                "report",
                ...
                // DATA RUJUKAN FKTP
                "bridging_sep.tglrujukan AS tglrujukan,"+
                "bridging_sep.no_rujukan AS no_rujukan,"+
                ...
                "inner join bridging_surat_kontrol_bpjs "+
                "on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep "+

                "where bridging_surat_kontrol_bpjs.tgl_surat between '"+
                Valid.SetTgl(DTPTanggalSurat1.getSelectedItem()+"")+
                "' and '"+
                Valid.SetTgl(DTPTanggalSurat2.getSelectedItem()+"")+
                "' "+
                ...
                (
                    ...
                    :
                    "and ("+
                    "bridging_sep.no_rawat like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_sep.no_sep like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_sep.no_kartu like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_sep.nomr like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_sep.nama_pasien like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_surat_kontrol_bpjs.no_surat like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_surat_kontrol_bpjs.nm_poli_bpjs like '%"+TCari.getText().trim()+"%' or "+
                    "bridging_surat_kontrol_bpjs.nm_dokter_bpjs like '%"+TCari.getText().trim()+"%'"+
                    ") "
                )+
        ...
        // =========================================================
        // R2 : BERDASARKAN TANGGAL RENCANA KONTROL
        // =========================================================
            ...
            Valid.MyReportqry(
                ...
                "where bridging_surat_kontrol_bpjs.tgl_rencana between '"+
                Valid.SetTgl(DTPTanggalKontrol1.getSelectedItem()+"")+
                "' and '"+
                Valid.SetTgl(DTPTanggalKontrol2.getSelectedItem()+"")+
                "' "+
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void MnSuratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSuratActionPerformed
        ...
        if(tbObat.getSelectedRow()!= -1){
            ...
            Valid.MyReportqry(
                            ...
                            "inner join bridging_surat_kontrol_bpjs "+
                            "on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep "+
                            "where bridging_surat_kontrol_bpjs.no_surat='"+NoSurat.getText()+"'",
                            param
                        );             
            this.setCursor(Cursor.getDefaultCursor());
        }else{
    ...
    private void MnKirimWaSuratKontrolPasienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKirimWaSuratKontrolPasienActionPerformed
        FileName = "SK_" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString().replaceAll("/", "") + "_" + tbObat.getValueAt(tbObat.getSelectedRow(), 1).toString()+"_"+ tbObat.getValueAt(tbObat.getSelectedRow(), 3).toString()+"_"+ tbObat.getValueAt(tbObat.getSelectedRow(), 5).toString();
        CreatePDF(FileName);
        String filePath = "tmpPDF/" + FileName;
        UploadPDF(FileName, "media/");
        HapusPDF();
    }//GEN-LAST:event_MnKirimWaSuratKontrolPasienActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnKirimWaSuratKontrolPasien;
    ...
    private void KirimWaPasienSekarang() {
        ...
        String pesan = "============================\n"
                     ...
                     + "Surat Kontrol BPJS\n"
                     + "Nomor Surat: "+noSurat+"\n"
                     + "Tanggal Surat : "+TanggalSurat.getSelectedItem()+"\n"
        ...
        try {
            ...
            psWa.setString(6, "SURKON");  // SOURCE
    ...
    private void KirimWaPasienTanggalKontrol() {
        koneksiwa = koneksiDBWa.condb();
    ...
    private void CreatePDF(String FileName) {
        ...
        //    Valid.MyReportqry("rptBridgingSuratKontrol2.jasper","report","::[ Data Surat Kontrol VClaim ]::",
            Valid.MyReportPDFqryUpload("rptBridgingSuratKontrol2.jasper","report","::[ Data Surat Kontrol VClaim ]::",
                    "select bridging_sep.no_rawat,bridging_sep.no_sep,bridging_sep.no_kartu,bridging_sep.nomr,bridging_sep.nama_pasien,bridging_sep.tanggal_lahir,"+
                    "bridging_sep.jkel,bridging_sep.diagawal,bridging_sep.nmdiagnosaawal,bridging_sep.tglsep,bridging_sep.tglrujukan,bridging_sep.no_rujukan,"+
                    "bridging_surat_kontrol_bpjs.tgl_surat,bridging_surat_kontrol_bpjs.no_surat,bridging_surat_kontrol_bpjs.tgl_rencana,"+
                    "bridging_surat_kontrol_bpjs.kd_dokter_bpjs,bridging_surat_kontrol_bpjs.nm_dokter_bpjs,"+
                    "bridging_surat_kontrol_bpjs.kd_poli_bpjs,bridging_surat_kontrol_bpjs.nm_poli_bpjs "+
                    "from bridging_sep inner join bridging_surat_kontrol_bpjs "+
                    "on bridging_surat_kontrol_bpjs.no_sep=bridging_sep.no_sep "+
                    "where bridging_surat_kontrol_bpjs.no_surat='"+NoSurat.getText()+"'",FileName,param);              
            this.setCursor(Cursor.getDefaultCursor());
        }else{
            JOptionPane.showMessageDialog(null,"Maaf, silahkan pilih data Surat Kontrol yang mau dicetak...!!!!");
            BtnBatal.requestFocus();
    ...
    private void UploadPDF(String FileName, String docpath) {
        try {
            ...
            HttpPost postRequest = new HttpPost("http://" + koneksiDB.HOSTWAWEB() + ":" + koneksiDB.PORTWEBWA() + "/" + koneksiDB.FOLDERFILEWA() + "/upload.php?doc=" + docpath);
            ...
            String pesan = "==========================\n"
                    ...
                    + "surat kontrol BPJS atas nama\n"
                    +  NmPasien.getText() + "\n"
                    + "Tanggal Kontrol: " + TanggalKontrol.getSelectedItem() + "\n"
                    + "Dokter : " + NmDokter.getText() + "\n"
                    + "Poli : " + NmPoli.getText() + "\n==========================\n"
                    + "Untuk Mempermudah & Mempercepat Pelayanan BPJS Silahkan Mendaftar Melalui Aplikasi Mobile JKN.\n==========================\nWA Admin: wa.me/62816266532\n" +
                        "WA Humas: wa.me/6285866660166\n" +
                        "IG: https://www.instagram.com/rsuaisyiyahklaten/ \nTerimakasih.";
