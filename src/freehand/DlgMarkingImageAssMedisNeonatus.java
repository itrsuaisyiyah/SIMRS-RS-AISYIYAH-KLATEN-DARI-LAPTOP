 ...
 * @author perpustakaan
 */
public class DlgMarkingImageAssMedisNeonatus extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DlgMarkingImageAssMedisNeonatus(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(885,674); 
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Marking Lokalis Asesmen Awal Medis Neonatus ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        jLabel3.setBounds(550, 10, 100, 23);
        ...
        PilihWarna.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Biru", "Merah", "Hitam" }));
        PilihWarna.setName("PilihWarna"); // NOI18N
        FormInput.add(PilihWarna);
        PilihWarna.setBounds(650, 10, 72, 20);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        try {
            // Buat objek Robot untuk menangkap layar
            Robot robot = new Robot();
            Rectangle captureArea = new Rectangle(panelGlass9.getBounds());
            BufferedImage image = robot.createScreenCapture(captureArea);

            // Format nama file gambar
            String fileName = "assMdsNeonatus" + TNoRawat.getText().replaceAll("/", "") + ".png";
            File outputFile = new File("tmpImageFreehand/" + fileName);

            // Simpan gambar ke file
            ImageIO.write(image, "png", outputFile);

            // Upload gambar ke server
            String imagePath = "assesmentmedisneonatus/imagemarking/" + fileName;
            uploadImage(fileName, "assesmentmedisneonatus/imagemarking");

            // Periksa apakah data sudah ada
            String queryCheck = "SELECT COUNT(no_rawat) AS jumlah FROM asesmen_medis_neonatus_image_marking WHERE no_rawat='" + TNoRawat.getText() + "'";
            boolean dataExists = Sequel.cariInteger(queryCheck) > 0;

            // Format tanggal dan jam
            String currentDate = tanggalNow.format(new Date());
            String currentTime = jamNow.format(new Date());
            ...
            if (dataExists) {
                ...
                Sequel.mengedittf("asesmen_medis_neonatus_image_marking", "no_rawat=?", "tanggal=?,jam=?,url_image=?", updateParams.length, updateParams);
            } else {
                ...
                Sequel.menyimpantf("asesmen_medis_neonatus_image_marking", "?,?,?,?", "No.Rawat", insertParams.length, insertParams);
            }

            // Tutup dialog
            dispose();
        } catch (AWTException | IOException ex) {
            Logger.getLogger(DlgMarkingImageAssMedisNeonatus.class.getName()).log(Level.SEVERE, null, ex);
            JOptionPane.showMessageDialog(this, "Terjadi kesalahan saat menyimpan gambar: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
...
//        System.out.println(index);
    ...
    private void BtnHapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapus1ActionPerformed
        imageAssesment("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/imagefreehand/masterimage/gambarbayi.png");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMarkingImageAssMedisNeonatus dialog = new DlgMarkingImageAssMedisNeonatus(new javax.swing.JFrame(), true);
...
//        Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=? ",TPasien,TNoRM.getText());
    ...
    public void setNoRw(String norw) {
        ...
        urlImage = Sequel.cariIsi("select url_image from asesmen_medis_neonatus_image_marking where no_rawat='" + norw + "' ");
