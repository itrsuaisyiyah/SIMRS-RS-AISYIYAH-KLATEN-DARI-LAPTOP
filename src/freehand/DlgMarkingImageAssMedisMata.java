 ...
 * @author perpustakaan
 */
public class DlgMarkingImageAssMedisMata extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgMarkingImageAssMedisMata(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        setSize(885,674); 
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Marking Lokalis Asesmen Awal Medis Mata ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(70, 70, 70))); // NOI18N
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/matadua.png"))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        try {
            ...
            Logger.getLogger(DlgMarkingImageAssMedisMata.class.getName()).log(Level.SEVERE, null, ex);
        }
        Rectangle capture = 
            new Rectangle(Toolkit.getDefaultToolkit().getScreenSize());
            BufferedImage Image = r.createScreenCapture(panelGlass9.bounds());
        try {
            ImageIO.write(Image, "png", new File("tmpImageFreehand/assMdsMata"+TNoRawat.getText().replaceAll("/", "")+".png"));
        } catch (IOException ex) {
            Logger.getLogger(DlgMarkingImageAssMedisMata.class.getName()).log(Level.SEVERE, null, ex);
        }
        uploadImage("assMdsMata"+TNoRawat.getText().replaceAll("/", "")+".png","assesmentmedismata/imagemarking");
        
        if(Sequel.cariInteger("select count(no_rawat) as jumlah from asesmen_medis_mata_image_marking where no_rawat='"+TNoRawat.getText()+"'")>0){
            if(Sequel.mengedittf("asesmen_medis_mata_image_marking","no_rawat=?","tanggal=?,jam=?,url_image=?",4,new String[]{
                   tanggalNow.format(new Date()),jamNow.format(new Date()),"assesmentmedismata/imagemarking/assMdsMata"+TNoRawat.getText().replaceAll("/", "")+".png",TNoRawat.getText()
                     })==true){
                
            }
        }else{
         if(Sequel.menyimpantf("asesmen_medis_mata_image_marking","?,?,?,?","No.Rawat",4,new String[]{
                    TNoRawat.getText(),tanggalNow.format(new Date()),jamNow.format(new Date()),"assesmentmedismata/imagemarking/assMdsMata"+TNoRawat.getText().replaceAll("/", "")+".png"
                })==true){
            }
        }
        dispose();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgMarkingImageAssMedisMata dialog = new DlgMarkingImageAssMedisMata(new javax.swing.JFrame(), true);
...
//        Sequel.cariIsi("select nm_pasien from pasien where no_rkm_medis=? ",TPasien,TNoRM.getText());
    ...
    public void setNoRw(String norw) {
        ...
        urlImage=Sequel.cariIsi("select url_image from asesmen_medis_mata_image_marking where no_rawat='"+norw+"' ");
