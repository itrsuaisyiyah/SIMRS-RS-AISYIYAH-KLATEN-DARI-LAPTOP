 ...
 * @author perpustakaan
 */
public class DicomViewerHybridSplitRadiologi extends javax.swing.JDialog {
    ...
    private String halaman="",norawat="",auth,authEncrypt;
    ...
    public DicomViewerHybridSplitRadiologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        DicomViewerHybridSplitRadiologi.this.setTitle(newValue);
                    });
                });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DicomViewerHybridSplitRadiologi dialog = new DicomViewerHybridSplitRadiologi(new javax.swing.JFrame(), true);
