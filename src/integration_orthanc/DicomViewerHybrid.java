 ...
 * @author perpustakaan
 */
public class DicomViewerHybrid extends javax.swing.JDialog {
    ...
    public DicomViewerHybrid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        DicomViewerHybrid.this.setTitle(newValue);
                    });
                });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DicomViewerHybrid dialog = new DicomViewerHybrid(new javax.swing.JFrame(), true);
