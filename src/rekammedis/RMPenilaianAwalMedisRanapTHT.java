...
public final class RMPenilaianAwalMedisRanapTHT extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap THT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:06:19" }));
        ...
        jLabel80.setBounds(44, 830, 80, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(454, 830, 70, 23);
        ...
        BtnDokter3.setBounds(120, 830, 28, 23);
        ...
        BtnDokter4.setBounds(510, 830, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_tht","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",31,new String[]{
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapTHT.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan THT]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_tht.tanggal,"+
                "penilaian_medis_ranap_tht.kd_dokter,penilaian_medis_ranap_tht.anamnesis,penilaian_medis_ranap_tht.hubungan,penilaian_medis_ranap_tht.keluhan_utama,penilaian_medis_ranap_tht.rps,"+
                "penilaian_medis_ranap_tht.rpd,penilaian_medis_ranap_tht.rpo,penilaian_medis_ranap_tht.alergi,penilaian_medis_ranap_tht.td,penilaian_medis_ranap_tht.nadi,penilaian_medis_ranap_tht.rr,"+
                "penilaian_medis_ranap_tht.suhu,penilaian_medis_ranap_tht.bb,penilaian_medis_ranap_tht.tb,penilaian_medis_ranap_tht.nyeri,penilaian_medis_ranap_tht.status_nutrisi,"+
                "penilaian_medis_ranap_tht.kondisi,penilaian_medis_ranap_tht.ket_lokalis,penilaian_medis_ranap_tht.lab,penilaian_medis_ranap_tht.rad,penilaian_medis_ranap_tht.tes_pendengaran,"+
                "penilaian_medis_ranap_tht.penunjang,penilaian_medis_ranap_tht.diagnosis,penilaian_medis_ranap_tht.diagnosisbanding,penilaian_medis_ranap_tht.permasalahan,"+
                "penilaian_medis_ranap_tht.terapi,penilaian_medis_ranap_tht.tindakan,penilaian_medis_ranap_tht.tatalaksana,penilaian_medis_ranap_tht.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_tht on reg_periksa.no_rawat=penilaian_medis_ranap_tht.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_tht.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_tht.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_tht on reg_periksa.no_rawat=penilaian_medis_ranap_tht.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_tht.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_tht.tanggal between ? and ? order by penilaian_medis_ranap_tht.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_tht.tanggal,"+
                        "penilaian_medis_ranap_tht.kd_dokter,penilaian_medis_ranap_tht.anamnesis,penilaian_medis_ranap_tht.hubungan,penilaian_medis_ranap_tht.keluhan_utama,penilaian_medis_ranap_tht.rps,"+
                        ...
                        "inner join penilaian_medis_ranap_tht on reg_periksa.no_rawat=penilaian_medis_ranap_tht.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_tht.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_tht.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_tht.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_tht.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_tht());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_tht());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_tht());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_tht where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_tht","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,td=?,nadi=?,rr=?,suhu=?,bb=?,tb=?,nyeri=?,"+
