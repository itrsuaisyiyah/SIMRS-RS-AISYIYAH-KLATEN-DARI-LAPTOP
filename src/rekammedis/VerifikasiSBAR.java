...
public class VerifikasiSBAR extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public VerifikasiSBAR(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ SBAR Perawatan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            VerifikasiSBAR dialog = new VerifikasiSBAR(new javax.swing.JFrame(), true);
        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#FFFAF8' align='center' width='56%'>S.B.A.R</td>"+
...
//                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2=koneksi.prepareStatement(
                                ...
                                "pemeriksaan_ranap_sbar.background,pemeriksaan_ranap_sbar.assesment,pemeriksaan_ranap_sbar.recommendation,pemeriksaan_ranap_sbar.instruksi,pemeriksaan_ranap_sbar.nip,pegawai.nama,departemen.nama, "+
                        ...
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                                        ...
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='20%'>Background</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='20%'>Asesmen</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='20%'>Recommendation</td>"+
                                        "<td valign='middle' bgcolor='#FFFFF8' align='center' width='13%'>Instruksi</td>"+
