...
public class VerifikasiTBAK extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public VerifikasiTBAK(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         setSize(1285,674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ TBAK Perawatan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            VerifikasiTBAK dialog = new VerifikasiTBAK(new javax.swing.JFrame(), true);
...
//                                "order by pemeriksaan_ranap.tgl_perawatan,pemeriksaan_ranap.jam_rawat").executeQuery();
                        rs2=koneksi.prepareStatement(
                                "select pemeriksaan_ranap_tbak.tgl_perawatan,pemeriksaan_ranap_tbak.jam_rawat,pemeriksaan_ranap_tbak.situation,"+
                                "pemeriksaan_ranap_tbak.background,pemeriksaan_ranap_tbak.assesment,pemeriksaan_ranap_tbak.recommendation,pemeriksaan_ranap_tbak.nip,pegawai.nama,departemen.nama, "+
                                "validasi_pemeriksaan_tbak.nik_validator,namavalidator.nama as namavalidator,validasi_pemeriksaan_tbak.tgl_validasi,validasi_pemeriksaan_tbak.jam_validasi,validasi_pemeriksaan_tbak.status_validasi "+ 
                                "from pemeriksaan_ranap_tbak LEFT JOIN validasi_pemeriksaan_tbak ON validasi_pemeriksaan_tbak.no_rawat = pemeriksaan_ranap_tbak.no_rawat AND validasi_pemeriksaan_tbak.tgl_perawatan = pemeriksaan_ranap_tbak.tgl_perawatan AND validasi_pemeriksaan_tbak.jam_rawat = pemeriksaan_ranap_tbak.jam_rawat inner join pegawai on pemeriksaan_ranap_tbak.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_tbak.nik_validator=namavalidator.nik where pemeriksaan_ranap_tbak.no_rawat='"+rs.getString("no_rawat")+"' "+
                                "order by pemeriksaan_ranap_tbak.tgl_perawatan,pemeriksaan_ranap_tbak.jam_rawat").executeQuery();
                        if(rs2.next()){
                            htmlContent.append(
                                    "<tr class='isi'>"+
                            ...
                            while(rs2.next()){
                                ...
                                if(Sequel.cariInteger("select count(validasi_pemeriksaan_tbak.nik_validator) " +
                                        "from pemeriksaan_ranap_tbak LEFT JOIN validasi_pemeriksaan_tbak ON validasi_pemeriksaan_tbak.no_rawat = pemeriksaan_ranap_tbak.no_rawat AND validasi_pemeriksaan_tbak.tgl_perawatan = pemeriksaan_ranap_tbak.tgl_perawatan AND validasi_pemeriksaan_tbak.jam_rawat = pemeriksaan_ranap_tbak.jam_rawat inner join pegawai on pemeriksaan_ranap_tbak.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_tbak.nik_validator=namavalidator.nik where pemeriksaan_ranap_tbak.no_rawat='"+rs.getString("no_rawat")+"' AND validasi_pemeriksaan_tbak.nik_validator='"+rs2.getString("nik_validator")+"'" +
                                        "order by pemeriksaan_ranap_tbak.tgl_perawatan,pemeriksaan_ranap_tbak.jam_rawat")>0){
