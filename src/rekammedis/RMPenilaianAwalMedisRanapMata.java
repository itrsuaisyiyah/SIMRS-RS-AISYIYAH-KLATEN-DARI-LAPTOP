 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapMata extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapMata(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Mata ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:02:31" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapMata.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Jalan Mata ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_mata.tanggal,"+
                "penilaian_medis_ranap_mata.kd_dokter,penilaian_medis_ranap_mata.anamnesis,penilaian_medis_ranap_mata.hubungan,penilaian_medis_ranap_mata.keluhan_utama,penilaian_medis_ranap_mata.rps,penilaian_medis_ranap_mata.rpd,penilaian_medis_ranap_mata.rpo,penilaian_medis_ranap_mata.alergi,"+
                "penilaian_medis_ranap_mata.status,penilaian_medis_ranap_mata.td,penilaian_medis_ranap_mata.nadi,penilaian_medis_ranap_mata.rr,penilaian_medis_ranap_mata.suhu,penilaian_medis_ranap_mata.nyeri,penilaian_medis_ranap_mata.bb,"+
                "penilaian_medis_ranap_mata.visuskanan,penilaian_medis_ranap_mata.visuskiri,penilaian_medis_ranap_mata.cckanan,penilaian_medis_ranap_mata.cckiri,penilaian_medis_ranap_mata.palkanan,penilaian_medis_ranap_mata.palkiri,penilaian_medis_ranap_mata.conkanan,penilaian_medis_ranap_mata.conkiri,"+
                "penilaian_medis_ranap_mata.corneakanan,penilaian_medis_ranap_mata.corneakiri,penilaian_medis_ranap_mata.coakanan,penilaian_medis_ranap_mata.coakiri,penilaian_medis_ranap_mata.pupilkanan,penilaian_medis_ranap_mata.pupilkiri,penilaian_medis_ranap_mata.lensakanan,penilaian_medis_ranap_mata.lensakiri,"+
                "penilaian_medis_ranap_mata.funduskanan,penilaian_medis_ranap_mata.funduskiri,penilaian_medis_ranap_mata.papilkanan,penilaian_medis_ranap_mata.papilkiri,penilaian_medis_ranap_mata.retinakanan,penilaian_medis_ranap_mata.retinakiri,penilaian_medis_ranap_mata.makulakanan,penilaian_medis_ranap_mata.makulakiri,"+
                "penilaian_medis_ranap_mata.tiokanan,penilaian_medis_ranap_mata.tiokiri,penilaian_medis_ranap_mata.mbokanan,penilaian_medis_ranap_mata.mbokiri,penilaian_medis_ranap_mata.lab,penilaian_medis_ranap_mata.rad,penilaian_medis_ranap_mata.penunjang,penilaian_medis_ranap_mata.tes,penilaian_medis_ranap_mata.pemeriksaan,"+
                "penilaian_medis_ranap_mata.diagnosis,penilaian_medis_ranap_mata.diagnosisbdg,penilaian_medis_ranap_mata.permasalahan,penilaian_medis_ranap_mata.terapi,penilaian_medis_ranap_mata.tindakan,penilaian_medis_ranap_mata.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_mata on reg_periksa.no_rawat=penilaian_medis_ranap_mata.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_mata.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_mata.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapMata dialog = new RMPenilaianAwalMedisRanapMata(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_mata on reg_periksa.no_rawat=penilaian_medis_ranap_mata.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_mata.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_mata.tanggal between ? and ? order by penilaian_medis_ranap_mata.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_mata.tanggal,"+
                        "penilaian_medis_ranap_mata.kd_dokter,penilaian_medis_ranap_mata.anamnesis,penilaian_medis_ranap_mata.hubungan,penilaian_medis_ranap_mata.keluhan_utama,penilaian_medis_ranap_mata.rps,penilaian_medis_ranap_mata.rpd,penilaian_medis_ranap_mata.rpo,penilaian_medis_ranap_mata.alergi,"+
                        ...
                        "inner join penilaian_medis_ranap_mata on reg_periksa.no_rawat=penilaian_medis_ranap_mata.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_mata.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_mata.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_mata.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_mata.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_mata());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_mata());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_mata());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_mata where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_mata","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,status=?,td=?,nadi=?,rr=?,suhu=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ranap_mata","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",56,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),StatusNutrisi.getText(),TD.getText(),Nadi.getText(),RR.getText(),Suhu.getText(),Nyeri.getText(),BB.getText(),
                Visuskanan.getText(),Visuskiri.getText(),CCkanan.getText(),CCkiri.getText(),Palkanan.getText(),Palkiri.getText(),Conkanan.getText(),Conkiri.getText(),Corneakanan.getText(),Corneakiri.getText(),COAkanan.getText(),COAkiri.getText(),Pupilkanan.getText(),Pupilkiri.getText(),
                Lensakanan.getText(),Lensakiri.getText(),Funduskanan.getText(),Funduskiri.getText(),Papilkanan.getText(),Papilkiri.getText(),Retinakanan.getText(),Retinakiri.getText(),Makulakanan.getText(),Makulakiri.getText(),TIOkanan.getText(),TIOkiri.getText(),MBOkanan.getText(),MBOkiri.getText(),
