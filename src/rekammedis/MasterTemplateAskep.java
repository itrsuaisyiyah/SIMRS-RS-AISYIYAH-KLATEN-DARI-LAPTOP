    ...
    */
    ...
    private void getData() {
        if(tbDokter.getSelectedRow()!= -1){
            ...
            MasalahKeperawatan.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),1).toString());
            Diagnosis.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),2).toString());
            Luaran.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),3).toString());
            Intervensi.setText(tabMode.getValueAt(tbDokter.getSelectedRow(),4).toString());
        }
    }
