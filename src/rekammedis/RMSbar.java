 ...
 * @author perpustakaan
 */
public final class RMSbar extends javax.swing.JDialog {
    ...
    private String TANGGALMUNDUR = "yes", pesan = "";
     ...
     * @param modal
     */
    public RMSbar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabModePemeriksaanSbar = new DefaultTableModel(null, new Object[]{
            ...
            "Situation", "Background", "Assesment", "Recommendation", "Instruksi", "NIP",
            "Dokter/Paramedis", "Profesi/Jabatan", "Status Verifikasi"}) {
...
// Optimasi pengaturan lebar kolom menggunakan switch-case
        ...
        TInstruksi.setDocument(new batasInput((int) 1000).getKata(TInstruksi));
        ...
        dokter.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (dokter.getTable().getSelectedRow() != -1) {
                    kd_dokter.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 0).toString());
                    NmDokter.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 1).toString());
                    kd_dokter.requestFocus();
                }
            }
        ...
        kamar.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(kamar.getTable().getSelectedRow()!= -1){   
                    kd_bed.setText(kamar.getTable().getValueAt(kamar.getTable().getSelectedRow(),1).toString());               
                    NmKamar.setText(kamar.getTable().getValueAt(kamar.getTable().getSelectedRow(),3).toString()+" ( "+kamar.getTable().getValueAt(kamar.getTable().getSelectedRow(),4).toString()+")");
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2026" }));
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-05-2026" }));
        ...
        scrollPane5.setBounds(70, 110, 360, 70);
        ...
        scrollPane6.setBounds(70, 190, 360, 70);

        jLabel88.setText("Situation :");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(0, 110, 70, 23);

        jLabel89.setText("Background :");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(0, 190, 70, 23);
        ...
        scrollPane9.setBounds(550, 110, 360, 70);

        jLabel90.setText("Asesmen :");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(450, 110, 90, 23);

        jLabel91.setText("Instruksi :");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(930, 110, 100, 23);
        ...
        scrollPane10.setBounds(550, 190, 360, 70);

        jLabel92.setText("Dilakukan :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(0, 70, 70, 23);
        ...
        TPegawai.setBounds(190, 70, 212, 23);
        ...
        BtnSeekPegawai1.setBounds(400, 70, 28, 23);
        ...
        MnKonsulDPJPWa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/wa.png"))); // NOI18N
        MnKonsulDPJPWa.setMnemonic('4');
        MnKonsulDPJPWa.setText("Konsul DPJP");
        MnKonsulDPJPWa.setToolTipText("");
        MnKonsulDPJPWa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKonsulDPJPWa.setGlassColor(new java.awt.Color(255, 153, 153));
        MnKonsulDPJPWa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnKonsulDPJPWa.setName("MnKonsulDPJPWa"); // NOI18N
        MnKonsulDPJPWa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKonsulDPJPWaActionPerformed(evt);
            }
        });
        FormInput.add(MnKonsulDPJPWa);
        MnKonsulDPJPWa.setBounds(950, 270, 160, 26);

        jLabel94.setText("DPJP:");
        jLabel94.setName("jLabel94"); // NOI18N
        FormInput.add(jLabel94);
        jLabel94.setBounds(0, 270, 70, 23);

        kd_dokter.setHighlighter(null);
        ...
        FormInput.add(kd_dokter);
        kd_dokter.setBounds(70, 270, 115, 23);
        ...
        NmDokter.setBounds(190, 270, 212, 23);
        ...
        BtnSeekPegawai2.setBounds(400, 270, 28, 23);

        jLabel95.setText("Kamar:");
        jLabel95.setName("jLabel95"); // NOI18N
        FormInput.add(jLabel95);
        jLabel95.setBounds(470, 270, 70, 23);

        kd_bed.setHighlighter(null);
        kd_bed.setName("kd_bed"); // NOI18N
        kd_bed.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                kd_bedActionPerformed(evt);
            }
        });
        kd_bed.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kd_bedKeyPressed(evt);
            }
        });
        FormInput.add(kd_bed);
        kd_bed.setBounds(540, 270, 115, 23);
        ...
        NmKamar.setBounds(660, 270, 212, 23);
        ...
        BtnSeekPegawai3.setBounds(870, 270, 28, 23);
        ...
        scrollPane11.setViewportView(TInstruksi);

        FormInput.add(scrollPane11);
        scrollPane11.setBounds(980, 130, 240, 70);

        jLabel96.setText("Recommendation :");
        jLabel96.setName("jLabel96"); // NOI18N
        FormInput.add(jLabel96);
        jLabel96.setBounds(440, 190, 100, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if ((!TSituation.getText().trim().equals("")) || (!TBackground.getText().trim().equals("")) || (!TAssesment.getText().trim().equals(""))
                || (!TRecommendation.getText().trim().equals("")) || (!TInstruksi.getText().trim().equals(""))) {
            if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                ...
                if (akses.getkode().equals("Admin Utama")) {
                    Sequel.menyimpan("pemeriksaan_ranap_sbar", "?,?,?,?,?,?,?,?,?", "Data", 9, new String[]{
                        ...
                        TSituation.getText(), TBackground.getText(), TAssesment.getText(), TRecommendation.getText(), TInstruksi.getText(), KdPeg.getText()
                    });
                    tampilPemeriksaanSbar();
                    BtnBatalActionPerformed(evt);
                } else {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (!TSituation.getText().trim().equals("") || !TBackground.getText().trim().equals("") || !TAssesment.getText().trim().equals("") || !TRecommendation.getText().trim().equals("") || !TInstruksi.getText().trim().equals("")) {
            if (tbPemeriksaanSbar.getSelectedRow() > -1) {
                //   String statusValidasi = tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 13).toString(); // Mendapatkan status validasi dari kolom 13
                String statusValidasi = Sequel.cariIsi("select status_validasi from validasi_pemeriksaan_sbar where no_rawat= '" + TNoRw.getText() + "' and tgl_perawatan = '" + tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 4).toString() + "'  and jam_rawat = '" + tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 5).toString() + "'");
                String kodePetugas = tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 10).toString(); // Mendapatkan kode petugas dari kolom 10
                String noRawat = tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 1).toString();
                String tglPerawatan = tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 4).toString();
                String jamRawat = tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 5).toString();

                // Jika status validasi adalah "Tervalidasi", tidak boleh diedit
                if (!statusValidasi.equals("Validasi")) {
                    // Memeriksa apakah akses adalah Admin Utama atau petugas yang bersangkutan
                    if (akses.getkode().equals("Admin Utama") || akses.getkode().equals(kodePetugas)) {
                        // Edit data
                        Sequel.mengedit("pemeriksaan_ranap_sbar",
                                "no_rawat='" + noRawat + "' and tgl_perawatan='" + tglPerawatan + "' and jam_rawat='" + jamRawat + "'",
                                "no_rawat='" + TNoRw.getText() + "', situation='" + TSituation.getText() + "', background='" + TBackground.getText() + "',"
                                + "assesment='" + TAssesment.getText() + "', recommendation='" + TRecommendation.getText() + "', instruksi='" + TInstruksi.getText() + "',"
                        ...
                        // Memperbarui tabel
                        tampilPemeriksaanSbar();
                        // Mengosongkan form setelah pengeditan
                        BtnBatalActionPerformed(evt);
                    } else {
                        JOptionPane.showMessageDialog(null, "Hanya bisa diganti oleh dokter/petugas yang bersangkutan.");
                    }
                } else {
                    // Jika status adalah "Tervalidasi", tidak boleh mengedit data
                    JOptionPane.showMessageDialog(null, "Data tidak dapat diedit karena sudah tervalidasi.");
                }
            } else {
            ...
            JOptionPane.showMessageDialog(rootPane, "Semua field harus diisi.");
        }
    ...
    private void MnKonsulDPJPWaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKonsulDPJPWaActionPerformed
        // Menyusun pesan untuk dikirim melalui WhatsApp
        pesan = "Kepada Yth. " + NmDokter.getText() + "\n\n"
                + "Mohon Konsultasi Pasien: \n"
                + "Nama: " + TPasien.getText() + "\n"
                + "Umur: " + Umur.getText() + "\n"
                + "Unit: " + NmKamar.getText() + "\n"
                + "-----------------------------\n"
                + "Situation: " + TSituation.getText() + "\n"
                + "-----------------------------\n"
                + "Background: " + TBackground.getText() + "\n"
                + "-----------------------------\n"
                + "Asesmen: " + TAssesment.getText() + "\n"
                + "-----------------------------\n"
                + "Recomendation: " + TRecommendation.getText() + " mmHg\n"
                + "-----------------------------\n"
                + "Mohon advis lebih lanjut. Terima Kasih";

        // Mengecek apakah data pasien sudah lengkap
        if (TPasien.getText().trim().equals("") || TNoRw.getText().trim().equals("")) {
            JOptionPane.showMessageDialog(null, "Maaf, silahkan pilih data terlebih dahulu dengan mengklik tabel...!!!");
            TCari.requestFocus();
        } else {
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));

            // Menampilkan form konsultasi
            WaKonsulDPJP form = new WaKonsulDPJP(null, false);
            form.isCek();
            form.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
            form.setLocationRelativeTo(internalFrame1);
            form.setVisible(true);
            // Mengirimkan data ke form dengan No. Rekam Medis dan pesan
            form.setNoRm(TNoRw.getText(), TNoRM.getText(), TPasien.getText(), pesan, kd_dokter.getText(), NmDokter.getText());
            this.setCursor(Cursor.getDefaultCursor());
        }
    }//GEN-LAST:event_MnKonsulDPJPWaActionPerformed
    ...
    private void kd_bedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kd_bedActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_kd_bedActionPerformed

    private void kd_bedKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kd_bedKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_kd_bedKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSbar dialog = new RMSbar(new javax.swing.JFrame(), true);
    ...
    private widget.Button MnKonsulDPJPWa;
    ...
    public void tampilPemeriksaanSbar() {
        ...
        try {
            ps = koneksi.prepareStatement("select pemeriksaan_ranap_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    ...
                    + "pemeriksaan_ranap_sbar.assesment,pemeriksaan_ranap_sbar.recommendation,pemeriksaan_ranap_sbar.instruksi,pemeriksaan_ranap_sbar.nip,pegawai.nama,pegawai.jbtn, IF(vps.no_rawat IS NOT NULL, 'Tervalidasi', 'Belum Divalidasi')"
                    ...
                    + "pemeriksaan_ranap_sbar.tgl_perawatan between ? and ? and reg_periksa.no_rawat like ? "
                    ...
                    + "pemeriksaan_ranap_sbar.recommendation like ? or pemeriksaan_ranap_sbar.instruksi like ? )")
    ...
    private void isDpjp() {
        try {
            ps = koneksi.prepareStatement(
                    "SELECT dpjp_ranap.no_rawat, dpjp_ranap.kd_dokter, dokter.nm_dokter FROM dpjp_ranap INNER JOIN "
                    + "reg_periksa ON dpjp_ranap.no_rawat = reg_periksa.no_rawat "
                    + "INNER JOIN dokter ON dpjp_ranap.kd_dokter = dokter.kd_dokter where dpjp_ranap.no_rawat=?");
            try {
                ps.setString(1, TNoRw.getText());
                rs = ps.executeQuery();
                if (rs.next()) {
    ...
    private void isKamar() {
        try {
            ps = koneksi.prepareStatement(
                    "select kamar_inap.no_rawat, kamar_inap.kd_kamar, kamar.kd_bangsal,"
                    + "bangsal.kd_bangsal, bangsal.nm_bangsal FROM kamar_inap "
                    + "INNER JOIN reg_periksa ON kamar_inap.no_rawat = reg_periksa.no_rawat "
                    + "INNER JOIN kamar ON kamar_inap.kd_kamar = kamar.kd_kamar "
                    + "INNER JOIN bangsal ON kamar.kd_bangsal = bangsal.kd_bangsal where reg_periksa.no_rawat=? order by kamar_inap.tgl_masuk desc limit 1");
            try {
                ps.setString(1, TNoRw.getText());
                rs = ps.executeQuery();
                if (rs.next()) {
                    kd_bed.setText(rs.getString("kd_kamar"));
                    NmKamar.setText(rs.getString("nm_bangsal"));
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private void getDataPemeriksaanSbar() {
        if (tbPemeriksaanSbar.getSelectedRow() != -1) {
            ...
            TInstruksi.setText(tbPemeriksaanSbar.getValueAt(tbPemeriksaanSbar.getSelectedRow(), 10).toString());
    ...
    private static class TInstruksi {
