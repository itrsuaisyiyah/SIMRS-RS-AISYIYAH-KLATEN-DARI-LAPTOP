 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapPenyakitDalam extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapPenyakitDalam(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Penyakit Dalam ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:04:56" }));
        ...
        jLabel80.setBounds(44, 490, 80, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Radiologi :");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(319, 490, 50, 23);
        ...
        BtnDokter1.setBounds(100, 110, 28, 23);
        ...
        BtnDokter2.setBounds(110, 490, 28, 23);
        ...
        BtnDokter3.setBounds(370, 490, 28, 23);
        ...
        BtnDokter4.setBounds(150, 190, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_penyakit_dalam","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapPenyakitDalam.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Penyakit Dalam ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_penyakit_dalam.tanggal,"+
                "penilaian_medis_ranap_penyakit_dalam.kd_dokter,penilaian_medis_ranap_penyakit_dalam.anamnesis,penilaian_medis_ranap_penyakit_dalam.hubungan,penilaian_medis_ranap_penyakit_dalam.keluhan_utama,"+
                "penilaian_medis_ranap_penyakit_dalam.rps,penilaian_medis_ranap_penyakit_dalam.rpd,penilaian_medis_ranap_penyakit_dalam.rpo,penilaian_medis_ranap_penyakit_dalam.alergi,"+
                "penilaian_medis_ranap_penyakit_dalam.kondisi,penilaian_medis_ranap_penyakit_dalam.status,penilaian_medis_ranap_penyakit_dalam.td,penilaian_medis_ranap_penyakit_dalam.nadi,"+
                "penilaian_medis_ranap_penyakit_dalam.suhu,penilaian_medis_ranap_penyakit_dalam.rr,penilaian_medis_ranap_penyakit_dalam.bb,penilaian_medis_ranap_penyakit_dalam.nyeri,penilaian_medis_ranap_penyakit_dalam.gcs,"+
                "penilaian_medis_ranap_penyakit_dalam.kepala,penilaian_medis_ranap_penyakit_dalam.thoraks,penilaian_medis_ranap_penyakit_dalam.abdomen,penilaian_medis_ranap_penyakit_dalam.ekstremitas,"+
                "penilaian_medis_ranap_penyakit_dalam.lainnya,penilaian_medis_ranap_penyakit_dalam.lab,penilaian_medis_ranap_penyakit_dalam.rad,penilaian_medis_ranap_penyakit_dalam.penunjanglain,"+
                "penilaian_medis_ranap_penyakit_dalam.diagnosis,penilaian_medis_ranap_penyakit_dalam.diagnosis2,penilaian_medis_ranap_penyakit_dalam.permasalahan,penilaian_medis_ranap_penyakit_dalam.terapi,"+
                "penilaian_medis_ranap_penyakit_dalam.tindakan,penilaian_medis_ranap_penyakit_dalam.edukasi,dokter.nm_dokter,penilaian_medis_ranap_penyakit_dalam.keterangan_kepala,penilaian_medis_ranap_penyakit_dalam.keterangan_thorak,"+
                "penilaian_medis_ranap_penyakit_dalam.keterangan_abdomen,penilaian_medis_ranap_penyakit_dalam.keterangan_ekstremitas "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_penyakit_dalam on reg_periksa.no_rawat=penilaian_medis_ranap_penyakit_dalam.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_penyakit_dalam.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_penyakit_dalam.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapPenyakitDalam dialog = new RMPenilaianAwalMedisRanapPenyakitDalam(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_penyakit_dalam on reg_periksa.no_rawat=penilaian_medis_ranap_penyakit_dalam.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_penyakit_dalam.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_penyakit_dalam.tanggal between ? and ? order by penilaian_medis_ranap_penyakit_dalam.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_penyakit_dalam.tanggal,"+
                        "penilaian_medis_ranap_penyakit_dalam.kd_dokter,penilaian_medis_ranap_penyakit_dalam.anamnesis,penilaian_medis_ranap_penyakit_dalam.hubungan,penilaian_medis_ranap_penyakit_dalam.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_penyakit_dalam on reg_periksa.no_rawat=penilaian_medis_ranap_penyakit_dalam.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_penyakit_dalam.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_penyakit_dalam.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_penyakit_dalam.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_penyakit_dalam.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_penyakit_dalam());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_penyakit_dalam());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_penyakit_dalam());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_penyakit_dalam where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_penyakit_dalam","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kondisi=?,status=?,td=?,nadi=?,suhu=?,"+
