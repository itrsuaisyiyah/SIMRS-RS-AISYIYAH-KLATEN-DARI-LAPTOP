...
public class RMSKriningRawatJalan extends javax.swing.JDialog {
    ...
    public RMSKriningRawatJalan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
                "Tgl.Skrining","Jam Skrining","No.R.M.","Nama Pasien","Tgl.Lahir","Ibu Kandung","J.K.","Resiko Jatuh",
                "Kesadaran","Pernafasan","Nyeri Dada","Skala Nyeri","Keputusan","TB.1 Batuk Berdahak","TB.2 Batuk Berdarah","TB.3 Demam","TB.4 BB Turun","TB.5 Keringat Malam","TB.6 Riwayat Kontak","NIP","Nama Petugas"
            }){
        ...
        tbObat.setPreferredScrollableViewportSize(new Dimension(400,500));
    ...
    private void initComponents() {
        ...
        tb1 = new widget.ComboBox();
        tb2 = new widget.ComboBox();
        tb3 = new widget.ComboBox();
        tb4 = new widget.ComboBox();
        tb5 = new widget.ComboBox();
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(750, 322));
        PanelInput.setLayout(new java.awt.BorderLayout(1, 1));

        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(750, 300));
        FormInput.setLayout(null);

        jLabel4.setText("Pasien :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(8, 8, 60, 24);
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(70, 8, 85, 24);

        TPasien.setEditable(false);
        TPasien.setHighlighter(null);
        TPasien.setName("TPasien"); // NOI18N
        FormInput.add(TPasien);
        TPasien.setBounds(163, 8, 230, 24);
        ...
        BtnPasien.setBounds(400, 8, 28, 24);

        jLabel8.setText("Resiko Jatuh :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(0, 200, 90, 24);

        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-08-2026" }));
        ...
        DTPReg.setBounds(220, 80, 95, 24);

        jLabel9.setText("Jam Skrining :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(320, 80, 90, 24);
        ...
        CmbMenit.setBounds(480, 80, 55, 24);
        ...
        CmbDetik.setBounds(540, 80, 55, 24);
        ...
        ChkJln.setBounds(600, 80, 24, 24);

        Geriatri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Beresiko", "Resiko Sedang", "Resiko Tinggi" }));
        Geriatri.setName("Geriatri"); // NOI18N
        Geriatri.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        Geriatri.setBounds(100, 200, 280, 24);

        jLabel11.setText("Tanggal Skrining :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(100, 80, 115, 24);
        ...
        Kesadaran.setBounds(100, 118, 280, 24);

        jLabel12.setText("Kesadaran :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(8, 118, 80, 24);

        jLabel13.setText("Pernafasan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(420, 120, 80, 24);
        ...
        Pernapasan.setBounds(510, 120, 200, 24);

        SkalaNyeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak sakit", "Agak mengganggu", "Mengganggu aktivitas", "Tak tertahankan" }));
        ...
        SkalaNyeri.setBounds(100, 160, 280, 24);

        jLabel14.setText("Skala Nyeri :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(10, 160, 80, 24);

        jLabel16.setText("Nyeri Dada :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(420, 160, 80, 24);
        ...
        NyeriDada.setBounds(510, 160, 200, 24);

        Keputusan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sesuai antrian", "IGD", "Beri Masker", "Poli TB" }));
        Keputusan.setName("Keputusan"); // NOI18N
        Keputusan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KeputusanActionPerformed(evt);
            }
        });
        ...
        KdPetugas.setBounds(460, 250, 100, 24);

        NmPetugas.setEditable(false);
        NmPetugas.setHighlighter(null);
        NmPetugas.setName("NmPetugas"); // NOI18N
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(570, 250, 250, 24);
        ...
        BtnPtg.setBounds(820, 250, 28, 24);

        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel21.setText("TB :");
        jLabel21.setName("jLabel21"); // NOI18N
        FormInput.add(jLabel21);
        jLabel21.setBounds(770, 10, 440, 22);

        tb6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        FormInput.add(tb6);
        tb6.setBounds(1150, 190, 60, 20);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("TB.1. Batuk berdahak secara terus-menerus selama lebih dari 2 minggu");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(770, 40, 340, 22);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("TB. 2. Pernah mengalami batuk berdarah (hemoptisis)");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(770, 70, 340, 22);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText("TB. 3. Mengalami demam hilang-timbul lebih dari 1 bulan");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(770, 100, 340, 22);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("TB. 4. Berat badan turun drastis tanpa penyebab jelas dalam 2 bulan terakhir");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(770, 130, 360, 22);

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText("TB. 5. Mengeluarkan keringat malam walau tanpa aktifitas fisik");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(770, 160, 340, 22);

        jLabel27.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel27.setText("TB. 6. Memiliki riwayat kontak erat dngan pasien terkonfirmasi TB");
        jLabel27.setName("jLabel27"); // NOI18N
        FormInput.add(jLabel27);
        jLabel27.setBounds(770, 190, 340, 22);

        tb1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        FormInput.add(tb1);
        tb1.setBounds(1150, 40, 60, 20);

        tb2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        FormInput.add(tb2);
        tb2.setBounds(1150, 70, 60, 20);

        tb3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        FormInput.add(tb3);
        tb3.setBounds(1150, 100, 60, 20);

        tb4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        FormInput.add(tb4);
        tb4.setBounds(1150, 160, 60, 20);

        tb5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak", "Ya" }));
        ...
        ChkInput.setPreferredSize(new java.awt.Dimension(750, 20));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("skrining_rawat_jalan","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Skrining Rawat Jalan",16,new String[]{
                ...
                Geriatri.getSelectedItem().toString(),Kesadaran.getSelectedItem().toString(),
                Pernapasan.getSelectedItem().toString(),NyeriDada.getSelectedItem().toString(),
                SkalaNyeri.getSelectedItem().toString(),Keputusan.getSelectedItem().toString(),
                tb1.getSelectedItem().toString(),tb2.getSelectedItem().toString(),tb3.getSelectedItem().toString(),tb4.getSelectedItem().toString(),tb5.getSelectedItem().toString(),tb6.getSelectedItem().toString(),KdPetugas.getText()
                })==true){
                    emptTeks();
                    tampil();
            }
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptSkriningRalan.jasper","report","::[ Data Skrining Rawat Jalan ]::",
                    ...
                    "skrining_rawat_jalan.nyeri_dada,skrining_rawat_jalan.skala_nyeri,skrining_rawat_jalan.keputusan,skrining_rawat_jalan.tb1,skrining_rawat_jalan.tb2,skrining_rawat_jalan.tb3,skrining_rawat_jalan.tb4,skrining_rawat_jalan.tb5,skrining_rawat_jalan.tb6,skrining_rawat_jalan.nip,petugas.nama "+
                    ...
                    "skrining_rawat_jalan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and skrining_rawat_jalan.tb1 like '%"+TCari.getText().trim()+"%' or "+
                    "skrining_rawat_jalan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and skrining_rawat_jalan.tb2 like '%"+TCari.getText().trim()+"%' or "+
                    "skrining_rawat_jalan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and skrining_rawat_jalan.tb3 like '%"+TCari.getText().trim()+"%' or "+
                    "skrining_rawat_jalan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and skrining_rawat_jalan.tb4 like '%"+TCari.getText().trim()+"%' or "+
                    "skrining_rawat_jalan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and skrining_rawat_jalan.tb5 like '%"+TCari.getText().trim()+"%' or "+
                    "skrining_rawat_jalan.tanggal between '"+Valid.SetTgl(DTPCari1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(DTPCari2.getSelectedItem()+"")+"' and skrining_rawat_jalan.tb6 like '%"+TCari.getText().trim()+"%' or "+
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void GeriatriActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GeriatriActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_GeriatriActionPerformed
    ...
    private void KeputusanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KeputusanActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KeputusanActionPerformed
    ...
    */
    ...
    private widget.ComboBox tb1;
    private widget.ComboBox tb2;
    private widget.ComboBox tb3;
    private widget.ComboBox tb4;
    private widget.ComboBox tb5;
    private widget.ComboBox tb6;
    ...
    private void tampil() {     
        try {
            ...
            ps=koneksi.prepareStatement(
                    "select skrining_rawat_jalan.tanggal,skrining_rawat_jalan.jam,skrining_rawat_jalan.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,"+
                    "pasien.nm_ibu,pasien.jk,skrining_rawat_jalan.geriatri,skrining_rawat_jalan.kesadaran,skrining_rawat_jalan.tb1,skrining_rawat_jalan.tb2,skrining_rawat_jalan.tb3,skrining_rawat_jalan.tb4,skrining_rawat_jalan.tb5,skrining_rawat_jalan.tb6,skrining_rawat_jalan.pernapasan,"+
                    ...
                    "skrining_rawat_jalan.tanggal between ? and ? and skrining_rawat_jalan.tb1 like ? or "+
                    "skrining_rawat_jalan.tanggal between ? and ? and skrining_rawat_jalan.tb2 like ? or "+
                    "skrining_rawat_jalan.tanggal between ? and ? and skrining_rawat_jalan.tb3 like ? or "+
                    "skrining_rawat_jalan.tanggal between ? and ? and skrining_rawat_jalan.tb4 like ? or "+
                    "skrining_rawat_jalan.tanggal between ? and ? and skrining_rawat_jalan.tb5 like ? or "+
                    "skrining_rawat_jalan.tanggal between ? and ? and skrining_rawat_jalan.tb6 like ? or "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("nyeri_dada"),rs.getString("skala_nyeri"),rs.getString("keputusan"),rs.getString("tb1"),rs.getString("tb2"),rs.getString("tb3"),rs.getString("tb4"),rs.getString("tb5"),rs.getString("tb6"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
    ...
    public void emptTeks() {
        ...
        tb2.setSelectedIndex(0);
        tb3.setSelectedIndex(0);
        tb4.setSelectedIndex(0);
        tb5.setSelectedIndex(0);
        tb6.setSelectedIndex(0);
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){            
            ...
            tb1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            tb2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            tb3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
            tb4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
            tb5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),17).toString());
            tb6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),18).toString());
        }
    }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            ...
            PanelInput.setPreferredSize(new Dimension(WIDTH,322));
