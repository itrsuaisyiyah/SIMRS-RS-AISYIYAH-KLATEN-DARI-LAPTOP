...
public class VerifikasiTBAKRalan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public VerifikasiTBAKRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(1285, 674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ TBAK Ralan Perawatan Pasien ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            VerifikasiTBAKRalan dialog = new VerifikasiTBAKRalan(new javax.swing.JFrame(), true);
    ...
    private void prosesCari() {
        ...
        try {
            ...
            htmlContent.append(
                    ...
                    + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='66%'>T.B.A.K</td>"
                    + "</tr>"
            );
                ...
                while (rs.next()) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                "select pemeriksaan_ralan_tbak.tgl_perawatan,pemeriksaan_ralan_tbak.jam_rawat,pemeriksaan_ralan_tbak.situation,"
                                + "pemeriksaan_ralan_tbak.background,pemeriksaan_ralan_tbak.assesment,pemeriksaan_ralan_tbak.recommendation,pemeriksaan_ralan_tbak.nip,pegawai.nama,departemen.nama, "
                                + "validasi_pemeriksaan_tbak_ralan.nik_validator,namavalidator.nama as namavalidator,validasi_pemeriksaan_tbak_ralan.tgl_validasi,validasi_pemeriksaan_tbak_ralan.jam_validasi,validasi_pemeriksaan_tbak_ralan.status_validasi "
                                + "from pemeriksaan_ralan_tbak LEFT JOIN validasi_pemeriksaan_tbak_ralan ON validasi_pemeriksaan_tbak_ralan.no_rawat = pemeriksaan_ralan_tbak.no_rawat AND validasi_pemeriksaan_tbak_ralan.tgl_perawatan = pemeriksaan_ralan_tbak.tgl_perawatan AND validasi_pemeriksaan_tbak_ralan.jam_rawat = pemeriksaan_ralan_tbak.jam_rawat inner join pegawai on pemeriksaan_ralan_tbak.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_tbak_ralan.nik_validator=namavalidator.nik where pemeriksaan_ralan_tbak.no_rawat='" + rs.getString("no_rawat") + "' "
                                + "order by pemeriksaan_ralan_tbak.tgl_perawatan,pemeriksaan_ralan_tbak.jam_rawat").executeQuery();
                        if (rs2.next()) {
                            htmlContent.append(
                                    "<tr class='isi'>"
                                    ...
                                    + "<td valign='middle' bgcolor='#FFFFF8' align='center' width='43%'>Instruksi</td>"
                            ...
                            while (rs2.next()) {
                                ...
                                if (Sequel.cariInteger("select count(validasi_pemeriksaan_tbak_ralan.nik_validator) "
                                        + "from pemeriksaan_ralan_tbak LEFT JOIN validasi_pemeriksaan_tbak_ralan ON validasi_pemeriksaan_tbak_ralan.no_rawat = pemeriksaan_ralan_tbak.no_rawat AND validasi_pemeriksaan_tbak_ralan.tgl_perawatan = pemeriksaan_ralan_tbak.tgl_perawatan AND validasi_pemeriksaan_tbak_ralan.jam_rawat = pemeriksaan_ralan_tbak.jam_rawat inner join pegawai on pemeriksaan_ralan_tbak.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_tbak_ralan.nik_validator=namavalidator.nik where pemeriksaan_ralan_tbak.no_rawat='" + rs.getString("no_rawat") + "' AND validasi_pemeriksaan_tbak_ralan.nik_validator='" + rs2.getString("nik_validator") + "'"
                                        + "order by pemeriksaan_ralan_tbak.tgl_perawatan,pemeriksaan_ralan_tbak.jam_rawat") > 0) {
