 ...
 * @author perpustakaan
 */
public final class ValidasiTBAKRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public ValidasiTBAKRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi TBAK Ralan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().equals("")||TNoRM.getText().equals("")||TPasien.getText().equals("")){
            ...
            if(Sequel.menyimpantf("validasi_pemeriksaan_tbak_ralan","?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",12,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ValidasiTBAKRalan dialog = new ValidasiTBAKRalan(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan_tbak.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan_tbak.tgl_perawatan,pemeriksaan_ralan_tbak.jam_rawat,pemeriksaan_ralan_tbak.situation, " +
                    "pemeriksaan_ralan_tbak.background,pemeriksaan_ralan_tbak.assesment,pemeriksaan_ralan_tbak.recommendation,pemeriksaan_ralan_tbak.nip,pegawai.nama from pasien inner join reg_periksa inner join pemeriksaan_ralan_tbak "+
                    "on pemeriksaan_ralan_tbak.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ralan_tbak.nip=pegawai.nik LEFT JOIN validasi_pemeriksaan_tbak_ralan ON validasi_pemeriksaan_tbak_ralan.no_rawat = pemeriksaan_ralan_tbak.no_rawat AND validasi_pemeriksaan_tbak_ralan.tgl_perawatan = pemeriksaan_ralan_tbak.tgl_perawatan AND validasi_pemeriksaan_tbak_ralan.jam_rawat = pemeriksaan_ralan_tbak.jam_rawat where "+
                    "pemeriksaan_ralan_tbak.no_rawat like ? and ISNULL(validasi_pemeriksaan_tbak_ralan.status_validasi) order by pemeriksaan_ralan_tbak.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan_tbak.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan_tbak.tgl_perawatan,pemeriksaan_ralan_tbak.jam_rawat,pemeriksaan_ralan_tbak.situation, " +
