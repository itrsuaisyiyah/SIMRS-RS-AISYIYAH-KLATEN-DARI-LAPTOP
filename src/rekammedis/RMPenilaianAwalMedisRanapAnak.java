...
public final class RMPenilaianAwalMedisRanapAnak extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                for (i = 0; i < carilaborat.getTable().getRowCount(); i++) {
                    if(carilaborat.getTable().getValueAt(i,0).toString().equals("true")){
                        Penunjang.append(carilaborat.getTable().getValueAt(i,3).toString()+", ");
                    }
                }
                Penunjang.requestFocus();
            }
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Bayi/Anak ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-08-2026 18:36:51" }));
        ...
        BtnDokter2.setBounds(10, 930, 28, 23);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapBayi.jasper","report","::[ Laporan Penilaian Awal Medis Ranap Bayi/Anak ]::",
                ...
                "penilaian_medis_ranap_anak.ket_fisik,penilaian_medis_ranap_anak.ket_lokalis,penilaian_medis_ranap_anak.penunjang,penilaian_medis_ranap_anak.diagnosis,penilaian_medis_ranap_anak.tata,penilaian_medis_ranap_anak.konsul,dokter.nm_dokter "+
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_anak());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_anak());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_anak());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ranap_anak","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",36,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
