 ...
 * @author perpustakaan
 */
public final class ValidasiSBARRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public ValidasiSBARRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi SBAR Ralan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ValidasiSBARRalan dialog = new ValidasiSBARRalan(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat,pemeriksaan_ralan_sbar.situation, " +
                    "pemeriksaan_ralan_sbar.background,pemeriksaan_ralan_sbar.assesment,pemeriksaan_ralan_sbar.recommendation,pemeriksaan_ralan_sbar.nip,pegawai.nama from pasien inner join reg_periksa inner join pemeriksaan_ralan_sbar "+
                    "on pemeriksaan_ralan_sbar.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join pegawai on pemeriksaan_ralan_sbar.nip=pegawai.nik LEFT JOIN validasi_pemeriksaan_sbar_ralan ON validasi_pemeriksaan_sbar_ralan.no_rawat = pemeriksaan_ralan_sbar.no_rawat AND validasi_pemeriksaan_sbar_ralan.tgl_perawatan = pemeriksaan_ralan_sbar.tgl_perawatan AND validasi_pemeriksaan_sbar_ralan.jam_rawat = pemeriksaan_ralan_sbar.jam_rawat where "+
                    "pemeriksaan_ralan_sbar.no_rawat like ? and ISNULL(validasi_pemeriksaan_sbar_ralan.status_validasi) order by pemeriksaan_ralan_sbar.no_rawat desc");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.tgl_registrasi,reg_periksa.status_lanjut,pemeriksaan_ralan_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "+
                    "pemeriksaan_ralan_sbar.tgl_perawatan,pemeriksaan_ralan_sbar.jam_rawat,pemeriksaan_ralan_sbar.situation, " +
