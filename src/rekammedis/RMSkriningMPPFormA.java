...
public final class RMSkriningMPPFormA extends javax.swing.JDialog {
    ...
    public RMSkriningMPPFormA(java.awt.Frame parent, boolean modal) {
        ...
        TDiagnosis.setDocument(new batasInput((int)300).getKata(TDiagnosis));
        TKelompok.setDocument(new batasInput((int)300).getKata(TKelompok));
        Assemen.setDocument(new batasInput((int)500).getKata(Assemen));
        Identifikasi.setDocument(new batasInput((int)500).getKata(Identifikasi));
    ...
    private void initComponents() {
        ...
        TglEvaluasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "10-02-2025 11:09:14" }));
