 ...
 * @author perpustakaan
 */
public final class RMChecklistKriteriaMasukBBRT extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMChecklistKriteriaMasukBBRT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        MnKriteriaMasukPICU.setText("Formulir Checklist Kriteria Masuk BBRT");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Check List Kriteria Masuk BBRT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-08-2026 08:50:19" }));
        ...
        Keputusan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Diterima Di BBRT", "Tidak Diterima - Dirawat Di Ruang Lain" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataChecklistKriteriaMasukBBRT.html");            
                            ...
                            "<table width='3600px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA CHECK LIST KRITERIA MASUK BBRT<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnKriteriaMasukPICUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKriteriaMasukPICUActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirChecklistKriteriaMasukBBRT.jasper","report","::[ Formulir Check List Kriteria Masuk BBRT ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,checklist_kriteria_masuk_bbrt.tanggal,"+
                    "checklist_kriteria_masuk_bbrt.kriteriaumum1,checklist_kriteria_masuk_bbrt.kriteriaumum2,checklist_kriteria_masuk_bbrt.kriteriaumum3,"+
                    "checklist_kriteria_masuk_bbrt.respirasi1,checklist_kriteria_masuk_bbrt.respirasi2,checklist_kriteria_masuk_bbrt.respirasi3,"+
                    "checklist_kriteria_masuk_bbrt.respirasi4,checklist_kriteria_masuk_bbrt.kardio1,checklist_kriteria_masuk_bbrt.kardio2,"+
                    "checklist_kriteria_masuk_bbrt.kardio3,checklist_kriteria_masuk_bbrt.kardio4,checklist_kriteria_masuk_bbrt.neuro1,"+
                    "checklist_kriteria_masuk_bbrt.neuro2,checklist_kriteria_masuk_bbrt.neuro3,checklist_kriteria_masuk_bbrt.neuro4,"+
                    "checklist_kriteria_masuk_bbrt.bedah1,checklist_kriteria_masuk_bbrt.bedah2,checklist_kriteria_masuk_bbrt.bedah3,"+
                    "checklist_kriteria_masuk_bbrt.kondisilain1,checklist_kriteria_masuk_bbrt.kondisilain2,checklist_kriteria_masuk_bbrt.kondisilain3,"+
                    "checklist_kriteria_masuk_bbrt.keputusan,checklist_kriteria_masuk_bbrt.keterangan,checklist_kriteria_masuk_bbrt.nik,pegawai.nama "+
                    "from checklist_kriteria_masuk_bbrt inner join reg_periksa on checklist_kriteria_masuk_bbrt.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on pegawai.nik=checklist_kriteria_masuk_bbrt.nik "+
                    "where checklist_kriteria_masuk_bbrt.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' and checklist_kriteria_masuk_bbrt.tanggal='"+tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()+"' ",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMChecklistKriteriaMasukBBRT dialog = new RMChecklistKriteriaMasukBBRT(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on pegawai.nik=checklist_kriteria_masuk_bbrt.nik "+
                    "where checklist_kriteria_masuk_bbrt.tanggal between ? and ? order by checklist_kriteria_masuk_bbrt.tanggal ");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,checklist_kriteria_masuk_bbrt.tanggal,"+
                    "checklist_kriteria_masuk_bbrt.kriteriaumum1,checklist_kriteria_masuk_bbrt.kriteriaumum2,checklist_kriteria_masuk_bbrt.kriteriaumum3,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on pegawai.nik=checklist_kriteria_masuk_bbrt.nik "+
                    "where checklist_kriteria_masuk_bbrt.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or "+
                    "pasien.nm_pasien like ? or pegawai.nama like ? or checklist_kriteria_masuk_bbrt.nik like ?) order by checklist_kriteria_masuk_bbrt.tanggal ");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getkriteria_masuk_bbrt());
        BtnHapus.setEnabled(akses.getkriteria_masuk_bbrt());
        BtnEdit.setEnabled(akses.getkriteria_masuk_bbrt());
        BtnPrint.setEnabled(akses.getkriteria_masuk_bbrt()); 
        if(akses.getjml2()>=1){
    ...
    private void ganti() {
        if(Sequel.mengedittf("checklist_kriteria_masuk_bbrt","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,kriteriaumum1=?,kriteriaumum2=?,kriteriaumum3=?,respirasi1=?,respirasi2=?,respirasi3=?,"+
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from checklist_kriteria_masuk_bbrt where no_rawat=? and tanggal=?",2,new String[]{
    ...
    private void simpan() {
        if(Sequel.menyimpantf("checklist_kriteria_masuk_bbrt","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",26,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KriteriaUmum1.getSelectedItem().toString(),
            KriteriaUmum2.getSelectedItem().toString(),KriteriaUmum3.getSelectedItem().toString(),Respirasi1.getSelectedItem().toString(),Respirasi2.getSelectedItem().toString(),
            Respirasi3.getSelectedItem().toString(),Respirasi4.getSelectedItem().toString(),Kardiovaskuler1.getSelectedItem().toString(),Kardiovaskuler2.getSelectedItem().toString(),
            Kardiovaskuler3.getSelectedItem().toString(),Kardiovaskuler4.getSelectedItem().toString(),Neurologis1.getSelectedItem().toString(),Neurologis2.getSelectedItem().toString(),
