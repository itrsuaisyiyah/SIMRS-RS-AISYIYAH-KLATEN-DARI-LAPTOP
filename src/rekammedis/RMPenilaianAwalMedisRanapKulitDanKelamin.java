 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapKulitDanKelamin extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapKulitDanKelamin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Kulit & Kelamin ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:01:29" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapKulitKelamin.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Kulit & Kelamin ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_kulitdankelamin.tanggal,"+
                "penilaian_medis_ranap_kulitdankelamin.kd_dokter,penilaian_medis_ranap_kulitdankelamin.anamnesis,penilaian_medis_ranap_kulitdankelamin.hubungan,penilaian_medis_ranap_kulitdankelamin.keluhan_utama,penilaian_medis_ranap_kulitdankelamin.rps,penilaian_medis_ranap_kulitdankelamin.rpd,penilaian_medis_ranap_kulitdankelamin.rpo,penilaian_medis_ranap_kulitdankelamin.rpk,"+
                "penilaian_medis_ranap_kulitdankelamin.kesadaran,penilaian_medis_ranap_kulitdankelamin.status,penilaian_medis_ranap_kulitdankelamin.td,penilaian_medis_ranap_kulitdankelamin.nadi,penilaian_medis_ranap_kulitdankelamin.suhu,penilaian_medis_ranap_kulitdankelamin.rr,penilaian_medis_ranap_kulitdankelamin.bb,penilaian_medis_ranap_kulitdankelamin.nyeri,penilaian_medis_ranap_kulitdankelamin.gcs,"+
                "penilaian_medis_ranap_kulitdankelamin.statusderma,penilaian_medis_ranap_kulitdankelamin.pemeriksaan,penilaian_medis_ranap_kulitdankelamin.diagnosis,penilaian_medis_ranap_kulitdankelamin.diagnosis2,penilaian_medis_ranap_kulitdankelamin.permasalahan,penilaian_medis_ranap_kulitdankelamin.terapi,penilaian_medis_ranap_kulitdankelamin.tindakan,penilaian_medis_ranap_kulitdankelamin.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_kulitdankelamin on reg_periksa.no_rawat=penilaian_medis_ranap_kulitdankelamin.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_kulitdankelamin.kd_dokter=dokter.kd_dokter "+
                "where penilaian_medis_ranap_kulitdankelamin.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapKulitDanKelamin dialog = new RMPenilaianAwalMedisRanapKulitDanKelamin(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_kulitdankelamin on reg_periksa.no_rawat=penilaian_medis_ranap_kulitdankelamin.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_kulitdankelamin.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_kulitdankelamin.tanggal between ? and ? order by penilaian_medis_ranap_kulitdankelamin.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_kulitdankelamin.tanggal,"+
                        "penilaian_medis_ranap_kulitdankelamin.kd_dokter,penilaian_medis_ranap_kulitdankelamin.anamnesis,penilaian_medis_ranap_kulitdankelamin.hubungan,penilaian_medis_ranap_kulitdankelamin.keluhan_utama,penilaian_medis_ranap_kulitdankelamin.rps,penilaian_medis_ranap_kulitdankelamin.rpd,penilaian_medis_ranap_kulitdankelamin.rpo,penilaian_medis_ranap_kulitdankelamin.rpk,"+
                        ...
                        "inner join penilaian_medis_ranap_kulitdankelamin on reg_periksa.no_rawat=penilaian_medis_ranap_kulitdankelamin.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_kulitdankelamin.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_kulitdankelamin.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_kulitdankelamin.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_kulitdankelamin.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_kulit_kelamin());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_kulit_kelamin());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_kulit_kelamin());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_kulitdankelamin where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_kulitdankelamin","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,rpk=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,gcs=?,statusderma=?,pemeriksaan=?,diagnosis=?,diagnosis2=?,permasalahan=?,terapi=?,tindakan=?,edukasi=?",28,new String[]{
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ranap_kulitdankelamin","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",27,new String[]{
