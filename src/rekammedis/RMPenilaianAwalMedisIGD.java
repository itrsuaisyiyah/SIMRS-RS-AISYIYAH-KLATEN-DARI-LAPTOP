...
import freehand.DlgMarkingPenilaianAwalMedisIGD;
...
public final class RMPenilaianAwalMedisIGD extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisIGD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Mata","Gigi & Mulut","Leher","Thoraks","Abdomen","Genital & Anus","Ekstremitas","Ket.Pemeriksaan Fisik","Ket.Status Lokalis","EKG","Radiologi","Laborat","Diagnosis/Asesmen","Tatalaksana","Keputusan"
        }){
    ...
    private void initComponents() {
        ...
        BtnMarkingLokalis = new widget.Button();
        ...
        Keadaan.setBounds(130, 260, 118, 23);
        ...
        BtnMarkingLokalis.setMnemonic('L');
        BtnMarkingLokalis.setText("Marking Status Lokalis");
        BtnMarkingLokalis.setToolTipText("Alt+L");
        BtnMarkingLokalis.setName("BtnMarkingLokalis"); // NOI18N
        BtnMarkingLokalis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnMarkingLokalisActionPerformed(evt);
            }
        });
        FormInput.add(BtnMarkingLokalis);
        BtnMarkingLokalis.setBounds(650, 438, 220, 25);
        ...
        scrollPane13.setBounds(44, 1070, 810, 270);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2026 09:14:14" }));
        ...
        jLabel81.setBounds(319, 890, 60, 23);
        ...
        jLabel82.setBounds(594, 890, 50, 23);
        ...
        jLabel104.setText("VII. KEPUTUSAN :");
        jLabel104.setName("jLabel104"); // NOI18N
        FormInput.add(jLabel104);
        jLabel104.setBounds(10, 1350, 100, 23);

        keputusan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat Jalan", "Rawat Inap", "Rujuk", "APS", "Meninggal" }));
        ...
        keputusan.setBounds(110, 1350, 300, 23);
        ...
        BtnDokter3.setBounds(650, 890, 28, 23);
        ...
        BtnDokter4.setBounds(380, 890, 28, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2026" }));
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            try {
                String noRawatCetak=tbObat.getValueAt(tbObat.getSelectedRow(),0).toString();
                String urlMarking=Sequel.cariIsi("select url_image from penilaian_medis_igd_image_marking where no_rawat='"+noRawatCetak+"'");
                if(urlMarking!=null && !urlMarking.trim().isEmpty()){
                    java.net.URL uMarking=new java.net.URL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/imagefreehand/"+urlMarking.trim());
                    param.put("lokalis",uMarking.openStream());
                }else{
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisIGD.jasper","report","::[ Laporan Penilaian Awal Medis IGD ]::",
                ...
                "penilaian_medis_igd.ket_lokalis,penilaian_medis_igd.ekg,penilaian_medis_igd.rad,penilaian_medis_igd.lab,penilaian_medis_igd.diagnosis,penilaian_medis_igd.tata,penilaian_medis_igd.keputusan,dokter.nm_dokter "+
    ...
    private void BtnMarkingLokalisActionPerformed(java.awt.event.ActionEvent evt) {
        if (TNoRw.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "No. Rawat belum terisi");
            return;
        }
        DlgMarkingPenilaianAwalMedisIGD dlg = new DlgMarkingPenilaianAwalMedisIGD(null, true);
        dlg.setNoRw(TNoRw.getText());
        dlg.setVisible(true);
        // dialog modal, setVisible baru "kembali" setelah dialog ditutup (Simpan/Keluar)
        refreshLokalisPreview();
    }
    ...
    */
    ...
    private widget.Button BtnMarkingLokalis;
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("ekstremitas"),rs.getString("ket_fisik"),rs.getString("ket_lokalis"),rs.getString("ekg"),rs.getString("rad"),rs.getString("lab"),rs.getString("diagnosis"),rs.getString("tata"),rs.getString("keputusan")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            keputusan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
    ...
    /**
     * Menampilkan gambar III. STATUS LOKALIS sesuai kondisi terakhir:
     * kalau pasien (no_rawat) yang sedang dibuka sudah pernah di-marking
     * (coret-coret) lewat dialog Marking Status Lokalis, tampilkan hasil
     * coretan itu. Kalau belum pernah, tampilkan gambar induk (kosong)
     * seperti biasa.
     */
    private void refreshLokalisPreview() {
        try {
            String urlMarking = Sequel.cariIsi("select url_image from penilaian_medis_igd_image_marking where no_rawat='" + TNoRw.getText() + "'");
            if (urlMarking != null && !urlMarking.trim().isEmpty()) {
                URL u = new URL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + koneksiDB.PORTWEB() + "/" + koneksiDB.HYBRIDWEB() + "/imagefreehand/" + urlMarking.trim());
            ...
            // gagal ambil gambar hasil marking dari web server, jatuh ke gambar default di bawah
        }
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/semua.png")));
    }
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_igd","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpk=?,rpo=?,alergi=?,keadaan=?,gcs=?,kesadaran=?,td=?,nadi=?,rr=?,suhu=?,spo=?,bb=?,tb=?,kepala=?,mata=?,gigi=?,leher=?,thoraks=?,abdomen=?,genital=?,ekstremitas=?,ket_fisik=?,ket_lokalis=?,ekg=?,rad=?,lab=?,diagnosis=?,tata=?,keputusan=?",38,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                    ...
                    Radiologi.getText(),Laborat.getText(),Diagnosis.getText(),Tatalaksana.getText(),keputusan.getSelectedItem().toString(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
               ...
               tbObat.setValueAt(keputusan.getSelectedItem().toString(),tbObat.getSelectedRow(),41);
               emptTeks();
               TabRawat.setSelectedIndex(1);
        }
    }
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPK.getText(),RPO.getText(),Alergi.getText(),Keadaan.getSelectedItem().toString(),GCS.getText(),Kesadaran.getSelectedItem().toString(),TD.getText(),
                Nadi.getText(),RR.getText(),Suhu.getText(),SPO.getText(),BB.getText(),TB.getText(),Kepala.getSelectedItem().toString(),Mata.getSelectedItem().toString(),Gigi.getSelectedItem().toString(),Leher.getSelectedItem().toString(),
                Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Genital.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),KetFisik.getText(),KetLokalis.getText(),EKG.getText(),
                Radiologi.getText(),Laborat.getText(),Diagnosis.getText(),Tatalaksana.getText(),keputusan.getSelectedItem().toString()
            })==true){
                tabMode.addRow(new String[]{
                    ...
                    Diagnosis.getText(),Tatalaksana.getText(),keputusan.getSelectedItem().toString()
                });
                LCount.setText(""+tabMode.getRowCount());
                emptTeks();
        }
