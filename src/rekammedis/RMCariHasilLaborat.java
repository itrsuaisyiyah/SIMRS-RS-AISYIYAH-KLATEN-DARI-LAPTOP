...
public final class RMCariHasilLaborat extends javax.swing.JDialog {
    ...
    private int z=0;
    private String hasilDipilih;
    private RMDataResumePasienRanap parent;
    /** Creates new form DlgPenyakit
     * @param parent
     * @param modal */
    
    public void setParent(RMDataResumePasienRanap parent){
    this.parent = parent;
}
       ...
       if(tabMode.getRowCount()!=0){
        ...
        if(evt.getKeyCode()==KeyEvent.VK_SPACE){
            ...
            for(int i=0; i<tbKamar.getRowCount(); i++){
                ...
                Object cek = tbKamar.getValueAt(i,0);

                if(cek != null && cek.toString().equals("true")){

                    Object val = tbKamar.getValueAt(i,3);

                    if(val != null){
                        hasil.append(val.toString()).append(", ");
                    }
                }
            }
            ...
            if(hasil.length()==0){
                ...
                if(row != -1){
                    Object val = tbKamar.getValueAt(row,3);
                    if(val != null){
                        hasil.append(val.toString()).append(", ");
                    }
                }
            ...
            // kirim langsung ke form utama
            if(parent != null){
                parent.setHasilLaborat(hasil.toString());
            }
    ...
    */
    ...
    public String getHasilDipilih(){
    if(hasilDipilih==null){
        return "";
    }
    return hasilDipilih;
}
