 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapRehabMedik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapRehabMedik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Ranap Kedokteran Fisik & Rehabilitasi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:05:46" }));
        ...
        TglFisioterapi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026" }));
        ...
        TglOkupasi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026" }));
        ...
        TglWicara.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026" }));
        ...
        TglAkupuntur.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026" }));
        ...
        TglTerapilainnya.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_rehab_medik","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",48,new String[]{
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapRehabMedik.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Kedokteran Fisik dan Rehabilitasi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_rehab_medik.tanggal,"+
                "penilaian_medis_ranap_rehab_medik.kd_dokter,penilaian_medis_ranap_rehab_medik.anamnesis,penilaian_medis_ranap_rehab_medik.hubungan,penilaian_medis_ranap_rehab_medik.keluhan_utama,"+
                "penilaian_medis_ranap_rehab_medik.rps,penilaian_medis_ranap_rehab_medik.rpd,penilaian_medis_ranap_rehab_medik.alergi,penilaian_medis_ranap_rehab_medik.kesadaran,penilaian_medis_ranap_rehab_medik.nyeri,penilaian_medis_ranap_rehab_medik.skala_nyeri,"+
                "penilaian_medis_ranap_rehab_medik.td,penilaian_medis_ranap_rehab_medik.nadi,penilaian_medis_ranap_rehab_medik.suhu,penilaian_medis_ranap_rehab_medik.rr,penilaian_medis_ranap_rehab_medik.bb,"+
                "penilaian_medis_ranap_rehab_medik.kepala,penilaian_medis_ranap_rehab_medik.keterangan_kepala,penilaian_medis_ranap_rehab_medik.thoraks,penilaian_medis_ranap_rehab_medik.keterangan_thoraks,"+
                "penilaian_medis_ranap_rehab_medik.abdomen,penilaian_medis_ranap_rehab_medik.keterangan_abdomen,penilaian_medis_ranap_rehab_medik.ekstremitas,penilaian_medis_ranap_rehab_medik.keterangan_ekstremitas,"+
                "penilaian_medis_ranap_rehab_medik.columna,penilaian_medis_ranap_rehab_medik.keterangan_columna,penilaian_medis_ranap_rehab_medik.muskulos,penilaian_medis_ranap_rehab_medik.keterangan_muskulos,"+
                "penilaian_medis_ranap_rehab_medik.lainnya,penilaian_medis_ranap_rehab_medik.resiko_jatuh,penilaian_medis_ranap_rehab_medik.resiko_nutrisional,penilaian_medis_ranap_rehab_medik.kebutuhan_fungsional,"+
                "penilaian_medis_ranap_rehab_medik.diagnosa_medis,penilaian_medis_ranap_rehab_medik.diagnosa_fungsi,penilaian_medis_ranap_rehab_medik.penunjang_lain,penilaian_medis_ranap_rehab_medik.fisio,penilaian_medis_ranap_rehab_medik.okupasi,"+
                "penilaian_medis_ranap_rehab_medik.wicara,penilaian_medis_ranap_rehab_medik.akupuntur,penilaian_medis_ranap_rehab_medik.tatalain,penilaian_medis_ranap_rehab_medik.frekuensi_terapi,penilaian_medis_ranap_rehab_medik.fisioterapi,"+
                "penilaian_medis_ranap_rehab_medik.terapi_okupasi,penilaian_medis_ranap_rehab_medik.terapi_wicara,penilaian_medis_ranap_rehab_medik.terapi_akupuntur,penilaian_medis_ranap_rehab_medik.terapi_lainnya,penilaian_medis_ranap_rehab_medik.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_rehab_medik on reg_periksa.no_rawat=penilaian_medis_ranap_rehab_medik.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_rehab_medik.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_rehab_medik.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapRehabMedik dialog = new RMPenilaianAwalMedisRanapRehabMedik(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_rehab_medik on reg_periksa.no_rawat=penilaian_medis_ranap_rehab_medik.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_rehab_medik.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_rehab_medik.tanggal between ? and ? order by penilaian_medis_ranap_rehab_medik.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_rehab_medik.tanggal,"+
                        "penilaian_medis_ranap_rehab_medik.kd_dokter,penilaian_medis_ranap_rehab_medik.anamnesis,penilaian_medis_ranap_rehab_medik.hubungan,penilaian_medis_ranap_rehab_medik.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_rehab_medik on reg_periksa.no_rawat=penilaian_medis_ranap_rehab_medik.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_rehab_medik.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_rehab_medik.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_rehab_medik.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_rehab_medik.tanggal");
            }
    ...
    try {
        // Ambil data pasien
        ps = koneksi.prepareStatement(
            "SELECT rp.no_rkm_medis, p.nm_pasien, " +
            "IF(p.jk='L','Laki-Laki','Perempuan') AS jk, " +
            "p.tgl_lahir, rp.tgl_registrasi, rp.jam_reg " +
            "FROM reg_periksa rp " +
        ...
        ps = koneksi.prepareStatement(
            "SELECT suhu, td, bb, td, nadi, rr, gcs, keluhan_utama, alergi, rps, rpd, rpk, rpo " +
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_medis_ranap_rehab_medik());
        BtnHapus.setEnabled(akses.getpenilaian_medis_ranap_rehab_medik());
        BtnEdit.setEnabled(akses.getpenilaian_medis_ranap_rehab_medik());
        BtnEdit.setEnabled(akses.getpenilaian_medis_ranap_rehab_medik());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_rehab_medik where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_rehab_medik","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,alergi=?,kesadaran=?,nyeri=?,skala_nyeri=?,td=?,nadi=?,suhu=?,rr=?,bb=?,"+
