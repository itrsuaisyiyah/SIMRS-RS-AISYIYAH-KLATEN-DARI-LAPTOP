...
public final class RMStandarAsuhanKeperawatan extends javax.swing.JDialog {
    ...
    public RMStandarAsuhanKeperawatan(java.awt.Frame parent, boolean modal) {
        ...
        Diagnosis.setDocument(new batasInput((int) 2000).getKata(Diagnosis));
        Luaran.setDocument(new batasInput((int) 2000).getKata(Luaran));
        Intervensi.setDocument(new batasInput((int) 2000).getKata(Intervensi));
    ...
    private void initComponents() {
        ...
        internalFrame1.setPreferredSize(new java.awt.Dimension(462, 643));
        ...
        scrollPane2.setBounds(780, 120, 310, 300);

        jLabel25.setText("Diagnosa Keperawatan (SDKI) :");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(60, 100, 190, 23);

        scrollPane3.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane3.setName("scrollPane3"); // NOI18N
        scrollPane3.setPreferredSize(new java.awt.Dimension(160, 74));
        ...
        scrollPane3.setBounds(10, 120, 320, 300);

        jLabel26.setText("Luaran Keperawatan (SLKI):");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(420, 100, 190, 23);

        scrollPane5.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        scrollPane5.setToolTipText("");
        scrollPane5.setName("scrollPane5"); // NOI18N
        scrollPane5.setPreferredSize(new java.awt.Dimension(160, 74));

        Luaran.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        Luaran.setColumns(20);
        Luaran.setRows(5);
        Luaran.setMinimumSize(new java.awt.Dimension(103, 16));
        ...
        scrollPane5.setBounds(390, 120, 320, 300);
        ...
        ChkTemplate.setEnabled(false);
        ChkTemplate.setFocusable(false);
        ...
        lblTemplate.setBounds(550, 70, 193, 23);
        ...
        btnAmbilPhoto1.setBounds(1110, 270, 230, 30);
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().equals("")) {
                Valid.MyReportqry("rptDataCatatanADIMEGizi.jasper", "report", "::[ Data Catatan ADIME Gizi Pasien ]::",
                        ...
                        + "asuhan_keperawatan.intervensi,asuhan_keperawatan.monitoring,asuhan_keperawatan.evaluasi,asuhan_keperawatan.instruksi,"
                ...
                Valid.MyReportqry("rptDataCatatanADIMEGizi.jasper", "report", "::[ Data Catatan ADIME Gizi Pasien ]::",
                        ...
                        + "asuhan_keperawatan.asesmen like '%" + TCari.getText().trim() + "%' or asuhan_keperawatan.diagnosis like '%" + TCari.getText().trim() + "%' or asuhan_keperawatan.intervensi like '%" + TCari.getText().trim() + "%' or "
                        + "asuhan_keperawatan.monitoring like '%" + TCari.getText().trim() + "%' or asuhan_keperawatan.evaluasi like '%" + TCari.getText().trim() + "%' or asuhan_keperawatan.instruksi like '%" + TCari.getText().trim() + "%' or "
    ...
    private void MnAsuhanKeperawatanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnAsuhanKeperawatanActionPerformed
        if (tbObat.getSelectedRow() > -1) {
            ...
            Valid.MyReportqry("rptFormulirAsuhanKeperawatan.jasper", "report", "::[ Formulir Asuhan Keperawatan ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.tmp_lahir,reg_periksa.umurdaftar,reg_periksa.sttsumur,"
                    + "pasien.jk,asuhan_keperawatan.tanggal,asuhan_keperawatan.diagnosis,"
                    + "asuhan_keperawatan.masalah,asuhan_keperawatan.diagnosis,asuhan_keperawatan.luaran,asuhan_keperawatan.intervensi,"
                    + "asuhan_keperawatan.nip,petugas.nama "
                    + "from asuhan_keperawatan inner join reg_periksa on asuhan_keperawatan.no_rawat=reg_periksa.no_rawat "
                    + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
        ...
        try {
            if (TCari.getText().toString().trim().equals("")) {
                ps = koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,reg_periksa.umurdaftar,reg_periksa.sttsumur,"
                        + "pasien.jk,asuhan_keperawatan.tanggal,asuhan_keperawatan.masalah,"
                        + "asuhan_keperawatan.diagnosis,asuhan_keperawatan.luaran,asuhan_keperawatan.intervensi,"
                        + "asuhan_keperawatan.nip,petugas.nama "
                        + "from asuhan_keperawatan inner join reg_periksa on asuhan_keperawatan.no_rawat=reg_periksa.no_rawat "
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join petugas on asuhan_keperawatan.nip=petugas.nip where "
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "asuhan_keperawatan.intervensi like ? or asuhan_keperawatan.luaran like ? or "                      
