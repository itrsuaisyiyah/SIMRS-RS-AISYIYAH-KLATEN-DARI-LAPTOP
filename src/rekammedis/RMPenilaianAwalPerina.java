 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalPerina extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalPerina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "T.M.","Skala Sydney 1","N.S. 1","Skala Sydney 2","N.S. 2","Skala Sydney 3","N.S. 3","Skala Sydney 4","N.S. 4",
            "Skala Sydney 5","N.S. 5","Skala Sydney 6","N.S. 6","Skala Sydney 7","N.S. 7",
            "T.S.","1. Apakah ada penurunan BB yang tidak diinginkan selama 6 bulan terakhir ?","Skor 1","2. Apakah asupan makan berkurang karena tidak nafsu makan ?",
    ...
    private void initComponents() {
        ...
        Apgar_score = new widget.TextBox();
        jLabel60 = new widget.Label();
        Lingkar_kepala = new widget.TextBox();
        jLabel61 = new widget.Label();
        Lingkar_dada = new widget.TextBox();
        jLabel62 = new widget.Label();
        Lingkar_perut = new widget.TextBox();
        jLabel63 = new widget.Label();
        Lingkar_lengan = new widget.TextBox();
        jLabel289 = new widget.Label();
        Tangis = new widget.ComboBox();
        jLabel290 = new widget.Label();
        Gerakan = new widget.ComboBox();
        jLabel291 = new widget.Label();
        Refleks_moro = new widget.ComboBox();
        jLabel292 = new widget.Label();
        jLabel293 = new widget.Label();
        Refleks_genggam = new widget.ComboBox();
        jLabel294 = new widget.Label();
        Refleks_rooting = new widget.ComboBox();
        jLabel295 = new widget.Label();
        Refleks_hisap = new widget.ComboBox();
        jLabel296 = new widget.Label();
        Labio = new widget.ComboBox();
        jLabel297 = new widget.Label();
        Cara_minum = new widget.ComboBox();
        ...
        Mata_secret = new widget.ComboBox();
        jLabel301 = new widget.Label();
        Tali_pusat = new widget.ComboBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Perina ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-12-2023 14:56:06" }));
        ...
        TibadiRuang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Jalan Tanpa Bantuan", "Kursi Roda", "Brankar", "Incubator", "Box Bayi" }));
        ...
        CaraMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Poli", "IGD", "IGD Ponek", "RB", "OK", "Lain-lain" }));
        ...
        jLabel27.setBounds(40, 500, 187, 23);

        jLabel131.setText("Kepala :");
        jLabel131.setName("jLabel131"); // NOI18N
        FormInput.add(jLabel131);
        jLabel131.setBounds(0, 560, 109, 23);
        ...
        SistemSarafKepala.setBounds(110, 560, 103, 23);
        ...
        KetSistemSarafKepala.setBounds(240, 560, 184, 23);

        jLabel132.setText("Wajah :");
        jLabel132.setName("jLabel132"); // NOI18N
        FormInput.add(jLabel132);
        jLabel132.setBounds(430, 560, 80, 23);
        ...
        SistemSarafWajah.setBounds(510, 560, 150, 23);
        ...
        KetSistemSarafWajah.setBounds(670, 560, 184, 23);

        jLabel133.setText("Leher :");
        jLabel133.setName("jLabel133"); // NOI18N
        FormInput.add(jLabel133);
        jLabel133.setBounds(0, 590, 109, 23);
        ...
        SistemSarafLeher.setBounds(110, 590, 155, 23);

        jLabel134.setText("Sensorik :");
        jLabel134.setName("jLabel134"); // NOI18N
        FormInput.add(jLabel134);
        jLabel134.setBounds(650, 590, 80, 23);
        ...
        SistemSarafSensorik.setBounds(740, 590, 115, 23);

        jLabel135.setText("Kejang :");
        jLabel135.setName("jLabel135"); // NOI18N
        FormInput.add(jLabel135);
        jLabel135.setBounds(300, 590, 60, 23);
        ...
        SistemSarafKejang.setBounds(360, 590, 80, 23);
        ...
        KetSistemSarafKejang.setBounds(450, 590, 184, 23);

        jLabel33.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel33.setText("Kardiovaskuler :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(40, 620, 122, 23);

        jLabel136.setText("Pulsasi :");
        jLabel136.setName("jLabel136"); // NOI18N
        FormInput.add(jLabel136);
        jLabel136.setBounds(0, 640, 109, 23);
        ...
        KardiovaskularPulsasi.setBounds(110, 640, 96, 23);

        jLabel137.setText("Sirkulasi :");
        jLabel137.setName("jLabel137"); // NOI18N
        FormInput.add(jLabel137);
        jLabel137.setBounds(240, 640, 60, 23);
        ...
        KardiovaskularSirkulasi.setBounds(310, 640, 120, 23);
        ...
        KetKardiovaskularSirkulasi.setBounds(430, 640, 184, 23);

        jLabel138.setText("Denyut Nadi :");
        jLabel138.setName("jLabel138"); // NOI18N
        FormInput.add(jLabel138);
        jLabel138.setBounds(650, 640, 80, 23);
        ...
        KardiovaskularDenyutNadi.setBounds(730, 640, 120, 23);

        jLabel35.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel35.setText("Respirasi :");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(40, 670, 96, 23);

        jLabel139.setText("Retraksi :");
        jLabel139.setName("jLabel139"); // NOI18N
        FormInput.add(jLabel139);
        jLabel139.setBounds(0, 690, 109, 23);
        ...
        RespirasiRetraksi.setBounds(110, 690, 100, 23);
        ...
        RespirasiPolaNafas.setBounds(300, 690, 102, 23);

        jLabel140.setText("Pola Nafas :");
        jLabel140.setName("jLabel140"); // NOI18N
        FormInput.add(jLabel140);
        jLabel140.setBounds(220, 690, 80, 23);

        jLabel141.setText("Suara Nafas :");
        jLabel141.setName("jLabel141"); // NOI18N
        FormInput.add(jLabel141);
        jLabel141.setBounds(420, 690, 80, 23);
        ...
        RespirasiSuaraNafas.setBounds(500, 690, 100, 23);

        jLabel142.setText("Irama :");
        jLabel142.setName("jLabel142"); // NOI18N
        FormInput.add(jLabel142);
        jLabel142.setBounds(670, 720, 60, 23);
        ...
        RespirasiIrama.setBounds(730, 720, 120, 23);

        jLabel143.setText("Volume :");
        jLabel143.setName("jLabel143"); // NOI18N
        FormInput.add(jLabel143);
        jLabel143.setBounds(0, 720, 109, 23);
        ...
        RespirasiVolume.setBounds(110, 720, 120, 23);

        jLabel144.setText("Jenis Pernafasaan :");
        jLabel144.setName("jLabel144"); // NOI18N
        FormInput.add(jLabel144);
        jLabel144.setBounds(230, 720, 120, 23);
        ...
        RespirasiJenisPernafasan.setBounds(360, 720, 166, 23);
        ...
        KetRespirasiJenisPernafasan.setBounds(530, 720, 135, 23);

        jLabel145.setText("Batuk & Sekresi :");
        jLabel145.setName("jLabel145"); // NOI18N
        FormInput.add(jLabel145);
        jLabel145.setBounds(610, 690, 100, 23);
        ...
        RespirasiBatuk.setBounds(710, 690, 140, 23);

        jLabel49.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel49.setText("Gastrointestinal :");
        jLabel49.setName("jLabel49"); // NOI18N
        FormInput.add(jLabel49);
        jLabel49.setBounds(40, 750, 129, 23);

        jLabel146.setText("Mulut :");
        jLabel146.setName("jLabel146"); // NOI18N
        FormInput.add(jLabel146);
        jLabel146.setBounds(0, 810, 109, 23);
        ...
        GastrointestinalMulut.setBounds(110, 810, 120, 23);
        ...
        KetGastrointestinalMulut.setBounds(240, 810, 190, 23);
        ...
        GastrointestinalGigi.setBounds(110, 870, 95, 23);

        jLabel148.setText("Gigi :");
        jLabel148.setName("jLabel148"); // NOI18N
        FormInput.add(jLabel148);
        jLabel148.setBounds(0, 870, 109, 23);
        ...
        KetGastrointestinalGigi.setBounds(210, 870, 170, 23);

        jLabel149.setText("Anus :");
        jLabel149.setName("jLabel149"); // NOI18N
        FormInput.add(jLabel149);
        jLabel149.setBounds(690, 870, 50, 23);
        ...
        GastrointestinalAnus.setBounds(740, 870, 108, 23);

        jLabel147.setText("Lidah :");
        jLabel147.setName("jLabel147"); // NOI18N
        FormInput.add(jLabel147);
        jLabel147.setBounds(0, 840, 109, 23);
        ...
        GastrointestinalLidah.setBounds(110, 840, 130, 23);
        ...
        KetGastrointestinalLidah.setBounds(250, 840, 190, 23);

        jLabel150.setText("Tenggorokan :");
        jLabel150.setName("jLabel150"); // NOI18N
        FormInput.add(jLabel150);
        jLabel150.setBounds(450, 810, 80, 23);
        ...
        GastrointestinalTenggorakan.setBounds(530, 810, 150, 23);
        ...
        KetGastrointestinalTenggorakan.setBounds(690, 810, 164, 23);

        jLabel151.setText("Abdomen :");
        jLabel151.setName("jLabel151"); // NOI18N
        FormInput.add(jLabel151);
        jLabel151.setBounds(450, 840, 80, 23);
        ...
        GastrointestinalAbdomen.setBounds(530, 840, 150, 23);
        ...
        KetGastrointestinalAbdomen.setBounds(690, 840, 164, 23);

        jLabel152.setText("Peistatik Usus :");
        jLabel152.setName("jLabel152"); // NOI18N
        FormInput.add(jLabel152);
        jLabel152.setBounds(390, 870, 100, 23);
        ...
        GastrointestinalUsus.setBounds(500, 870, 164, 23);

        jLabel50.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel50.setText("Neurologi :");
        jLabel50.setName("jLabel50"); // NOI18N
        FormInput.add(jLabel50);
        jLabel50.setBounds(40, 900, 98, 23);

        jLabel153.setText("Sensorik :");
        jLabel153.setName("jLabel153"); // NOI18N
        FormInput.add(jLabel153);
        jLabel153.setBounds(0, 920, 109, 23);
        ...
        NeurologiSensorik.setBounds(110, 920, 108, 23);

        jLabel154.setText("Motorik :");
        jLabel154.setName("jLabel154"); // NOI18N
        FormInput.add(jLabel154);
        jLabel154.setBounds(0, 950, 109, 23);
        ...
        NeurologiMotorik.setBounds(110, 950, 108, 23);

        jLabel155.setText("Otot :");
        jLabel155.setName("jLabel155"); // NOI18N
        FormInput.add(jLabel155);
        jLabel155.setBounds(730, 950, 40, 23);
        ...
        NeurologiOtot.setBounds(770, 950, 82, 23);

        jLabel156.setText("Penglihatan :");
        jLabel156.setName("jLabel156"); // NOI18N
        FormInput.add(jLabel156);
        jLabel156.setBounds(230, 920, 80, 23);
        ...
        NeurologiPenglihatan.setBounds(310, 920, 115, 23);
        ...
        KetNeurologiPenglihatan.setBounds(430, 920, 150, 23);

        jLabel157.setText("Alat Bantu Penglihatan :");
        jLabel157.setName("jLabel157"); // NOI18N
        FormInput.add(jLabel157);
        jLabel157.setBounds(590, 920, 140, 23);
        ...
        NeurologiAlatBantuPenglihatan.setBounds(730, 920, 120, 23);

        jLabel158.setText("Pendengaran :");
        jLabel158.setName("jLabel158"); // NOI18N
        FormInput.add(jLabel158);
        jLabel158.setBounds(230, 950, 80, 23);
        ...
        NeurologiPendengaran.setBounds(310, 950, 117, 23);

        jLabel159.setText("Bicara :");
        jLabel159.setName("jLabel159"); // NOI18N
        FormInput.add(jLabel159);
        jLabel159.setBounds(430, 950, 50, 23);
        ...
        NeurologiBicara.setBounds(490, 950, 105, 23);
        ...
        KetNeurologiBicara.setBounds(590, 950, 127, 23);

        jLabel51.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel51.setText("Integument :");
        jLabel51.setName("jLabel51"); // NOI18N
        FormInput.add(jLabel51);
        jLabel51.setBounds(40, 980, 108, 23);
        ...
        jLabel161.setBounds(250, 1030, 70, 23);
        ...
        jLabel162.setBounds(420, 1030, 48, 23);
        ...
        jLabel163.setBounds(560, 1030, 90, 23);

        jLabel52.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel52.setText("Muskuloskletal :");
        jLabel52.setName("jLabel52"); // NOI18N
        FormInput.add(jLabel52);
        jLabel52.setBounds(40, 1060, 122, 23);

        jLabel164.setText("Oedema :");
        jLabel164.setName("jLabel164"); // NOI18N
        FormInput.add(jLabel164);
        jLabel164.setBounds(0, 1080, 109, 23);
        ...
        MuskuloskletalOedema.setBounds(110, 1080, 100, 23);
        ...
        KetMuskuloskletalOedema.setBounds(220, 1080, 220, 23);
        ...
        KetMuskuloskletalFraktur.setBounds(220, 1110, 220, 23);
        ...
        MuskuloskletalFraktur.setBounds(110, 1110, 100, 23);

        jLabel165.setText("Fraktur :");
        jLabel165.setName("jLabel165"); // NOI18N
        FormInput.add(jLabel165);
        jLabel165.setBounds(0, 1110, 109, 23);
        ...
        MuskuloskletalNyeriSendi.setBounds(530, 1110, 100, 23);
        ...
        MuskuloskletalKekuatanOtot.setBounds(770, 1080, 85, 23);
        ...
        jLabel53.setBounds(40, 1140, 95, 23);

        jLabel113.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel113.setText("X/");
        jLabel113.setName("jLabel113"); // NOI18N
        FormInput.add(jLabel113);
        jLabel113.setBounds(220, 1160, 13, 23);
        ...
        FormInput.add(KBAB);
        KBAB.setBounds(410, 1160, 175, 23);

        jLabel114.setText("Konsistensi :");
        jLabel114.setName("jLabel114"); // NOI18N
        FormInput.add(jLabel114);
        jLabel114.setBounds(340, 1160, 70, 23);
        ...
        FormInput.add(BAB);
        BAB.setBounds(170, 1160, 50, 23);

        jLabel115.setText("BAB : Frekuensi :");
        jLabel115.setName("jLabel115"); // NOI18N
        FormInput.add(jLabel115);
        jLabel115.setBounds(0, 1160, 166, 23);
        ...
        FormInput.add(XBAB);
        XBAB.setBounds(240, 1160, 75, 23);

        jLabel116.setText("Warna :");
        jLabel116.setName("jLabel116"); // NOI18N
        FormInput.add(jLabel116);
        jLabel116.setBounds(620, 1160, 55, 23);
        ...
        FormInput.add(WBAB);
        WBAB.setBounds(680, 1160, 175, 23);

        jLabel117.setText("BAK : Frekuensi :");
        jLabel117.setName("jLabel117"); // NOI18N
        FormInput.add(jLabel117);
        jLabel117.setBounds(0, 1190, 166, 23);
        ...
        FormInput.add(BAK);
        BAK.setBounds(170, 1190, 50, 23);

        jLabel118.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel118.setText("X/");
        jLabel118.setName("jLabel118"); // NOI18N
        FormInput.add(jLabel118);
        jLabel118.setBounds(220, 1190, 13, 23);
        ...
        FormInput.add(XBAK);
        XBAK.setBounds(240, 1190, 75, 23);

        jLabel119.setText("Warna :");
        jLabel119.setName("jLabel119"); // NOI18N
        FormInput.add(jLabel119);
        jLabel119.setBounds(340, 1190, 70, 23);
        ...
        FormInput.add(WBAK);
        WBAK.setBounds(410, 1190, 175, 23);

        jLabel120.setText("Lain-lain :");
        jLabel120.setName("jLabel120"); // NOI18N
        FormInput.add(jLabel120);
        jLabel120.setBounds(620, 1190, 55, 23);
        ...
        FormInput.add(LBAK);
        LBAK.setBounds(680, 1190, 175, 23);
        ...
        jSeparator5.setBounds(0, 1220, 880, 1);
        ...
        PolaAktifitasMandi.setBounds(120, 1260, 164, 23);
        ...
        PolaAktifitasMakan.setBounds(410, 1260, 164, 23);
        ...
        PolaAktifitasBerpakaian.setBounds(690, 1260, 164, 23);
        ...
        PolaAktifitasBerpindah.setBounds(410, 1290, 164, 23);

        jLabel55.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel55.setText("a. Pola Aktifitas :");
        jLabel55.setName("jLabel55"); // NOI18N
        FormInput.add(jLabel55);
        jLabel55.setBounds(50, 1240, 128, 23);

        jLabel121.setText("Porsi Makan");
        jLabel121.setName("jLabel121"); // NOI18N
        FormInput.add(jLabel121);
        jLabel121.setBounds(110, 1320, 73, 23);
        ...
        PolaNutrisiFrekuensi.setBounds(360, 1320, 50, 23);
        ...
        PolaTidurLama.setBounds(180, 1350, 50, 23);
        ...
        jLabel178.setBounds(230, 1350, 51, 23);
        ...
        PolaTidurGangguan.setBounds(280, 1350, 164, 23);
        ...
        jSeparator4.setBounds(0, 1380, 880, 1);
        ...
        jLabel180.setBounds(20, 1390, 180, 23);
        ...
        jLabel179.setBounds(50, 1410, 180, 23);
        ...
        Berjalan.setBounds(480, 1410, 178, 23);
        ...
        KeteranganBerjalan.setBounds(660, 1410, 204, 23);
        ...
        jLabel182.setBounds(50, 1440, 60, 23);
        ...
        EkstrimitasAtas.setBounds(600, 1440, 120, 23);
        ...
        KeteranganEkstrimitasAtas.setBounds(720, 1440, 137, 23);
        ...
        jLabel185.setBounds(50, 1470, 110, 23);
        ...
        EkstrimitasBawah.setBounds(170, 1470, 120, 23);
        ...
        KemampuanMenggenggam.setBounds(600, 1470, 147, 23);
        ...
        KeteranganKemampuanMenggenggam.setBounds(750, 1470, 115, 23);
        ...
        jLabel187.setBounds(50, 1500, 140, 23);
        ...
        KemampuanKoordinasi.setBounds(190, 1500, 147, 23);
        ...
        KesimpulanGangguanFungsi.setBounds(670, 1500, 195, 23);
        ...
        jSeparator6.setBounds(10, 1530, 880, 1);
        ...
        jLabel189.setBounds(20, 1530, 490, 23);

        jLabel190.setText(":");
        jLabel190.setName("jLabel190"); // NOI18N
        FormInput.add(jLabel190);
        jLabel190.setBounds(150, 1550, 10, 23);
        ...
        AdakahPerilaku.setBounds(420, 1550, 235, 23);
        ...
        KeteranganAdakahPerilaku.setBounds(660, 1550, 202, 23);

        jLabel192.setText(":");
        jLabel192.setName("jLabel192"); // NOI18N
        FormInput.add(jLabel192);
        jLabel192.setBounds(200, 1580, 10, 23);
        ...
        TinggalDengan.setBounds(150, 1610, 105, 23);
        ...
        CaraBayar.setBounds(720, 1610, 140, 23);

        jLabel198.setText(":");
        jLabel198.setName("jLabel198"); // NOI18N
        FormInput.add(jLabel198);
        jLabel198.setBounds(330, 1640, 10, 23);
        ...
        NilaiKepercayaan.setBounds(340, 1640, 105, 23);
        ...
        EdukasiPsikolgis.setBounds(660, 1670, 95, 23);
        ...
        KeteranganEdukasiPsikologis.setBounds(760, 1670, 99, 23);
        ...
        jSeparator8.setBounds(10, 1700, 880, 1);
        ...
        jLabel203.setBounds(20, 1700, 380, 23);
        ...
        jSeparator9.setBounds(370, 1720, 1, 140);
        ...
        PanelWall.setBounds(50, 1720, 320, 130);
        ...
        Provokes.setBounds(580, 1720, 130, 23);
        ...
        Quality.setBounds(440, 1750, 140, 23);
        ...
        jLabel210.setBounds(430, 1830, 60, 23);
        ...
        Durasi.setBounds(730, 1830, 90, 23);
        ...
        NyeriHilang.setBounds(140, 1860, 130, 23);
        ...
        KetPadaDokter.setBounds(780, 1860, 80, 23);
        ...
        jSeparator10.setBounds(10, 1890, 880, 1);
        ...
        jLabel216.setBounds(10, 2100, 380, 23);

        jLabel57.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel57.setText("Skala FLACCS :");
        jLabel57.setName("jLabel57"); // NOI18N
        FormInput.add(jLabel57);
        jLabel57.setBounds(50, 1910, 80, 23);

        jLabel217.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel217.setText("1. Wajah");
        jLabel217.setName("jLabel217"); // NOI18N
        FormInput.add(jLabel217);
        jLabel217.setBounds(70, 1930, 300, 23);

        SkalaResiko1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tersenyum/tidak ada ekspresi khusus", "Terkadang meringis/menarik diri", "Sering menggetarkan dagu dan mengatupkan rahang" }));
        ...
        SkalaResiko1.setBounds(440, 1930, 310, 23);

        jLabel218.setText("Nilai :");
        jLabel218.setName("jLabel218"); // NOI18N
        FormInput.add(jLabel218);
        jLabel218.setBounds(710, 1930, 75, 23);
        ...
        NilaiResiko1.setBounds(790, 1930, 60, 23);

        jLabel219.setText("Skala :");
        jLabel219.setName("jLabel219"); // NOI18N
        FormInput.add(jLabel219);
        jLabel219.setBounds(350, 1930, 80, 23);

        jLabel220.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel220.setText("2. Kaki");
        jLabel220.setName("jLabel220"); // NOI18N
        FormInput.add(jLabel220);
        jLabel220.setBounds(70, 1960, 300, 23);

        jLabel221.setText("Skala :");
        jLabel221.setName("jLabel221"); // NOI18N
        FormInput.add(jLabel221);
        jLabel221.setBounds(350, 1960, 80, 23);

        SkalaResiko2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gerakan normal/relaksasi", "Tidak tenang/tegang", "Kaki dibuat menendang/menarik" }));
        ...
        SkalaResiko2.setBounds(440, 1960, 310, 23);

        jLabel222.setText("Nilai :");
        jLabel222.setName("jLabel222"); // NOI18N
        FormInput.add(jLabel222);
        jLabel222.setBounds(710, 1960, 75, 23);
        ...
        NilaiResiko2.setBounds(790, 1960, 60, 23);

        jLabel223.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel223.setText("3. Aktifitas");
        jLabel223.setName("jLabel223"); // NOI18N
        FormInput.add(jLabel223);
        jLabel223.setBounds(70, 1990, 300, 23);

        jLabel224.setText("Skala :");
        jLabel224.setName("jLabel224"); // NOI18N
        FormInput.add(jLabel224);
        jLabel224.setBounds(350, 1990, 80, 23);

        SkalaResiko3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidur posisi normal, mudah bergerak", "Gerakan menggeliat/berguling, kaku", "Melengkungkan punggung/kaku menghentak" }));
        ...
        SkalaResiko3.setBounds(440, 1990, 310, 23);

        jLabel225.setText("Nilai :");
        jLabel225.setName("jLabel225"); // NOI18N
        FormInput.add(jLabel225);
        jLabel225.setBounds(710, 1990, 75, 23);
        ...
        NilaiResiko3.setBounds(790, 1990, 60, 23);

        jLabel226.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel226.setText("4. Menangis");
        jLabel226.setName("jLabel226"); // NOI18N
        FormInput.add(jLabel226);
        jLabel226.setBounds(70, 2020, 300, 23);

        jLabel227.setText("Skala :");
        jLabel227.setName("jLabel227"); // NOI18N
        FormInput.add(jLabel227);
        jLabel227.setBounds(350, 2020, 80, 23);

        SkalaResiko4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak menangis (mudah bergerak)", "Mengerang/merengek", "Menangis terus menerus, terisak, menjerit" }));
        ...
        SkalaResiko4.setBounds(440, 2020, 310, 23);

        jLabel228.setText("Nilai :");
        jLabel228.setName("jLabel228"); // NOI18N
        FormInput.add(jLabel228);
        jLabel228.setBounds(710, 2020, 75, 23);
        ...
        NilaiResiko4.setBounds(790, 2020, 60, 23);

        jLabel229.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel229.setText("5. Bersuara");
        jLabel229.setName("jLabel229"); // NOI18N
        FormInput.add(jLabel229);
        jLabel229.setBounds(70, 2050, 300, 23);

        jLabel230.setText("Skala :");
        jLabel230.setName("jLabel230"); // NOI18N
        FormInput.add(jLabel230);
        jLabel230.setBounds(350, 2050, 80, 23);

        SkalaResiko5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bersuara normal/tenang", "Tenang bila dipeluk, digendong/diajak bicara", "Sulit untuk menenangkan" }));
        ...
        NilaiResiko5.setBounds(790, 2050, 60, 23);

        jLabel235.setText("Total :");
        jLabel235.setName("jLabel235"); // NOI18N
        FormInput.add(jLabel235);
        jLabel235.setBounds(710, 2080, 75, 23);
        ...
        NilaiResikoTotal.setBounds(790, 2080, 60, 23);

        jLabel58.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel58.setText("Skala Humpty Dumpty :");
        jLabel58.setName("jLabel58"); // NOI18N
        FormInput.add(jLabel58);
        jLabel58.setBounds(40, 2120, 130, 23);

        jLabel236.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel236.setText("1. Umur");
        jLabel236.setName("jLabel236"); // NOI18N
        FormInput.add(jLabel236);
        jLabel236.setBounds(60, 2140, 330, 23);

        jLabel237.setText("Skala :");
        jLabel237.setName("jLabel237"); // NOI18N
        FormInput.add(jLabel237);
        jLabel237.setBounds(350, 2140, 80, 23);

        SkalaSydney1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "0 - 3 Tahun", "3 - 7 Tahun", "7 - 13 Tahun", "> 13 Tahun" }));
        ...
        NilaiSydney1.setBounds(790, 2140, 60, 23);

        jLabel239.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel239.setText("2. Jenis Kelamin");
        jLabel239.setName("jLabel239"); // NOI18N
        FormInput.add(jLabel239);
        jLabel239.setBounds(60, 2170, 330, 23);

        jLabel240.setText("Skala :");
        jLabel240.setName("jLabel240"); // NOI18N
        FormInput.add(jLabel240);
        jLabel240.setBounds(350, 2170, 80, 23);

        SkalaSydney2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Laki-laki", "Perempuan" }));
        ...
        NilaiSydney2.setBounds(790, 2170, 60, 23);

        jLabel242.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel242.setText("3. Diagnosa");
        jLabel242.setName("jLabel242"); // NOI18N
        FormInput.add(jLabel242);
        jLabel242.setBounds(60, 2200, 330, 23);

        jLabel243.setText("Skala :");
        jLabel243.setName("jLabel243"); // NOI18N
        FormInput.add(jLabel243);
        jLabel243.setBounds(350, 2200, 80, 23);

        SkalaSydney3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Kelainan Neurologi", "Perubahan Dalam Oksigen(Masalah Saluran Nafas, Dehidrasi, Anemia, Anoreksia / Sakit Kepala, Dll)", "Kelainan Psikis / Perilaku", "Diagnosa Lain" }));
        ...
        NilaiSydney3.setBounds(790, 2200, 60, 23);

        jLabel245.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel245.setText("4. Gangguan Kognitif");
        jLabel245.setName("jLabel245"); // NOI18N
        FormInput.add(jLabel245);
        jLabel245.setBounds(60, 2230, 330, 23);

        jLabel246.setText("Skala :");
        jLabel246.setName("jLabel246"); // NOI18N
        FormInput.add(jLabel246);
        jLabel246.setBounds(350, 2230, 80, 23);

        SkalaSydney4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Sadar Terhadap Keterbatasan", "Lupa Keterbatasan", "Mengetahui Kemampuan Diri" }));
        ...
        NilaiSydney4.setBounds(790, 2230, 60, 23);

        jLabel248.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel248.setText("5. Faktor Lingkungan");
        jLabel248.setName("jLabel248"); // NOI18N
        FormInput.add(jLabel248);
        jLabel248.setBounds(60, 2260, 330, 23);

        jLabel249.setText("Skala :");
        jLabel249.setName("jLabel249"); // NOI18N
        FormInput.add(jLabel249);
        jLabel249.setBounds(350, 2260, 80, 23);

        SkalaSydney5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Riwayat Jatuh Dari Tempat Tidur Saat Bayi/Anak", "Pasien Menggunakan Alat Bantu/Box/Mebel", "Pasien Berada Di Tempat Tidur", "Di Luar Ruang Rawat" }));
        ...
        NilaiSydney5.setBounds(790, 2260, 60, 23);

        jLabel251.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel251.setText("6. Efek Obat Penenang/Operasi/Anastesi");
        jLabel251.setName("jLabel251"); // NOI18N
        FormInput.add(jLabel251);
        jLabel251.setBounds(60, 2290, 330, 23);

        jLabel252.setText("Skala :");
        jLabel252.setName("jLabel252"); // NOI18N
        FormInput.add(jLabel252);
        jLabel252.setBounds(350, 2290, 80, 23);

        SkalaSydney6.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Dalam 24 Jam", "Dalam 48 Jam", "> 48 Jam" }));
        ...
        NilaiSydney6.setBounds(790, 2290, 60, 23);

        jLabel254.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel254.setText("7. Penggunaan Obat");
        jLabel254.setName("jLabel254"); // NOI18N
        FormInput.add(jLabel254);
        jLabel254.setBounds(60, 2320, 310, 23);

        jLabel255.setText("Skala :");
        jLabel255.setName("jLabel255"); // NOI18N
        FormInput.add(jLabel255);
        jLabel255.setBounds(350, 2320, 80, 23);

        SkalaSydney7.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bermacam-macam Obat Yang Digunakan : Obat Sedative (Kecuali Pasien ICU Yang Menggunakan sedasi dan paralisis), Hipnotik, Barbiturat, Fenoti-Azin, Antidepresan, Laksans/Diuretika,Narkotik", "Salah Satu Dari Pengobatan Di Atas", "Pengobatan Lain" }));
        ...
        NilaiSydney7.setBounds(790, 2320, 60, 23);
        ...
        NilaiSydneyTotal.setBounds(790, 2360, 60, 23);

        jLabel270.setText("Total :");
        jLabel270.setName("jLabel270"); // NOI18N
        FormInput.add(jLabel270);
        jLabel270.setBounds(710, 2360, 75, 23);

        TingkatSydney.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        TingkatSydney.setText("Tingkat Resiko : Risiko Tinggi (>=12), Tindakan : Intervensi risiko jatuh tinggi(pasang gelang warna kuning)");
        TingkatSydney.setName("TingkatSydney"); // NOI18N
        FormInput.add(TingkatSydney);
        TingkatSydney.setBounds(60, 2360, 650, 23);
        ...
        jLabel272.setBounds(40, 2410, 380, 23);
        ...
        SkalaGizi1.setBounds(420, 2410, 320, 23);
        ...
        NilaiGizi1.setBounds(790, 2410, 60, 23);
        ...
        jLabel274.setBounds(40, 2440, 380, 23);
        ...
        SkalaGizi2.setBounds(420, 2440, 320, 23);
        ...
        NilaiGizi2.setBounds(790, 2440, 60, 23);
        ...
        DiagnosaKhususGizi.setBounds(210, 2500, 80, 23);
        ...
        DiketahuiDietisen.setBounds(670, 2500, 80, 23);
        ...
        KeteranganDiketahuiDietisen.setBounds(790, 2500, 60, 23);
        ...
        TabRencanaKeperawatan.setBounds(430, 2540, 420, 143);
        ...
        BtnTambahMasalah.setBounds(360, 2690, 28, 23);
        ...
        BtnAllMasalah.setBounds(330, 2690, 28, 23);
        ...
        BtnCariMasalah.setBounds(300, 2690, 28, 23);
        ...
        BtnTambahRencana.setBounds(800, 2690, 28, 23);
        ...
        BtnAllRencana.setBounds(770, 2690, 28, 23);
        ...
        BtnCariRencana.setBounds(740, 2690, 28, 23);

        label13.setText("Key Word :");
        label13.setName("label13"); // NOI18N
        label13.setPreferredSize(new java.awt.Dimension(60, 23));
        FormInput.add(label13);
        label13.setBounds(440, 2690, 60, 23);
        ...
        jLabel284.setBounds(50, 1550, 110, 23);
        ...
        jLabel285.setBounds(50, 1580, 160, 23);
        ...
        jLabel286.setBounds(50, 1610, 100, 23);
        ...
        jLabel287.setBounds(50, 1640, 290, 23);
        ...
        jLabel288.setBounds(50, 1670, 110, 23);

        jLabel59.setText("Apgar Score :");
        jLabel59.setName("jLabel59"); // NOI18N
        FormInput.add(jLabel59);
        jLabel59.setBounds(0, 470, 73, 23);

        Apgar_score.setFocusTraversalPolicyProvider(true);
        Apgar_score.setName("Apgar_score"); // NOI18N
        Apgar_score.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Apgar_scoreKeyPressed(evt);
            }
        });
        FormInput.add(Apgar_score);
        Apgar_score.setBounds(78, 470, 50, 23);

        jLabel60.setText("Lingkar Kepala :");
        jLabel60.setName("jLabel60"); // NOI18N
        FormInput.add(jLabel60);
        jLabel60.setBounds(143, 470, 90, 23);

        Lingkar_kepala.setFocusTraversalPolicyProvider(true);
        Lingkar_kepala.setName("Lingkar_kepala"); // NOI18N
        Lingkar_kepala.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Lingkar_kepalaKeyPressed(evt);
            }
        });
        FormInput.add(Lingkar_kepala);
        Lingkar_kepala.setBounds(240, 470, 50, 23);

        jLabel61.setText("Lingkar Dada :");
        jLabel61.setName("jLabel61"); // NOI18N
        FormInput.add(jLabel61);
        jLabel61.setBounds(310, 470, 90, 23);

        Lingkar_dada.setFocusTraversalPolicyProvider(true);
        Lingkar_dada.setName("Lingkar_dada"); // NOI18N
        Lingkar_dada.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Lingkar_dadaKeyPressed(evt);
            }
        });
        FormInput.add(Lingkar_dada);
        Lingkar_dada.setBounds(410, 470, 50, 23);

        jLabel62.setText("Lingkar Perut :");
        jLabel62.setName("jLabel62"); // NOI18N
        FormInput.add(jLabel62);
        jLabel62.setBounds(460, 470, 80, 23);

        Lingkar_perut.setFocusTraversalPolicyProvider(true);
        Lingkar_perut.setName("Lingkar_perut"); // NOI18N
        Lingkar_perut.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Lingkar_perutKeyPressed(evt);
            }
        });
        FormInput.add(Lingkar_perut);
        Lingkar_perut.setBounds(550, 470, 50, 23);

        jLabel63.setText("Lingkar Lengan :");
        jLabel63.setName("jLabel63"); // NOI18N
        FormInput.add(jLabel63);
        jLabel63.setBounds(610, 470, 90, 23);

        Lingkar_lengan.setFocusTraversalPolicyProvider(true);
        Lingkar_lengan.setName("Lingkar_lengan"); // NOI18N
        Lingkar_lengan.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Lingkar_lenganKeyPressed(evt);
            }
        });
        FormInput.add(Lingkar_lengan);
        Lingkar_lengan.setBounds(710, 470, 50, 23);

        jLabel289.setText("Tangis :");
        jLabel289.setName("jLabel289"); // NOI18N
        FormInput.add(jLabel289);
        jLabel289.setBounds(0, 530, 109, 23);

        Tangis.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Lemas", "Kuat" }));
        ...
        Tangis.setBounds(110, 530, 103, 23);

        jLabel290.setText("Gerakan :");
        jLabel290.setName("jLabel290"); // NOI18N
        FormInput.add(jLabel290);
        jLabel290.setBounds(230, 530, 50, 23);

        Gerakan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Aktif", "Lemah", "Paralisis" }));
        ...
        Gerakan.setBounds(280, 530, 103, 23);

        jLabel291.setText("Refleks Moro :");
        jLabel291.setName("jLabel291"); // NOI18N
        FormInput.add(jLabel291);
        jLabel291.setBounds(420, 530, 80, 23);

        Refleks_moro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ada" }));
        Refleks_moro.setName("Refleks_moro"); // NOI18N
        Refleks_moro.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Refleks_moroKeyPressed(evt);
            }
        });
        FormInput.add(Refleks_moro);
        Refleks_moro.setBounds(510, 530, 103, 23);

        jLabel292.setText("Tonus ");
        jLabel292.setName("jLabel292"); // NOI18N
        FormInput.add(jLabel292);
        jLabel292.setBounds(390, 500, 70, 23);

        jLabel293.setText("Refleks Genggam :");
        jLabel293.setName("jLabel293"); // NOI18N
        FormInput.add(jLabel293);
        jLabel293.setBounds(640, 530, 100, 23);

        Refleks_genggam.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ada" }));
        Refleks_genggam.setName("Refleks_genggam"); // NOI18N
        Refleks_genggam.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Refleks_genggamKeyPressed(evt);
            }
        });
        FormInput.add(Refleks_genggam);
        Refleks_genggam.setBounds(750, 530, 103, 23);

        jLabel294.setText("Refleks Rooting :");
        jLabel294.setName("jLabel294"); // NOI18N
        FormInput.add(jLabel294);
        jLabel294.setBounds(0, 780, 109, 23);

        Refleks_rooting.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ada" }));
        Refleks_rooting.setName("Refleks_rooting"); // NOI18N
        Refleks_rooting.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Refleks_rootingKeyPressed(evt);
            }
        });
        FormInput.add(Refleks_rooting);
        Refleks_rooting.setBounds(110, 780, 103, 23);

        jLabel295.setText("Refleks Hisap :");
        jLabel295.setName("jLabel295"); // NOI18N
        FormInput.add(jLabel295);
        jLabel295.setBounds(230, 780, 80, 23);

        Refleks_hisap.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ada" }));
        Refleks_hisap.setName("Refleks_hisap"); // NOI18N
        Refleks_hisap.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Refleks_hisapKeyPressed(evt);
            }
        });
        FormInput.add(Refleks_hisap);
        Refleks_hisap.setBounds(320, 780, 103, 23);

        jLabel296.setText("Labio :");
        jLabel296.setName("jLabel296"); // NOI18N
        FormInput.add(jLabel296);
        jLabel296.setBounds(420, 780, 80, 23);

        Labio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada Kelainan", "Palatoschizi", "Schizis", "Genetoschizis" }));
        Labio.setName("Labio"); // NOI18N
        Labio.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                LabioKeyPressed(evt);
            }
        });
        FormInput.add(Labio);
        Labio.setBounds(510, 780, 150, 23);

        jLabel297.setText("Cara Minum :");
        jLabel297.setName("jLabel297"); // NOI18N
        FormInput.add(jLabel297);
        jLabel297.setBounds(640, 780, 100, 23);

        Cara_minum.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Oral", "Sonde", "Puasa", "OGT Terbuka", "Muntah", "Residu" }));
        Cara_minum.setName("Cara_minum"); // NOI18N
        Cara_minum.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Cara_minumKeyPressed(evt);
            }
        });
        FormInput.add(Cara_minum);
        Cara_minum.setBounds(750, 780, 103, 23);

        jLabel298.setText("Suhu Tubuh :");
        jLabel298.setName("jLabel298"); // NOI18N
        FormInput.add(jLabel298);
        jLabel298.setBounds(0, 1000, 109, 23);

        Suhu_tubuh.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Hangat", "Dingin" }));
        ...
        Suhu_tubuh.setBounds(110, 1000, 103, 23);

        jLabel299.setText("Kepala :");
        jLabel299.setName("jLabel299"); // NOI18N
        FormInput.add(jLabel299);
        jLabel299.setBounds(230, 1000, 80, 23);

        Kepala.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bersih", "Kotor", "Kering" }));
        ...
        Kepala.setBounds(320, 1000, 103, 23);

        jLabel300.setText("Mata :");
        jLabel300.setName("jLabel300"); // NOI18N
        FormInput.add(jLabel300);
        jLabel300.setBounds(450, 980, 50, 23);

        Mata_secret.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Tidak Ada", "Ada" }));
        Mata_secret.setName("Mata_secret"); // NOI18N
        Mata_secret.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Mata_secretKeyPressed(evt);
            }
        });
        FormInput.add(Mata_secret);
        Mata_secret.setBounds(510, 1000, 150, 23);

        jLabel301.setText("Tali Pusat :");
        jLabel301.setName("jLabel301"); // NOI18N
        FormInput.add(jLabel301);
        jLabel301.setBounds(640, 1000, 100, 23);

        Tali_pusat.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Bersih", "Kotor", "Kering", "Bau", "Basah" }));
        Tali_pusat.setName("Tali_pusat"); // NOI18N
        Tali_pusat.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Tali_pusatKeyPressed(evt);
            }
        });
        FormInput.add(Tali_pusat);
        Tali_pusat.setBounds(750, 1000, 103, 23);

        jLabel302.setText("Secret :");
        jLabel302.setName("jLabel302"); // NOI18N
        FormInput.add(jLabel302);
        jLabel302.setBounds(420, 1000, 80, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_awal_perina","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",200,new String[]{
                    ...
                    SkalaResiko5.getSelectedItem().toString(),NilaiResiko5.getText(),NilaiResikoTotal.getText(),SkalaSydney1.getSelectedItem().toString(),NilaiSydney1.getText(),SkalaSydney2.getSelectedItem().toString(),NilaiSydney2.getText(),
                    ...
                    SkalaSydney7.getSelectedItem().toString(),NilaiSydney7.getText(),NilaiSydneyTotal.getText(),SkalaGizi1.getSelectedItem().toString(),NilaiGizi1.getText(),SkalaGizi2.getSelectedItem().toString(),NilaiGizi2.getText(),NilaiGiziTotal.getText(),DiagnosaKhususGizi.getSelectedItem().toString(),
                    KeteranganDiagnosaKhususGizi.getText(),DiketahuiDietisen.getSelectedItem().toString(),KeteranganDiketahuiDietisen.getText(),Rencana.getText(),KdPetugas.getText(),KdPetugas2.getText(),KdDPJP.getText(),Apgar_score.getText(),Lingkar_kepala.getText(),Lingkar_dada.getText(),Lingkar_perut.getText(),Lingkar_lengan.getText(),Tangis.getSelectedItem().toString(),Gerakan.getSelectedItem().toString(),Refleks_moro.getSelectedItem().toString(),Refleks_genggam.getSelectedItem().toString(),
                    Refleks_rooting.getSelectedItem().toString(),Refleks_hisap.getSelectedItem().toString(),Labio.getSelectedItem().toString(),Cara_minum.getSelectedItem().toString(),Suhu_tubuh.getSelectedItem().toString(),Kepala.getSelectedItem().toString(),Mata_secret.getSelectedItem().toString(),Tali_pusat.getSelectedItem().toString()
                })==true){
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                ps=koneksi.prepareStatement(
                    "select penilaian_awal_perina.no_rawat,penilaian_awal_perina.tanggal,penilaian_awal_perina.informasi,penilaian_awal_perina.ket_informasi,penilaian_awal_perina.tiba_diruang_rawat,"+
                    "penilaian_awal_perina.kasus_trauma,penilaian_awal_perina.cara_masuk,penilaian_awal_perina.rps,penilaian_awal_perina.rpd,penilaian_awal_perina.rpk,penilaian_awal_perina.rpo,"+
                    "penilaian_awal_perina.riwayat_pembedahan,penilaian_awal_perina.riwayat_dirawat_dirs,penilaian_awal_perina.alat_bantu_dipakai,penilaian_awal_perina.riwayat_kehamilan,"+
                    "penilaian_awal_perina.riwayat_kehamilan_perkiraan,penilaian_awal_perina.riwayat_tranfusi,penilaian_awal_perina.riwayat_alergi,penilaian_awal_perina.riwayat_merokok,"+
                    "penilaian_awal_perina.riwayat_merokok_jumlah,penilaian_awal_perina.riwayat_alkohol,penilaian_awal_perina.riwayat_alkohol_jumlah,penilaian_awal_perina.riwayat_narkoba,"+
                    "penilaian_awal_perina.riwayat_olahraga,penilaian_awal_perina.pemeriksaan_mental,penilaian_awal_perina.pemeriksaan_keadaan_umum,penilaian_awal_perina.pemeriksaan_gcs,"+
                    "penilaian_awal_perina.pemeriksaan_td,penilaian_awal_perina.pemeriksaan_nadi,penilaian_awal_perina.pemeriksaan_rr,penilaian_awal_perina.pemeriksaan_suhu,"+
                    "penilaian_awal_perina.pemeriksaan_spo2,penilaian_awal_perina.pemeriksaan_bb,penilaian_awal_perina.pemeriksaan_tb,penilaian_awal_perina.pemeriksaan_susunan_kepala,"+
                    "penilaian_awal_perina.pemeriksaan_susunan_kepala_keterangan,penilaian_awal_perina.pemeriksaan_susunan_wajah,penilaian_awal_perina.pemeriksaan_susunan_wajah_keterangan,"+
                    "penilaian_awal_perina.pemeriksaan_susunan_leher,penilaian_awal_perina.pemeriksaan_susunan_kejang,penilaian_awal_perina.pemeriksaan_susunan_kejang_keterangan,"+
                    "penilaian_awal_perina.pemeriksaan_susunan_sensorik,penilaian_awal_perina.pemeriksaan_kardiovaskuler_denyut_nadi,penilaian_awal_perina.pemeriksaan_kardiovaskuler_sirkulasi,"+
                    "penilaian_awal_perina.pemeriksaan_kardiovaskuler_sirkulasi_keterangan,penilaian_awal_perina.pemeriksaan_kardiovaskuler_pulsasi,penilaian_awal_perina.pemeriksaan_respirasi_pola_nafas,"+
                    "penilaian_awal_perina.pemeriksaan_respirasi_retraksi,penilaian_awal_perina.pemeriksaan_respirasi_suara_nafas,penilaian_awal_perina.pemeriksaan_respirasi_volume_pernafasan,"+
                    "penilaian_awal_perina.pemeriksaan_respirasi_jenis_pernafasan,penilaian_awal_perina.pemeriksaan_respirasi_jenis_pernafasan_keterangan,penilaian_awal_perina.pemeriksaan_respirasi_irama_nafas,"+
                    "penilaian_awal_perina.pemeriksaan_respirasi_batuk,penilaian_awal_perina.pemeriksaan_gastrointestinal_mulut,penilaian_awal_perina.pemeriksaan_gastrointestinal_mulut_keterangan,"+
                    "penilaian_awal_perina.pemeriksaan_gastrointestinal_gigi,penilaian_awal_perina.pemeriksaan_gastrointestinal_gigi_keterangan,penilaian_awal_perina.pemeriksaan_gastrointestinal_lidah,"+
                    "penilaian_awal_perina.pemeriksaan_gastrointestinal_lidah_keterangan,penilaian_awal_perina.pemeriksaan_gastrointestinal_tenggorokan,penilaian_awal_perina.pemeriksaan_gastrointestinal_tenggorokan_keterangan,"+
                    "penilaian_awal_perina.pemeriksaan_gastrointestinal_abdomen,penilaian_awal_perina.pemeriksaan_gastrointestinal_abdomen_keterangan,penilaian_awal_perina.pemeriksaan_gastrointestinal_peistatik_usus,"+
                    "penilaian_awal_perina.pemeriksaan_gastrointestinal_anus,penilaian_awal_perina.pemeriksaan_neurologi_pengelihatan,penilaian_awal_perina.pemeriksaan_neurologi_pengelihatan_keterangan,"+
                    "penilaian_awal_perina.pemeriksaan_neurologi_alat_bantu_penglihatan,penilaian_awal_perina.pemeriksaan_neurologi_pendengaran,penilaian_awal_perina.pemeriksaan_neurologi_bicara,"+
                    "penilaian_awal_perina.pemeriksaan_neurologi_bicara_keterangan,penilaian_awal_perina.pemeriksaan_neurologi_sensorik,penilaian_awal_perina.pemeriksaan_neurologi_motorik,"+
                    "penilaian_awal_perina.pemeriksaan_neurologi_kekuatan_otot,penilaian_awal_perina.pemeriksaan_integument_warnakulit,penilaian_awal_perina.pemeriksaan_integument_turgor,"+
                    "penilaian_awal_perina.pemeriksaan_integument_kulit,penilaian_awal_perina.pemeriksaan_integument_dekubitas,penilaian_awal_perina.pemeriksaan_muskuloskletal_pergerakan_sendi,"+
                    "penilaian_awal_perina.pemeriksaan_muskuloskletal_kekauatan_otot,penilaian_awal_perina.pemeriksaan_muskuloskletal_nyeri_sendi,penilaian_awal_perina.pemeriksaan_muskuloskletal_nyeri_sendi_keterangan,"+
                    "penilaian_awal_perina.pemeriksaan_muskuloskletal_oedema,penilaian_awal_perina.pemeriksaan_muskuloskletal_oedema_keterangan,penilaian_awal_perina.pemeriksaan_muskuloskletal_fraktur,"+
                    "penilaian_awal_perina.pemeriksaan_muskuloskletal_fraktur_keterangan,penilaian_awal_perina.pemeriksaan_eliminasi_bab_frekuensi_jumlah,penilaian_awal_perina.pemeriksaan_eliminasi_bab_frekuensi_durasi,"+
                    "penilaian_awal_perina.pemeriksaan_eliminasi_bab_konsistensi,penilaian_awal_perina.pemeriksaan_eliminasi_bab_warna,penilaian_awal_perina.pemeriksaan_eliminasi_bak_frekuensi_jumlah,"+
                    "penilaian_awal_perina.pemeriksaan_eliminasi_bak_frekuensi_durasi,penilaian_awal_perina.pemeriksaan_eliminasi_bak_warna,penilaian_awal_perina.pemeriksaan_eliminasi_bak_lainlain,"+
                    "penilaian_awal_perina.pola_aktifitas_makanminum,penilaian_awal_perina.pola_aktifitas_mandi,penilaian_awal_perina.pola_aktifitas_eliminasi,penilaian_awal_perina.pola_aktifitas_berpakaian,"+
                    "penilaian_awal_perina.pola_aktifitas_berpindah,penilaian_awal_perina.pola_nutrisi_frekuesi_makan,penilaian_awal_perina.pola_nutrisi_jenis_makanan,penilaian_awal_perina.pola_nutrisi_porsi_makan,"+
                    "penilaian_awal_perina.pola_tidur_lama_tidur,penilaian_awal_perina.pola_tidur_gangguan,penilaian_awal_perina.pengkajian_fungsi_kemampuan_sehari,penilaian_awal_perina.pengkajian_fungsi_aktifitas,"+
                    "penilaian_awal_perina.pengkajian_fungsi_berjalan,penilaian_awal_perina.pengkajian_fungsi_berjalan_keterangan,penilaian_awal_perina.pengkajian_fungsi_ambulasi,"+
                    "penilaian_awal_perina.pengkajian_fungsi_ekstrimitas_atas,penilaian_awal_perina.pengkajian_fungsi_ekstrimitas_atas_keterangan,penilaian_awal_perina.pengkajian_fungsi_ekstrimitas_bawah,"+
                    "penilaian_awal_perina.pengkajian_fungsi_ekstrimitas_bawah_keterangan,penilaian_awal_perina.pengkajian_fungsi_menggenggam,penilaian_awal_perina.pengkajian_fungsi_menggenggam_keterangan,"+
                    "penilaian_awal_perina.pengkajian_fungsi_koordinasi,penilaian_awal_perina.pengkajian_fungsi_koordinasi_keterangan,penilaian_awal_perina.pengkajian_fungsi_kesimpulan,"+
                    "penilaian_awal_perina.riwayat_psiko_kondisi_psiko,penilaian_awal_perina.riwayat_psiko_gangguan_jiwa,penilaian_awal_perina.riwayat_psiko_perilaku,"+
                    "penilaian_awal_perina.riwayat_psiko_perilaku_keterangan,penilaian_awal_perina.riwayat_psiko_hubungan_keluarga,penilaian_awal_perina.riwayat_psiko_tinggal,"+
                    "penilaian_awal_perina.riwayat_psiko_tinggal_keterangan,penilaian_awal_perina.riwayat_psiko_nilai_kepercayaan,penilaian_awal_perina.riwayat_psiko_nilai_kepercayaan_keterangan,"+
                    "penilaian_awal_perina.riwayat_psiko_pendidikan_pj,penilaian_awal_perina.riwayat_psiko_edukasi_diberikan,penilaian_awal_perina.riwayat_psiko_edukasi_diberikan_keterangan,"+
                    "penilaian_awal_perina.penilaian_nyeri,penilaian_awal_perina.penilaian_nyeri_penyebab,penilaian_awal_perina.penilaian_nyeri_ket_penyebab,penilaian_awal_perina.penilaian_nyeri_kualitas,"+
                    "penilaian_awal_perina.penilaian_nyeri_ket_kualitas,penilaian_awal_perina.penilaian_nyeri_lokasi,penilaian_awal_perina.penilaian_nyeri_menyebar,penilaian_awal_perina.penilaian_nyeri_skala,"+
                    "penilaian_awal_perina.penilaian_nyeri_waktu,penilaian_awal_perina.penilaian_nyeri_hilang,penilaian_awal_perina.penilaian_nyeri_ket_hilang,penilaian_awal_perina.penilaian_nyeri_diberitahukan_dokter,"+
                    "penilaian_awal_perina.penilaian_nyeri_jam_diberitahukan_dokter,penilaian_awal_perina.penilaian_jatuhmorse_skala1,penilaian_awal_perina.penilaian_jatuhmorse_nilai1,"+
                    "penilaian_awal_perina.penilaian_jatuhmorse_skala2,penilaian_awal_perina.penilaian_jatuhmorse_nilai2,penilaian_awal_perina.penilaian_jatuhmorse_skala3,"+
                    "penilaian_awal_perina.penilaian_jatuhmorse_nilai3,penilaian_awal_perina.penilaian_jatuhmorse_skala4,penilaian_awal_perina.penilaian_jatuhmorse_nilai4,"+
                    "penilaian_awal_perina.penilaian_jatuhmorse_skala5,penilaian_awal_perina.penilaian_jatuhmorse_nilai5,"+
                    "penilaian_awal_perina.penilaian_jatuhmorse_totalnilai,penilaian_awal_perina.penilaian_jatuhsydney_skala1,"+
                    "penilaian_awal_perina.penilaian_jatuhsydney_nilai1,penilaian_awal_perina.penilaian_jatuhsydney_skala2,penilaian_awal_perina.penilaian_jatuhsydney_nilai2,"+
                    "penilaian_awal_perina.penilaian_jatuhsydney_skala3,penilaian_awal_perina.penilaian_jatuhsydney_nilai3,penilaian_awal_perina.penilaian_jatuhsydney_skala4,"+
                    "penilaian_awal_perina.penilaian_jatuhsydney_nilai4,penilaian_awal_perina.penilaian_jatuhsydney_skala5,penilaian_awal_perina.penilaian_jatuhsydney_nilai5,"+
                    "penilaian_awal_perina.penilaian_jatuhsydney_skala6,penilaian_awal_perina.penilaian_jatuhsydney_nilai6,penilaian_awal_perina.penilaian_jatuhsydney_skala7,"+
                    "penilaian_awal_perina.penilaian_jatuhsydney_nilai7,"+
                    "penilaian_awal_perina.penilaian_jatuhsydney_totalnilai,penilaian_awal_perina.skrining_gizi1,penilaian_awal_perina.nilai_gizi1,penilaian_awal_perina.skrining_gizi2,"+
                    "penilaian_awal_perina.nilai_gizi2,penilaian_awal_perina.nilai_total_gizi,penilaian_awal_perina.skrining_gizi_diagnosa_khusus,penilaian_awal_perina.skrining_gizi_ket_diagnosa_khusus,"+
                    "penilaian_awal_perina.skrining_gizi_diketahui_dietisen,penilaian_awal_perina.skrining_gizi_jam_diketahui_dietisen,penilaian_awal_perina.rencana,penilaian_awal_perina.nip1,"+
                    "penilaian_awal_perina.nip2,penilaian_awal_perina.kd_dokter,pasien.tgl_lahir,pasien.jk,pengkaji1.nama as pengkaji1,pengkaji2.nama as pengkaji2,dokter.nm_dokter,"+
                    ...
                    "inner join penilaian_awal_perina on reg_periksa.no_rawat=penilaian_awal_perina.no_rawat "+
                    "inner join petugas as pengkaji1 on penilaian_awal_perina.nip1=pengkaji1.nip "+
                    "inner join petugas as pengkaji2 on penilaian_awal_perina.nip2=pengkaji2.nip "+
                    "inner join dokter on penilaian_awal_perina.kd_dokter=dokter.kd_dokter "+
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalPerina.jasper","report","::[ Laporan Penilaian Awal Perina ]::",
                "select penilaian_awal_perina.no_rawat,penilaian_awal_perina.tanggal,penilaian_awal_perina.informasi,penilaian_awal_perina.ket_informasi,penilaian_awal_perina.tiba_diruang_rawat,"+
                "penilaian_awal_perina.kasus_trauma,penilaian_awal_perina.cara_masuk,penilaian_awal_perina.rps,penilaian_awal_perina.rpd,penilaian_awal_perina.rpk,penilaian_awal_perina.rpo,"+
                "penilaian_awal_perina.riwayat_pembedahan,penilaian_awal_perina.riwayat_dirawat_dirs,penilaian_awal_perina.alat_bantu_dipakai,penilaian_awal_perina.riwayat_kehamilan,"+
                "penilaian_awal_perina.riwayat_kehamilan_perkiraan,penilaian_awal_perina.riwayat_tranfusi,penilaian_awal_perina.riwayat_alergi,penilaian_awal_perina.riwayat_merokok,"+
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalPerina2.jasper","report","::[ Laporan Penilaian Awal Perina ]::",
                "select penilaian_awal_perina.no_rawat,penilaian_awal_perina.tanggal,penilaian_awal_perina.informasi,penilaian_awal_perina.ket_informasi,penilaian_awal_perina.tiba_diruang_rawat,"+
                "penilaian_awal_perina.kasus_trauma,penilaian_awal_perina.cara_masuk,penilaian_awal_perina.rps,penilaian_awal_perina.rpd,penilaian_awal_perina.rpk,penilaian_awal_perina.rpo,"+
                "penilaian_awal_perina.riwayat_pembedahan,penilaian_awal_perina.riwayat_dirawat_dirs,penilaian_awal_perina.alat_bantu_dipakai,penilaian_awal_perina.riwayat_kehamilan,"+
                "penilaian_awal_perina.riwayat_kehamilan_perkiraan,penilaian_awal_perina.riwayat_tranfusi,penilaian_awal_perina.riwayat_alergi,penilaian_awal_perina.riwayat_merokok,"+
...
//        Valid.pindah(evt,SkalaSydney11,SkalaGizi2);
    ...
    private void Apgar_scoreKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Apgar_scoreKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Apgar_scoreKeyPressed

    private void Lingkar_kepalaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Lingkar_kepalaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Lingkar_kepalaKeyPressed

    private void Lingkar_dadaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Lingkar_dadaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Lingkar_dadaKeyPressed

    private void Lingkar_perutKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Lingkar_perutKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Lingkar_perutKeyPressed

    private void Lingkar_lenganKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Lingkar_lenganKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Lingkar_lenganKeyPressed
    ...
    private void Refleks_moroKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Refleks_moroKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Refleks_moroKeyPressed

    private void Refleks_genggamKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Refleks_genggamKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Refleks_genggamKeyPressed

    private void Refleks_rootingKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Refleks_rootingKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Refleks_rootingKeyPressed

    private void Refleks_hisapKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Refleks_hisapKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Refleks_hisapKeyPressed

    private void LabioKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LabioKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_LabioKeyPressed

    private void Cara_minumKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Cara_minumKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Cara_minumKeyPressed
    ...
    private void Mata_secretKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Mata_secretKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Mata_secretKeyPressed

    private void Tali_pusatKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Tali_pusatKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Tali_pusatKeyPressed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalPerina dialog = new RMPenilaianAwalPerina(new javax.swing.JFrame(), true);
    ...
    private widget.TextBox Apgar_score;
    ...
    private widget.ComboBox Cara_minum;
    ...
    private widget.ComboBox Labio;
    private widget.TextBox Lingkar_dada;
    private widget.TextBox Lingkar_kepala;
    private widget.TextBox Lingkar_lengan;
    private widget.TextBox Lingkar_perut;
    private widget.TextBox Lokasi;
    private widget.ComboBox MacamKasus;
    private widget.ComboBox Mata_secret;
    ...
    private widget.ComboBox Refleks_genggam;
    private widget.ComboBox Refleks_hisap;
    private widget.ComboBox Refleks_moro;
    private widget.ComboBox Refleks_rooting;
    ...
    private widget.ComboBox Tali_pusat;
    private widget.ComboBox Tangis;
        ...
        try{
            ps=koneksi.prepareStatement(
              "select penilaian_awal_perina.no_rawat,penilaian_awal_perina.tanggal,penilaian_awal_perina.informasi,penilaian_awal_perina.ket_informasi,penilaian_awal_perina.tiba_diruang_rawat,"+
                ...
                "penilaian_awal_perina.penilaian_jatuhsydney_totalnilai,penilaian_awal_perina.skrining_gizi1,penilaian_awal_perina.nilai_gizi1,penilaian_awal_perina.skrining_gizi2,"+
                "penilaian_awal_perina.nilai_gizi2,penilaian_awal_perina.nilai_total_gizi,penilaian_awal_perina.skrining_gizi_diagnosa_khusus,penilaian_awal_perina.skrining_gizi_ket_diagnosa_khusus,"+
                "penilaian_awal_perina.skrining_gizi_diketahui_dietisen,penilaian_awal_perina.skrining_gizi_jam_diketahui_dietisen,penilaian_awal_perina.rencana,penilaian_awal_perina.nip1,penilaian_awal_perina.apgar_score,lingkar_kepala,lingkar_dada,lingkar_perut,lingkar_lengan,tangis,gerakan,refleks_moro,refleks_genggam,refleks_rooting,refleks_hisap,labio,cara_minum,suhu_tubuh,kepala,mata_secret,tali_pusat,"+
                "penilaian_awal_perina.nip2,penilaian_awal_perina.kd_dokter,pasien.tgl_lahir,pasien.jk,pengkaji1.nama as pengkaji1,pengkaji2.nama as pengkaji2,dokter.nm_dokter,"+
                "reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.agama,pasien.pekerjaan,pasien.pnd,penjab.png_jawab,bahasa_pasien.nama_bahasa "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_awal_perina on reg_periksa.no_rawat=penilaian_awal_perina.no_rawat "+
                ...
                "inner join bahasa_pasien on bahasa_pasien.id=pasien.bahasa_pasien "+
                "inner join penjab on penjab.kd_pj=reg_periksa.kd_pj where "+
                "penilaian_awal_perina.tanggal between ? and ? "+
                (TCari.getText().trim().equals("")?"":"and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_awal_perina.nip1 like ? or "+
                "pengkaji1.nama like ? or penilaian_awal_perina.kd_dokter like ? or dokter.nm_dokter like ?)")+
                " order by penilaian_awal_perina.tanggal");
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("penilaian_jatuhmorse_skala5"),rs.getString("penilaian_jatuhmorse_nilai5"),
                        ...
                        rs.getString("rencana"),rs.getString("apgar_score"),rs.getString("lingkar_kepala"),rs.getString("lingkar_dada"),rs.getString("lingkar_perut"),rs.getString("lingkar_lengan"),
                        rs.getString("tangis"),rs.getString("gerakan"),rs.getString("refleks_moro"),rs.getString("refleks_genggam"),rs.getString("refleks_rooting"),rs.getString("refleks_hisap"),rs.getString("labio"),rs.getString("cara_minum"),
                        rs.getString("suhu_tubuh"),rs.getString("kepala"),rs.getString("mata_secret"),rs.getString("tali_pusat")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
...
//            NilaiResiko6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),140).toString());
            NilaiResikoTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),139).toString());
            isTotalResikoJatuh();
            SkalaSydney1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),140).toString());
            NilaiSydney1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),141).toString());
            SkalaSydney2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),142).toString());
            NilaiSydney2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),143).toString());
            SkalaSydney3.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),144).toString());
            NilaiSydney3.setText(tbObat.getValueAt(tbObat.getSelectedRow(),145).toString());
            SkalaSydney4.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),146).toString());
            NilaiSydney4.setText(tbObat.getValueAt(tbObat.getSelectedRow(),147).toString());
            SkalaSydney5.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),148).toString());
            NilaiSydney5.setText(tbObat.getValueAt(tbObat.getSelectedRow(),149).toString());
            SkalaSydney6.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),150).toString());
            NilaiSydney6.setText(tbObat.getValueAt(tbObat.getSelectedRow(),151).toString());
            SkalaSydney7.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),152).toString());
            NilaiSydney7.setText(tbObat.getValueAt(tbObat.getSelectedRow(),153).toString());
//            SkalaSydney8.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),154).toString());
//            NilaiSydney8.setText(tbObat.getValueAt(tbObat.getSelectedRow(),155).toString());
//            SkalaSydney9.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),156).toString());
//            NilaiSydney9.setText(tbObat.getValueAt(tbObat.getSelectedRow(),157).toString());
//            SkalaSydney10.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),158).toString());
//            NilaiSydney10.setText(tbObat.getValueAt(tbObat.getSelectedRow(),159).toString());
//            SkalaSydney11.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),160).toString());
//            NilaiSydney11.setText(tbObat.getValueAt(tbObat.getSelectedRow(),161).toString());
            NilaiSydneyTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),154).toString());
            isTotalResikoSydney();
            SkalaGizi1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),155).toString());
            NilaiGizi1.setText(tbObat.getValueAt(tbObat.getSelectedRow(),156).toString());
            SkalaGizi2.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),157).toString());
            NilaiGizi2.setText(tbObat.getValueAt(tbObat.getSelectedRow(),158).toString());
            NilaiGiziTotal.setText(tbObat.getValueAt(tbObat.getSelectedRow(),159).toString());
            DiagnosaKhususGizi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),160).toString());
            KeteranganDiagnosaKhususGizi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),161).toString());
            DiketahuiDietisen.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),162).toString());
            KeteranganDiketahuiDietisen.setText(tbObat.getValueAt(tbObat.getSelectedRow(),163).toString());
            Rencana.setText(tbObat.getValueAt(tbObat.getSelectedRow(),164).toString());
            Apgar_score.setText(tbObat.getValueAt(tbObat.getSelectedRow(),165).toString());  
            Lingkar_kepala.setText(tbObat.getValueAt(tbObat.getSelectedRow(),166).toString()); 
            Lingkar_dada.setText(tbObat.getValueAt(tbObat.getSelectedRow(),167).toString());  
            Lingkar_perut.setText(tbObat.getValueAt(tbObat.getSelectedRow(),168).toString());  
            Lingkar_lengan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),169).toString());  
            Tangis.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),170).toString());
            Gerakan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),171).toString());
            Refleks_moro.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),172).toString());
            Refleks_genggam.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),173).toString());
            Refleks_rooting.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),174).toString());
            Refleks_hisap.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),175).toString());
            Labio.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),176).toString());
            Cara_minum.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),177).toString());
            Suhu_tubuh.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),178).toString());
            Kepala.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),179).toString());
            Mata_secret.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),180).toString());
            Tali_pusat.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),181).toString());
            try {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_awal_perina where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_awal_perina","no_rawat=?","no_rawat=?,tanggal=?,informasi=?,ket_informasi=?,tiba_diruang_rawat=?,kasus_trauma=?,cara_masuk=?,rps=?,rpd=?,rpk=?,rpo=?,riwayat_pembedahan=?,riwayat_dirawat_dirs=?,alat_bantu_dipakai=?,riwayat_kehamilan=?,riwayat_kehamilan_perkiraan=?,riwayat_tranfusi=?,riwayat_alergi=?,riwayat_merokok=?,riwayat_merokok_jumlah=?,riwayat_alkohol=?,riwayat_alkohol_jumlah=?,riwayat_narkoba=?,riwayat_olahraga=?,pemeriksaan_mental=?,pemeriksaan_keadaan_umum=?,pemeriksaan_gcs=?,pemeriksaan_td=?,pemeriksaan_nadi=?,pemeriksaan_rr=?,pemeriksaan_suhu=?,pemeriksaan_spo2=?,pemeriksaan_bb=?,pemeriksaan_tb=?,pemeriksaan_susunan_kepala=?,pemeriksaan_susunan_kepala_keterangan=?,pemeriksaan_susunan_wajah=?,pemeriksaan_susunan_wajah_keterangan=?,pemeriksaan_susunan_leher=?,pemeriksaan_susunan_kejang=?,pemeriksaan_susunan_kejang_keterangan=?,pemeriksaan_susunan_sensorik=?,pemeriksaan_kardiovaskuler_denyut_nadi=?,pemeriksaan_kardiovaskuler_sirkulasi=?,pemeriksaan_kardiovaskuler_sirkulasi_keterangan=?,pemeriksaan_kardiovaskuler_pulsasi=?,pemeriksaan_respirasi_pola_nafas=?,pemeriksaan_respirasi_retraksi=?,pemeriksaan_respirasi_suara_nafas=?,pemeriksaan_respirasi_volume_pernafasan=?,pemeriksaan_respirasi_jenis_pernafasan=?,pemeriksaan_respirasi_jenis_pernafasan_keterangan=?,pemeriksaan_respirasi_irama_nafas=?,pemeriksaan_respirasi_batuk=?,pemeriksaan_gastrointestinal_mulut=?,pemeriksaan_gastrointestinal_mulut_keterangan=?,pemeriksaan_gastrointestinal_gigi=?,pemeriksaan_gastrointestinal_gigi_keterangan=?,pemeriksaan_gastrointestinal_lidah=?,pemeriksaan_gastrointestinal_lidah_keterangan=?,pemeriksaan_gastrointestinal_tenggorokan=?,pemeriksaan_gastrointestinal_tenggorokan_keterangan=?,pemeriksaan_gastrointestinal_abdomen=?,pemeriksaan_gastrointestinal_abdomen_keterangan=?,pemeriksaan_gastrointestinal_peistatik_usus=?,pemeriksaan_gastrointestinal_anus=?,pemeriksaan_neurologi_pengelihatan=?,pemeriksaan_neurologi_pengelihatan_keterangan=?,pemeriksaan_neurologi_alat_bantu_penglihatan=?,pemeriksaan_neurologi_pendengaran=?,pemeriksaan_neurologi_bicara=?,pemeriksaan_neurologi_bicara_keterangan=?,pemeriksaan_neurologi_sensorik=?,pemeriksaan_neurologi_motorik=?,pemeriksaan_neurologi_kekuatan_otot=?,pemeriksaan_integument_warnakulit=?,pemeriksaan_integument_turgor=?,pemeriksaan_integument_kulit=?,pemeriksaan_integument_dekubitas=?,pemeriksaan_muskuloskletal_pergerakan_sendi=?,pemeriksaan_muskuloskletal_kekauatan_otot=?,pemeriksaan_muskuloskletal_nyeri_sendi=?,pemeriksaan_muskuloskletal_nyeri_sendi_keterangan=?,pemeriksaan_muskuloskletal_oedema=?,pemeriksaan_muskuloskletal_oedema_keterangan=?,pemeriksaan_muskuloskletal_fraktur=?,pemeriksaan_muskuloskletal_fraktur_keterangan=?,pemeriksaan_eliminasi_bab_frekuensi_jumlah=?,pemeriksaan_eliminasi_bab_frekuensi_durasi=?,pemeriksaan_eliminasi_bab_konsistensi=?,pemeriksaan_eliminasi_bab_warna=?,pemeriksaan_eliminasi_bak_frekuensi_jumlah=?,pemeriksaan_eliminasi_bak_frekuensi_durasi=?,pemeriksaan_eliminasi_bak_warna=?,pemeriksaan_eliminasi_bak_lainlain=?,pola_aktifitas_makanminum=?,pola_aktifitas_mandi=?,pola_aktifitas_eliminasi=?,pola_aktifitas_berpakaian=?,pola_aktifitas_berpindah=?,pola_nutrisi_frekuesi_makan=?,pola_nutrisi_jenis_makanan=?,pola_nutrisi_porsi_makan=?,pola_tidur_lama_tidur=?,pola_tidur_gangguan=?,pengkajian_fungsi_kemampuan_sehari=?,pengkajian_fungsi_aktifitas=?,pengkajian_fungsi_berjalan=?,pengkajian_fungsi_berjalan_keterangan=?,pengkajian_fungsi_ambulasi=?,pengkajian_fungsi_ekstrimitas_atas=?,pengkajian_fungsi_ekstrimitas_atas_keterangan=?,pengkajian_fungsi_ekstrimitas_bawah=?,pengkajian_fungsi_ekstrimitas_bawah_keterangan=?,pengkajian_fungsi_menggenggam=?,pengkajian_fungsi_menggenggam_keterangan=?,pengkajian_fungsi_koordinasi=?,pengkajian_fungsi_koordinasi_keterangan=?,pengkajian_fungsi_kesimpulan=?,riwayat_psiko_kondisi_psiko=?,riwayat_psiko_gangguan_jiwa=?,riwayat_psiko_perilaku=?,riwayat_psiko_perilaku_keterangan=?,riwayat_psiko_hubungan_keluarga=?,riwayat_psiko_tinggal=?,riwayat_psiko_tinggal_keterangan=?,riwayat_psiko_nilai_kepercayaan=?,riwayat_psiko_nilai_kepercayaan_keterangan=?,riwayat_psiko_pendidikan_pj=?,riwayat_psiko_edukasi_diberikan=?,riwayat_psiko_edukasi_diberikan_keterangan=?,penilaian_nyeri=?,penilaian_nyeri_penyebab=?,penilaian_nyeri_ket_penyebab=?,penilaian_nyeri_kualitas=?,penilaian_nyeri_ket_kualitas=?,penilaian_nyeri_lokasi=?,penilaian_nyeri_menyebar=?,penilaian_nyeri_skala=?,penilaian_nyeri_waktu=?,penilaian_nyeri_hilang=?,penilaian_nyeri_ket_hilang=?,penilaian_nyeri_diberitahukan_dokter=?,penilaian_nyeri_jam_diberitahukan_dokter=?,penilaian_jatuhmorse_skala1=?,penilaian_jatuhmorse_nilai1=?,penilaian_jatuhmorse_skala2=?,penilaian_jatuhmorse_nilai2=?,penilaian_jatuhmorse_skala3=?,penilaian_jatuhmorse_nilai3=?,penilaian_jatuhmorse_skala4=?,penilaian_jatuhmorse_nilai4=?,penilaian_jatuhmorse_skala5=?,penilaian_jatuhmorse_nilai5=?,penilaian_jatuhmorse_totalnilai=?,penilaian_jatuhsydney_skala1=?,penilaian_jatuhsydney_nilai1=?,penilaian_jatuhsydney_skala2=?,penilaian_jatuhsydney_nilai2=?,penilaian_jatuhsydney_skala3=?,penilaian_jatuhsydney_nilai3=?,penilaian_jatuhsydney_skala4=?,penilaian_jatuhsydney_nilai4=?,penilaian_jatuhsydney_skala5=?,penilaian_jatuhsydney_nilai5=?,penilaian_jatuhsydney_skala6=?,penilaian_jatuhsydney_nilai6=?,penilaian_jatuhsydney_skala7=?,penilaian_jatuhsydney_nilai7=?,penilaian_jatuhsydney_totalnilai=?,skrining_gizi1=?,nilai_gizi1=?,skrining_gizi2=?,nilai_gizi2=?,nilai_total_gizi=?,skrining_gizi_diagnosa_khusus=?,skrining_gizi_ket_diagnosa_khusus=?,skrining_gizi_diketahui_dietisen=?,skrining_gizi_jam_diketahui_dietisen=?,rencana=?,apgar_score=?,lingkar_kepala=?,lingkar_dada=?,lingkar_perut=?,lingkar_lengan=?,tangis=?,gerakan=?,refleks_moro=?,refleks_genggam=?,refleks_rooting=?,refleks_hisap=?,labio=?,cara_minum=?,nip1=?,nip2=?,kd_dokter=?",197,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),Anamnesis.getSelectedItem().toString(),KetAnamnesis.getText(),TibadiRuang.getSelectedItem().toString(),MacamKasus.getSelectedItem().toString(), 
                    ...
                    SkalaSydney3.getSelectedItem().toString(),NilaiSydney3.getText(),SkalaSydney4.getSelectedItem().toString(),NilaiSydney4.getText(),SkalaSydney5.getSelectedItem().toString(),NilaiSydney5.getText(),SkalaSydney6.getSelectedItem().toString(),NilaiSydney6.getText(), 
                    SkalaSydney7.getSelectedItem().toString(),NilaiSydney7.getText(),NilaiSydneyTotal.getText(),SkalaGizi1.getSelectedItem().toString(),NilaiGizi1.getText(),SkalaGizi2.getSelectedItem().toString(),NilaiGizi2.getText(),NilaiGiziTotal.getText(),DiagnosaKhususGizi.getSelectedItem().toString(),
                    KeteranganDiagnosaKhususGizi.getText(),DiketahuiDietisen.getSelectedItem().toString(),KeteranganDiketahuiDietisen.getText(),Rencana.getText(),Apgar_score.getText(),Lingkar_kepala.getText(),Lingkar_dada.getText(),Lingkar_perut.getText(),Lingkar_lengan.getText(),Tangis.getSelectedItem().toString(),Gerakan.getSelectedItem().toString(),Refleks_moro.getSelectedItem().toString(),Refleks_genggam.getSelectedItem().toString(),Refleks_rooting.getSelectedItem().toString(),Refleks_hisap.getSelectedItem().toString(),Labio.getSelectedItem().toString(),Cara_minum.getSelectedItem().toString(),KdPetugas.getText(),KdPetugas2.getText(),KdDPJP.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
             })==true){
...
//            TingkatResiko.setText("Tingkat Resiko : Risiko Rendah (0-24), Tindakan : Intervensi pencegahan risiko jatuh standar");
    ...
    private void isTotalResikoSydney() {
        try {
            NilaiSydneyTotal.setText((Integer.parseInt(NilaiSydney1.getText())+Integer.parseInt(NilaiSydney2.getText())+Integer.parseInt(NilaiSydney3.getText())+Integer.parseInt(NilaiSydney4.getText())+Integer.parseInt(NilaiSydney5.getText())+Integer.parseInt(NilaiSydney6.getText())+Integer.parseInt(NilaiSydney7.getText()))+"");
            if(Integer.parseInt(NilaiSydneyTotal.getText())<12){
                TingkatSydney.setText("Tingkat Resiko : Risiko Rendah (7-11), Tindakan : Intervensi pencegahan risiko jatuh standar");
            }else if(Integer.parseInt(NilaiSydneyTotal.getText())<7){
                TingkatSydney.setText("Tingkat Resiko : Risiko Rendah (0-7), Tindakan : Intervensi pencegahan risiko jatuh standar");
            }
        } catch (Exception e) {
