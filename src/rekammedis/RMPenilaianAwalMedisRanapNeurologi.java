 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapNeurologi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapNeurologi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            public void windowClosed(WindowEvent e) {
                for (i = 0; i < carilaborat.getTable().getRowCount(); i++) {
                    if(carilaborat.getTable().getValueAt(i,0).toString().equals("true")){
                        Lab.append(carilaborat.getTable().getValueAt(i,3).toString()+", ");
                    }
                }
                Lab.requestFocus();
            }
        ...
        cariradiologi.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariradiologi.getTable().getSelectedRow()!= -1){
                    Rad.append(cariradiologi.getTable().getValueAt(cariradiologi.getTable().getSelectedRow(),2).toString()+", ");
                    Rad.requestFocus();
                }
            }
            @Override
            ...
            public void windowClosed(WindowEvent e) {
                for (i = 0; i < cariobat.getTable().getRowCount(); i++) {
                    if(cariobat.getTable().getValueAt(i,0).toString().equals("true")){
                        RPO.append(cariobat.getTable().getValueAt(i,3).toString()+", ");
                    }
                }
                RPO.requestFocus();
            }
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Neurologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(870, 1053));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "11-08-2026 12:31:23" }));
        ...
        scrollPane12.setBounds(644, 540, 210, 63);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("Penunjang Lainnya :");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(650, 520, 190, 23);
        ...
        scrollPane9.setBounds(44, 540, 250, 63);
        ...
        jLabel81.setBounds(360, 520, 150, 23);
        ...
        scrollPane10.setBounds(359, 540, 220, 63);
        ...
        scrollPane17.setBounds(450, 740, 400, 130);

        jLabel108.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel108.setText("Terapi/Pengobatan :");
        jLabel108.setName("jLabel108"); // NOI18N
        FormInput.add(jLabel108);
        jLabel108.setBounds(450, 720, 190, 20);
        ...
        scrollPane20.setBounds(44, 740, 400, 130);
        ...
        scrollPane19.setBounds(44, 900, 810, 40);

        jLabel113.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel113.setText("Tindakan/Rencana Tindakan :");
        jLabel113.setName("jLabel113"); // NOI18N
        FormInput.add(jLabel113);
        jLabel113.setBounds(40, 880, 320, 20);
        ...
        scrollPane14.setBounds(44, 980, 810, 70);
        ...
        BtnDokter2.setBounds(90, 110, 28, 23);
        ...
        BtnDokter3.setBounds(10, 560, 28, 23);
        ...
        BtnDokter4.setBounds(330, 560, 28, 23);
        ...
        BtnDokter5.setBounds(150, 190, 28, 23);
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_neurologi.tanggal,"+
                        "penilaian_medis_ranap_neurologi.kd_dokter,penilaian_medis_ranap_neurologi.anamnesis,penilaian_medis_ranap_neurologi.hubungan,penilaian_medis_ranap_neurologi.keluhan_utama,"+
                        "penilaian_medis_ranap_neurologi.rps,penilaian_medis_ranap_neurologi.rpd,penilaian_medis_ranap_neurologi.rpo,penilaian_medis_ranap_neurologi.alergi,penilaian_medis_ranap_neurologi.kesadaran,"+
                        "penilaian_medis_ranap_neurologi.status,penilaian_medis_ranap_neurologi.td,penilaian_medis_ranap_neurologi.nadi,penilaian_medis_ranap_neurologi.suhu,penilaian_medis_ranap_neurologi.rr,"+
                        "penilaian_medis_ranap_neurologi.bb,penilaian_medis_ranap_neurologi.nyeri,penilaian_medis_ranap_neurologi.gcs,penilaian_medis_ranap_neurologi.kepala,penilaian_medis_ranap_neurologi.keterangan_kepala,"+
                        "penilaian_medis_ranap_neurologi.thoraks,penilaian_medis_ranap_neurologi.keterangan_thoraks,penilaian_medis_ranap_neurologi.abdomen,penilaian_medis_ranap_neurologi.keterangan_abdomen,"+
                        "penilaian_medis_ranap_neurologi.ekstremitas,penilaian_medis_ranap_neurologi.keterangan_ekstremitas,penilaian_medis_ranap_neurologi.columna,penilaian_medis_ranap_neurologi.keterangan_columna,"+
                        "penilaian_medis_ranap_neurologi.muskulos,penilaian_medis_ranap_neurologi.keterangan_muskulos,penilaian_medis_ranap_neurologi.lainnya,penilaian_medis_ranap_neurologi.lab,"+
                        "penilaian_medis_ranap_neurologi.rad,penilaian_medis_ranap_neurologi.penunjanglain,penilaian_medis_ranap_neurologi.diagnosis,penilaian_medis_ranap_neurologi.diagnosis2,"+
                        "penilaian_medis_ranap_neurologi.permasalahan,penilaian_medis_ranap_neurologi.terapi,penilaian_medis_ranap_neurologi.tindakan,penilaian_medis_ranap_neurologi.edukasi,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_neurologi on reg_periksa.no_rawat=penilaian_medis_ranap_neurologi.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_neurologi.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_neurologi.tanggal between ? and ? order by penilaian_medis_ranap_neurologi.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_neurologi.tanggal,"+
                        "penilaian_medis_ranap_neurologi.kd_dokter,penilaian_medis_ranap_neurologi.anamnesis,penilaian_medis_ranap_neurologi.hubungan,penilaian_medis_ranap_neurologi.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_neurologi on reg_periksa.no_rawat=penilaian_medis_ranap_neurologi.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_neurologi.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_neurologi.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_neurologi.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_neurologi.tanggal");
                }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapNeurologi.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Neurologi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_neurologi.tanggal,"+
                "penilaian_medis_ranap_neurologi.kd_dokter,penilaian_medis_ranap_neurologi.anamnesis,penilaian_medis_ranap_neurologi.hubungan,penilaian_medis_ranap_neurologi.keluhan_utama,"+
                "penilaian_medis_ranap_neurologi.rps,penilaian_medis_ranap_neurologi.rpd,penilaian_medis_ranap_neurologi.rpo,penilaian_medis_ranap_neurologi.alergi,penilaian_medis_ranap_neurologi.kesadaran,"+
                "penilaian_medis_ranap_neurologi.status,penilaian_medis_ranap_neurologi.td,penilaian_medis_ranap_neurologi.nadi,penilaian_medis_ranap_neurologi.suhu,penilaian_medis_ranap_neurologi.rr,"+
                ...
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_neurologi on reg_periksa.no_rawat=penilaian_medis_ranap_neurologi.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_neurologi.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_neurologi.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapNeurologi dialog = new RMPenilaianAwalMedisRanapNeurologi(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_neurologi());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_neurologi());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_neurologi());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_neurologi where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_neurologi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,gcs=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ranap_neurologi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",41,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Kesadaran.getSelectedItem().toString(),Status.getSelectedItem().toString(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),BB.getText(),Nyeri.getText(),GCS.getText(),
                Kepala.getSelectedItem().toString(),KeteranganKepala.getText(),Thoraks.getSelectedItem().toString(),KeteranganThoraks.getText(),Abdomen.getSelectedItem().toString(),KeteranganAbdomen.getText(),Ekstremitas.getSelectedItem().toString(),KeteranganEkstremitas.getText(),
                Columna.getSelectedItem().toString(),KeteranganColumna.getText(),Muskulos.getSelectedItem().toString(),KeteranganMusku.getText(),Lainnya.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),
