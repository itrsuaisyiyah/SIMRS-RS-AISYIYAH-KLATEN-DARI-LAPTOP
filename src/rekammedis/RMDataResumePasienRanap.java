...
public final class RMDataResumePasienRanap extends javax.swing.JDialog {
    ...
    public RMDataResumePasienRanap(java.awt.Frame parent, boolean modal) {
        ...
        carikeluhan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(carikeluhan.getTable().getSelectedRow()!= -1){
                    KeluhanUtama.append(carikeluhan.getTable().getValueAt(carikeluhan.getTable().getSelectedRow(),1).toString()+", ");
        ...
        carilaborat.BtnKeluar.addActionListener(new ActionListener(){
            ...
            public void setHasilLaborat(String hasil){
    HasilLaborat.append(hasil);
    HasilLaborat.requestFocus();
}
        });
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode()==KeyEvent.VK_SPACE){
                    if(cariobat.getTable().getSelectedRow()!= -1){
                        cariobatpulang.append(cariobat.getTable().getValueAt(cariobat.getTable().getSelectedRow(),3).toString()+", ");
                        cariobatpulang.requestFocus();
                    }
                }
            }
            @Override
        ...
        /*cariobatpulang.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                int selectedRow = cariobatpulang.getTable().getSelectedRow();
                if (selectedRow != -1) {
                    StringBuilder obatList = new StringBuilder();
                    for (int i = 0; i < cariobatpulang.getTable().getRowCount(); i++) {
                        // Pastikan mengambil nama obat yang benar dari kolom yang diinginkan
                        obatList.append(cariobatpulang.getTable().getValueAt(i, 3).toString()).append(", ");
                    }
                    // Menghilangkan koma dan spasi terakhir jika ada
                    if (obatList.length() > 0) {
                        obatList.setLength(obatList.length() - 2);
                    }
                   cariobatpulang.setText(obatList.toString()); // Menampilkan hasil ke JTextArea
                   cariobatpulang.requestFocus();
                }
            }
    ...
    private void initComponents() {
        ...
        MnLaporanResume1 = new javax.swing.JMenuItem();
        MnLaporanResume2 = new javax.swing.JMenuItem();
        MnLaporanResume3 = new javax.swing.JMenuItem();
        MnLaporanResume4 = new javax.swing.JMenuItem();
        MnLaporanResume5 = new javax.swing.JMenuItem();
        MnLaporanResume6 = new javax.swing.JMenuItem();
        MnLaporanResume7 = new javax.swing.JMenuItem();
        MnLaporanResume8 = new javax.swing.JMenuItem();
        MnLaporanResume9 = new javax.swing.JMenuItem();
        MnLaporanResume10 = new javax.swing.JMenuItem();
        MnLaporanResume11 = new javax.swing.JMenuItem();
        MnLaporanResume12 = new javax.swing.JMenuItem();
        MnLaporanResume13 = new javax.swing.JMenuItem();
        MnLaporanResume14 = new javax.swing.JMenuItem();
        MnLaporanResume15 = new javax.swing.JMenuItem();
        MnLaporanResume16 = new javax.swing.JMenuItem();
        MnLaporanResume17 = new javax.swing.JMenuItem();
        MnLaporanResume18 = new javax.swing.JMenuItem();
        MnLaporanResume19 = new javax.swing.JMenuItem();
        MnLaporanResume20 = new javax.swing.JMenuItem();
        MnLaporanResume21 = new javax.swing.JMenuItem();
        MnLaporanResume22 = new javax.swing.JMenuItem();
        MnLaporanResume23 = new javax.swing.JMenuItem();
        MnLaporanResume24 = new javax.swing.JMenuItem();
        MnLaporanResume25 = new javax.swing.JMenuItem();
        MnLaporanResume26 = new javax.swing.JMenuItem();
        ...
        MnLaporanResume1.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume1.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume1.setText("Laporan Resume dr. Ani Isti, Sp.A");
        MnLaporanResume1.setName("MnLaporanResume1"); // NOI18N
        MnLaporanResume1.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume1ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume1);

        MnLaporanResume2.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume2.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume2.setText("Laporan Resume dr. Samad, Sp.A");
        MnLaporanResume2.setName("MnLaporanResume2"); // NOI18N
        MnLaporanResume2.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume2ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume2);

        MnLaporanResume3.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume3.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume3.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume3.setText("Laporan Resume dr. Nov, Sp.A");
        MnLaporanResume3.setName("MnLaporanResume3"); // NOI18N
        MnLaporanResume3.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume3ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume3);

        MnLaporanResume4.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume4.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume4.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume4.setText("Laporan Resume dr. Ahimsa, Sp.A");
        MnLaporanResume4.setName("MnLaporanResume4"); // NOI18N
        MnLaporanResume4.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume4ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume4);

        MnLaporanResume5.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume5.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume5.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume5.setText("Laporan Resume dr. Usman, Sp.OG");
        MnLaporanResume5.setName("MnLaporanResume5"); // NOI18N
        MnLaporanResume5.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume5ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume5);

        MnLaporanResume6.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume6.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume6.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume6.setText("Laporan Resume dr. Purwanto, Sp.OG");
        MnLaporanResume6.setName("MnLaporanResume6"); // NOI18N
        MnLaporanResume6.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume6ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume6);

        MnLaporanResume7.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume7.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume7.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume7.setText("Laporan Resume dr. Agung, Sp.OG");
        MnLaporanResume7.setName("MnLaporanResume7"); // NOI18N
        MnLaporanResume7.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume7ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume7);

        MnLaporanResume8.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume8.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume8.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume8.setText("Laporan Resume dr. Joko, Sp.OG");
        MnLaporanResume8.setName("MnLaporanResume8"); // NOI18N
        MnLaporanResume8.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume8.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume8ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume8);

        MnLaporanResume9.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume9.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume9.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume9.setText("Laporan Resume dr. Ghea, Sp.PD");
        MnLaporanResume9.setName("MnLaporanResume9"); // NOI18N
        MnLaporanResume9.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume9.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume9ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume9);

        MnLaporanResume10.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume10.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume10.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume10.setText("Laporan Resume dr. Tri, Sp.PD");
        MnLaporanResume10.setName("MnLaporanResume10"); // NOI18N
        MnLaporanResume10.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume10ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume10);

        MnLaporanResume11.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume11.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume11.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume11.setText("Laporan Resume dr. Husam, Sp.PD");
        MnLaporanResume11.setName("MnLaporanResume11"); // NOI18N
        MnLaporanResume11.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume11ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume11);

        MnLaporanResume12.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume12.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume12.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume12.setText("Laporan Resume drg. Nurna");
        MnLaporanResume12.setName("MnLaporanResume12"); // NOI18N
        MnLaporanResume12.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume12.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume12ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume12);

        MnLaporanResume13.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume13.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume13.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume13.setText("Laporan Resume drg. Rezki");
        MnLaporanResume13.setName("MnLaporanResume13"); // NOI18N
        MnLaporanResume13.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume13.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume13ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume13);

        MnLaporanResume14.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume14.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume14.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume14.setText("Laporan Resume dr. Nimas Ayu Suri P, Sp.JP");
        MnLaporanResume14.setName("MnLaporanResume14"); // NOI18N
        MnLaporanResume14.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume14.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume14ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume14);

        MnLaporanResume15.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume15.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume15.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume15.setText("Laporan Resume dr. Mayrovi Dewi Nyuyorike Djati, Sp.KFR");
        MnLaporanResume15.setName("MnLaporanResume15"); // NOI18N
        MnLaporanResume15.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume15.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume15ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume15);

        MnLaporanResume16.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume16.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume16.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume16.setText("Laporan Resume dr. Unun Eka Yunita, Sp.N");
        MnLaporanResume16.setName("MnLaporanResume16"); // NOI18N
        MnLaporanResume16.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume16.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume16ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume16);

        MnLaporanResume17.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume17.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume17.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume17.setText("Laporan Resume dr. Yossy Catharina, Sp.N");
        MnLaporanResume17.setName("MnLaporanResume17"); // NOI18N
        MnLaporanResume17.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume17.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume17ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume17);

        MnLaporanResume18.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume18.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume18.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume18.setText("Laporan Resume dr. Nastiti Lestari, Sp.P, MMR");
        MnLaporanResume18.setName("MnLaporanResume18"); // NOI18N
        MnLaporanResume18.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume18.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume18ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume18);

        MnLaporanResume19.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume19.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume19.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume19.setText("Laporan Resume dr. Hastomo Agung Wibowo, Sp.OT (K)");
        MnLaporanResume19.setName("MnLaporanResume19"); // NOI18N
        MnLaporanResume19.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume19.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume19ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume19);

        MnLaporanResume20.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume20.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume20.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume20.setText("Laporan Resume dr. Juli Purnomo, Sp.P");
        MnLaporanResume20.setName("MnLaporanResume20"); // NOI18N
        MnLaporanResume20.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume20.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume20ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume20);

        MnLaporanResume21.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume21.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume21.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume21.setText("Laporan Resume dr. Riza Setya Agrensa, Sp.B");
        MnLaporanResume21.setName("MnLaporanResume21"); // NOI18N
        MnLaporanResume21.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume21.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume21ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume21);

        MnLaporanResume22.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume22.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume22.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume22.setText("Laporan Resume dr. Saktiaji Hendro Iswoyo. Sp.B");
        MnLaporanResume22.setName("MnLaporanResume22"); // NOI18N
        MnLaporanResume22.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume22.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume22ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume22);

        MnLaporanResume23.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume23.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume23.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume23.setText("Laporan Resume dr. Kusumalaga, Sp.PD");
        MnLaporanResume23.setName("MnLaporanResume23"); // NOI18N
        MnLaporanResume23.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume23.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume23ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume23);

        MnLaporanResume24.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume24.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume24.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume24.setText("Laporan Resume dr. Ardhila,Sp. T.H.T.B.K.L");
        MnLaporanResume24.setName("MnLaporanResume24"); // NOI18N
        MnLaporanResume24.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume24.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume24ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume24);

        MnLaporanResume25.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume25.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume25.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume25.setText("Laporan Resume dr. Prasthiti Dewi H, Sp.M");
        MnLaporanResume25.setName("MnLaporanResume25"); // NOI18N
        MnLaporanResume25.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume25.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume25ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume25);

        MnLaporanResume26.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanResume26.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanResume26.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanResume26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanResume26.setText("Laporan Resume dr. Lukluk Purbaningrum, MPH., Sp.B");
        MnLaporanResume26.setName("MnLaporanResume26"); // NOI18N
        MnLaporanResume26.setPreferredSize(new java.awt.Dimension(220, 26));
        MnLaporanResume26.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanResume26ActionPerformed(evt);
            }
        });
        jPopupMenu1.add(MnLaporanResume26);
        ...
        Kontrol.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "06-08-2026 09:44:34" }));
    ...
    private void BtnDokter3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokter3ActionPerformed
        ...
        if(carilaborat.getHasilDipilih()!=null && !carilaborat.getHasilDipilih().equals("")){
            HasilLaborat.append(
                carilaborat.getHasilDipilih()
            );
            HasilLaborat.requestFocus();
        }
    }
    ...
    private void MnLaporanResume1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume1ActionPerformed
       if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap1.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume1ActionPerformed
           
       
    private void MnLaporanResume2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume2ActionPerformed
       if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap2.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume2ActionPerformed

    private void MnLaporanResume3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume3ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap3.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume3ActionPerformed

    private void MnLaporanResume4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume4ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap4.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume4ActionPerformed

    private void MnLaporanResume5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume5ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap5.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume5ActionPerformed

    private void MnLaporanResume6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume6ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap6.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume6ActionPerformed

    private void MnLaporanResume7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume7ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap7.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume7ActionPerformed

    private void MnLaporanResume8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume8ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap8.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume8ActionPerformed

    private void MnLaporanResume9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume9ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap9.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume9ActionPerformed

    private void MnLaporanResume10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume10ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap10.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume10ActionPerformed

    private void MnLaporanResume11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume11ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap11.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume11ActionPerformed

    private void MnLaporanResume12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume12ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap12.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume12ActionPerformed

    private void MnLaporanResume13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume13ActionPerformed
       if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap13.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume13ActionPerformed

    private void MnLaporanResume14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume14ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap14.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume14ActionPerformed

    private void MnLaporanResume15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume15ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap15.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume15ActionPerformed

    private void MnLaporanResume16ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume16ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap16.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume16ActionPerformed

    private void MnLaporanResume17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume17ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap17.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume17ActionPerformed

    private void MnLaporanResume18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume18ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap18.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume18ActionPerformed

    private void MnLaporanResume19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume19ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap19.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume19ActionPerformed

    private void MnLaporanResume20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume20ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap20.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume20ActionPerformed

    private void MnLaporanResume21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume21ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap21.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume21ActionPerformed

    private void MnLaporanResume22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume22ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap22.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }
    }//GEN-LAST:event_MnLaporanResume22ActionPerformed

    private void MnLaporanResume23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume23ActionPerformed
     if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap23.jasper","report","::[ Laporan Resume Pasien ]::",param);
        }    // TODO add your handling code here:
    }//GEN-LAST:event_MnLaporanResume23ActionPerformed

    private void MnLaporanResume24ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume24ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap24.jasper","report","::[ Laporan Resume Pasien ]::",param);
        // TODO add your handling code here:
    }//GEN-LAST:event_MnLaporanResume24ActionPerformed
    }
    private void MnLaporanResume25ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume25ActionPerformed
        if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap25.jasper","report","::[ Laporan Resume Pasien ]::",param);
        // TODO add your handling code here:
        }
    }//GEN-LAST:event_MnLaporanResume25ActionPerformed

    private void MnLaporanResume26ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanResume26ActionPerformed
    if(tbObat.getSelectedRow()>-1){
            Map<String, Object> param = new HashMap<>();    
            param.put("namars",akses.getnamars());
            param.put("alamatrs",akses.getalamatrs());
            ...
            param.put("tanggalkeluar",Valid.SetTgl3(Keluar.getText()));
            param.put("jamkeluar",JamKeluar.getText());
            Valid.MyReport("rptLaporanResumeRanap26.jasper","report","::[ Laporan Resume Pasien ]::",param);        
// TODO add your handling code here:
    }
    }//GEN-LAST:event_MnLaporanResume26ActionPerformed
    ...
    */
    ...
    public javax.swing.JMenuItem MnLaporanResume1;
    private javax.swing.JMenuItem MnLaporanResume10;
    private javax.swing.JMenuItem MnLaporanResume11;
    private javax.swing.JMenuItem MnLaporanResume12;
    private javax.swing.JMenuItem MnLaporanResume13;
    private javax.swing.JMenuItem MnLaporanResume14;
    private javax.swing.JMenuItem MnLaporanResume15;
    private javax.swing.JMenuItem MnLaporanResume16;
    private javax.swing.JMenuItem MnLaporanResume17;
    private javax.swing.JMenuItem MnLaporanResume18;
    private javax.swing.JMenuItem MnLaporanResume19;
    private javax.swing.JMenuItem MnLaporanResume2;
    private javax.swing.JMenuItem MnLaporanResume20;
    private javax.swing.JMenuItem MnLaporanResume21;
    private javax.swing.JMenuItem MnLaporanResume22;
    private javax.swing.JMenuItem MnLaporanResume23;
    private javax.swing.JMenuItem MnLaporanResume24;
    private javax.swing.JMenuItem MnLaporanResume25;
    private javax.swing.JMenuItem MnLaporanResume26;
    private javax.swing.JMenuItem MnLaporanResume3;
    private javax.swing.JMenuItem MnLaporanResume4;
    private javax.swing.JMenuItem MnLaporanResume5;
    private javax.swing.JMenuItem MnLaporanResume6;
    private javax.swing.JMenuItem MnLaporanResume7;
    private javax.swing.JMenuItem MnLaporanResume8;
    private javax.swing.JMenuItem MnLaporanResume9;
    ...
    // Daftar tabel penilaian medis yang menjadi sumber Keluhan Utama.
    // Dicek satu per satu sesuai urutan; begitu ditemukan tabel yang ada
    // isinya untuk no_rawat tsb, pencarian dihentikan (menyesuaikan mana
    // yang ada isinya, seperti pada isRawat() di DlgRawatJalan.java).
    private static final String[] TABEL_KELUHAN_UTAMA = {
        "penilaian_medis_ranap_anak",
        "penilaian_medis_ranap_bedah",
        "penilaian_medis_ranap_bedah_mulut",
        "penilaian_medis_ranap_geriatri",
        "penilaian_medis_ranap_hemodialisa",
        "penilaian_medis_ranap_icu",
        "penilaian_medis_ranap_jantung",
        "penilaian_medis_ranap_tht",
        "penilaian_medis_ranap_urologi",
        "penilaian_medis_ranap_orthopedi",
        "penilaian_medis_ranap_mata",
        "penilaian_medis_ranap_kulitdankelamin",
        "penilaian_medis_ranap_paru",
        "penilaian_medis_ranap_neurologi",
        "penilaian_medis_ranap_penyakit_dalam",
        "penilaian_medis_ranap_kandungan",
        
        "asesmen_medis_ranap_neonatus"
    };

    private void isiKeluhanUtamaOtomatis() {
        // Tidak menimpa apabila field sudah pernah diisi/dipilih sebelumnya
        // (manual atau lewat dialog pencarian).
        boolean alasanKosong = Alasan.getText().trim().equals("");
        boolean keluhanKosong = KeluhanUtama.getText().trim().equals("");
        if (!alasanKosong && !keluhanKosong) {
            return;
        }

        for (String tabel : TABEL_KELUHAN_UTAMA) {
            try {
                ps = koneksi.prepareStatement(
                        "select keluhan_utama,rps from " + tabel + " " +
                        "where no_rawat=? and " +
                        "((keluhan_utama is not null and keluhan_utama<>'') or (rps is not null and rps<>'')) " +
                        "order by tanggal desc limit 1");
                try {
                    ps.setString(1, TNoRw.getText());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                        String keluhan = rs.getString("keluhan_utama");
                        String rps = rs.getString("rps");
                        keluhan = (keluhan == null) ? "" : keluhan.trim();
                        rps = (rps == null) ? "" : rps.trim();

                        if (!keluhan.equals("") || !rps.equals("")) {
                            // Alasan Masuk Dirawat diambil dari keluhan_utama
                            if (alasanKosong && !keluhan.equals("")) {
                                Alasan.setText(keluhan);
                            }
                            // Keluhan Utama Riwayat Penyakit = gabungan keluhan_utama + rps
                            if (keluhanKosong) {
                                String gabungan;
                                if (!keluhan.equals("") && !rps.equals("")) {
                                    gabungan = keluhan + " - " + rps;
                                } else {
                                    gabungan = keluhan + rps;
                                }
                                KeluhanUtama.setText(gabungan);
                            }
                            return; // sudah ketemu, berhenti tidak perlu cek tabel lain
                        }
                    }
                } catch (Exception ex) {
    ...
    // Mengisi Pemeriksaan Fisik otomatis dari data tanda vital
    // (kesadaran, td, nadi, rr, suhu, spo, bb, tb) di tabel-tabel
    // penilaian_medis_ranap_*, dicek satu per satu sampai ketemu
    // yang ada isinya (pola sama seperti Keluhan Utama).
    private void isiPemeriksaanFisikOtomatis() {
        ...
        for (String tabel : TABEL_KELUHAN_UTAMA) {
            try {
                ps = koneksi.prepareStatement(
                        "select kesadaran,td,nadi,rr,suhu,spo,bb,tb,ket_fisik from " + tabel + " " +
                        "where no_rawat=? and (" +
                        "(kesadaran is not null and kesadaran<>'') or (td is not null and td<>'') or " +
                        "(nadi is not null and nadi<>'') or (rr is not null and rr<>'') or " +
                        "(suhu is not null and suhu<>'') or (spo is not null and spo<>'') or " +
                        "(bb is not null and bb<>'') or (tb is not null and tb<>'') or " +
                        "(ket_fisik is not null and ket_fisik<>'')" +
                        ") order by tanggal desc limit 1");
                try {
                    ps.setString(1, TNoRw.getText());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                        ...
                        String ketFisik = rs.getString("ket_fisik");

                        kesadaran = (kesadaran == null) ? "" : kesadaran.trim();
                        td = (td == null) ? "" : td.trim();
                        nadi = (nadi == null) ? "" : nadi.trim();
                        rr = (rr == null) ? "" : rr.trim();
                        suhu = (suhu == null) ? "" : suhu.trim();
                        spo = (spo == null) ? "" : spo.trim();
                        bb = (bb == null) ? "" : bb.trim();
                        tb = (tb == null) ? "" : tb.trim();
                        ketFisik = (ketFisik == null) ? "" : ketFisik.trim();

                        StringBuilder teks = new StringBuilder();
                        if (!kesadaran.equals("")) {
                            teks.append("Kesadaran: ").append(kesadaran).append(", ");
                        }
                        if (!td.equals("")) {
                            teks.append("TD: ").append(td).append(" mmHg, ");
                        }
                        if (!nadi.equals("")) {
                            teks.append("Nadi: ").append(nadi).append(" x/menit, ");
                        }
                        if (!rr.equals("")) {
                            teks.append("RR: ").append(rr).append(" x/menit, ");
                        }
                        if (!suhu.equals("")) {
                            teks.append("Suhu: ").append(suhu).append(" C, ");
                        }
                        if (!spo.equals("")) {
                            teks.append("SpO2: ").append(spo).append("%, ");
                        }
                        if (!bb.equals("")) {
                            teks.append("BB: ").append(bb).append(" kg, ");
                        }
                        if (!tb.equals("")) {
                            teks.append("TB: ").append(tb).append(" cm, ");
                        }

                        // buang ", " terakhir dari rangkaian data vital
                        if (teks.length() > 1) {
                            teks.setLength(teks.length() - 2);
                        }
                        ...
                        if (!ketFisik.equals("")) {
                            ...
                            teks.append(ketFisik);
                        }

                        if (teks.length() > 0) {
                            PemeriksaanFisik.setText(teks.toString());
                            return; // sudah ketemu, berhenti tidak perlu cek tabel lain
                        }
                    }
                } catch (Exception ex) {
    ...
    // Mengisi Obat-obatan Selama Perawatan otomatis dari kolom
    // tatalaksana (tata) di tabel-tabel penilaian_medis_ranap_*,
    // dicek satu per satu sampai ketemu yang ada isinya.
    private void isiObatSelamaDiRSOtomatis() {
        ...
        for (String tabel : TABEL_KELUHAN_UTAMA) {
            try {
                ps = koneksi.prepareStatement(
                        "select tata from " + tabel + " " +
                        "where no_rawat=? and tata is not null and tata<>'' " +
                        "order by tanggal desc limit 1");
                try {
                    ps.setString(1, TNoRw.getText());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                        String tata = rs.getString("tata");
                        if (tata != null && !tata.trim().equals("")) {
                            ObatSelamaDiRS.setText(tata.trim());
                            return; // sudah ketemu, berhenti tidak perlu cek tabel lain
                        }
                    }
                } catch (Exception ex) {
        ...
        for (String tabel : TABEL_KELUHAN_UTAMA) {
            try {
                ps = koneksi.prepareStatement(
                        "select terapi from " + tabel + " " +
                        "where no_rawat=? and terapi is not null and terapi<>'' " +
                        "order by tanggal desc limit 1");
                try {
                    ps.setString(1, TNoRw.getText());
                    rs = ps.executeQuery();
                    if (rs.next()) {
                        ...
                        if (terapi != null && !terapi.trim().equals("")) {
                            ObatSelamaDiRS.setText(terapi.trim());
                            return; // sudah ketemu, berhenti tidak perlu cek tabel lain
                        }
                    }
                } catch (Exception ex) {
    ...
    public void setNoRm(String norwt, Date tgl2) {
        ...
        isRawat();
        isiKeluhanUtamaOtomatis();
        isiPemeriksaanFisikOtomatis();
        isiObatSelamaDiRSOtomatis();
        ChkInput.setSelected(true);
        isForm();
