 ...
 * @author perpustakaan
 */
public final class RMSkriningIGD extends javax.swing.JDialog {
    ...
    private JTextField JenisKontakTBC;
    private JTextArea AbnormalitasTBC;
    /** Creates new form DlgRujuk
     * @param parent
     * @param modal */
    public RMSkriningIGD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Status Obesitas","Keterangan","Pernah Terdiagnosa TBC","Ket. Pernah Terdiagnosa","Pernah Berobat TBC Tak Tuntas",
            "Malnutrisi","Merokok/Perokok Pasif","Riwayat DM","ODHIV","Lansia > 65 Th","Ibu Hamil","WBP","Tinggal Diwilayah Padat Kumuh"
        }){
        ...
        scrollInput.setViewport(new javax.swing.JViewport());
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Skrining IGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-09-2026" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-09-2026" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(292, 373));
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(202, 557));
        scrollInput.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);

        FormInput.setBackground(new java.awt.Color(250, 255, 245));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(100, 550));
        FormInput.setLayout(null);

        jLabel4.setText("No.Rawat :");
        jLabel4.setName("jLabel4"); // NOI18N
        FormInput.add(jLabel4);
        jLabel4.setBounds(0, 25, 75, 23);
        ...
        TPasien.setBounds(336, 25, 285, 23);

        Tanggal.setForeground(new java.awt.Color(50, 70, 50));
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "01-09-2026" }));
        ...
        FormInput.add(TNoRM);
        TNoRM.setBounds(222, 25, 112, 23);

        jLabel16.setText("Tanggal :");
        jLabel16.setName("jLabel16"); // NOI18N
        jLabel16.setVerifyInputWhenFocusTarget(false);
        FormInput.add(jLabel16);
        jLabel16.setBounds(0, 55, 75, 23);
        ...
        ChkKejadian.setBounds(368, 55, 23, 23);

        jLabel18.setText("Petugas :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(400, 55, 70, 23);
        ...
        KdPetugas.setBounds(474, 55, 94, 23);

        NmPetugas.setEditable(false);
        NmPetugas.setName("NmPetugas"); // NOI18N
        FormInput.add(NmPetugas);
        NmPetugas.setBounds(570, 55, 187, 23);
        ...
        btnPetugas.setBounds(761, 55, 28, 23);

        jLabel8.setText("Tgl.Lahir :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(625, 25, 60, 23);

        TglLahir.setHighlighter(null);
        TglLahir.setName("TglLahir"); // NOI18N
        FormInput.add(TglLahir);
        TglLahir.setBounds(689, 25, 100, 23);
        ...
        FormInput.add(BB);
        BB.setBounds(80, 230, 50, 23);

        jLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel12.setText("BB :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(60, 230, 30, 23);

        jLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel13.setText("Kg");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(140, 230, 40, 23);
        ...
        FormInput.add(TB);
        TB.setBounds(190, 230, 50, 23);

        jLabel25.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel25.setText("Cm");
        jLabel25.setName("jLabel25"); // NOI18N
        FormInput.add(jLabel25);
        jLabel25.setBounds(250, 230, 30, 23);
        ...
        KebiasaanMakanManis.setBounds(390, 105, 60, 23);
        ...
        RisikoLP.setBounds(870, 230, 230, 23);
        ...
        jSeparator1.setBounds(0, 85, 807, 1);

        jLabel99.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel99.setText("I. ANAMNESIS");
        jLabel99.setName("jLabel99"); // NOI18N
        FormInput.add(jLabel99);
        jLabel99.setBounds(10, 85, 200, 23);

        jLabel77.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel77.setText("1.");
        jLabel77.setName("jLabel77"); // NOI18N
        FormInput.add(jLabel77);
        jLabel77.setBounds(80, 105, 20, 23);

        jLabel78.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel78.setText("Batuk berdahak secara terus-menerus lebih dari 2 minggu");
        jLabel78.setName("jLabel78"); // NOI18N
        FormInput.add(jLabel78);
        jLabel78.setBounds(90, 105, 290, 23);

        jLabel92.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel92.setText("Risiko Berdasarkan LP :");
        jLabel92.setName("jLabel92"); // NOI18N
        FormInput.add(jLabel92);
        jLabel92.setBounds(750, 230, 120, 23);

        jLabel79.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel79.setText("2.");
        jLabel79.setName("jLabel79"); // NOI18N
        FormInput.add(jLabel79);
        jLabel79.setBounds(80, 135, 20, 23);

        jLabel80.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel80.setText("Pernah mengalami batuk berdarah (hemoptisis)");
        jLabel80.setName("jLabel80"); // NOI18N
        FormInput.add(jLabel80);
        jLabel80.setBounds(90, 135, 280, 23);
        ...
        AktifitasFisik.setBounds(390, 135, 60, 23);
        ...
        IstirahatCukup.setBounds(390, 165, 60, 23);

        jLabel81.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel81.setText("Mengalami demam hilang-timbul lebih dari 1 bulan");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(90, 165, 280, 23);

        jLabel82.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel82.setText("3.");
        jLabel82.setName("jLabel82"); // NOI18N
        FormInput.add(jLabel82);
        jLabel82.setBounds(80, 165, 20, 23);

        jLabel83.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel83.setText("Berat badan turun drastis tanpa penyebab jelas dalam 2bln terakhir");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(600, 105, 360, 23);

        jLabel84.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel84.setText("4.");
        jLabel84.setName("jLabel84"); // NOI18N
        FormInput.add(jLabel84);
        jLabel84.setBounds(590, 105, 20, 23);

        jLabel85.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel85.setText("Mengeluarkan keringat malam walau tanpa aktifitas fisik");
        jLabel85.setName("jLabel85"); // NOI18N
        FormInput.add(jLabel85);
        jLabel85.setBounds(600, 135, 300, 23);
        ...
        RisikoMerokok.setBounds(930, 105, 60, 23);

        jLabel86.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel86.setText("5.");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(590, 135, 20, 23);

        jLabel87.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel87.setText("6.");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(590, 165, 20, 23);

        jLabel88.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel88.setText("Memiliki riwayat kontak erat dngan pasien terkonfirmasi TB");
        jLabel88.setName("jLabel88"); // NOI18N
        FormInput.add(jLabel88);
        jLabel88.setBounds(600, 165, 290, 23);
        ...
        RiwayatSteroid.setBounds(930, 165, 60, 23);
        ...
        RiwayatKeluarga.setBounds(930, 135, 60, 23);
        ...
        jSeparator2.setBounds(0, 195, 807, 1);

        jLabel100.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel100.setText("III. FAKTOR RESIKO");
        jLabel100.setName("jLabel100"); // NOI18N
        FormInput.add(jLabel100);
        jLabel100.setBounds(10, 280, 490, 23);

        jLabel17.setText("IMT(BB/TB²) :");
        jLabel17.setName("jLabel17"); // NOI18N
        FormInput.add(jLabel17);
        jLabel17.setBounds(280, 230, 80, 23);

        IMT.setEditable(false);
        IMT.setFocusTraversalPolicyProvider(true);
        IMT.setName("IMT"); // NOI18N
        FormInput.add(IMT);
        IMT.setBounds(360, 230, 60, 23);
        ...
        KlasifikasiIMT.setBounds(630, 230, 110, 23);

        jLabel20.setText("Klasifikasi IMT :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(530, 230, 90, 23);

        jLabel22.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel22.setText("Status Skrining :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(40, 510, 100, 23);
        ...
        FormInput.add(LP);
        LP.setBounds(460, 230, 50, 23);

        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel26.setText("Cm");
        jLabel26.setName("jLabel26"); // NOI18N
        FormInput.add(jLabel26);
        jLabel26.setBounds(510, 230, 20, 23);
        ...
        jSeparator3.setBounds(0, 273, 807, 3);

        jLabel101.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel101.setText("IV. INTERPRETASI");
        jLabel101.setName("jLabel101"); // NOI18N
        FormInput.add(jLabel101);
        jLabel101.setBounds(10, 490, 200, 23);
        ...
        StatusObesitas.setBounds(130, 510, 140, 24);

        jLabel93.setText("Keterangan :");
        jLabel93.setName("jLabel93"); // NOI18N
        FormInput.add(jLabel93);
        jLabel93.setBounds(270, 510, 100, 23);
        ...
        Keterangan.setBounds(380, 510, 410, 24);

        jLabel23.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel23.setText("LP :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(440, 230, 30, 23);

        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel24.setText("TB :");
        jLabel24.setName("jLabel24"); // NOI18N
        FormInput.add(jLabel24);
        jLabel24.setBounds(170, 230, 20, 23);

        jLabel102.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel102.setText("II. PEMERIKSAAN FISIK (KLASIFIKASI WHO ASIA PASIFIK, 2020)");
        jLabel102.setName("jLabel102"); // NOI18N
        FormInput.add(jLabel102);
        jLabel102.setBounds(10, 200, 490, 23);

        jLabel89.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel89.setText("Pernah Terdiagnosa / Berobat TBC ?");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(60, 310, 200, 23);

        jLabel95.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel95.setText("Jika Pertanyaan 1 Ya, Kapan ?");
        jLabel95.setName("jLabel95"); // NOI18N
        FormInput.add(jLabel95);
        jLabel95.setBounds(60, 340, 180, 23);

        jLabel90.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel90.setText("Pernah Berobat TBC Tapi Pernah Tidak Tuntas");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(60, 370, 240, 23);

        jLabel91.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel91.setText("Malnutrisi");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(60, 400, 200, 23);

        jLabel94.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel94.setText("Merokok / Perokok Pasif ?");
        jLabel94.setName("jLabel94"); // NOI18N
        FormInput.add(jLabel94);
        jLabel94.setBounds(60, 430, 200, 23);

        jLabel96.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel96.setText("Riwayat DM / Kencing Manis ?");
        jLabel96.setName("jLabel96"); // NOI18N
        FormInput.add(jLabel96);
        jLabel96.setBounds(60, 460, 210, 23);
        ...
        RiwayatDM.setBounds(320, 460, 80, 23);
        ...
        Merokok.setBounds(320, 430, 80, 23);
        ...
        Malnutrisi.setBounds(320, 400, 80, 23);
        ...
        PernahberobatTBC.setBounds(320, 370, 80, 23);

        KetPernahTerdiagnosa.setFocusTraversalPolicyProvider(true);
        KetPernahTerdiagnosa.setName("KetPernahTerdiagnosa"); // NOI18N
        KetPernahTerdiagnosa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                KetPernahTerdiagnosaActionPerformed(evt);
            }
        });
        ...
        KetPernahTerdiagnosa.setBounds(210, 340, 190, 23);
        ...
        Tingaldiwilayahkumuh.setBounds(710, 430, 80, 23);
        ...
        WargaBinaan.setBounds(710, 400, 80, 23);
        ...
        Ibuhamil.setBounds(710, 370, 80, 23);
        ...
        Lansia.setBounds(710, 340, 80, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataSkriningIGD.html");            
                            ...
                            "<table width='1700px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA SEKRINING IGD<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnSkriningObesitasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSkriningObesitasActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirSkriningIGD.jasper","report","::[ Formulir Skrining Obesitas ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,skrining_igd.nip,petugas.nama,skrining_igd.tanggal,"+
                    "skrining_igd.kebiasaan_makan_manis,skrining_igd.aktifitas_fisik_setiap_hari,skrining_igd.istirahat_cukup,skrining_igd.risiko_merokok,"+
                    "skrining_igd.riwayat_minum_alkohol_merokok_keluarga,skrining_igd.riwayat_penggunaan_obat_steroid,skrining_igd.berat_badan,skrining_igd.tinggi_badan,"+
                    "skrining_igd.imt,skrining_igd.kasifikasi_imt,skrining_igd.lingkar_pinggang,skrining_igd.risiko_lingkar_pinggang,skrining_igd.status_obesitas,"+
                    "skrining_igd.keterangan,skrining_igd.faktor_resiko_pernah_terdiagnosa_tbc,skrining_igd.keterangan_pernah_terdiagnosa,skrining_igd.faktor_resiko_pernah_berobat_tbc,"+
                    "skrining_igd.faktor_resiko_malnutrisi,skrining_igd.faktor_resiko_merokok,skrining_igd.faktor_resiko_riwayat_dm,skrining_igd.faktor_resiko_odhiv,"+
                    "skrining_igd.faktor_resiko_lansia,skrining_igd.faktor_resiko_ibu_hamil,skrining_igd.faktor_resiko_wbp,skrining_igd.faktor_resiko_tinggal_diwilayah_padat_kumuh "+
                    "from skrining_igd inner join reg_periksa on skrining_igd.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on skrining_igd.nip=petugas.nip "+
    ...
    private void KetPernahTerdiagnosaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_KetPernahTerdiagnosaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_KetPernahTerdiagnosaActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSkriningIGD dialog = new RMSkriningIGD(new javax.swing.JFrame(), true);
            ...
            */
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "from skrining_igd inner join reg_periksa on skrining_igd.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on skrining_igd.nip=petugas.nip "+
                    "where skrining_igd.tanggal between ? and ? order by skrining_igd.tanggal ");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,skrining_igd.nip,petugas.nama,skrining_igd.tanggal,"+
                    "skrining_igd.kebiasaan_makan_manis,skrining_igd.aktifitas_fisik_setiap_hari,skrining_igd.istirahat_cukup,skrining_igd.risiko_merokok,"+
                    ...
                    "from skrining_igd inner join reg_periksa on skrining_igd.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join petugas on skrining_igd.nip=petugas.nip "+
                    "where skrining_igd.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or "+
                    "pasien.nm_pasien like ? or skrining_igd.nip like ? or petugas.nama like ?) "+
                    "order by skrining_igd.tanggal ");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("faktor_resiko_pernah_terdiagnosa_tbc"),rs.getString("keterangan_pernah_terdiagnosa"),rs.getString("faktor_resiko_pernah_berobat_tbc"),
                        rs.getString("faktor_resiko_malnutrisi"),rs.getString("faktor_resiko_merokok"),rs.getString("faktor_resiko_riwayat_dm"),rs.getString("faktor_resiko_odhiv"),
                        rs.getString("faktor_resiko_lansia"),rs.getString("faktor_resiko_ibu_hamil"),rs.getString("faktor_resiko_wbp"),rs.getString("faktor_resiko_tinggal_diwilayah_padat_kumuh")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            PernahTerdiagnosaTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),22).toString());
            KetPernahTerdiagnosa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),23).toString());
            PernahberobatTBC.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),24).toString());
            Malnutrisi.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),25).toString());
            Merokok.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),26).toString());
            RiwayatDM.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),27).toString());
            Odhiv.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),28).toString());
            Lansia.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),29).toString());
            Ibuhamil.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),30).toString());
            WargaBinaan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),31).toString());
            Tingaldiwilayahkumuh.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),32).toString());
        }
    }
    ...
    private void isForm(){
        if(ChkInput.isSelected()==true){
            if(internalFrame1.getHeight()>508){
                ...
                PanelInput.setPreferredSize(new Dimension(WIDTH,373));
                FormInput.setVisible(true);      
                ChkInput.setVisible(true);
            }else{
                ChkInput.setVisible(false);
                PanelInput.setPreferredSize(new Dimension(WIDTH,internalFrame1.getHeight()-135));
                FormInput.setVisible(true);      
                ChkInput.setVisible(true);
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getskrining_igd());
        BtnHapus.setEnabled(akses.getskrining_igd());
        BtnEdit.setEnabled(akses.getskrining_igd());
        BtnPrint.setEnabled(akses.getskrining_igd()); 
        if(akses.getjml2()>=1){
            KdPetugas.setEditable(false);
    ...
    private void ganti() {
        if(Sequel.mengedittf("skrining_igd","no_rawat=?","no_rawat=?,tanggal=?,kebiasaan_makan_manis=?,aktifitas_fisik_setiap_hari=?,istirahat_cukup=?,risiko_merokok=?,"+
                ...
                "risiko_lingkar_pinggang=?,status_obesitas=?,keterangan=?,nip=?,faktor_resiko_pernah_terdiagnosa_tbc=?,keterangan_pernah_terdiagnosa=?,faktor_resiko_pernah_berobat_tbc=?,"+
                "faktor_resiko_malnutrisi=?,faktor_resiko_merokok=?,faktor_resiko_riwayat_dm=?,faktor_resiko_odhiv=?,faktor_resiko_lansia=?,faktor_resiko_ibu_hamil=?,faktor_resiko_wbp=?,"+
                "faktor_resiko_tinggal_diwilayah_padat_kumuh=?",29,new String[]{
                ...
                Merokok.getSelectedItem().toString(),RiwayatDM.getSelectedItem().toString(),Odhiv.getSelectedItem().toString(),Lansia.getSelectedItem().toString(),
                Ibuhamil.getSelectedItem().toString(),WargaBinaan.getSelectedItem().toString(),Tingaldiwilayahkumuh.getSelectedItem().toString(),
               ...
               tbObat.setValueAt(PernahTerdiagnosaTBC.getSelectedItem().toString(),tbObat.getSelectedRow(),22);
               tbObat.setValueAt(KetPernahTerdiagnosa.getText(),tbObat.getSelectedRow(),23);
               tbObat.setValueAt(PernahberobatTBC.getSelectedItem().toString(),tbObat.getSelectedRow(),24);
               tbObat.setValueAt(Malnutrisi.getSelectedItem().toString(),tbObat.getSelectedRow(),25);
               tbObat.setValueAt(Merokok.getSelectedItem().toString(),tbObat.getSelectedRow(),26);
               tbObat.setValueAt(RiwayatDM.getSelectedItem().toString(),tbObat.getSelectedRow(),27);
               tbObat.setValueAt(Odhiv.getSelectedItem().toString(),tbObat.getSelectedRow(),28);
               tbObat.setValueAt(Lansia.getSelectedItem().toString(),tbObat.getSelectedRow(),29);
               tbObat.setValueAt(Ibuhamil.getSelectedItem().toString(),tbObat.getSelectedRow(),30);
               tbObat.setValueAt(WargaBinaan.getSelectedItem().toString(),tbObat.getSelectedRow(),31);
               tbObat.setValueAt(Tingaldiwilayahkumuh.getSelectedItem().toString(),tbObat.getSelectedRow(),32);
               emptTeks();
        }
    }

    private void hapus() {
        if(Sequel.queryu2tf("delete from skrining_igd where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
        })==true){
    ...
    private void simpan() {
        if(Sequel.menyimpantf("skrining_igd","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",28,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),
            KebiasaanMakanManis.getSelectedItem().toString(),AktifitasFisik.getSelectedItem().toString(),IstirahatCukup.getSelectedItem().toString(), 
            RisikoMerokok.getSelectedItem().toString(),RiwayatKeluarga.getSelectedItem().toString(),RiwayatSteroid.getSelectedItem().toString(),BB.getText(), 
            TB.getText(),IMT.getText(),KlasifikasiIMT.getText(),LP.getText(),StatusObesitas.getText(),RisikoLP.getText(),Keterangan.getText(),KdPetugas.getText(),
            PernahTerdiagnosaTBC.getSelectedItem().toString(),KetPernahTerdiagnosa.getText(),PernahberobatTBC.getSelectedItem().toString(),Malnutrisi.getSelectedItem().toString(),
            Merokok.getSelectedItem().toString(),RiwayatDM.getSelectedItem().toString(),Odhiv.getSelectedItem().toString(),Lansia.getSelectedItem().toString(),
            Ibuhamil.getSelectedItem().toString(),WargaBinaan.getSelectedItem().toString(),Tingaldiwilayahkumuh.getSelectedItem().toString()
        })==true){
