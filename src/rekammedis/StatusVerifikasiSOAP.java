...
public class StatusVerifikasiSOAP extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public StatusVerifikasiSOAP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setSize(1285, 674);
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Status Verifikasi SOAP ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Helvetica Neue", 0, 13), new java.awt.Color(50, 50, 50))); // NOI18N
...
private void btnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnCariKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            StatusVerifikasiSOAP dialog = new StatusVerifikasiSOAP(new javax.swing.JFrame(), true);
                ...
                while (rs.next()) {
                    ...
                    try {
                        rs2 = koneksi.prepareStatement(
                                ...
                                + "pemeriksaan_ranap.pemeriksaan,pemeriksaan_ranap.penilaian,pemeriksaan_ranap.rtl,pemeriksaan_ranap.instruksi,pemeriksaan_ranap.evaluasi,pemeriksaan_ranap.nip,pegawai.nama,departemen.nama, "
                                ...
                                + "from pemeriksaan_ranap LEFT JOIN validasi_pemeriksaan_ranap ON validasi_pemeriksaan_ranap.no_rawat = pemeriksaan_ranap.no_rawat AND validasi_pemeriksaan_ranap.tgl_perawatan = pemeriksaan_ranap.tgl_perawatan AND validasi_pemeriksaan_ranap.jam_rawat = pemeriksaan_ranap.jam_rawat inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS namavalidator ON validasi_pemeriksaan_ranap.nik_validator=namavalidator.nik where pemeriksaan_ranap.no_rawat='" + rs.getString("no_rawat") + "' "
                        ...
                        if (rs2.next()) {
                            ...
                            while (rs2.next()) {
                                ...
                                if (Sequel.cariInteger("select count(validasi_pemeriksaan_ranap.nik_validator) "
                                        + "from pemeriksaan_ranap LEFT JOIN validasi_pemeriksaan_ranap ON validasi_pemeriksaan_ranap.no_rawat = pemeriksaan_ranap.no_rawat AND validasi_pemeriksaan_ranap.tgl_perawatan = pemeriksaan_ranap.tgl_perawatan "
                                        + "AND validasi_pemeriksaan_ranap.jam_rawat = pemeriksaan_ranap.jam_rawat inner join pegawai on pemeriksaan_ranap.nip=pegawai.nik inner join departemen on pegawai.departemen=departemen.dep_id LEFT JOIN pegawai AS "
                                        + "namavalidator ON validasi_pemeriksaan_ranap.nik_validator=namavalidator.nik where pemeriksaan_ranap.no_rawat='" + rs.getString("no_rawat") + "' AND validasi_pemeriksaan_ranap.nik_validator='" + rs2.getString("nik_validator") + "'"
