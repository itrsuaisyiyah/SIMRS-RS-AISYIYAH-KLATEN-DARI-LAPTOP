 ...
 * @author perpustakaan
 */
public final class RMChecklistKriteriaKeluarBBRT extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMChecklistKriteriaKeluarBBRT(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Rencana Terapi Jelas Untuk Rawat Ruang Biasa","Keputusan","Keterangan/Catatan","NIP/Kode Dokter","DPJP/Dokter Jaga/BBRT"
        }){
    ...
    private void initComponents() {
        ...
        MnKriteriaKeluarPICU.setText("Formulir Checklist Kriteria Keluar BBRT");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Check List Kriteria Keluar BBRT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-08-2026 08:48:02" }));
        ...
        Keputusan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Layak Keluar Dari BBRT/Pindah Ke Ruang Rawat Biasa", "Tidak Layak Keluar/Tetap Dirawat Di BBRT" }));
        ...
        internalFrame1.getAccessibleContext().setAccessibleName("::[ Data Check List Kriteria Keluar BBRT ]::");
            ...
            try{
                ...
                htmlContent.append(                             
                    "<tr class='isi'>").append(
                        ...
                        "<td valign='middle' bgcolor='#FFFAFA' align='center'><b>DPJP/Dokter Jaga/BBRT").append(
                    "</tr>"
                );
                ...
                File f = new File("DataChecklistKriteriaKeluarBBRT.html");            
                            ...
                            "<table width='3300px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA CHECK LIST KRITERIA KELUAR BBRT<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnKriteriaKeluarPICUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKriteriaKeluarPICUActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirChecklistKriteriaKeluarBBRT.jasper","report","::[ Formulir Check List Kriteria Keluar BBRT ]::",
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,checklist_kriteria_keluar_bbrt.tanggal,"+
                    "checklist_kriteria_keluar_bbrt.kondisiklinis1,checklist_kriteria_keluar_bbrt.kondisiklinis2,checklist_kriteria_keluar_bbrt.kondisiklinis3,"+
                    "checklist_kriteria_keluar_bbrt.kondisiklinis4,checklist_kriteria_keluar_bbrt.kondisiklinis5,checklist_kriteria_keluar_bbrt.kondisiklinis6,"+
                    "checklist_kriteria_keluar_bbrt.kebutuhanperawatan1,checklist_kriteria_keluar_bbrt.kebutuhanperawatan2,checklist_kriteria_keluar_bbrt.kebutuhanperawatan3,"+
                    "checklist_kriteria_keluar_bbrt.kebutuhanperawatan4,checklist_kriteria_keluar_bbrt.tindaklanjut1,checklist_kriteria_keluar_bbrt.tindaklanjut2,"+
                    "checklist_kriteria_keluar_bbrt.tindaklanjut3,checklist_kriteria_keluar_bbrt.tindaklanjut4,checklist_kriteria_keluar_bbrt.keputusan,"+
                    "checklist_kriteria_keluar_bbrt.keterangan,checklist_kriteria_keluar_bbrt.nik,pegawai.nama from checklist_kriteria_keluar_bbrt "+
                    "inner join reg_periksa on checklist_kriteria_keluar_bbrt.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on pegawai.nik=checklist_kriteria_keluar_bbrt.nik "+
                    "where checklist_kriteria_keluar_bbrt.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' and checklist_kriteria_keluar_bbrt.tanggal='"+tbObat.getValueAt(tbObat.getSelectedRow(),5).toString()+"' ",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMChecklistKriteriaKeluarBBRT dialog = new RMChecklistKriteriaKeluarBBRT(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on pegawai.nik=checklist_kriteria_keluar_bbrt.nik "+
                    "where checklist_kriteria_keluar_bbrt.tanggal between ? and ? order by checklist_kriteria_keluar_bbrt.tanggal ");
            }else{
                ps=koneksi.prepareStatement(
                    "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,pasien.jk,checklist_kriteria_keluar_bbrt.tanggal,"+
                    "checklist_kriteria_keluar_bbrt.kondisiklinis1,checklist_kriteria_keluar_bbrt.kondisiklinis2,checklist_kriteria_keluar_bbrt.kondisiklinis3,"+
                    ...
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join pegawai on pegawai.nik=checklist_kriteria_keluar_bbrt.nik "+
                    "where checklist_kriteria_keluar_bbrt.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or "+
                    "pasien.nm_pasien like ? or pegawai.nama like ? or checklist_kriteria_keluar_bbrt.nik like ?) order by checklist_kriteria_keluar_bbrt.tanggal ");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getkriteria_keluar_bbrt());
        BtnHapus.setEnabled(akses.getkriteria_keluar_bbrt());
        BtnEdit.setEnabled(akses.getkriteria_keluar_bbrt());
        BtnPrint.setEnabled(akses.getkriteria_keluar_bbrt()); 
        if(akses.getjml2()>=1){
    ...
    private void ganti() {
        if(Sequel.mengedittf("checklist_kriteria_keluar_bbrt","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,kondisiklinis1=?,kondisiklinis2=?,kondisiklinis3=?,kondisiklinis4=?,kondisiklinis5=?,"+
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from checklist_kriteria_keluar_bbrt where no_rawat=? and tanggal=?",2,new String[]{
    ...
    private void simpan() {
        if(Sequel.menyimpantf("checklist_kriteria_keluar_bbrt","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data",19,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KondisiKlinis1.getSelectedItem().toString(),
            KondisiKlinis2.getSelectedItem().toString(),KondisiKlinis3.getSelectedItem().toString(),KondisiKlinis4.getSelectedItem().toString(),KondisiKlinis5.getSelectedItem().toString(),
            KondisiKlinis6.getSelectedItem().toString(),KebutuhanPerawatan1.getSelectedItem().toString(),KebutuhanPerawatan2.getSelectedItem().toString(),KebutuhanPerawatan3.getSelectedItem().toString(),
            KebutuhanPerawatan4.getSelectedItem().toString(),TindakLanjut1.getSelectedItem().toString(),TindakLanjut2.getSelectedItem().toString(),TindakLanjut3.getSelectedItem().toString(),
