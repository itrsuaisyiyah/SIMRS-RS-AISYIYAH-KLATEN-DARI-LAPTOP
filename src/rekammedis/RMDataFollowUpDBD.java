...
public final class RMDataFollowUpDBD extends javax.swing.JDialog {
    ...
    public RMDataFollowUpDBD(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Hematokrit","Trombosit","Albumin","Keterangan","NIP","Nama Petugas"
        }){
    ...
    private void initComponents() {
        ...
        FormInput.add(Leo);
        Leo.setBounds(470, 70, 50, 23);

        jLabel20.setText("Albumin :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(410, 70, 60, 23);
        ...
        Trombo.setBounds(350, 70, 50, 23);

        jLabel28.setText("Trombosit :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(280, 70, 70, 23);
    ...
    */
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("trombosit"),rs.getString("leokosit"),rs.getString("terapi_cairan"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Leo.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            Trombo.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("follow_up_dbd","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,hemoglobin=?,hematokrit=?,leokosit=?,trombosit=?,terapi_cairan=?,nip=?",12,new String[]{
            ...
            tbObat.setValueAt(Leo.getText(),tbObat.getSelectedRow(),11);
            tbObat.setValueAt(Trombo.getText(),tbObat.getSelectedRow(),10);
    ...
    private void simpan() {
        if(Sequel.menyimpantf("follow_up_dbd","?,?,?,?,?,?,?,?,?","Data",9,new String[]{
            ...
            tabMode.addRow(new String[]{
                ...
                Hemo.getText(),Hema.getText(),Trombo.getText(),Leo.getText(),TerapiCairan.getText(),NIP.getText(),NamaPetugas.getText()
            });
            LCount.setText(""+tabMode.getRowCount());
            emptTeks();
        } 
