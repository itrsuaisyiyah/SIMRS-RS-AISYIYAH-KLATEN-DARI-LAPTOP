 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapOrthopedi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapOrthopedi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Orthopedi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:04:06" }));
        ...
        jLabel81.setBounds(319, 850, 60, 23);
        ...
        BtnDokter4.setBounds(370, 850, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_orthopedi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
            ...
            try{
                if(TCari.getText().trim().equals("")){
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_orthopedi.tanggal,"+
                        "penilaian_medis_ranap_orthopedi.kd_dokter,penilaian_medis_ranap_orthopedi.anamnesis,penilaian_medis_ranap_orthopedi.hubungan,penilaian_medis_ranap_orthopedi.keluhan_utama,"+
                        "penilaian_medis_ranap_orthopedi.rps,penilaian_medis_ranap_orthopedi.rpd,penilaian_medis_ranap_orthopedi.rpo,penilaian_medis_ranap_orthopedi.alergi,penilaian_medis_ranap_orthopedi.kesadaran,"+
                        "penilaian_medis_ranap_orthopedi.status,penilaian_medis_ranap_orthopedi.td,penilaian_medis_ranap_orthopedi.nadi,penilaian_medis_ranap_orthopedi.suhu,penilaian_medis_ranap_orthopedi.rr,"+
                        "penilaian_medis_ranap_orthopedi.bb,penilaian_medis_ranap_orthopedi.nyeri,penilaian_medis_ranap_orthopedi.gcs,penilaian_medis_ranap_orthopedi.kepala,penilaian_medis_ranap_orthopedi.thoraks,"+
                        "penilaian_medis_ranap_orthopedi.abdomen,penilaian_medis_ranap_orthopedi.ekstremitas,penilaian_medis_ranap_orthopedi.genetalia,penilaian_medis_ranap_orthopedi.columna,"+
                        "penilaian_medis_ranap_orthopedi.muskulos,penilaian_medis_ranap_orthopedi.lainnya,penilaian_medis_ranap_orthopedi.ket_lokalis,penilaian_medis_ranap_orthopedi.lab,"+
                        "penilaian_medis_ranap_orthopedi.rad,penilaian_medis_ranap_orthopedi.pemeriksaan,penilaian_medis_ranap_orthopedi.diagnosis,penilaian_medis_ranap_orthopedi.diagnosis2,"+
                        "penilaian_medis_ranap_orthopedi.permasalahan,penilaian_medis_ranap_orthopedi.terapi,penilaian_medis_ranap_orthopedi.tindakan,penilaian_medis_ranap_orthopedi.edukasi,dokter.nm_dokter "+
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_orthopedi on reg_periksa.no_rawat=penilaian_medis_ranap_orthopedi.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_orthopedi.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_orthopedi.tanggal between ? and ? order by penilaian_medis_ranap_orthopedi.tanggal");
                }else{
                    ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_orthopedi.tanggal,"+
                        "penilaian_medis_ranap_orthopedi.kd_dokter,penilaian_medis_ranap_orthopedi.anamnesis,penilaian_medis_ranap_orthopedi.hubungan,penilaian_medis_ranap_orthopedi.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_orthopedi on reg_periksa.no_rawat=penilaian_medis_ranap_orthopedi.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_orthopedi.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_orthopedi.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_orthopedi.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_orthopedi.tanggal");
                }
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapOrthopedi.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Orthopedi ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_orthopedi.tanggal,"+
                "penilaian_medis_ranap_orthopedi.kd_dokter,penilaian_medis_ranap_orthopedi.anamnesis,penilaian_medis_ranap_orthopedi.hubungan,penilaian_medis_ranap_orthopedi.keluhan_utama,"+
                "penilaian_medis_ranap_orthopedi.rps,penilaian_medis_ranap_orthopedi.rpd,penilaian_medis_ranap_orthopedi.rpo,penilaian_medis_ranap_orthopedi.alergi,penilaian_medis_ranap_orthopedi.kesadaran,"+
                "penilaian_medis_ranap_orthopedi.status,penilaian_medis_ranap_orthopedi.td,penilaian_medis_ranap_orthopedi.nadi,penilaian_medis_ranap_orthopedi.suhu,penilaian_medis_ranap_orthopedi.rr,"+
                ...
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_orthopedi on reg_periksa.no_rawat=penilaian_medis_ranap_orthopedi.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_orthopedi.kd_dokter=dokter.kd_dokter "+
                "where penilaian_medis_ranap_orthopedi.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapOrthopedi dialog = new RMPenilaianAwalMedisRanapOrthopedi(new javax.swing.JFrame(), true);
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_orthopedi());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_orthopedi());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_orthopedi());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_orthopedi where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_orthopedi","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,"+
