...
public final class RMPenilaianAwalMedisRanapKandungan extends javax.swing.JDialog {
            ...
            public void windowClosed(WindowEvent e) {
                for (i = 0; i < carilaborat.getTable().getRowCount(); i++) {
                    if(carilaborat.getTable().getValueAt(i,0).toString().equals("true")){
                        Laborat.append(carilaborat.getTable().getValueAt(i,3).toString()+", ");
                    }
                }
                Laborat.requestFocus();
            }
            @Override
            public void windowIconified(WindowEvent e) {}
            @Override
        ...
        cariradiologi.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(cariradiologi.getTable().getSelectedRow()!= -1){
                    Ultra.append(cariradiologi.getTable().getValueAt(cariradiologi.getTable().getSelectedRow(),2).toString()+", ");
                    Ultra.requestFocus();
                }
            }
            @Override
    ...
    private void initComponents() {
        ...
        jLabel46.setBounds(67, 440, 60, 23);
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:01:03" }));
        ...
        jLabel80.setBounds(44, 730, 90, 23);
        ...
        jLabel82.setBounds(594, 730, 80, 23);
        ...
        BtnDokter2.setBounds(150, 210, 28, 23);
        ...
        BtnDokter3.setBounds(670, 730, 28, 23);
        ...
        BtnDokter4.setBounds(130, 730, 28, 23);
