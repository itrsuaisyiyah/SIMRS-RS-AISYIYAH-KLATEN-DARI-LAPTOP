...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        PrimerCatatan = new widget.ComboBox();
        ...
        SekunderCatatan = new widget.ComboBox();
        ...
        jLabel28.setBounds(360, 10, 90, 23);

        PrimerTanggalTriase.setForeground(new java.awt.Color(50, 70, 50));
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2026 09:03:33" }));
        ...
        label14.setText("Keputusan :");
        label14.setName("label14"); // NOI18N
        label14.setPreferredSize(new java.awt.Dimension(60, 23));
        internalFrame8.add(label14);
        label14.setBounds(180, 10, 65, 23);

        PrimerCatatan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat Jalan", "Rawat Inap", "Rujuk", "APS", "Meninggal" }));
        ...
        PrimerCatatan.setBounds(250, 10, 130, 23);
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2026 09:03:33" }));
        ...
        SekunderZonaKuning.setBounds(456, 10, 100, 23);
        ...
        SekunderZonaHijau.setBounds(560, 10, 100, 23);

        label15.setText("Keputusan :");
        label15.setName("label15"); // NOI18N
        label15.setPreferredSize(new java.awt.Dimension(60, 23));
        internalFrame12.add(label15);
        label15.setBounds(190, 10, 65, 23);

        SekunderCatatan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Rawat Jalan", "Rawat Inap", "Rujuk", "APS", "Meninggal" }));
        ...
        SekunderCatatan.setBounds(270, 10, 130, 23);
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "22-08-2026 09:03:34" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if(TabTriase.getSelectedIndex()==0){
                ...
                if(PrimerKeluhanUtama.getText().trim().equals("")){
                ...
                }else if(PrimerCatatan.getSelectedItem()==null){
                    sukses=false;
                    Valid.textKosong(PrimerCatatan,"Keputusan");
                    ...
                    if(Sequel.menyimpantf("data_triase_igd","?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",13,new String[]{
                        ...
                        if(Sequel.menyimpantf2("data_triase_igdprimer","?,?,?,?,?,?,?", 7,new String[]{
                            TNoRw.getText(),PrimerKeluhanUtama.getText(),PrimerKubutuhanKusus.getSelectedItem().toString(),PrimerCatatan.getSelectedItem().toString(),keputusan,
                ...
                if(SekunderAnamnesa.getText().trim().equals("")){
                ...
                }else if(SekunderCatatan.getSelectedItem()==null){
                    sukses=false;
                    Valid.textKosong(SekunderCatatan,"Keputusan");
                    ...
                    if(Sequel.menyimpantf("data_triase_igd","?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",13,new String[]{
                        ...
                        if(Sequel.menyimpantf2("data_triase_igdsekunder","?,?,?,?,?,?", 6,new String[]{
                            TNoRw.getText(),SekunderAnamnesa.getText(),SekunderCatatan.getSelectedItem().toString(),keputusan,
                                    ...
                                    htmlContent.append(
                                        "<td valign='top' cellpadding='0' cellspacing='0'>"+
                                            "<table width='100%' border='0' cellpadding='0' cellspacing='0' align='center'>"+
                                                ...
                                                "</tr>"+
                                                "<tr class='isi2'>"+
                                                    "<td width='34%' valign='top'>Keputusan</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>"+rs.getString("catatan")+"</td>"+
                                                "</tr>"+
                                                "<tr class='isi2'>"+
                    ...
                    try {
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                PrimerCatatan.setSelectedItem(rs.getString("catatan"));
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        } finally{
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                SekunderCatatan.setSelectedItem(rs.getString("catatan"));
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        } finally{
    ...
    */
    ...
    private widget.ComboBox PrimerCatatan;
    ...
    private widget.ComboBox SekunderCatatan;
    ...
    private void emptTeks(){
        ...
        PrimerCatatan.setSelectedIndex(0);
        ...
        SekunderCatatan.setSelectedIndex(0);
