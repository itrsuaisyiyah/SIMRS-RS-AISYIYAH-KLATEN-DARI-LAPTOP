...
public final class RMHasilPemeriksaanEcho extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-03-2024 07:54:08" }));
        ...
        jLabel31.setBounds(0, 80, 130, 23);
        ...
        sistolik.setBounds(137, 80, 580, 23);
        ...
        FormInput.add(Katup);
        Katup.setBounds(137, 200, 580, 23);

        jLabel35.setText("Katup Katup:");
        jLabel35.setName("jLabel35"); // NOI18N
        FormInput.add(jLabel35);
        jLabel35.setBounds(0, 200, 130, 23);

        jLabel40.setText("Fungsi Diastolik LV :");
        jLabel40.setName("jLabel40"); // NOI18N
        FormInput.add(jLabel40);
        jLabel40.setBounds(0, 110, 130, 23);
        ...
        AnalisaSegmental.setBounds(137, 230, 580, 23);
        ...
        Dimensi.setBounds(137, 170, 580, 23);

        jLabel43.setText("Dimensi Ruang Jantung :");
        jLabel43.setName("jLabel43"); // NOI18N
        FormInput.add(jLabel43);
        jLabel43.setBounds(0, 170, 130, 23);

        jLabel44.setText("Kesimpulan :");
        jLabel44.setName("jLabel44"); // NOI18N
        FormInput.add(jLabel44);
        jLabel44.setBounds(0, 320, 130, 23);
        ...
        FormInput.add(Erap);
        Erap.setBounds(137, 260, 580, 23);

        jLabel42.setText("Kontaktilitas RV :");
        jLabel42.setName("jLabel42"); // NOI18N
        FormInput.add(jLabel42);
        jLabel42.setBounds(0, 140, 130, 23);
        ...
        LainLain.setBounds(137, 290, 580, 23);
                    ...
                    while(rs.next()){
                        htmlContent.append(
                            "<tr class='isi'>"+
                               ...
                               "<td valign='top'>"+rs.getString("sistolik")+"</td>"+
                               "<td valign='top'>"+rs.getString("diastolik")+"</td>"+
                               "<td valign='top'>"+rs.getString("kontraktilitas")+"</td>"+
                               "<td valign='top'>"+rs.getString("dimensi_ruang")+"</td>"+
                               "<td valign='top'>"+rs.getString("katup")+"</td>"+
                               "<td valign='top'>"+rs.getString("analisa_segmental")+"</td>"+
                               "<td valign='top'>"+rs.getString("erap")+"</td>"+
                                ...
                                "<table width='2100px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    "<tr class='isi2'>"+
                                        "<td valign='top' align='center'>"+
                                            ...
                                            "<font size='2' face='Tahoma'>HASIL PEMERIKSAAN ECHOCARDIOGRAFI<br><br></font>"+        
                                        "</td>"+
                                   "</tr>"+
                                "</table>")
                    );
...
//            param.put("hasil",Sequel.cariIsi("select concat('http://"+koneksiDB.HOSTHYBRIDWEB()+":"+koneksiDB.PORTWEB()+"/"+koneksiDB.HYBRIDWEB()+"/hasilpemeriksaanecho/',hasil_pemeriksaan_echo_gambar.photo) as tandatangan from hasil_pemeriksaan_echo_gambar inner join dokter on dokter.kd_dokter=tandatangan_dokter.kd_dokter where dokter.kd_dokter=?",rs.getString("kd_dokter")));
    ...
    private void sistolikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sistolikKeyPressed
        Valid.pindah(evt,Diastolik,Katup);
    ...
    private void KatupKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KatupKeyPressed
        Valid.pindah(evt,Dimensi,Katup);
    ...
    private void DiastolikKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiastolikKeyPressed
        Valid.pindah(evt,Katup,AnalisaSegmental);
    ...
    private void AnalisaSegmentalKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AnalisaSegmentalKeyPressed
        Valid.pindah(evt,Diastolik,Erap);
    ...
    private void DimensiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DimensiKeyPressed
        Valid.pindah(evt,Diastolik,Kesimpulan);
    }//GEN-LAST:event_DimensiKeyPressed

    private void KesimpulanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KesimpulanKeyPressed
        Valid.pindah2(evt,Dimensi,BtnSimpan);
    ...
    private void ErapKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_ErapKeyPressed
        Valid.pindah(evt,Dimensi,Kontraktilitas);
