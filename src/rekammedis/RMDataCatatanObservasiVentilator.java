...
public final class RMDataCatatanObservasiVentilator extends javax.swing.JDialog {
    ...
    public RMDataCatatanObservasiVentilator(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Rawat","No.R.M.","Nama Pasien","Umur","JK","Tgl.Lahir","Tgl.Obser","Jam Obser","Tipe","Mode",
            "RR","Fi02","PIP/PEEP","Ti : Te","VT","Flow","Keterangan","NIP","Nama Petugas"
        }){
        ...
        VT.setDocument(new batasInput((byte)50).getKata(VT));
        Pakar.setDocument(new batasInput((byte)50).getKata(Pakar));
        RR.setDocument(new batasInput((byte)50).getKata(RR));
        REEFPS.setDocument(new batasInput((byte)50).getKata(REEFPS));
        EE.setDocument(new batasInput((byte)50).getKata(EE));
        fio.setDocument(new batasInput((byte)50).getKata(fio));
    ...
    private void initComponents() {
        ...
        jLabel12.setBounds(280, 70, 70, 23);
        ...
        FormInput.add(Pakar);
        Pakar.setBounds(240, 130, 160, 23);

        jLabel20.setText("Flow :");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(180, 130, 60, 23);

        jLabel22.setText("Ti : Te :");
        jLabel22.setName("jLabel22"); // NOI18N
        FormInput.add(jLabel22);
        jLabel22.setBounds(570, 100, 50, 23);
        ...
        REEFPS.setBounds(630, 100, 160, 23);

        jLabel23.setText("VT :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(30, 130, 40, 23);
        ...
        FormInput.add(RR);
        RR.setBounds(70, 100, 90, 23);

        jLabel28.setText("RR :");
        jLabel28.setName("jLabel28"); // NOI18N
        FormInput.add(jLabel28);
        jLabel28.setBounds(30, 100, 40, 23);

        jLabel29.setText("PIP / PEEP :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(310, 100, 70, 23);
        ...
        FormInput.add(EE);
        EE.setBounds(390, 100, 180, 23);

        Mode.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "  CMV / AC / PAC / VAC", "  P - SIMV", "  V - SIMV", "  PSV", "  CPAP", "  BiPAP", "  HFNC", "  HFO" }));
        ...
        FormInput.add(Mode);
        Mode.setBounds(350, 70, 148, 23);

        jLabel13.setText("Keterangan :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(430, 130, 90, 23);
        ...
        Keterangan.setBounds(530, 130, 260, 23);

        jLabel14.setText("Therapy Tipe :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(0, 70, 70, 23);

        Mode1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "  Invasif / Tube", "  Non Invasif / NIV", "  02 Therapi" }));
        Mode1.setName("Mode1"); // NOI18N
        Mode1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Mode1ActionPerformed(evt);
            }
        });
        Mode1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                Mode1KeyPressed(evt);
            }
        });
        FormInput.add(Mode1);
        Mode1.setBounds(70, 70, 148, 23);
        ...
        FormInput.add(fio);
        fio.setBounds(210, 100, 100, 23);

        jLabel30.setText("Fi02 :");
        jLabel30.setName("jLabel30"); // NOI18N
        FormInput.add(jLabel30);
        jLabel30.setBounds(160, 100, 40, 23);
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(TCari.getText().trim().equals("")){
                Valid.MyReportqry("rptDataCatatanObservasiVentilator.jasper","report","::[ Data Catatan Observasi Ventilator ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_ventilator.tgl_perawatan,catatan_observasi_ventilator.jam_rawat,catatan_observasi_ventilator.tipe,catatan_observasi_ventilator.mode,"+
                    "catatan_observasi_ventilator.rr,catatan_observasi_ventilator.fio,catatan_observasi_ventilator.ee,catatan_observasi_ventilator.reefps,catatan_observasi_ventilator.vt,catatan_observasi_ventilator.pakar,"+
                    "catatan_observasi_ventilator.keterangan,catatan_observasi_ventilator.nip,petugas.nama from catatan_observasi_ventilator inner join reg_periksa on catatan_observasi_ventilator.no_rawat=reg_periksa.no_rawat "+
    ...
    private void MnCatatanObservasiVentilatorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCatatanObservasiVentilatorActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptFormulirCatatanObservasiVentilator.jasper","report","::[ Formulir Catatan Observasi Ventilator ]::",
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_ventilator.tgl_perawatan,catatan_observasi_ventilator.jam_rawat,catatan_observasi_ventilator.tipe,catatan_observasi_ventilator.mode,dokter.nm_dokter,"+
                    "catatan_observasi_ventilator.rr,catatan_observasi_ventilator.fio,catatan_observasi_ventilator.ee,catatan_observasi_ventilator.reefps,catatan_observasi_ventilator.vt,catatan_observasi_ventilator.pakar,"+
                    "catatan_observasi_ventilator.keterangan,petugas.nama from catatan_observasi_ventilator inner join reg_periksa on catatan_observasi_ventilator.no_rawat=reg_periksa.no_rawat "+
    ...
    private void Mode1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Mode1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_Mode1KeyPressed
    ...
    */
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "pasien.jk,pasien.tgl_lahir,catatan_observasi_ventilator.tgl_perawatan,catatan_observasi_ventilator.jam_rawat,catatan_observasi_ventilator.tipe,catatan_observasi_ventilator.mode,"+
                    "catatan_observasi_ventilator.rr,catatan_observasi_ventilator.fio,catatan_observasi_ventilator.ee,catatan_observasi_ventilator.reefps,catatan_observasi_ventilator.vt,catatan_observasi_ventilator.pakar,"+
                    "catatan_observasi_ventilator.keterangan,catatan_observasi_ventilator.nip,petugas.nama from catatan_observasi_ventilator "+
                    "inner join reg_periksa on catatan_observasi_ventilator.no_rawat=reg_periksa.no_rawat "+
                    "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "inner join petugas on catatan_observasi_ventilator.nip=petugas.nip where "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),rs.getString("tipe"),rs.getString("mode"),
                        rs.getString("rr"),rs.getString("fio"),rs.getString("ee"),rs.getString("reefps"),rs.getString("vt"),
                        rs.getString("pakar"),rs.getString("keterangan"),rs.getString("nip"),rs.getString("nama")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Mode1.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());
            Mode.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),9).toString());
            RR.setText(tbObat.getValueAt(tbObat.getSelectedRow(),10).toString());
            fio.setText(tbObat.getValueAt(tbObat.getSelectedRow(),11).toString());
            EE.setText(tbObat.getValueAt(tbObat.getSelectedRow(),12).toString());
            REEFPS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
            VT.setText(tbObat.getValueAt(tbObat.getSelectedRow(),14).toString());
            Pakar.setText(tbObat.getValueAt(tbObat.getSelectedRow(),15).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("catatan_observasi_ventilator","tgl_perawatan=? and jam_rawat=? and no_rawat=?","no_rawat=?,tgl_perawatan=?,jam_rawat=?,tipe=?,mode=?,rr=?,fio=?,ee=?,reefps=?,vt=?,pakar=?,keterangan=?,nip=?",16,new String[]{
            TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+""),Jam.getSelectedItem()+":"+Menit.getSelectedItem()+":"+Detik.getSelectedItem(),Mode1.getSelectedItem().toString(),Mode.getSelectedItem().toString(),RR.getText(),
            fio.getText(),EE.getText(),REEFPS.getText(),VT.getText(),Pakar.getText(),Keterangan.getText(),KdPetugas.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),6).toString(),tbObat.getValueAt(tbObat.getSelectedRow(),7).toString(),
            ...
            tbObat.setValueAt(Mode1.getSelectedItem().toString(),tbObat.getSelectedRow(),8);
            tbObat.setValueAt(Mode.getSelectedItem().toString(),tbObat.getSelectedRow(),9);
            tbObat.setValueAt(RR.getText(),tbObat.getSelectedRow(),10);
            tbObat.setValueAt(fio.getText(),tbObat.getSelectedRow(),11);
            tbObat.setValueAt(EE.getText(),tbObat.getSelectedRow(),12);
            tbObat.setValueAt(REEFPS.getText(),tbObat.getSelectedRow(),13);
            tbObat.setValueAt(VT.getText(),tbObat.getSelectedRow(),14);
            tbObat.setValueAt(Pakar.getText(),tbObat.getSelectedRow(),15);
    ...
    private void simpan() {
        if(Sequel.menyimpantf("catatan_observasi_ventilator","?,?,?,?,?,?,?,?,?,?,?,?,?","Data",13,new String[]{
            ...
            Mode1.getSelectedItem().toString(),Mode.getSelectedItem().toString(),RR.getText(),fio.getText(),EE.getText(),REEFPS.getText(),VT.getText(),Pakar.getText(),
