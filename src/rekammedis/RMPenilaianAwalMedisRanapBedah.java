 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapBedah extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapBedah(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Bedah ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        Anamnesis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                AnamnesisActionPerformed(evt);
            }
        });
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 15:51:31" }));
        ...
        scrollPane12.setBounds(614, 870, 240, 63);

        jLabel105.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel105.setText("Penunjang Lainnya :");
        jLabel105.setName("jLabel105"); // NOI18N
        FormInput.add(jLabel105);
        jLabel105.setBounds(620, 850, 190, 23);
        ...
        scrollPane10.setBounds(339, 870, 240, 63);
        ...
        BtnDokter2.setBounds(150, 190, 28, 23);
        ...
        BtnDokter3.setBounds(120, 850, 28, 23);
        ...
        BtnDokter4.setBounds(400, 850, 28, 23);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapBedah.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Bedah ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_bedah.tanggal,"+
                "penilaian_medis_ranap_bedah.kd_dokter,penilaian_medis_ranap_bedah.anamnesis,penilaian_medis_ranap_bedah.hubungan,penilaian_medis_ranap_bedah.keluhan_utama,"+
                "penilaian_medis_ranap_bedah.rps,penilaian_medis_ranap_bedah.rpd,penilaian_medis_ranap_bedah.rpo,penilaian_medis_ranap_bedah.alergi,penilaian_medis_ranap_bedah.kesadaran,"+
                "penilaian_medis_ranap_bedah.status,penilaian_medis_ranap_bedah.td,penilaian_medis_ranap_bedah.nadi,penilaian_medis_ranap_bedah.suhu,penilaian_medis_ranap_bedah.rr,"+
                "penilaian_medis_ranap_bedah.bb,penilaian_medis_ranap_bedah.nyeri,penilaian_medis_ranap_bedah.gcs,penilaian_medis_ranap_bedah.kepala,penilaian_medis_ranap_bedah.thoraks,"+
                "penilaian_medis_ranap_bedah.abdomen,penilaian_medis_ranap_bedah.ekstremitas,penilaian_medis_ranap_bedah.genetalia,penilaian_medis_ranap_bedah.columna,"+
                "penilaian_medis_ranap_bedah.muskulos,penilaian_medis_ranap_bedah.lainnya,penilaian_medis_ranap_bedah.ket_lokalis,penilaian_medis_ranap_bedah.lab,"+
                "penilaian_medis_ranap_bedah.rad,penilaian_medis_ranap_bedah.pemeriksaan,penilaian_medis_ranap_bedah.diagnosis,penilaian_medis_ranap_bedah.diagnosis2,"+
                "penilaian_medis_ranap_bedah.permasalahan,penilaian_medis_ranap_bedah.terapi,penilaian_medis_ranap_bedah.tindakan,penilaian_medis_ranap_bedah.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_bedah on reg_periksa.no_rawat=penilaian_medis_ranap_bedah.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_bedah.kd_dokter=dokter.kd_dokter "+
                "where penilaian_medis_ranap_bedah.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void AnamnesisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AnamnesisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_AnamnesisActionPerformed
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapBedah dialog = new RMPenilaianAwalMedisRanapBedah(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_bedah on reg_periksa.no_rawat=penilaian_medis_ranap_bedah.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_bedah.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_bedah.tanggal between ? and ? order by penilaian_medis_ranap_bedah.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_bedah.tanggal,"+
                        "penilaian_medis_ranap_bedah.kd_dokter,penilaian_medis_ranap_bedah.anamnesis,penilaian_medis_ranap_bedah.hubungan,penilaian_medis_ranap_bedah.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_bedah on reg_periksa.no_rawat=penilaian_medis_ranap_bedah.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_bedah.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_bedah.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_bedah.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_bedah.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_bedah());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_bedah());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_bedah());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_bedah where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_bedah","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ranap_bedah","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",37,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),Kesadaran.getSelectedItem().toString(),Status.getText(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),BB.getText(),Nyeri.getText(),GCS.getText(),
                Kepala.getSelectedItem().toString(),Thoraks.getSelectedItem().toString(),Abdomen.getSelectedItem().toString(),Ekstremitas.getSelectedItem().toString(),Genetalia.getSelectedItem().toString(),Columna.getSelectedItem().toString(),
                Muskulos.getSelectedItem().toString(),Lainnya.getText(),KetLokalis.getText(),Lab.getText(),Rad.getText(),PenunjangLain.getText(),Diagnosis.getText(),Diagnosis2.getText(),Permasalahan.getText(),Terapi.getText(),Tindakan.getText(),
