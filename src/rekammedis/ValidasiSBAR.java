...
public final class ValidasiSBAR extends javax.swing.JDialog {
    ...
    public ValidasiSBAR(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "A (ASSESSMENT)","R (RECOMENDATION)","I (INSTRUKSI)"
        }){
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Validasi SBAR Rawat Inap ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        scrollPane3.setBounds(400, 130, 320, 80);
        ...
        scrollPane4.setBounds(400, 220, 320, 80);
        ...
        scrollPane5.setViewportView(TInstruksi);

        FormInput.add(scrollPane5);
        scrollPane5.setBounds(730, 130, 210, 80);
        scrollPane5.getAccessibleContext().setAccessibleName("");
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        ...
        }else if(TInstruksi.getText().equals("")){
            Valid.textKosong(TBackground,"I (INSTRUKSI)");
        }else{
            if(Sequel.menyimpantf("validasi_pemeriksaan_sbar","?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",13,new String[]{
                    TNoRw.getText(),TanggalPemeriksaan.getText(),JamPemeriksaan.getText(),TSituation.getText(),TBackground.getText(),TAssesment.getText(),TRecomendation.getText(),TInstruksi.getText(), 
    ...
    */
        ...
        try{
            if(TCari.getText().equals("")){
                ps=koneksi.prepareStatement(
                    ...
                    "pemeriksaan_ranap_sbar.background,pemeriksaan_ranap_sbar.assesment,pemeriksaan_ranap_sbar.recommendation,pemeriksaan_ranap_sbar.instruksi,pemeriksaan_ranap_sbar.nip,pegawai.nama from pasien inner join reg_periksa inner join pemeriksaan_ranap_sbar "+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tgl_perawatan"),rs.getString("jam_rawat"),rs.getString("situation"),rs.getString("background"),rs.getString("assesment"),rs.getString("recommendation"),rs.getString("instruksi")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TInstruksi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),13).toString());
        }
    }
