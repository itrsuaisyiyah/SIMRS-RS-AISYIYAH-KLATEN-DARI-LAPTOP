 ...
 * @author perpustakaan
 */
public final class RMSbarRalan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMSbarRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
// Optimasi pengaturan lebar kolom menggunakan switch-case
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Catatan SBAR Ralan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        jLabel91.setBounds(440, 190, 100, 23);
            ...
            if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                ...
                if (akses.getkode().equals("Admin Utama")) {
                    Sequel.menyimpan("pemeriksaan_ralan_sbar", "?,?,?,?,?,?,?,?", "Data", 8, new String[]{
                        ...
                        TSituation.getText(), TBackground.getText(), TAssesment.getText(), TRecommendation.getText(), KdPeg.getText()
                    });
                    tampilPemeriksaanSbar();
                    BtnBatalActionPerformed(evt);
                } else {
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSbarRalan dialog = new RMSbarRalan(new javax.swing.JFrame(), true);
    ...
    public void tampilPemeriksaanSbar() {
        ...
        try {
            ps = koneksi.prepareStatement("select pemeriksaan_ralan_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    ...
                    + "pemeriksaan_ralan_sbar.assesment,pemeriksaan_ralan_sbar.recommendation,pemeriksaan_ralan_sbar.nip,pegawai.nama,pegawai.jbtn, IF(vps.no_rawat IS NOT NULL, 'Tervalidasi', 'Belum Divalidasi')"
                    + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join pemeriksaan_ralan_sbar on pemeriksaan_ralan_sbar.no_rawat=reg_periksa.no_rawat "
                    + "inner join pegawai on pemeriksaan_ralan_sbar.nip=pegawai.nik "
                    + "LEFT JOIN validasi_pemeriksaan_sbar vps ON CONCAT(pemeriksaan_ralan_sbar.no_rawat, pemeriksaan_ralan_sbar.tgl_perawatan, pemeriksaan_ralan_sbar.jam_rawat) = CONCAT (vps.no_rawat, vps.tgl_perawatan, vps.jam_rawat) where "
                    + "pemeriksaan_ralan_sbar.tgl_perawatan between ? and ? and reg_periksa.no_rawat like ? "
