 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapParu extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapParu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Inap Paru ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:04:33" }));
        ...
        BtnDokter1.setBounds(90, 110, 28, 23);
        ...
        BtnDokter2.setBounds(140, 190, 28, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("penilaian_medis_ranap_paru","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",34,new String[]{
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataPenilaianAwalMedisRanapParu.html");            
                            ...
                            "<table width='4700px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA PENILAIAN AWAL MEDIS RAWAT JALAN PARU<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapParu.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Paru ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_paru.tanggal,"+
                "penilaian_medis_ranap_paru.kd_dokter,penilaian_medis_ranap_paru.anamnesis,penilaian_medis_ranap_paru.hubungan,penilaian_medis_ranap_paru.keluhan_utama,"+
                "penilaian_medis_ranap_paru.rps,penilaian_medis_ranap_paru.rpd,penilaian_medis_ranap_paru.rpo,penilaian_medis_ranap_paru.alergi,penilaian_medis_ranap_paru.kesadaran,"+
                "penilaian_medis_ranap_paru.status,penilaian_medis_ranap_paru.td,penilaian_medis_ranap_paru.nadi,penilaian_medis_ranap_paru.suhu,penilaian_medis_ranap_paru.rr,"+
                "penilaian_medis_ranap_paru.bb,penilaian_medis_ranap_paru.nyeri,penilaian_medis_ranap_paru.gcs,penilaian_medis_ranap_paru.kepala,penilaian_medis_ranap_paru.thoraks,"+
                "penilaian_medis_ranap_paru.abdomen,penilaian_medis_ranap_paru.muskulos,penilaian_medis_ranap_paru.lainnya,"+
                "penilaian_medis_ranap_paru.ket_lokalis,penilaian_medis_ranap_paru.lab,"+
                "penilaian_medis_ranap_paru.rad,penilaian_medis_ranap_paru.pemeriksaan,penilaian_medis_ranap_paru.diagnosis,penilaian_medis_ranap_paru.diagnosis2,"+
                "penilaian_medis_ranap_paru.permasalahan,penilaian_medis_ranap_paru.terapi,penilaian_medis_ranap_paru.tindakan,penilaian_medis_ranap_paru.edukasi,dokter.nm_dokter "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_paru on reg_periksa.no_rawat=penilaian_medis_ranap_paru.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_paru.kd_dokter=dokter.kd_dokter "+
                "where penilaian_medis_ranap_paru.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapParu dialog = new RMPenilaianAwalMedisRanapParu(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_paru on reg_periksa.no_rawat=penilaian_medis_ranap_paru.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_paru.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_paru.tanggal between ? and ? order by penilaian_medis_ranap_paru.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_paru.tanggal,"+
                        "penilaian_medis_ranap_paru.kd_dokter,penilaian_medis_ranap_paru.anamnesis,penilaian_medis_ranap_paru.hubungan,penilaian_medis_ranap_paru.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_paru on reg_periksa.no_rawat=penilaian_medis_ranap_paru.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_paru.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_paru.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_paru.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_paru.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_paru());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_paru());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_paru());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_paru());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_paru where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_paru","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,kesadaran=?,status=?,td=?,nadi=?,suhu=?,rr=?,bb=?,nyeri=?,"+
