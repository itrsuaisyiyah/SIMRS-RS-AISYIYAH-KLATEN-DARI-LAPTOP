...
public final class RMPenilaianAwalKeperawatanRalanPsikiatri extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel52.setText("VI. PENILAIAN TINGKAT NYERI");
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-05-2024 05:17:01" }));
        ...
        jLabel63.setText("IX. PENILAIAN RESIKO JATUH");
    ...
    */
    ...
    private void tampilMasalah() {
        try{
            ...
            fileWriter.write("{\"masalahkeperawatanpsikiatri\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
    ...
    private void tampilRencana() {
        try{
            ...
            fileWriter.write("{\"rencanakeperawatanpsikiatri\":["+iyem.substring(0,iyem.length()-1)+"]}");
            fileWriter.flush();
            fileWriter.close();
            iyem=null;
        }catch(Exception e){
