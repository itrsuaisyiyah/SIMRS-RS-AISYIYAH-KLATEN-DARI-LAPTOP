 ...
 * @author perpustakaan
 */
public final class RMPenilaianAwalMedisRanapGeriatri extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMPenilaianAwalMedisRanapGeriatri(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "05-08-2026 16:00:09" }));
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            try{
                ...
                File f = new File("DataPenilaianAwalMedisRanapGeriatri.html");            
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakPenilaianAwalMedisRanapGeriatri.jasper","report","::[ Laporan Penilaian Awal Medis Rawat Inap Geriatri ]::",
                "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_geriatri.tanggal,"+
                "penilaian_medis_ranap_geriatri.kd_dokter,dokter.nm_dokter,penilaian_medis_ranap_geriatri.anamnesis,penilaian_medis_ranap_geriatri.hubungan,penilaian_medis_ranap_geriatri.keluhan_utama,"+
                "penilaian_medis_ranap_geriatri.rps,penilaian_medis_ranap_geriatri.rpd,penilaian_medis_ranap_geriatri.rpo,penilaian_medis_ranap_geriatri.alergi,penilaian_medis_ranap_geriatri.tulang_belakang,"+
                "penilaian_medis_ranap_geriatri.td,penilaian_medis_ranap_geriatri.nadi,penilaian_medis_ranap_geriatri.suhu,penilaian_medis_ranap_geriatri.rr,penilaian_medis_ranap_geriatri.kondisi_umum,"+
                "penilaian_medis_ranap_geriatri.status_psikologis_gds,penilaian_medis_ranap_geriatri.kondisi_sosial,penilaian_medis_ranap_geriatri.status_kognitif_mmse,penilaian_medis_ranap_geriatri.kepala,"+
                "penilaian_medis_ranap_geriatri.keterangan_kepala,penilaian_medis_ranap_geriatri.thoraks,penilaian_medis_ranap_geriatri.keterangan_thoraks,penilaian_medis_ranap_geriatri.abdomen,"+
                "penilaian_medis_ranap_geriatri.keterangan_abdomen,penilaian_medis_ranap_geriatri.ekstremitas,penilaian_medis_ranap_geriatri.keterangan_ekstremitas,penilaian_medis_ranap_geriatri.Integument_kebersihan,"+
                "penilaian_medis_ranap_geriatri.Integument_warna,penilaian_medis_ranap_geriatri.Integument_kelembaban,penilaian_medis_ranap_geriatri.Integument_gangguan_kulit,penilaian_medis_ranap_geriatri.status_fungsional,"+
                "penilaian_medis_ranap_geriatri.skrining_jatuh,penilaian_medis_ranap_geriatri.status_nutrisi,penilaian_medis_ranap_geriatri.lainnya,penilaian_medis_ranap_geriatri.lab,penilaian_medis_ranap_geriatri.rad,"+
                "penilaian_medis_ranap_geriatri.pemeriksaan,penilaian_medis_ranap_geriatri.diagnosis,penilaian_medis_ranap_geriatri.diagnosis2,penilaian_medis_ranap_geriatri.permasalahan,penilaian_medis_ranap_geriatri.terapi,"+
                "penilaian_medis_ranap_geriatri.tindakan,penilaian_medis_ranap_geriatri.edukasi "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join penilaian_medis_ranap_geriatri on reg_periksa.no_rawat=penilaian_medis_ranap_geriatri.no_rawat "+
                "inner join dokter on penilaian_medis_ranap_geriatri.kd_dokter=dokter.kd_dokter where penilaian_medis_ranap_geriatri.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMPenilaianAwalMedisRanapGeriatri dialog = new RMPenilaianAwalMedisRanapGeriatri(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        ...
                        "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join penilaian_medis_ranap_geriatri on reg_periksa.no_rawat=penilaian_medis_ranap_geriatri.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_geriatri.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_geriatri.tanggal between ? and ? order by penilaian_medis_ranap_geriatri.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,penilaian_medis_ranap_geriatri.tanggal,"+
                        "penilaian_medis_ranap_geriatri.kd_dokter,dokter.nm_dokter,penilaian_medis_ranap_geriatri.anamnesis,penilaian_medis_ranap_geriatri.hubungan,penilaian_medis_ranap_geriatri.keluhan_utama,"+
                        ...
                        "inner join penilaian_medis_ranap_geriatri on reg_periksa.no_rawat=penilaian_medis_ranap_geriatri.no_rawat "+
                        "inner join dokter on penilaian_medis_ranap_geriatri.kd_dokter=dokter.kd_dokter where "+
                        "penilaian_medis_ranap_geriatri.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "penilaian_medis_ranap_geriatri.kd_dokter like ? or dokter.nm_dokter like ?) order by penilaian_medis_ranap_geriatri.tanggal");
            }
    ...
    public void isCek(){
        BtnSimpan.setEnabled(akses.getpenilaian_awal_medis_ranap_geriatri());
        BtnHapus.setEnabled(akses.getpenilaian_awal_medis_ranap_geriatri());
        BtnEdit.setEnabled(akses.getpenilaian_awal_medis_ranap_geriatri());
        if(akses.getjml2()>=1){
            KdDokter.setEditable(false);
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap_geriatri where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ranap_geriatri","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,rps=?,rpd=?,rpo=?,alergi=?,tulang_belakang=?,td=?,nadi=?,suhu=?,rr=?,kondisi_umum=?,"+
    ...
    private void simpan() {
        if(Sequel.menyimpantf("penilaian_medis_ranap_geriatri","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",44,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),KdDokter.getText(),Anamnesis.getSelectedItem().toString(),Hubungan.getText(),
                KeluhanUtama.getText(),RPS.getText(),RPD.getText(),RPO.getText(),Alergi.getText(),PosturTulang.getSelectedItem().toString(),TD.getText(),Nadi.getText(),Suhu.getText(),RR.getText(),KondisiUmum.getText(),
                Psikologis.getSelectedItem().toString(),KondisiSosial.getText(),Kognitif.getSelectedItem().toString(),Kepala.getSelectedItem().toString(),KeteranganKepala.getText(),Thoraks.getSelectedItem().toString(),
                KeteranganThoraks.getText(),Abdomen.getSelectedItem().toString(),KeteranganAbdomen.getText(),Ekstremitas.getSelectedItem().toString(),KeteranganEkstremitas.getText(),IntegumentKebersihan.getSelectedItem().toString(),
