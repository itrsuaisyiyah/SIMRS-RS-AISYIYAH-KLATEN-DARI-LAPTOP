 ...
 * @author perpustakaan
 */
public class WhatsappKirimFonnter extends javax.swing.JDialog {
...
//    private WhatsappTemplate templateWA=new WhatsappTemplate(null,false);
    ...
    public WhatsappKirimFonnter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        //modif khanza
        if (templateWA != null && TPesan != null) {
            templateWA.addWindowListener(new WindowAdapter() {
                @Override
                public void windowClosed(WindowEvent e) {
                    try {
                        int selectedRow = templateWA.getTable().getSelectedRow();
                        if (selectedRow != -1) {
                            DefaultTableModel model = (DefaultTableModel) templateWA.getTable().getModel();

                            //auto template terisi
                            Object WaTemplate = model.getValueAt(selectedRow, 2);
                            TPesan.setText((WaTemplate != null ? WaTemplate.toString() : "").trim() + " ");
                            TPesan.requestFocus();

                            //auto terisi pada TFile
                            Object URLMedia = model.getValueAt(selectedRow, 3); // Ambil nilai
                            if (URLMedia != null) {
                                TFile.setText(URLMedia.toString().trim()); // Set nilai jika tidak null
                            } else {
                                TFile.setText(""); // Set kosong jika null
                            }
            ...
            templateWA.setVisible(false);
        } else {
            System.out.println("templateWA or TPesan is null.");
        }
    ...
    private void initComponents() {
        ...
        BtnTemplate.setGlassColor(new java.awt.Color(255, 255, 204));
        ...
        BtnKirim.setGlassColor(new java.awt.Color(204, 255, 204));
        ...
        BtnKirim.setBounds(290, 260, 110, 30);
        ...
        BtnKeluar.setMaximumSize(new java.awt.Dimension(50, 50));
        ...
        BtnKeluar.setBounds(670, 4, 30, 30);
        ...
        BtnTemplate1.setGlassColor(new java.awt.Color(255, 255, 204));
        ...
        TDokter.setBounds(260, 30, 180, 14);
        ...
        TPasien.setBounds(260, 10, 180, 14);
        ...
        jLabel1.setBounds(440, 30, 60, 14);
        ...
        jLabel3.setBounds(430, 250, 120, 30);
        ...
        jLabel7.setBounds(440, 10, 60, 14);

        DTPReg.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-08-2025" }));
        ...
        DTPReg.setBounds(560, 253, 140, 20);
        ...
        jLabel6.setBounds(200, 10, 60, 14);
        ...
        jLabel5.setBounds(200, 30, 60, 14);

        TFile.setEditable(false);
        TFile.setBackground(new java.awt.Color(153, 255, 204));
        TFile.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        TFile.setBorder(null);
        TFile.setName("TFile"); // NOI18N
        FormInput.add(TFile);
        TFile.setBounds(20, 340, 340, 14);

        TglKirim.setForeground(new java.awt.Color(50, 70, 50));
        TglKirim.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "15-08-2025 09:19:16" }));
        TglKirim.setDisplayFormat("dd-MM-yyyy HH:mm:ss");
        TglKirim.setName("TglKirim"); // NOI18N
        TglKirim.setOpaque(false);
        TglKirim.setPreferredSize(new java.awt.Dimension(111, 22));
        TglKirim.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TglKirimKeyPressed(evt);
            }
        });
        FormInput.add(TglKirim);
        TglKirim.setBounds(561, 280, 140, 20);

        jLabel8.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(123, 36, 28));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel8.setText("Tanggal Kirim :");
        jLabel8.setName("jLabel8"); // NOI18N
        FormInput.add(jLabel8);
        jLabel8.setBounds(430, 280, 120, 20);
...
private void BtnTemplateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTemplateActionPerformed
    ...
    try {
//        WhatsappTemplate temp = new WhatsappTemplate(null, false);
//        temp.tampil();
...
private void BtnTemplateKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnTemplateKeyPressed
    ...
    private void BtnKirimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnKirimActionPerformed
        if (NoHp.getText().trim().equals("") || NoHp.getText().trim().equals("")) {
            ...
            // Muat properti dari file XML
            Properties prop = new Properties();
            // JALANKAN FUNGSI JIKA JENIS WAGATEWAY ADALAH APP diambil dari WA Gateway Mas Kofa
            try {
                String message = TPesan.getText();
                String pesan = TPesan.getText();
                String nowa = NoHp.getText() + "@c.us";
                String tanggal = (String) DTPReg.getSelectedItem();
                String tanggalkirim = Valid.SetTgl(TglKirim.getSelectedItem() + "") + " " + TglKirim.getSelectedItem().toString().substring(11, 19);
                String urlfile = TFile.getText();
                String type = urlfile.isEmpty() ? "TEXT" : "FILE";
                message = message.replace("{nama}", TPasien.getText())
                        ...
                        .replace("{tanggalkirim}", tanggalkirim);
                ...
                PreparedStatement pswa = koneksiwa.prepareStatement("insert into wa_outbox (NOWA, PESAN, TANGGAL_JAM, STATUS, SOURCE, SENDER, SUCCESS, RESPONSE, REQUEST) values(?,?,?,?,?,?,?,?,?)");
                // Set nilai parameter
                pswa.setString(1, nowa); // NOWA
                pswa.setString(2, message); // PESAN
                pswa.setString(3, tanggalkirim); // TANGGAL_JAM
                pswa.setString(4, "ANTRIAN"); // STATUS
                pswa.setString(5, "RANAP"); // SOURCE
                pswa.setString(6, "NODEJS"); // SENDER
                pswa.setString(7, "0"); // SUCCESS
                pswa.setString(8, ""); // RESPONSE
                pswa.setString(9, ""); 
                
                int affectedRows = pswa.executeUpdate();
                
                // Cek berapa banyak baris yang terpengaruh
                try {
                    if (affectedRows > 0) {
                        JOptionPane.showMessageDialog(null, "Proses Berhasil, Cek WA Anda..!!");
                    }
                } catch (Exception e) {
                ...
                JOptionPane.showMessageDialog(null, "Gagal Memproses " + e);
            }
    ...
    private void TglKirimKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TglKirimKeyPressed

    }//GEN-LAST:event_TglKirimKeyPressed
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            WhatsappKirimFonnter dialog = new WhatsappKirimFonnter(new javax.swing.JFrame(), true);
    ...
    private widget.Tanggal TglKirim;
