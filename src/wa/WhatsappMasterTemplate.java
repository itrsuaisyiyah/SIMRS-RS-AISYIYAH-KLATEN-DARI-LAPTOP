...
public class WhatsappMasterTemplate extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public WhatsappMasterTemplate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        TabRawat.setSelectedIndex(1);

        Object[] row={"No.Template","Judul","Template"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Template Whatsapp ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        FormInput.setPreferredSize(new java.awt.Dimension(700, 400));
        ...
        FormInput.add(Nm);
        Nm.setBounds(274, 10, 280, 23);

        jLabel40.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel40.setText("Template :");
        ...
        Template.setColumns(5);
        Template.setRows(15);
        Template.setTabSize(6);
        ...
        scrollPane2.setBounds(16, 60, 550, 300);
        ...
        BtnSimpan.setMaximumSize(new java.awt.Dimension(22, 22));
        BtnSimpan.setMinimumSize(new java.awt.Dimension(22, 22));
...
//                    TabRawat.setSelectedIndex(0);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if(Nm.getText().trim().equals("")){
            ...
            if(Valid.hapusTabletf(tabMode,Kd,"wa_template","no_template")==true){
...
//            Valid.pindah(evt, BtnBatal, BtnEdit);
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            Valid.textKosong(Nm,"Nama Template");
        }else if(Template.getText().trim().equals("")){
            Valid.textKosong(Template,"Template ");
        }else{
            if(Valid.editTabletf(tabMode,"wa_template","no_template","?","no_template=?,nama_template=?,wa_template=?",4,new String[]{
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(Kd.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("wa_template","?,?,?","No.Template",3,new String[]{
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            WhatsappMasterTemplate dialog = new WhatsappMasterTemplate(new javax.swing.JFrame(), true);
    ...
    void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "select wa_template.no_template,wa_template.nama_template, "+
                    "wa_template.wa_template from wa_template "+
                    "where wa_template.no_template like ? or wa_template.nama_template like ? or "+
                    "wa_template.wa_template like ? order by wa_template.no_template");
            try {
    ...
    public void emptTeks() {
        ...
        Nm.setText("");
        Template.setText("");
        Valid.autoNomer("wa_template","WA",4,Kd);
        TabRawat.setSelectedIndex(0);
        Kd.requestFocus();
    }
    ...
    private void getCopy() {
        ...
        if(tabMode.getValueAt(tbDokter.getSelectedRow(),2).toString().trim().equals("")){
            JOptionPane.showMessageDialog(null,"Maaf, Silahkan pilih data terlebih dahulu...!!!");
            TCari.requestFocus();
        }else{
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
            WhatsappKirimFonnte kirim=new WhatsappKirimFonnte(null,false); 
            kirim.setPesan(tabMode.getValueAt(tbDokter.getSelectedRow(),2).toString());
