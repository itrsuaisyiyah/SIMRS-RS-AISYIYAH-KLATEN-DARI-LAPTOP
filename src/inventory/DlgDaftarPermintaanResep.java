...
import fungsi.WarnaTablePermintaanResepRalan;
import fungsi.WarnaTablePermintaanResepRanap;
...
public class DlgDaftarPermintaanResep extends javax.swing.JDialog {
    ...
    public DlgDaftarPermintaanResep(java.awt.Frame parent, boolean modal) {
        ...
        // DIPERBAIKI: sebelumnya pakai WarnaTable() generik (cuma warna selang-seling baris),
        // sehingga status "Sudah Terlayani"/"Belum Terlayani" (kolom 7) tidak pernah terwarnai
        // sama sekali. WarnaTablePermintaanResepRalan sudah dibuat khusus untuk ini tapi belum
        // pernah dipasang - sekarang dipasang supaya pewarnaan status benar-benar aktif.
        tbResepRalan.setDefaultRenderer(Object.class, new WarnaTablePermintaanResepRalan());
        ...
        // DIHAPUS: baris "tbResepRalan.setDefaultRenderer(Object.class, new WarnaTable());"
        // yang sebelumnya ada di sini adalah duplikat/leftover yang menimpa balik renderer
        // WarnaTablePermintaanResepRalan yang sudah benar dipasang di atas (baris ~94) -
        // inilah kenapa pewarnaan status masih belum berubah walau renderer sudah "dipasang".
        ...
        // DIPERBAIKI: sama seperti tbResepRalan - sebelumnya pakai WarnaTable() generik,
        // status "Sudah Terlayani"/"Belum Terlayani" (kolom 7) tidak pernah terwarnai.
        tbResepRanap.setDefaultRenderer(Object.class, new WarnaTablePermintaanResepRanap());
        ...
        // DIHAPUS: baris "tbResepRanap.setDefaultRenderer(Object.class, new WarnaTable());"
        // yang sebelumnya ada di sini adalah duplikat/leftover yang menimpa balik renderer
        // WarnaTablePermintaanResepRanap yang sudah benar dipasang di atas (baris ~177).
            ...
            obatralan.addWindowListener(new WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    ...
                    if(obatralan.sukses==true){
                        ...
                        // DITAMBAHKAN: setValueAt() cuma me-repaint sel yang berubah, bukan
                        // seluruh baris - padahal WarnaTablePermintaanResepRalan mewarnai
                        // seluruh baris berdasarkan status ini. Tanpa repaint() manual, warna
                        // baris lain di baris yang sama tidak ikut ter-update sampai ada trigger
                        // repaint lain (scroll/resize).
                        tbResepRalan.repaint();
                    }
                    obatralan=null;
                }
            }); 
