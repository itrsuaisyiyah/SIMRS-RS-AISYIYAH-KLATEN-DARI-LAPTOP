...
public final class SuratSakit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakSuratSakit4.setText("Cetak Surat Keterangan Inap");
        ...
        MnCetakSuratSakit1.setText("Cetak Surat Keterangan Diagnosa");
        ...
        MnCetakSuratSakit5.setHideActionText(true);
        ...
        MnCetakSuratSakit2.setEnabled(false);
        MnCetakSuratSakit2.setHideActionText(true);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Sakit / Diagnosa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TPasien.setBounds(330, 10, 365, 23);

        TanggalAkhir.setForeground(new java.awt.Color(50, 70, 50));
        TanggalAkhir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-09-2026" }));
        ...
        TanggalAkhir.setBounds(400, 40, 80, 23);
        ...
        LamaSakit.setBounds(550, 40, 90, 23);

        jLabel16.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel16.setText("s.d.");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(370, 40, 27, 23);

        jLabel18.setText("Lama Sakit :");
        jLabel18.setName("jLabel18"); // NOI18N
        FormInput.add(jLabel18);
        jLabel18.setBounds(480, 40, 70, 23);

        TanggalAwal.setForeground(new java.awt.Color(50, 70, 50));
        TanggalAwal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "02-09-2026" }));
        ...
        TanggalAwal.setBounds(280, 40, 80, 23);

        jLabel13.setText(" Tgl :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(250, 40, 30, 23);

        jLabel20.setText("Terapi/Tindakan");
        jLabel20.setName("jLabel20"); // NOI18N
        FormInput.add(jLabel20);
        jLabel20.setBounds(640, 40, 90, 23);

        LamaSakit1.setHighlighter(null);
        LamaSakit1.setName("LamaSakit1"); // NOI18N
        LamaSakit1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                LamaSakit1ActionPerformed(evt);
            }
        });
        LamaSakit1.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                LamaSakit1KeyPressed(evt);
            }
        });
        FormInput.add(LamaSakit1);
        LamaSakit1.setBounds(730, 40, 106, 23);
    ...
    private void MnCetakSuratSakitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakitActionPerformed
       if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                param.put("kontakrs",akses.getkontakrs());
                param.put("emailrs",akses.getemailrs());  
                // Dokter yang merawat diambil dengan urutan prioritas:
                // 1) dpjp_ranap (Dokter Penanggung Jawab Pasien) - untuk pasien rawat inap.
                // 2) rawat_jl_dr (dokter yang menangani tindakan rawat jalan) - untuk pasien
                //    rawat jalan yang tidak memiliki data di dpjp_ranap.
                // 3) reg_periksa.kd_dokter (dokter yang dituju saat pendaftaran) - cadangan
                //    terakhir apabila kedua sumber di atas kosong.
                // Ini mencegah nama dokter tampil "null" di laporan saat dpjp_ranap kosong.
                kodedokter=Sequel.cariIsi("select dpjp_ranap.kd_dokter from dpjp_ranap where dpjp_ranap.no_rawat=?",TNoRw.getText());
                if (kodedokter==null || kodedokter.trim().equals("")) {
                    kodedokter=Sequel.cariIsi("select rawat_inap_dr.kd_dokter from rawat_inap_dr where rawat_inap_dr.no_rawat=? "
                            + "order by rawat_inap_dr.tgl_perawatan desc,rawat_inap_dr.jam_rawat desc limit 1",TNoRw.getText());
                }
                if (kodedokter==null || kodedokter.trim().equals("")) {
                ...
                Valid.MyReportqry("rptSuratSakit5.jasper","report","::[ Surat Sakit ]::",
                              "select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,perusahaan_pasien.nama_perusahaan,reg_periksa.no_rawat," +
                              "'"+namadokter.replace("'","''")+"' as nm_dokter," +
                              "pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.jk," +
                              ...
                              " from reg_periksa inner join pasien inner join kelurahan inner join perusahaan_pasien inner join kecamatan inner join kabupaten" +
    ...
    private void MnCetakSuratSakit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit1ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                ...
                finger=Sequel.cariIsi("select sha1(sidikjari.sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",kodedokter);
                param.put("finger","Dikeluarkan di "+akses.getnamars()+", Kabupaten/Kota "+akses.getkabupatenrs()+"\nDitandatangani secara elektronik oleh "+namadokter+"\nID "+(finger.equals("")?kodedokter:finger)+"\n"+Sequel.cariIsi("select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y') from reg_periksa where reg_periksa.no_rawat=?",TNoRw.getText()));  
                Valid.MyReportqry("rptSuratSakit5D.jasper","report","::[ Surat Sakit ]::",
                              "select DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi,perusahaan_pasien.nama_perusahaan,reg_periksa.no_rawat," +
                              "'"+namadokter.replace("'","''")+"' as nm_dokter," +
                              "pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.jk," +
                              " pasien.nm_pasien,pasien.jk,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,pasien.pekerjaan,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat" +
    ...
    private void MnCetakSuratSakit5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakSuratSakit5ActionPerformed
        if(TPasien.getText().trim().equals("")){
            ...
            Valid.MyReportqry("rptSuratSakit4.jasper","report","::[ Surat Sakit ]::",
                      "select dpjp_ranap.no_rawat,dokter.nm_dokter,pasien.keluarga,pasien.namakeluarga,pasien.tgl_lahir,pasien.jk,DATE_FORMAT(reg_periksa.tgl_registrasi,'%d-%m-%Y')as tgl_registrasi," +
                      ...
                      " on reg_periksa.no_rkm_medis=pasien.no_rkm_medis and reg_periksa.kd_dokter=dokter.kd_dokter and pasien.kd_kel=kelurahan.kd_kel "+
                      " and pasien.kd_kec=kecamatan.kd_kec and pasien.kd_kab=kabupaten.kd_kab "+
                      "where dpjp_ranap.no_rawat='"+TNoRw.getText()+"' ",param);
            this.setCursor(Cursor.getDefaultCursor());  
        }
    }//GEN-LAST:event_MnCetakSuratSakit5ActionPerformed

    private void LamaSakit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LamaSakit1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_LamaSakit1ActionPerformed

    private void LamaSakit1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_LamaSakit1KeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_LamaSakit1KeyPressed
    ...
    */
    ...
    private widget.TextBox LamaSakit1;
