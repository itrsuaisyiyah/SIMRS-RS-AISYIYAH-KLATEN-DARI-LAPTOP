...
public final class SuratKewaspadaanKesehatan extends javax.swing.JDialog {
    ...
    public SuratKewaspadaanKesehatan(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tgl.Periksa","Diagnosa","Kode Dokter","Nama Dokter","Jenis Pelayanan"
        }){
    ...
    private void initComponents() {
        ...
        MnCetakSuratKewaspadaanKesehatan.setText("Cetak Surat Perintah Rawat Inap");
        ...
        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "12-02-2025" }));
        TanggalPeriksa.setDisplayFormat("dd-MM-yyyy");
        TanggalPeriksa.setName("TanggalPeriksa"); // NOI18N
        FormInput.add(TanggalPeriksa);
        TanggalPeriksa.setBounds(632, 10, 90, 23);

        jLabel5.setText("Jenis Pelayanan :");
        jLabel5.setName("jLabel5"); // NOI18N
        FormInput.add(jLabel5);
        jLabel5.setBounds(460, 40, 100, 23);
        ...
        Keperluan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Preventif", "Paliatif", "Kuratif", "Rehabilitatif", "Pelayanan Khusus/ Spesialistik / Intensif" }));
        ...
        Keperluan.setBounds(580, 40, 180, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(NoSurat.getText().trim().equals("")){
        ...
        }else if(Keperluan.getSelectedItem()==null || Keperluan.getSelectedItem().toString().trim().equals("")){
            ...
            if(Sequel.menyimpantf("surat_kewaspadaan_kesehatan","?,?,?,?,?","No.Surat",5,new String[]{
                    NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),Keluhan.getText(),Keperluan.getSelectedItem()+""
            })==true){
                tampil();
                emptTeks();
            }
        ...
        if(NoSurat.getText().trim().equals("")){
            ...
            if(tbObat.getSelectedRow()!= -1){
                if(Sequel.mengedittf("surat_kewaspadaan_kesehatan","no_surat=?","no_surat=?,no_rawat=?,tanggalperiksa=?,keluhan_saat_ini=?,keperluan=?",6,new String[]{
                        NoSurat.getText(),TNoRw.getText(),Valid.SetTgl(TanggalPeriksa.getSelectedItem()+""),Keluhan.getText(),Keperluan.getSelectedItem()+"",tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                    })==true){
                    ...
                    tbObat.setValueAt(Keperluan.getSelectedItem()+"",tbObat.getSelectedRow(),8);
                    emptTeks();
                }
            }
        }
    ...
    private void KeluhanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KeluhanKeyPressed
        Valid.pindah(evt,NoSurat,Keluhan);
    ...
    */
    ...
    private widget.ComboBox Keperluan;
    ...
    public void emptTeks() {
        ...
        TPasien.setText("");
        NoSurat.setText("");
        if(Keperluan.getItemCount()>0){
            Keperluan.setSelectedIndex(0);
        }
        Keluhan.setText("");
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            Keperluan.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),8).toString());      
        }
    }
