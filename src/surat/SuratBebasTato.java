...
public final class SuratBebasTato extends javax.swing.JDialog {
    ...
    public SuratBebasTato(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            "No.Surat","No.Rawat","No.R.M.","Nama Pasien","Tgl.Periksa","Dokter DPJP","Kode Dokter","Nama Dokter","Diagnosa"
        }){
        ...
        Keperluan.setDocument(new batasInput((byte)100).getKata(Keperluan));           
    ...
    private void initComponents() {
        ...
        MnCetakSuratBebasTato.setLabel("Cetak Surat Keterangan Emergency");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Surat Keterangan Emergency ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50)));
        ...
        HasilPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "dr. Agung Kurniawan, Sp.OG", "dr. Joko Prasanto, Sp.OG", "dr. Usman Arifin, Sp.OG", "dr. Purwanto, Sp.OG", "dr. Ahimsa Yoga Anindita, Sp.A", "dr. Ani Isti Rokhmawati, Sp.A., M.Sc.", "dr. Nov Sugiyanto, Sp.A", "dr. Samad, M.Sc. Sp.A(K)", "dr. Tri Hartanto, Sp.PD., FINASIM", "dr. Gheavita Chandra Dewi, Sp.PD", "dr. Husam, Sp.PD", "dr. Mayrovi Dewi Nyuyorike Djati, Sp.KFR", "dr. Nimas Ayu Suri P, Sp.JP", "dr. Riza Setya Agrensa, Sp.B", "dr. Hastomo Agung Wibowo, Sp.OT (K)", "dr. Diana Purnamasari, Sp.P", "dr. Unun Eka Yunita, Sp.N", "dr. Yossy Catharina, Sp.N", "dr. Saktiaji Hendro Iswoyo. Sp.B", "dr. Juli Purnomo, Sp.P", "dr. Kusumalaga Ramadhana Putra, Sp.PD", "dr. Ardhila Rahman Rasyada, Sp. T.H.T.B.K.L", "dr. Lukluk Purbaningrum, MPH., Sp.B", "-" }));
        ...
        HasilPeriksa.setBounds(297, 40, 200, 23);

        jLabel14.setText("Dokter DPJP :");
        jLabel14.setName("jLabel14"); // NOI18N
        FormInput.add(jLabel14);
        jLabel14.setBounds(218, 40, 80, 23);

        TanggalPeriksa.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-03-2026" }));
        ...
        jLabel5.setBounds(490, 40, 68, 23);
        ...
        Keperluan.setBounds(570, 40, 208, 23);
